...
description: Find out how delivery extensions can use the Notification class, which stores subscription information that is used when delivering reports.
ms.date: 03/06/2017
