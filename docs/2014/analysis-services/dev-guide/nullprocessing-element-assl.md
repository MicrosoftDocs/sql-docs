...
|*Error*|Raises a null key error. The value of [NullKeyNotAllowed](../../../2014/analysis-services/dev-guide/nullkeynotallowed-element-assl.md) determines how the instance reacts to the error. **Note:**  This value is not supported for measures.|  
|*UnknownMember*|Generates an unknown member and raises a null conversion error. The value of [NullKeyConvertedToUnknown](../../../2014/analysis-services/dev-guide/nullkeyconvertedtounknown-element-assl.md) determines how the instance reacts to the error. **Note:**  This value is not supported for columns associated with measures.|  
