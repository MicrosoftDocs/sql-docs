//<snippetFILESTREAM_CS_GetTransactionContext>
using System;
...
namespace ConsoleApplication
{
    ...
    class SqlAccessWrapper
    {
        ...
        /// SqlConnection object that represents the SqlServer to
        /// obtain the transaction context from.
        /// </param>
        /// <returns>
        /// If there is a current transaction context then the return
        /// value is an Object that represents the context.
        /// If there is not a current transaction context then the
        ...
        /// for the BEGIN TRANSACTION statement.
        /// </param>
        ...
        /// </summary>
        /// <param name="sqlConnection">
        /// SqlConnection object that represents the SqlServer
    ...
    class Program
    {
        ...
        {
            //Open a connection to the local SqlServer.
