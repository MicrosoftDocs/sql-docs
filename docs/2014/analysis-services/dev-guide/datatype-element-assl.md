...
|------------------|-------------|  
|Parent element|[DataItem](../../../2014/analysis-services/dev-guide/dataitem-data-type-assl.md), [Measure](../../../2014/analysis-services/dev-guide/measure-element-assl.md)|  
|Child elements|None|  
...
|*Inherited*|The data type of the `DataItem` contained in the [Source](../../../2014/analysis-services/dev-guide/source-element-measure-assl.md) element of the `Measure` element. **Note:**  Applicable only to `Measure` elements.|  
