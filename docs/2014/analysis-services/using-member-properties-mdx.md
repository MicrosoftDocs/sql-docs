...
> [!NOTE]  
>  In [!INCLUDE[msCoName](../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)], member properties are know as attribute relationships. For more information, see [Attribute Relationships](dev-guide/attribute-relationships.md).  
 ...
 For more information, see [Intrinsic Member Properties &#40;MDX&#41;](intrinsic-member-properties-mdx.md).  
 ...
 For more information, see [User-Defined Member Properties &#40;MDX&#41;](user-defined-member-properties-mdx.md).  
...
> [!NOTE]  
>  For more information about the `<set>` and `<axis_name>` values, see [Specifying the Contents of a Query Axis &#40;MDX&#41;](specifying-the-contents-of-a-query-axis-mdx.md).  
...
-   Context sensitive intrinsic member properties must be preceded with the name of the dimension or level. However, non-context sensitive intrinsic member properties cannot be qualified by the dimension or level name. For more information about how to use the `PROPERTIES` keyword with intrinsic member properties, see [Intrinsic Member Properties &#40;MDX&#41;](intrinsic-member-properties-mdx.md).  
  
-   User-defined member properties should be preceded by the name of the level in which they reside. For more information about how to use the `PROPERTIES` keyword with user-defined member properties, see [User-Defined Member Properties &#40;MDX&#41;](user-defined-member-properties-mdx.md).  
