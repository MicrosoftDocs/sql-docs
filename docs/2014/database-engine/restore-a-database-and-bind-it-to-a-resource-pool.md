...
1.  [Restore with NORECOVERY](../../2014/database-engine/restore-a-database-and-bind-it-to-a-resource-pool.md#bkmk_NORECOVERY)  
  
2.  [Create the resource pool](../../2014/database-engine/restore-a-database-and-bind-it-to-a-resource-pool.md#bkmk_createPool)  
  
3.  [Bind the database and resource pool](../../2014/database-engine/restore-a-database-and-bind-it-to-a-resource-pool.md#bkmk_bind)  
  
4.  [Restore with RECOVERY](../../2014/database-engine/restore-a-database-and-bind-it-to-a-resource-pool.md#bkmk_RECOVERY)  
  
5.  [Monitor the resource pool performance](../../2014/database-engine/restore-a-database-and-bind-it-to-a-resource-pool.md#bkmk_Monitor)  
