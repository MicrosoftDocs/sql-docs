---
title: Connect SQL Servers on Azure Arc-enabled servers at scale using Autodeploy
description: In this article, you learn how to use Autodeploy to connect SQL Server instances to Azure Arc at scale.
author: pochiraju
ms.author: rajpo
...
# Connect SQL Server instances to Azure at scale | Autodeploy
