...
-   You can use the Help Library Manager to install [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Books Online on a local computer. For more information, see [Add or Remove Product Documentation for SQL Server](~/2014/books-online-for-sql-server-2014.md).  
...
## See Also  
 [Use Product Documentation for SQL Server](~/2014/books-online-for-sql-server-2014.md)  
