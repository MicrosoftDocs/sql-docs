---
title: "CREATE TABLE statements (SQL Server PDW)"
ms.custom: na
ms.date: 07/27/2016
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 3795ce86-6d69-4ae3-8b15-4867b4e6da8d
caps.latest.revision: 3
author: BarbKess
---
# CREATE TABLE statements (SQL Server PDW)
This section contains statement for creating tables in SQL Server PDW.  
