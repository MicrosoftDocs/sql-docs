...
2.  Select the CDC service you want to work with.  
     ...
     You can also right-click the CDC service you want to work with and select the desired action. See [What can you do with a CDC Service](../../2014/integration-services/manage-an-oracle-cdc-service.md#BKMK_WhatcandowithCDCService).  
...
## See Also  
 [How to Manage a Local CDC Service](../../2014/integration-services/how-to-manage-a-local-cdc-service.md)  
