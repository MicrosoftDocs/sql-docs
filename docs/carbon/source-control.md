...
Carbon provides the same integrated source control as VS Code and includes [Git](https://git-scm.com/) support in-the-box.
...
![install additional scm providers](media/source-control/additional-scm-providers.png)
