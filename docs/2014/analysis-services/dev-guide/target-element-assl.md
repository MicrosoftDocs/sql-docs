...
---
# Target Element (ASSL)
  Identifies the target of the [Action](../../../2014/analysis-services/dev-guide/action-element-assl.md) element.  
...
## Remarks  
 The expected value of this element depends on the value of the [TargetType](../../../2014/analysis-services/dev-guide/targettype-element-assl.md) element for the parent `Action`. The following table describes the expected values of `Target` based on the value of `TargetType`.  
