...
description: View an example of how to generate siblings by using a nested AUTO mode query as an alternative to using EXPLICIT mode to generate the same XML.
ms.custom: ""
ms.date: "03/04/2017"
ms.prod: sql
