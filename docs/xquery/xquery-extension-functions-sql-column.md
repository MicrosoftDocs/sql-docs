...
description: Learn how the XQuery function sql:column() can be used with the query() method to bind non-XML relational data inside XML and bring relational and XML data together.
ms.custom: ""
ms.date: "03/16/2017"
ms.prod: sql
ms.prod_service: sql
