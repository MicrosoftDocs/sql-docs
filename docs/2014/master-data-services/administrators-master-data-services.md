...
-   If the user has access to other functional areas, the user can perform all administrative tasks available in the functional area.  
 ...
 A user can be configured as a model administrator either in [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] or programmatically. For more information, see [Create a Model Administrator &#40;Master Data Services&#41;](master-data-services-installation-and-configuration.md).  
...
## See Also  
 [Create a Model Administrator &#40;Master Data Services&#41;](master-data-services-installation-and-configuration.md)   
