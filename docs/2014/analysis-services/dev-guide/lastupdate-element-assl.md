...
# LastUpdate Element (ASSL)
  Contains a read-only timestamp that indicates the last time that the associated [Database](../../../2014/analysis-services/dev-guide/database-element-assl.md) or any of the major objects that the database contains were altered.  
...
|------------------|-------------|  
|Parent element|[Database](../../../2014/analysis-services/dev-guide/database-element-assl.md)|  
|Child elements|None|  
