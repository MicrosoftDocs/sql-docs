...
## Displaying Line Numbers  
 You can turn on line numbering in your code. Line numbers are useful for navigating code. For more information, see [Navigate Code and Text](../../2014/database-engine/navigate-code-and-text.md).  
