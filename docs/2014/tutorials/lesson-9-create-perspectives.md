...
# Lesson 9: Create Perspectives
 ...
 To learn more, see [Perspectives &#40;SSAS Tabular&#41;](../../2014/analysis-services/perspectives-ssas-tabular.md).  
  
 Estimated time to complete this lesson: **5 minutes**  
  
## Prerequisites  
 This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 8: Create Key Performance Indicators](../../2014/tutorials/lesson-8-create-key-performance-indicators.md).  
...
## Next Steps  
 To continue this tutorial, go to the next lesson: [Lesson 10: Create Hierarchies](../../2014/tutorials/lesson-10-create-hierarchies.md).  
