...
3.  When you are ready to assign user and group accounts to specific roles, use Report Manager. For more information, see [Grant User Access to a Report Server &#40;Report Manager&#41;](../../2014/reporting-services/grant-user-access-to-a-report-server-report-manager.md).  
...
|Set security policies for items|Define security policies for reports, linked reports, folders, resources, and data sources. For more information, see [Securable Items](../../2014/reporting-services/securable-items.md).|  
...
### Customizing the Content Manager Role  
 ...
 The **Content Manager** role is used in default security. For more information, see [Using Default Security](../../2014/reporting-services/predefined-roles.md).  
...
##  <a name="bkmk_myreports"></a> My Reports Role  
 ...
 Although you can choose another role to use with the My Reports feature, it is recommended that you choose one that is used exclusively for My Reports security. For more information, see [Secure My Reports](../../2014/reporting-services/secure-my-reports.md).  
...
|Manage jobs|View and cancel jobs that are running. For more information, see [Manage a Running Process](../../2014/reporting-services/manage-a-running-process.md).|  
...
|Manage report server security|View and modify system-wide role assignments|  
 ...
 The **System Administrator** role is used in default security. For more information, see [Using Default Security](../../2014/reporting-services/predefined-roles.md).  
