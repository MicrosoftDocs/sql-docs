...
## In This Section  
 ...
 [Using DiffGrams to Modify Data in SQLXML 4.0](../../../2014/database-engine/dev-guide/using-diffgrams-to-modify-data-in-sqlxml-4-0.md)  
 Describes Diffgrams and provides examples of their usage.  
  
 [Using SQLXML Bulk Load in the .NET Environment](../../../2014/database-engine/dev-guide/using-sqlxml-bulk-load-in-the-net-environment.md)  
