...
|operation_name|**nvarchar(4000)**|The job ID for a map-reduce job. This is returned by Hadoop after [!INCLUDEssazuresynapse-md(../../includes/ssazuresynapse-md.md)] submits the job.||  
