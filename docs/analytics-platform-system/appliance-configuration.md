...
|The password for DSRM can be changed.<br /><br />(Optional)|For more information, see [Set Admin Password for Logging on to AD Nodes in Directory Services Restore Mode &#40;DSRM&#41; &#40;Analytics Platform System&#41;](set-admin-password-for-logging-on-to-ad-nodes-in-directory-services-restore-mode-dsrm.md).|  
