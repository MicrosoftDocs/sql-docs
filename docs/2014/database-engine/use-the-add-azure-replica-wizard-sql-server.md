...
####  <a name="Permissions"></a> Permissions  
 See [Security](../../2014/database-engine/use-the-add-replica-to-availability-group-wizard-sql-server-management-studio.md#Security)  
  
##  <a name="SSMSProcedure"></a> Using the Add Azure Replica Wizard (SQL Server Management Studio)  
 The Add Azure Replica Wizard can be launched from the [Specify Replicas Page](../../2014/database-engine/specify-replicas-page-new-availability-group-wizard-add-replica-wizard.md). There are two ways to reach this page:  
...
6.  Continue with the rest of the configuration steps for [Specify Replicas Page](../../2014/database-engine/specify-replicas-page-new-availability-group-wizard-add-replica-wizard.md) as you do for any new replica.  
