...
### In-Memory Database
[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]’s In-Memory Database technologies allow you to deliver sub-millisecond response times over your databases.
