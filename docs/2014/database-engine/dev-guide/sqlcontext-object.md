...
-   `SqlPipe`: The `SqlPipe` object represents the "pipe" through which results flow to the client. For more information about the `SqlPipe` object, see [SqlPipe Object](../../../2014/database-engine/dev-guide/sqlpipe-object.md).  
