...
|xml_compression|**bit**|**Applies to**: [!INCLUDE[ssSQL22](../../includes/sssql22-md.md)] and later.<br /><br /> Indicates the state of XML compression for each partition:<br /><br /> 0 = OFF <br />1 = ON|
|xml_compression_desc|**varchar(3)**|**Applies to**: [!INCLUDE[ssSQL22](../../includes/sssql22-md.md)] and later.<br /><br /> Indicates the state of XML compression for each partition. Possible values are OFF and ON.|
