...
1.  All the instances contained by `CompoundCurve` instance are accepted circular arc segment instances. For more information on accepted circular arc segment instances, see [LineString](../../2014/database-engine/linestring.md) and [CircularString](../../2014/database-engine/circularstring.md).  
...
```  
 ...
 `@g3` is valid because the `CircularString` instance is valid. For more information on the validity of the `CircularString` instance, see [CircularString](../../2014/database-engine/circularstring.md).  
