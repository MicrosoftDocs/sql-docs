...
- -P *password*  
Specifies the password for the login ID. When used with the -G option without -U specifies a file that contains an access token (v17.8+). The token file should be in UTF-16 format when used with AAD access tokens.  
