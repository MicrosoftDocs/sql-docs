...
description: In SQL Server Reporting Services in SharePoint integrated mode, set options to determine when data processing occurs, a time-out value, and other options.
ms.date: 10/05/2017
