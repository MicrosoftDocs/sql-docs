...
For more information on the requirements of building CLR database objects, see [Building Database Objects with Common Language Runtime (CLR) Integration](http://msdn.microsoft.com/library/ms131046.aspx).  
...
[Advantages of Using Managed Code to Create Database Objects](http://msdn.microsoft.com/library/k2e1fb36.aspx)  
[Building Database Objects with Common Language Runtime (CLR) Integration](http://msdn.microsoft.com/library/ms131046.aspx)  
