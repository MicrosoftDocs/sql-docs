...
## Parts  
 *object*  
 A [ServerNetworkProtocolIPAdress Class](../../../2014/database-engine/dev-guide/servernetworkprotocolipaddress-class.md) object that represents an IP address for the network protocol on the instance of [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
