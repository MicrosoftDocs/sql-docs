...
description: You can detach and reattach data and transaction log files of a SQL Server database to change the database to a different instance to move the database.
ms.custom: ""
ms.date: "11/26/2018"
ms.prod: sql
