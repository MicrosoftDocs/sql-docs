...
-   Right-click anywhere in the [Results pane](../../2014/database-engine/results-pane-visual-database-tools.md), on the shortcut menu point to **Pane**, and then click **Clear Results**.  
