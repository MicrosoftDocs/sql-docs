...
At this time, CTP 2.4 supports connecting to Azure Data Lake Storage Gen2 and Amazon S3. Instructions on how to mount against these storage types can be found here [TODO' ADD LINK to how-to-mount-adlsgen2 and how-to-mount-s3].
...
[*TODO*: LINK to ADLSgen2 and S3 topics]
