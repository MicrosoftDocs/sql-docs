...
description: Learn about code access security in Reporting Services. Read about how evidence, code groups, and named permission sets factor into a security policy.
ms.date: 03/14/2017
