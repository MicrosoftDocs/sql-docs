...
For detailed information about Default Field Set, see [Configure Default Field Set for Power View Reports](../tabular-models/power-view-configure-default-field-set-for-reports.md).  
