...
|**EventClass**|**int**|Type of event=171|27|No|  
...
|**LoginName**|**nvarchar**|Name of the login of the user (either a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] security login or the [!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows login credentials in the form of DOMAIN\username).|11|Yes|  
...
|**Permissions**|**bigint**|Integer value representing the type of permissions checked.<br /><br /> 1 = SELECT ALL<br /><br /> 2 = UPDATE ALL<br /><br /> 4 = REFERENCES ALL<br /><br /> 8 = INSERT<br /><br /> 16 = DELETE<br /><br /> 32 = EXECUTE (procedures only)<br /><br /> 4096 = SELECT ANY (at least one column)<br /><br /> 8192 = UPDATE ANY|19|Yes|  
