...
# ImpersonationInfoSecurity Element (ASSL)
  Contains a read-only value that indicates if any changes were made to the security credentials that are supplied in the [ImpersonationInfo](../../../2014/analysis-services/dev-guide/impersonationinfo-data-type-assl.md) data type.  
...
|------------------|-------------|  
|Parent element|[ImpersonationInfo](../../../2014/analysis-services/dev-guide/impersonationinfo-data-type-assl.md)|  
|Child elements|None|  
