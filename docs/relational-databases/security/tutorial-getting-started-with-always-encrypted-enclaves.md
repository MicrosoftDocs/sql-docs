...
- CPU support for virtualization technologies:
  ...
  - If you're running [!INCLUDE [ssnoversion-md](../../includes/ssnoversion-md.md)] in a VM:
    - In Azure, use a [Generation 2 VM size](/azure/virtual-machines/generation-2#generation-2-vm-sizes) (recommended) or use a Generation 1 VM size with nested virtualization enabled. Check the individual [virtual machine sizes](/azure/virtual-machines/sizes) documentation to determine which Generation 1 VM sizes support nested virtualization.
