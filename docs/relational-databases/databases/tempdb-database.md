...
- **Internal objects** that are created by the [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]. These include:
...
## Physical Properties of tempdb  
 The following table lists the initial configuration values of the **tempdb** data and log files, which are based on the defaults for the Model database. The sizes of these files may vary slightly for different editions of [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
