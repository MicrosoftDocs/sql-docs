...
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sqlserver.md)]
  ...
  This topic contains information about the using a contained database with [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)] in [!INCLUDE[ssCurrent](../../../includes/ssnoversion-md.md)].  
