...
For more information regarding DACFx, please see the DACFx managed API documentation at [http://msdn.microsoft.com/en-us/library/microsoft.sqlserver.dac.aspx](http://msdn.microsoft.com/en-us/library/microsoft.sqlserver.dac.aspx) or [SqlPackage.exe](../ssdt/sqlpackage-exe.md) (DACFx command-line tool).  
