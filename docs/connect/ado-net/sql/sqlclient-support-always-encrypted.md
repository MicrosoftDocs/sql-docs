...
- `Attestation Protocol` - specifies an attestation protocol.
  ...
  - If you're using [!INCLUDE[ssSDSfull](../../../includes/ssazure-sqldb.md)] with Intel SGX enclaves and Microsoft Azure Attestation, the value of this keyword should be `AAS`.
  - If you're using [!INCLUDE[ssSDSfull](../../../includes/ssazure-sqldb.md)] or [!INCLUDE [ssnoversion-md](../../../includes/ssnoversion-md.md)] with VBS enclaves and want to forgo attestation, the value of this keyword should be `None`. Requires version 4.1 or higher. 

  > [!NOTE]
  > 'None' (no attestation) is the only option currently supported for VBS enclaves in [!INCLUDE[ssSDSfull](../../../includes/ssazure-sqldb.md)].
