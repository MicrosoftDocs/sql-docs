...
###### [Use the PowerShell Provider for Extended Events](use-the-powershell-provider-for-../relational-databases/extended-events/extended-events.md)
...
##### [Monitor System Activity Using Extended Events](monitor-system-activity-using-../relational-databases/extended-events/extended-events.md)
#### [SQL Trace](sql-trace.md)
##### [Create and Run Traces Using Transact-SQL Stored Procedures](../relational-databases/native-client/ole-db/stored-procedures.md)
...
##### [Open Log File Viewer](open-../relational-databases/logs/log-file-viewer.md)
...
##### [Requirements for Using Memory-Optimized Tables](../relational-databases/in-memory-oltp/memory-optimized-tables.md)
...
###### [Determining the Correct Bucket Count for Hash Indexes](determining-the-correct-bucket-count-for-../relational-databases/indexes/indexes.md)
###### [Troubleshooting Common Performance Problems with Memory-Optimized Hash Indexes](troubleshooting-common-performance-problems-with-memory-optimized-../relational-databases/indexes/indexes.md)
##### [Natively Compiled Stored Procedures](../relational-databases/in-memory-oltp/natively-compiled-stored-procedures.md)
###### [Creating Natively Compiled Stored Procedures](../relational-databases/in-memory-oltp/creating-../relational-databases/in-memory-oltp/natively-compiled-stored-procedures.md)
###### [Atomic Blocks](../relational-databases/in-memory-oltp/atomic-blocks-in-native-procedures.md)
###### [Supported Constructs in Natively Compiled Stored Procedures](supported-constructs-in-../relational-databases/in-memory-oltp/natively-compiled-stored-procedures.md)
###### [Using Try..Catch in Natively Compiled Stored Procedures](using-try-catch-in-../relational-databases/in-memory-oltp/natively-compiled-stored-procedures.md)
###### [Supported Constructs on Natively Compiled Stored Procedures](supported-constructs-on-../relational-databases/in-memory-oltp/natively-compiled-stored-procedures.md)
...
###### [Best Practices for Calling Natively Compiled Stored Procedures](../relational-databases/in-memory-oltp/best-practices-for-calling-../relational-databases/in-memory-oltp/natively-compiled-stored-procedures.md)
###### [Monitoring Performance of Natively Compiled Stored Procedures](../relational-databases/in-memory-oltp/monitoring-performance-of-../relational-databases/in-memory-oltp/natively-compiled-stored-procedures.md)
...
##### [Backup, Restore, and Recovery of Memory-Optimized Tables](../relational-databases/in-memory-oltp/restore-and-recovery-of-memory-optimized-tables.md)
...
###### [Migration Issues for Natively Compiled Stored Procedures](../relational-databases/in-memory-oltp/migration-issues-for-../relational-databases/in-memory-oltp/natively-compiled-stored-procedures.md)
...
####### [Implementing the OR Operator in Natively Compiled Stored Procedures](implementing-the-or-operator-in-../relational-databases/in-memory-oltp/natively-compiled-stored-procedures.md)
...
##### [Columnstore Indexes Described](../relational-databases/indexes/columnstore-indexes-overview.md)
...
###### [Non-XML Format Files](../relational-databases/import-export/xml-format-files-sql-server.md)
...
##### [Audit Broker Conversation Event Class](../relational-databases/event-classes/audit-../relational-databases/event-classes/broker-conversation-event-class.md)
...
##### [Unprepare SQL Event Class](un../relational-databases/event-classes/prepare-sql-event-class.md)
