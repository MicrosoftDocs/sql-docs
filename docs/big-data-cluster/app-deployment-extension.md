...
This extension is in private preview.  If you find any bugs or have any feedback, feel free to reach out through the teams channel.

### Install

Download the sqlservbdc-app-deploy .vsix file (link to be added) in order to install the extension as part of Visual Studio Code.  
