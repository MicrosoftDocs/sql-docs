...
|version_record_count|**bigint**|[!INCLUDE[SQL2019](../../includes/applies-to-version/sqlserver2019.md)] through [current version](https://go.microsoft.com/fwlink/p/?LinkId=299658)), [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)] <br /> This is the count of the row version records being maintained in this index.  These row versions are maintained by the [Accelerated Database Recovery](../../relational-databases/accelerated-database-recovery-concepts.md) feature.|  
|inrow_version_record_count|**bigint**|[!INCLUDE[SQL2019](../../includes/applies-to-version/sqlserver2019.md)] through [current version](https://go.microsoft.com/fwlink/p/?LinkId=299658)), [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]<br />  Count of ADR version records kept in the data row for fast retrieval.|  
|inrow_diff_version_record_count|**bigint**| [!INCLUDE[SQL2019](../../includes/applies-to-version/sqlserver2019.md)] through [current version](https://go.microsoft.com/fwlink/p/?LinkId=299658)), [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]<br />  Count of ADR version records kept in the form of differences from the base version|  
|total_inrow_version_payload_size_in_bytes|**bigint**|[!INCLUDE[SQL2019](../../includes/applies-to-version/sqlserver2019.md)] through [current version](https://go.microsoft.com/fwlink/p/?LinkId=299658)), [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]<br />  Total size in bytes of the inrow version records for this index|  
|offrow_regular_version_record_count|**bigint**|[!INCLUDE[SQL2019](../../includes/applies-to-version/sqlserver2019.md)] through [current version](https://go.microsoft.com/fwlink/p/?LinkId=299658)), [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]<br />  Count of version records being kept outside the original data row|  
|offrow_long_term_version_record_count|**bigint**|[!INCLUDE[SQL2019](../../includes/applies-to-version/sqlserver2019.md)] through [current version](https://go.microsoft.com/fwlink/p/?LinkId=299658)), [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]<br />  Count of version records considered long term.|  
