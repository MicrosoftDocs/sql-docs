...
-   An update is implemented as a delete followed by an insert. The deleted rows are not immediately removed from the storage. The deleted rows are removed by a background process, called MERGE, based on a policy as described in [Durability for Memory-Optimized Tables](../../2014/database-engine/durability-for-memory-optimized-tables.md).  
...
-   [Configuring Storage for Memory-Optimized Tables](../../2014/database-engine/configuring-storage-for-memory-optimized-tables.md)  
  
-   [The Memory Optimized Filegroup](../../2014/database-engine/the-memory-optimized-filegroup.md)  
  
-   [Durability for Memory-Optimized Tables](../../2014/database-engine/durability-for-memory-optimized-tables.md)  
  
-   [Checkpoint Operation for Memory-Optimized Tables](../../2014/database-engine/checkpoint-operation-for-memory-optimized-tables.md)  
  
-   [Defining Durability for Memory-Optimized Objects](../../2014/database-engine/defining-durability-for-memory-optimized-objects.md)  
  
-   [Comparing Disk-Based Table Storage to Memory-Optimized Table Storage](../../2014/database-engine/comparing-disk-based-table-storage-to-memory-optimized-table-storage.md)  
  
-   [Monitoring and Troubleshooting Merge for Data and Delta File Pairs](../../2014/database-engine/monitoring-and-troubleshooting-merge-for-data-and-delta-file-pairs.md)  
