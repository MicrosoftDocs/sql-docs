...
|Java/Machine Learning Services (In-Database)| /SQL_INST_JAVA, <br /><br /> /SQLJAVADIR = "path"<br /><br /> **Optional** | Starting with SQL Server 2019, specifies installing Java with the Machine Learning Services. If /SQL_INSTA_JAVA is provided without the /SQLJAVADIR parameter, it's assumed you want to install the Zulu JRE that is provided by the installation media. <br /><br /> Providing a path for /SQLJAVADIR indicates you would like to use an already-installed version of the JRE or JDK. |
