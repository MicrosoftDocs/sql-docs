...
5.  Join the new secondary replica to the availability group. For more information, see [Join a Secondary Replica to an Availability Group &#40;SQL Server&#41;](../../2014/database-engine/join-a-secondary-replica-to-an-availability-group-sql-server.md).  
...
7.  Join every new secondary database to the availability group. For more information, see [Join a Secondary Replica to an Availability Group &#40;SQL Server&#41;](../../2014/database-engine/join-a-secondary-replica-to-an-availability-group-sql-server.md).  
...
-   **Blogs:**  
     ...
     [Configuring AlwaysOn with SQL Server PowerShell](http://blogs.msdn.com/b/sqlalwayson/archive/2012/02/03/configuring-alwayson-with-sql-server-powershell.aspx)  
