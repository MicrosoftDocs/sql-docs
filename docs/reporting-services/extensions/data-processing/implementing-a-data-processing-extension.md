...
description: Read an overview of how to create a bridge between a data source and a dataset in Reporting Services by implementing a data processing extension.
ms.date: 03/14/2017
