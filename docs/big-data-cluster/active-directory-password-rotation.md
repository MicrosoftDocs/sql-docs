...
Use the following `azdata` command to update the autogenerated passwords. For more information on `azdata bdc rotate`, see the [azdata reference](/sql/azdata/reference/reference-azdata-bdc-rotate.md).
