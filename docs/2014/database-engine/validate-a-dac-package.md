...
-   Unpack the DAC package into a folder by following the instructions in [Unpack a DAC Package](../../2014/database-engine/unpack-a-dac-package.md).  
...
4.  For more information on using the wizard, see [Upgrade a Data-tier Application](../../2014/database-engine/upgrade-a-data-tier-application.md).  
...
## See Also  
 ...
 [Upgrade a Data-tier Application](../../2014/database-engine/upgrade-a-data-tier-application.md)  
