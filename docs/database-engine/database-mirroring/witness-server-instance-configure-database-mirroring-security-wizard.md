...
> [!NOTE]
>  A witness server instance is not available in every edition of [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. [!INCLUDE [editions-2016](../../includes/editions-2016.md)]
