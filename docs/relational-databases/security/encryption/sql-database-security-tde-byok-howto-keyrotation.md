...
description: Learn how to rotate the Transparent Data Encryption (TDE) protector for Azure SQL Database or Data Warehouse.
keywords: 
...
There are two options to rotate the TDE protector on the server:
