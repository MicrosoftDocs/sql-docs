...
| -------------------------- | ----------------------------- | ----------- |
| mssql-jdbc-7.4.0.jre12.jar | JDBC 4.3 (partially), and 4.2 | JDK 12.0    |
| mssql-jdbc-7.4.0.jre11.jar | JDBC 4.3 (partially), and 4.2 | JDK 11.0    |
| mssql-jdbc-7.4.0.jre8.jar  | JDBC 4.2                      | JDK 8.0     |
