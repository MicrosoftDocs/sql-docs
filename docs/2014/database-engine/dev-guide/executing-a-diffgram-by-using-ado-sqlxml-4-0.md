...
1.  To a folder on your computer, copy any one of the DiffGrams and the corresponding XSD schema from one of the examples in [DiffGram Examples](../../../2014/database-engine/dev-guide/diffgram-examples-sqlxml-4-0.md).  
