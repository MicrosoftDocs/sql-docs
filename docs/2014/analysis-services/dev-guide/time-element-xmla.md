...
---
# Time Element (XMLA)
  Specifies the time limit used by the [DesignAggregations](../../../2014/analysis-services/dev-guide/designaggregations-element-xmla.md) command to design aggregations.  
