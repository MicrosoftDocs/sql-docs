...
-   PDF, Excel, TIFF, XML, and CSV process the entire report in memory before displaying the report to the user.  
 ...
 To measure the size of a rendered report, you can view the report execution log. For more information, see [Report Server Execution Log and the ExecutionLog3 View](../../2014/reporting-services/report-server-execution-log-and-the-executionlog3-view.md).  
...
## See Also  
 ...
 [Process Large Reports](../../2014/reporting-services/process-large-reports.md)  
