...
|Data Loads|Files per load.|10,000<br /><br />[dwloader Command-Line Loader &#40;SQL Server PDW&#41;](../../mpp/sqlpdw/dwloader-command-line-loader-sql-server-pdw.md) can load a maximum of 10,000 files from the same directory.|  
...
|Minimum password length|Password characters|7 to 128 characters.<br /><br />For more information on password policies, see [CREATE LOGIN &#40;SQL Server PDW&#41;](../../mpp/sqlpdw/create-login-sql-server-pdw.md).|  
