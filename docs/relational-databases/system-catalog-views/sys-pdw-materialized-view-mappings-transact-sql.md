...
- [sys.pdw_materialized_view_distribution_properties (Transact-SQL) (preview)](sys-pdw-materialized-view-distribution-properties-transact-sql.md?view=azure-sqldw-latest&preserve-view=true)
