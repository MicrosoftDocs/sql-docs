...
# Primary and Foreign Key Constraints
 ...
 [Primary Key Constraints](../../2014/database-engine/primary-and-foreign-key-constraints.md#PKeys)  
  
 [Foreign Key Constraints](../../2014/database-engine/primary-and-foreign-key-constraints.md#FKeys)  
  
 [Related Tasks](../../2014/database-engine/primary-and-foreign-key-constraints.md#Tasks)  
...
|Task|Topic|  
|----------|-----------|  
|Describes how to create a primary key.|[Create Primary Keys](../../2014/database-engine/create-primary-keys.md)|  
|Describes how to delete a primary key.|[Delete Primary Keys](../../2014/database-engine/delete-primary-keys.md)|  
|Describes how to modify a primary key.|[Modify Primary Keys](../../2014/database-engine/modify-primary-keys.md)|  
|Describes how to create foreign key relationships|[Create Foreign Key Relationships](../../2014/database-engine/create-foreign-key-relationships.md)|  
|Describes how to modify foreign key relationships.|[Modify Foreign Key Relationships](../../2014/database-engine/modify-foreign-key-relationships.md)|  
|Describes how to delete foreign key relationships.|[Delete Foreign Key Relationships](../../2014/database-engine/delete-foreign-key-relationships.md)|  
|Describes how to view foreign key properties.|[View Foreign Key Properties](../../2014/database-engine/view-foreign-key-properties.md)|  
|Describes how to disable foreign key constraints for replication.|[Disable Foreign Key Constraints for Replication](../../2014/database-engine/disable-foreign-key-constraints-for-replication.md)|  
|Describes how to disable foreign key constraints during an INSERT or UPDATE statement.|[Disable Foreign Key Constraints with INSERT and UPDATE Statements](../../2014/database-engine/disable-foreign-key-constraints-with-insert-and-update-statements.md)|  
