...
-   The [Steps](../../../2014/analysis-services/dev-guide/steps-element-xmla.md) property determines how many iterations the `DesignAggregations` command should take before it returns control to the client application.  
