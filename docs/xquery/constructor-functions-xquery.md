...
description: Learn about the constructor functions in XQuery, that allow you to create instances of any of the XSD built-in or user-defined atomic types.
ms.custom: ""
ms.date: "03/09/2017"
ms.prod: sql
ms.prod_service: sql
