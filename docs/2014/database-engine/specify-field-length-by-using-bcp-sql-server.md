...
## The bcp Prompt for Field Length  
 ...
 For an example that shows this prompt in context, see [Specify Data Formats for Compatibility when Using bcp &#40;SQL Server&#41;](../../2014/database-engine/specify-data-formats-for-compatibility-when-using-bcp-sql-server.md).  
...
|XML|0|  
 ...
 \*For more information about the `decimal` and `numeric` data types, see [decimal and numeric &#40;Transact-SQL&#41;](../Topic/decimal%20and%20numeric%20\(Transact-SQL\).md).  
...
|`timestamp`|8|  
 ...
 <sup>1</sup> For more information about the `decimal` and `numeric` data types, see [decimal and numeric &#40;Transact-SQL&#41;](../Topic/decimal%20and%20numeric%20\(Transact-SQL\).md).  
