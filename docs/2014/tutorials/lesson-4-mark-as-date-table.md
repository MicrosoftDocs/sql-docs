...
## Prerequisites  
 This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 3: Rename Columns](../../2014/tutorials/lesson-3-rename-columns.md).  
...
## Next Steps  
 To continue this tutorial, go to the next lesson: [Lesson 5: Create Relationships](../../2014/tutorials/lesson-5-create-relationships.md).  
