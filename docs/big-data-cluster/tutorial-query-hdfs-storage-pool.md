...
description: This tutorial demonstrates how to query HDFS data in a SQL Server 2019 Big Data Clusters. You create an external table over data in the storage pool and then run a query.
author: MikeRayMSFT 
ms.author: mikeray
