...
###  <a name="bkmk_Templates"></a> DMX Templates  
 ...
 For an example of how to create a prediction query from a template, see [Create a Singleton Prediction Query from a Template](../../2014/analysis-services/create-a-singleton-prediction-query-from-a-template.md).  
...
## See Also  
 ...
 [Create a DMX Query in SQL Server Management Studio](../../2014/analysis-services/create-a-dmx-query-in-sql-server-management-studio.md)  
