...
##  <a name="bkmk_Reqs"></a> Requirements for OLAP Mining Structure and Models  
 ...
 For more information, see [Import a Data Mining Project using the Analysis Services Import Wizard](../../2014/analysis-services/import-a-data-mining-project-using-the-analysis-services-import-wizard.md).  
...
8.  **Specify Columns Content and Data Type**: By this point, you have added all the data that will be used for analysis, and must specify the *data type* and *content type* for each attribute.  
     ...
     In an OLAP model, you do not have the option to automatically detect data types, because the data type is already defined by the multidimensional solution and cannot be changed. Keys are also automatically identified. For more information, see  [Data Types &#40;Data Mining&#41;](../../2014/analysis-services/data-types-data-mining.md).  
  
     The *content type* that you choose for each column that you use in the model tells the algorithm how the data should be processed. For more information, see [Content Types &#40;Data Mining&#41;](../../2014/analysis-services/content-types-data-mining.md).  
