...
## See Also  
 [Configure HealthCheckTimeout Property Settings](../../2014/database-engine/configure-healthchecktimeout-property-settings.md)   
 [Configure FailureConditionLevel Property Settings](../../2014/database-engine/configure-failureconditionlevel-property-settings.md)   
 [View and Read Failover Cluster Instance Diagnostics Log](../../2014/database-engine/view-and-read-failover-cluster-instance-diagnostics-log.md)  
