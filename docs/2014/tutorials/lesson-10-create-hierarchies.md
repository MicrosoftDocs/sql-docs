...
## Prerequisites  
 This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 9: Create Perspectives](../../2014/tutorials/lesson-9-create-perspectives.md).  
...
## Next Steps  
 To continue this tutorial, go to the next lesson: [Lesson 11: Create Partitions](../../2014/tutorials/lesson-11-create-partitions.md).  
