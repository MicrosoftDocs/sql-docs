 ...
 **Max DOP**  
 Specify the default [MAXDOP](/sql-docs/docs/database-engine/configure-windows/configure-the-max-degree-of-parallelism-server-configuration-option) setting for the primary that should be used for statements.  
  
 **Max DOP for Secondary**  
 Specify the default [MAXDOP](/sql-docs/docs/database-engine/configure-windows/configure-the-max-degree-of-parallelism-server-configuration-option) setting for secondaries, if any, that should be used for statements.  
