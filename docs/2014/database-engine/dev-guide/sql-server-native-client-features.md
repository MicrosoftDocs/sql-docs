...
## In This Section  
 [ODBC Driver Behavior Change When Handling Character Conversions](../../../2014/database-engine/dev-guide/odbc-driver-behavior-change-when-handling-character-conversions.md)  
 Discusses a change of behavior beginning in [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 2012 Native Client.  
  
 [Using Database Mirroring](../../../2014/database-engine/dev-guide/using-database-mirroring.md)  
 ...
 [Using Multiple Active Result Sets &#40;MARS&#41;](../../../2014/database-engine/dev-guide/using-multiple-active-result-sets-mars.md)  
 ...
 [Changing Passwords Programmatically](../../../2014/database-engine/dev-guide/changing-passwords-programmatically.md)  
 ...
 [Working with Query Notifications](../../../2014/database-engine/dev-guide/working-with-query-notifications.md)  
 ...
 [Using Encryption Without Validation](../../../2014/database-engine/dev-guide/using-encryption-without-validation.md)  
 ...
 [Service Principal Name &#40;SPN&#41; Support in Client Connections](../../../2014/database-engine/dev-guide/service-principal-name-spn-support-in-client-connections.md)  
 ...
 [Sparse Columns Support in SQL Server Native Client](../../../2014/database-engine/dev-guide/sparse-columns-support-in-sql-server-native-client.md)  
 Discusses [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client support for sparse columns.  
  
 [Date and Time Improvements](../../../2014/database-engine/dev-guide/date-and-time-improvements.md)  
 Discusses support added to [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client for the date and time data types.  
  
 [Metadata Discovery](../../../2014/database-engine/dev-guide/metadata-discovery.md)  
 Discusses metadata discovery improvements that were made in [!INCLUDE[ssSQL11](../../../includes/sssql11-md.md)].  
  
 [UTF-16 Support in SQL Server Native Client 11.0](../../../2014/database-engine/dev-guide/utf-16-support-in-sql-server-native-client-11-0.md)  
 ...
 [Accessing Diagnostic Information in the Extended Events Log](../../../2014/database-engine/dev-guide/accessing-diagnostic-information-in-the-extended-events-log.md)  
 ...
 [SQL Server Native Client Support for LocalDB](../../../2014/database-engine/dev-guide/sql-server-native-client-support-for-localdb.md)  
