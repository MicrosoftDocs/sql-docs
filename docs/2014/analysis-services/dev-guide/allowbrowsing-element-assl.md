...
# AllowBrowsing Element (ASSL)
  Defines whether the members of a [Role](../../../2014/analysis-services/dev-guide/role-element-assl.md) element have browse permission on a [MiningModel](../../../2014/analysis-services/dev-guide/miningmodel-element-assl.md) element.  
...
|------------------|-------------|  
|Parent element|[MiningModelPermission](../../../2014/analysis-services/dev-guide/miningmodelpermission-element-assl.md)|  
|Child elements|None|  
