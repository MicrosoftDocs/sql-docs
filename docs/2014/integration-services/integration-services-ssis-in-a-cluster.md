...
## Related Tasks  
 For step-by-step instructions on configuring the Integration Services service in a cluster, see [Configure the Integration Services Service as a Cluster Resource](../../2014/integration-services/configure-the-integration-services-service-as-a-cluster-resource.md).  
