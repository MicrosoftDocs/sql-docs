...
description: Refer to these articles for configuration tasks for a Reporting Services native mode report server and to configure a report server for SharePoint integrated.
ms.date: 05/14/2019
