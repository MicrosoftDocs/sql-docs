...
WITH VALUES   
 ...
 Starting in SQL Server 2012 this may be a meta data operation [adding-not-null-columns-as-an-online-operation](alter-table-transact-sql.md?view=sql-server-2017&preserve-view=true#adding-not-null-columns-as-an-online-operation).
