...
---
# Database Suspect Data Page Event Class
  The **Database Suspect Data Page** event class indicates when a page is added to the [suspect_pages](../Topic/suspect_pages%20\(Transact-SQL\).md) table in [msdb](../../2014/database-engine/msdb-database.md). Include this event class in traces that are monitoring the occurrence of suspect pages.  
