...
| :::image type="icon" source="media/partner-hadr-sql-server/redgate.png" border="false"::: <br />**Redgate** | Redgate Monitor (formerly SQL Monitor) is a multi-platform database monitoring solution that helps teams looking after SQL Server be more proactive. It covers SQL Server - including Azure SQL Database and Managed Instance - plus PostgreSQL, Oracle, MySQL and MongoDB from one dashboard, whether your databases are on-premises, in the cloud, or hybrid, and is available self-hosted or as a fully managed SaaS edition. It doesn't just alert you to issues - it gives you the information you need to stop them happening in the future, and makes sure you always have the answer to questions about performance, security and compliance. | -&nbsp;[Website](https://www.red-gate.com/products/redgate-monitor/)<br />- [X](https://x.com/redgate)<br />- [LinkedIn](https://www.linkedin.com/company/red-gate-software/) |
