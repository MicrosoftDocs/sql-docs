...
description: Using Microsoft Visual Studio, you can develop CLR database objects for SQL Server. Deploy them to a test server, then distribute them to production servers.
ms.custom: ""
ms.date: "03/16/2017"
ms.prod: sql
ms.reviewer: ""
