...
|Configuration Options|`sp_configure 'user instance timeout'` and `'user instances enabled'`|Use the Local Database feature. For more information, see [SqlLocalDB Utility](../../2014/database-engine/sqllocaldb-utility.md)|  
...
|Mail|SQL Mail|Use Database Mail. For more information, see [Database Mail](../../2014/database-engine/database-mail.md) and  [Use Database Mail Instead of SQL Mail](../../2014/database-engine/use-database-mail-instead-of-sql-mail.md).|  
