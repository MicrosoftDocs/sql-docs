...
For more information, see [Hash Indexes for Memory-Optimized Tables](../sql-server-index-design-guide.md#hash_index).  
...
For details on how to interpret the results of this query, see [Troubleshooting Hash Indexes for Memory-Optimized Tables](../in-memory-oltp/hash-indexes-for-memory-optimized-tables.md).
