...
> [!NOTE]
> This feature is only available starting from SQL Server BDC CU13 release, please make sure your upgraded to at least CU13 if you're currently on BDC prevous versions the following steps are required to perform:
