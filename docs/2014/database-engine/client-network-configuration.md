...
## In This Section  
 ...
 [Logging In to SQL Server](../../2014/database-engine/logging-in-to-sql-server.md)  
  
 [Open the ODBC Data Source Administrator](../../2014/database-engine/open-the-odbc-data-source-administrator.md)  
  
 [Check the ODBC SQL Server Driver Version &#40;Windows&#41;](../../2014/database-engine/check-the-odbc-sql-server-driver-version-windows.md)  
