...
| obo_middle_tier_app_id | **varchar(120)** | **Applies to**: Azure SQL Database <br /><br />The application ID of the middle tier application which connects to SQL Database using OBO access.<br />Is nullable. Returns NULL if the request is not made using OBO access. |
