...
|----------------------|-----------|  
|Describes how to create a resource pool.|[Create a Resource Pool](create-a-resource-pool.md)|  
|Describes how to change resource pool settings.|[Change Resource Pool Settings](change-resource-pool-settings.md)|  
