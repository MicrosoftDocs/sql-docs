...
> [!NOTE]
> DMA does not support database migrations to Azure SQL Managed Instance. Recommendation is to use the [Azure Database Migration Service](/azure/dms/dms-overview), which supports both online and offline database migrations to Azure SQL Managed Instance.
