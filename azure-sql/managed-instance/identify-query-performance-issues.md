...
> * [Azure SQL Database](../database/identify-query-performance-issues.md?view=azuresql-db&preserve-view=true)
> * [Azure SQL Managed Instance](identify-query-performance-issues.md?view=azuresql-mi&preserve-view=true)
...
The [query tuning and hinting example in the Tune applications and databases for performance article](performance-guidance.md#query-tuning-and-hinting) shows the impact of a suboptimal query plan due to a parameterized query, how to detect this condition, and how to use a query hint to resolve.
