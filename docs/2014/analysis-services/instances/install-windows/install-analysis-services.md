...
1.  Select **Analysis Services** from the Feature Tree in Setup.  
     ...
     ![Setup feature tree showing Analsyis Services](../../../2014/sql-server/install/media/ssas-setupas.gif "Setup feature tree showing Analsyis Services")  
  
2.  On the Analysis Services Configuration page, be sure to select **Tabular Mode**.  
  
     ![Setup page with Analysis Services config options](../../../2014/sql-server/install/media/ssas-setupasconfig.gif "Setup page with Analysis Services config options")  
...
|POWERPIVOT|This value is optional. In practice, if you set the `ROLE` parameter, the server mode is automatically set to 1, making `ASSERVERMODE` optional for a PowerPivot for SharePoint installation. For more information, see [Install PowerPivot from the Command Prompt](../../../2014/sql-server/install/install-powerpivot-from-the-command-prompt.md).|  
