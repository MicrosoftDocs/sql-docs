...
# Prerequisites for Tutorials (Report Builder)
 ...
 If you do not have access to a report server or site or to a data source, you can learn about Report Builder by building an offline report. See [Tutorial: Create a Quick Chart Report Offline &#40;Report Builder&#41;](../../2014/reporting-services/tutorial-create-a-quick-chart-report-offline-report-builder.md).  
