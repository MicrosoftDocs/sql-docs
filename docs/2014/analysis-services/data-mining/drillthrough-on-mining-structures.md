...
|||  
|-|-|  
|Use drillthrough to structure from the mining model viewers|[Use Drillthrough from the Model Viewers](data-mining/use-drillthrough-from-the-model-viewers.md)|  
