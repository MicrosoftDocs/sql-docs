...
---
# SPID Element (XMLA)
  Identifies an active server process identifier (SPID) on which to execute the parent [Cancel](../../../2014/analysis-services/dev-guide/cancel-element-xmla.md) element.  
