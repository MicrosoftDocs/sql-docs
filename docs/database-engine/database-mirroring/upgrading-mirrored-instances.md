...
-   [Hardware and software requirements for SQL Server 2016](/previous-versions/sql/sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016):  Review the software requirements for installing [!INCLUDE [ssnoversion-md](../../includes/ssnoversion-md.md)]. If additional software is required, install it on each node before you begin the upgrade process to minimize any downtime.  
