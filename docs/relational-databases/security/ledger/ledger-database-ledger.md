...
To view the database ledger, run the following T-SQL statements in [SQL Server Management Studio](/ssms/sql-server-management-studio-ssms), or [SQL Server Developer Tools](../../../ssdt/download-sql-server-data-tools-ssdt.md).
