...
Syntax for [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)],  [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)], and [!INCLUDE[ssSOD](../../includes/sssodfull-md.md)]:
...
Applies to: [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)]
