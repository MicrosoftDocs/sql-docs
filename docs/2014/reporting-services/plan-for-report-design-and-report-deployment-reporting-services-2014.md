...
-   **Programmatically:** Programmatically publish a report by using the SOAP API interfaces to a report server. For more information, see [Report Server Web Service](../../2014/reporting-services/dev-guide/report-server-web-service.md).  
