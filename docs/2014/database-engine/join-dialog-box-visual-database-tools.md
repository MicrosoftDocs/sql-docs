...
# Join Dialog Box (Visual Database Tools)
 ...
 For more information about joining tables, see [Query with Joins &#40;Visual Database Tools&#41;](../../2014/database-engine/query-with-joins-visual-database-tools.md).  
