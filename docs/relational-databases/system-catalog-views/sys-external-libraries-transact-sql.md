...
+ [Install new R packages on SQL Server](../../machine-learning/r/install-additional-r-packages-on-sql-server.md)  
+ [Install new Python packages on SQL Server](../../machine-learning/python/install-additional-python-packages-on-sql-server.md)  