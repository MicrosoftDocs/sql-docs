...
3.  Published reports and compiled report snapshots are updated on first use. For more information, see [Upgrade Reports](../../../2014/sql-server/install/upgrade-reports.md).  
...
#### To upgrade a Native Mode database With Scripts  
 You can use WMI scripts to upgrade a report server database. For more information, see [GenerateDatabaseUpgradeScript Method &#40;WMI MSReportServer_ConfigurationSetting&#41;](../../../2014/reporting-services/generatedatabaseupgradescript-method-wmi-msreportserver-configurationsetting.md)  
