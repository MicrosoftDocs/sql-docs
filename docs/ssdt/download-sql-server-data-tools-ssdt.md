...
> - SSDT for Visual Studio 2017 since 15.8.1 can’t design SSIS packages that contain Teradata Source/Destination and this issue will be fixed in the near future. Please use SSDT for Visual Studio 2017 version 15.8.0 or previous for designing SSIS packages that contain Teradata Source/Destination.
