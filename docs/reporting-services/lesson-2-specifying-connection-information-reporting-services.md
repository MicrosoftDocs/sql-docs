...
After you add a [!INCLUDE[ssRSnoversion_md](../includes/ssrsnoversion-md.md)] paginated report to your tutorial project in lesson 1, next define a *data source*, the connection information the report uses to access data from a relational database, multidimensional database, or another source.  
