...
description: The sqlagent90 application starts SQL Server Agent from the command prompt when diagnosing SQL Server Agent or when directed by your primary support provider.
