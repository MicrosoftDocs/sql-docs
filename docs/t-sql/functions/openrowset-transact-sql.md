...
Beginning with [!INCLUDE[ssSQLv14_md](../../includes/sssql17-md.md)] CTP 1.1, the data_file can be in Azure blob storage. For examples, see [Examples of Bulk Access to Data in Azure Blob Storage](../../relational-databases/import-export/examples-of-bulk-access-to-data-in-azure-blob-storage.md).
...
**Applies to:** [!INCLUDE[ssSQLv14_md](../../includes/sssql17-md.md)] CTP 1.1.
Beginning with [!INCLUDE[ssSQLv14_md](../../includes/sssql17-md.md)] CTP 1.1, the format_file_path can be in Azure blob storage. For examples, see [Examples of Bulk Access to Data in Azure Blob Storage](../../relational-databases/import-export/examples-of-bulk-access-to-data-in-azure-blob-storage.md).
