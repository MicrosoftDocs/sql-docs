...
# Visibility Element (ASSL)
  Defines the visibility of an [Annotation](../../../2014/analysis-services/dev-guide/annotation-element-assl.md) element.  
...
|------------------|-------------|  
|Parent element|[Annotation](../../../2014/analysis-services/dev-guide/annotation-element-assl.md)|  
|Child elements|None|  
