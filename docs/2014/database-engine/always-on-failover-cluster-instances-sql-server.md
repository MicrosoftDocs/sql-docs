...
# Always On Failover Cluster Instances (SQL Server)
 ...
 An FCI can leverage [Always On Availability Groups](../../2014/database-engine/always-on-availability-groups-sql-server.md)to provide remote disaster recovery at the database level. For more information, see [Failover Clustering and Always On Availability Groups (;SQL Server);](../../2014/database-engine/failover-clustering-and-alwayson-availability-groups-sql-server.md).  
