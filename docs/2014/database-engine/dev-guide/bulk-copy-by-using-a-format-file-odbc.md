...
5.  Call [bcp_readfmt](../../../2014/database-engine/dev-guide/bcp-readfmt.md) to read the format file describing the data file to be used by the bulk copy operation.  
  
6.  Call [bcp_exec](../../../2014/database-engine/dev-guide/bcp-exec.md) to execute the bulk copy operation.  
