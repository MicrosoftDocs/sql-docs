...
-   Determine space for the temporary mapping index.  
 ...
 For more information about the temporary mapping index, see [Disk Space Requirements for Index DDL Operations](../../2014/database-engine/disk-space-requirements-for-index-ddl-operations.md).  
