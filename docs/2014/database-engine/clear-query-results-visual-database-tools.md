...
> [!NOTE]  
>  This will not undo the changes you've made to the database. For more information about how the Results pane works see [Work with Data in the Results Pane &#40;Visual Database Tools&#41;](../../2014/database-engine/work-with-data-in-the-results-pane-visual-database-tools.md).  
  
### To clear query results of a view  
  
-   Right-click in the [Results pane](../../2014/database-engine/results-pane-visual-database-tools.md), point to **Pane**, and then click **Clear Results**.  
