...
# Regular vs. Context Connections
 ...
 There are some cases in which you may need to open a separate regular connection to the same server. For example, there are certain restrictions on using the context connection, described in [Restrictions on Regular and Context Connections](../../../2014/database-engine/dev-guide/restrictions-on-regular-and-context-connections.md).  
