...
## Graphical MDX Query Designer in Query Mode  
 ...
 ![Analysis Services MDX query designer, query view](../../2014/analysis-services/media/rsqd-dsawas-mdx-querymode.gif "Analysis Services MDX query designer, query view")  
