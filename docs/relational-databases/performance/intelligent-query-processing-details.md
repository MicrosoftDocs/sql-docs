...
The `BATCH_MODE_ON_ROWSTORE` [database scoped configuration](../../t-sql/statements/alter-database-scoped-configuration-transact-sql.md#batchmodeonrowstore---on--off) is ON by default.
