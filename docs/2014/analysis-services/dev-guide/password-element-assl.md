...
# Password Element (ASSL)
  Contains the password of the user account for the [ImpersonationInfo](../../../2014/analysis-services/dev-guide/impersonationinfo-data-type-assl.md) element.  
