...
- In release candidate (RC) 0, when you set encryption to force strict with SQL Server Configuration Manager, the setting will not change the encryption and may cause errors.
