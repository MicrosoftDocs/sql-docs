...
description: Find out how to correlate performance logs of System Monitor objects and counters with a trace so that you can view their data in SQL Server Profiler.
ms.prod: sql
