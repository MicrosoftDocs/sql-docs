...
## Logins  
 ...
 If a user is orphaned, create the login on the new primary/principal server instance and run [sp_change_users_login](../Topic/sp_change_users_login%20\(Transact-SQL\).md). For more information, see [Troubleshoot Orphaned Users &#40;SQL Server&#41;](../../2014/database-engine/troubleshoot-orphaned-users-sql-server.md).  
