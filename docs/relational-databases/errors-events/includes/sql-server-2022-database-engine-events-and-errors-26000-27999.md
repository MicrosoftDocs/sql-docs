...
| 26022 | 10 | Yes | Server is listening on \[ %s \<%s\> %d\] accept sockets %d. |
...
| 27429 | 21 | No | Fatal error: Unable to synchronize attributes to database '%ls' for %d consecutive attempts. |
