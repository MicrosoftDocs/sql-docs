...
|**Commit table entries**|The size (row count) of the in-memory portion of the commit table for the database. For more information, see [sys.dm_tran_commit_table (Transact-SQL)](../system-dynamic-management-objects/change-tracking-sys-dm-tran-commit-table.md).|  
