...
[!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)] can push joins, projections, aggregations, and filters to external data sources, taking advantage of remote compute and restricting the data sent over the network.
...
[!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)] allows these basic expressions and operators for predicate pushdown:
...
[!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)] allows these functions for predicate pushdown:
...
Starting in [!INCLUDE [sssql22-md](../../includes/sssql22-md.md)], PolyBase introduced support for parquet files. SQL Server is capable of performing both row and column elimination when performing pushdown with parquet.
