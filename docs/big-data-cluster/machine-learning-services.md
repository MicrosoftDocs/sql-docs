...
[![demonstrate-configure-external-script-availability-group](media/machine-learning-services/example-kube-enable-scripts.png)](/machine-learning-services/example-kube-enable-scripts.png#lightbox)
