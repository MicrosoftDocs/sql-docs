...
## See Also  
 ...
 [Create an Updatable Subscription to a Transactional Publication](../../relational-databases/replication/create-an-updatable-subscription-to-a-transactional-publication.md)
