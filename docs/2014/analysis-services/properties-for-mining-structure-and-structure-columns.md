...
|**Type**|The data type for the content in the column.|  
 ...
 For more information about setting or changing properties, see [Mining Structure Tasks and How-tos](../../2014/analysis-services/mining-structure-tasks-and-how-tos.md).  
