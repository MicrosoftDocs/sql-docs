...
-   Returns the result expression value.  
 ...
 To retrieve multiple values for a single name or key field where there is a 1-to-many relationship, use [LookupSet Function &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/lookupset-function-report-builder-and-ssrs.md). To call `Lookup` for a set of values, use [Multilookup Function &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/multilookup-function-report-builder-and-ssrs.md).  
