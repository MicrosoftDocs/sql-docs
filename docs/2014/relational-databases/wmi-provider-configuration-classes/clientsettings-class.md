...
---
# ClientSettings Class
  The [ClientSettings Class](../../database-engine/dev-guide/clientsettings-class.md) represents the [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] settings on the client.  
