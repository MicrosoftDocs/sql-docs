...
# Logged vs. Unlogged Modifications
 ...
 The logging of **text**, **ntext**, and **image** modifications is controlled by calling [SQLSetStmtAttr](../../../2014/database-engine/dev-guide/sqlsetstmtattr.md) with the *Attribute* parameter set to SQL_SOPT_SS_ TEXTPTR_LOGGING and *ValuePtr* set to either SQL_TL_ON or SQL_TL_OFF.  
