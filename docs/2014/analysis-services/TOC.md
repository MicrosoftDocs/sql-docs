...
###### [Use Analysis Services Templates in SQL Server Management Studio](../ssms/sql-server-management-studio-ssms.md)
...
##### [Schedule Administrative Tasks with SQL Server Agent](../ssms/agent/sql-server-agent.md)
...
####### [Modify or Delete a Database Dimension in Solution Explorer](../ssms/solution/solution-explorer.md)
...
##### [Add/Remove Tables Dialog Box](../ssms/visual-db-tools/visual-database-tools.md)
