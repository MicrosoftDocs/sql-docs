...
| partition_count | **int** | The number of superblock partitions for this memory consumer. For more information, see [Memory fragmentation](../in-memory-oltp/estimate-memory-requirements-for-memory-optimized-tables.md#memory-fragmentation). |
| sizeclass_count | **int** | The number of superblock sizeclasses for this memory consumer. [Memory fragmentation](../in-memory-oltp/estimate-memory-requirements-for-memory-optimized-tables.md#memory-fragmentation). |
