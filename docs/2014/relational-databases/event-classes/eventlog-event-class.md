...
|Error|`int`|Error number of a given event, if available.|31|Yes|  
|EventClass|`int`|Type of event = 21.|27|No|  
...
|TextData|`ntext`|Text of the error message, if available.|1|Yes|  
