...
1. Connect to your database in Azure SQL Database by using [SQL Server Management Studio](/ssms/sql-server-management-studio-ssms). Validate the migration by reviewing the data and schema.
