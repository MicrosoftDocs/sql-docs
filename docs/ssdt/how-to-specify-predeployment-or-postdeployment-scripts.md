...
description: Learn how to use pre-deployment and post-deployment scripts to execute Transact-SQL statements before and after the main deployment script runs.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
