...
-   For information about the data that is returned by the COLUMNS_UPDATED function, see [Use Sparse Columns](../../2014/database-engine/use-sparse-columns.md).  
...
## See Also  
 [Use Sparse Columns](../../2014/database-engine/use-sparse-columns.md)  
