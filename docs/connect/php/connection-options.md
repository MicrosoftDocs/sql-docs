...
|Authentication|One of the following strings:<br /><br />'' (empty string)<br /><br />'SqlPassword'<br /><br />'ActiveDirectoryPassword'|Specifies the authentication mode.|Not set.|  
