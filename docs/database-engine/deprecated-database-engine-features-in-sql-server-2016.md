...
|Encryption|Encryption using the MD2, MD4, MD5, SHA, and SHA1 is deprecated. Use SHA2_256 or SHA2_512 instead. Older algorithms will continue working, but they will raise a deprecation event.|Deprecated encryption algorithm|None|
