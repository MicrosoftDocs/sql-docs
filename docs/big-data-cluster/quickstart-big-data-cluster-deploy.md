...
1. When prompted, enter the following information:
   ...
   | **Machine size** | The [machine size](/azure/virtual-machines/windows/sizes) to use for nodes in the AKS cluster (default **Standard_L8s**). |
