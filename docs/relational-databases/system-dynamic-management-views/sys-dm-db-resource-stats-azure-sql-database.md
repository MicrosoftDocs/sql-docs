...
|avg_instance_cpu_percent|**decimal (5,2)**|Average CPU utilization by the database engine instance hosting the pool, as a percentage of instance limit. Reported at one minute granularity.|
