...
## Viewing and Copying Facet States  
 [View the Policy-Based Management Facets on a SQL Server Object](../../2014/database-engine/view-the-policy-based-management-facets-on-a-sql-server-object.md)  
  
 [Copy a Policy-Based Management Facet State to an XML File](../../2014/database-engine/copy-a-policy-based-management-facet-state-to-an-xml-file.md)  
