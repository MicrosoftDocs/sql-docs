...
|**IsReportManagerEnabled**|This setting is no longer used.<br><br>**Note:** This setting is not available in the January 2017 Technical Preview of Power BI reports in SQL Server Reporting Services.|N|  
