...
|login_time|**datetime**|Time when session was established. Is not nullable. Sessions that have no completed logging in at the time this DMV is queried are shown with a a login time of `1900-01-01`.|  
