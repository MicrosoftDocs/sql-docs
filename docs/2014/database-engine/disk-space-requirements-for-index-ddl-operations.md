...
## Temporary Disk Space for Sorting  
 ...
 For an example of calculating disk space, see [Index Disk Space Example](../../2014/database-engine/index-disk-space-example.md).  
