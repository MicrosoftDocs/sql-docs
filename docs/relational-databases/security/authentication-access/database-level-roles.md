...
|**db_securityadmin**|Members of the **db_securityadmin** fixed database role can modify user-defined role membership and manage permissions. Adding principals to this role could enable unintended privilege escalation.|  
