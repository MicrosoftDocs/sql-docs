...
CTP 3.0 is preview software. It is not publicly supported for operations. Customers who are in the [SQL Early Adopter Program](aka.ms/sqleap), may have support to run SQL Server 2019 CTP 3.0 by special agreement, in consultation with Microsoft. For CTP 3.0 this support includes:
