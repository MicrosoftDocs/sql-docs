 ...
 **Summary**  
 In ODBC 3.*x*, the ODBC 2.*x* function **SQLAllocConnect** has been replaced by **SQLAllocHandle**. For more information, see [SQLAllocHandle Function](../../../odbc/reference/syntax/sqlallochandle-function.md).  
