...
<a id="ComputerRecommendations"></a>
...
- **Resource governor configuration:** If you're using resource governor, use the same resource governor configuration on all instances that host availability group replicas.

<a id="PermissionsWindows"></a>
...
- [Clustering and high availability](https://techcommunity.microsoft.com/category/windows-server/blog/failoverclustering) (Failover Clustering and network load balancing team blog)
...
- [DNS Registration with Network Name Resource](https://techcommunity.microsoft.com/blog/failoverclustering/dns-registration-with-the-network-name-resource/371482)

<a id="ServerInstance"></a>
...
- **FCIs don't support automatic failover by availability groups:** FCIs don't support automatic failover by availability groups, so any availability replica that's hosted by an FCI can be configured for manual failover only.
