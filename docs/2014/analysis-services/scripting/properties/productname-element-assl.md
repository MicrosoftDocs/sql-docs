...
# ProductName Element (ASSL)
  Contains the read-only product name of the instance of [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] that is associated with a [Server](../../dev-guide/server-element-assl.md) element.  
...
|------------------|-------------|  
|Parent element|[Server](../../dev-guide/server-element-assl.md)|  
|Child elements|None|  
