---
title: Create SQL Server on an Azure confidential virtual machine - Azure portal
description: This tutorial shows how to create an Azure Windows confidential virtual machine with SQL Server by using the Azure portal.
author: bluefooted
ms.author: pamela
ms.reviewer: mathoma
ms.date: 10/14/2022
...
# Quickstart: Create SQL Server on an Azure confidential virtual machine by using the Azure portal

[!INCLUDE[appliesto-sqlvm](../../includes/appliesto-sqlvm.md)]


This quickstart provides guidance to create a SQL Server on Azure VM deployed to a [confidential VM](security-considerations-best-practices.md#confidential-vms) in the Azure portal. 
...
Configure confidential OS disk encryption. This is optional for test VMs but recommended for production environments. 
