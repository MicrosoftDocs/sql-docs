...
|**ObjectType**|**int**|Value representing the type of the object involved in the event. This value corresponds to the type column in the **sysobjects** table. For values, see [ObjectType Trace Event Column](../../2014/database-engine/objecttype-trace-event-column.md).|28|Yes|  
