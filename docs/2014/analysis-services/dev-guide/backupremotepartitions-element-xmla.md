...
# BackupRemotePartitions Element (XMLA)
  Determines whether the parent [Backup](../../../2014/analysis-services/dev-guide/backup-element-xmla.md) command backs up remote partitions associated with the object.  
...
|------------------|-------------|  
|Parent elements|[Backup](../../../2014/analysis-services/dev-guide/backup-element-xmla.md)|  
|Child elements|None|  
