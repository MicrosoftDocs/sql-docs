...
Learn how to run Python and R scripts in [Azure Data Studio](../../azure-data-studio/what-is.md) notebooks with [SQL Server Machine Learning Services](../sql-server-machine-learning-services.md). Azure Data Studio is a cross-platform database tool.
