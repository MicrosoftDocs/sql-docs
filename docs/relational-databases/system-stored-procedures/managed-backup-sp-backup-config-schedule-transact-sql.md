...
The start time of the backup window. Backups won't be started outside of the time window, which is defined by a combination of `@backup_begin_time` and `@backup_duration`. Format: `'hh:mm'`.
