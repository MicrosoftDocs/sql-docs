...
> You can use the [sys.dm_exec_text_query_plan &#40;Transact-SQL&#41;](sys-dm-exec-text-query-plan-transact-sql.md) dynamic management function to return the output of the query plan in text format.  
