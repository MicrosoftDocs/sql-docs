...
# Load (SQL Server PDW)
You can load or insert data into SQL Server Parallel Data Warehouse (PDW) by using Integration Services, [bcp Utility](https://docs.microsoft.com/sql/tools/bcp-utility), **dwloader** Command-line Loader, or the SQL INSERT statement.  
