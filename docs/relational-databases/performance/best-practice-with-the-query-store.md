...
-  Trace flag 7752 enables asynchronous load of Query Store and allows a database to become online and queries to be executed before the Query Store has been fully recovered. The default behavior of synchoronous load of Query Store prevents queries from executing before the Query Store has been recovered.
