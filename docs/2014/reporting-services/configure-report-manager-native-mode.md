...
-   **Run Report Manager from a remote computer**. Depending on the configuration of your network, you may need to enable port 80 on computers to allow requests with Report Manager.  
    ...
    > [!TIP]  
    >  If you try to access Report Manager on a remote computer and you receive connection error messages in your browser, a common cause is Firewall settings. For more information, see [Configure a Firewall for Report Server Access](../../2014/reporting-services/configure-a-firewall-for-report-server-access.md).  
  
     If necessary, enable port 80 on both computers to allow requests over that port. For more information, see [Configure a Firewall for Report Server Access](../../2014/reporting-services/configure-a-firewall-for-report-server-access.md).  
