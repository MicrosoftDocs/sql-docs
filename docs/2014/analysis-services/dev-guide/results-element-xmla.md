...
# results Element (XMLA)
  Contains a collection of [root](../../../2014/analysis-services/dev-guide/root-element-xmla.md) elements returned by the [Execute](../../../2014/analysis-services/dev-guide/execute-method-xmla.md) method using the [Batch](../../../2014/analysis-services/dev-guide/batch-element-xmla.md) command.  
...
|------------------|-------------|  
|Parent elements|[return](../../../2014/analysis-services/dev-guide/return-element-xmla.md)|  
|Child elements|[root](../../../2014/analysis-services/dev-guide/root-element-xmla.md)|  
