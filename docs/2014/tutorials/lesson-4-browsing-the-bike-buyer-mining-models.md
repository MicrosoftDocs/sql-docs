...
## Returning the Content of a Mining Model  
 In this lesson, you use the [SELECT FROM &#60;model&#62;.CONTENT &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E.CONTENT%20\(DMX\).md) statement to return the contents of the clustering model.  
...
```  
 ...
 For more information about using the WHERE statement, see [SELECT &#40;DMX&#41;](../Topic/SELECT%20\(DMX\).md).  
...
3.  Replace the following:  
    ...
    *  
    ```  
     ...
     You can also replace * with a list of any of the columns contained within the [DMSCHEMA_MINING_MODEL_CONTENT Rowset](../../2014/analysis-services/dev-guide/dmschema-mining-model-content-rowset.md).  
...
## Use Drillthrough  
 The next step is to use the drillthrough statement to return a sampling of the cases that were used to train the decision tree mining model. In this lesson, you use the [SELECT FROM &#60;model&#62;.CASES &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md) statement to return the contents of the decision tree model.  
...
```  
 ...
 For more information about using the WHERE statement with IsInNode, see [SELECT FROM &#60;model&#62;.CASES &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md).  
...
```  
 ...
 You must include DISTINCT in order to return all of the states of the column. If you exclude DISTINCT, then the full statement becomes a shortcut for a prediction and returns the most likely state of the specified column. For more information, see [SELECT &#40;DMX&#41;](../Topic/SELECT%20\(DMX\).md).  
