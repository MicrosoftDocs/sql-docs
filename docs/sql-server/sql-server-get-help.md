...
The Azure Data Studio team closely monitors issues and feature requests on the [Azure Data Studio Github](https://github.com/microsoft/azuredatastudio/issues). Please submit an issue or feature request here, and you can see when the issue/feature will be fixed or added.
