...
# Using Table and Index Partitioning
  Data can be stored by using the storage algorithms provided by [Partitioned Tables and Indexes](../../relational-databases/indexes/indexes.md). Partitioning can make large tables and indexes more manageable and scalable.  
