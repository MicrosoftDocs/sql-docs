...
4.  Review the key and null key error configuration properties, but do not make any changes.  
    ...
    ![ErrorConfiguration property collection](../analysis-services/media/l4-productdimensionerrorconfig-1.gif "ErrorConfiguration property collection")  
...
6.  Expand **Components**, and then expand the unlabeled member of the **Model Name** level.  
    ...
    ![Assembly components used to build other components](../analysis-services/media/l4-productdimensionerrorconfig-2.gif "Assembly components used to build other components")  
...
4.  Click the SELECT DISTINCT query and then click **View Details**.  
    ...
    ![SELECT DISTINCT clause showing WHERE clause](../analysis-services/media/l4-productnametraceline-1.gif "SELECT DISTINCT clause showing WHERE clause")  
...
4.  Expand the **Assembly Components** member of the **Category** level and then expand the **Assembly Components** member of the **Subcategory** level.  
    ...
    ![Product Name level showing assembly components](../analysis-services/media/l4-assemblycomponents-1.gif "Product Name level showing assembly components")  
