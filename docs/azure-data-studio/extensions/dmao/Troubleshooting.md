...
2.	The assessment data folder does not exist or is in use by another program.
 
Remediation actions: You need to ensure that the logged in user has read and write permissions on the assessment data folder. In case you have changed the assessment data folder path, check the current assessment path mentioned in extension settings is correct. 
...
Remediation actions: Try to create a new assessment. To investigate further, go through the [logs](https://aka.ms/logsDMAO) to understand the reason of error. If the issue persists, please [contact Microsoft for help](https://aka.ms/contactDMAO). 
...
2.	Could not parse the json for the metadata file correctly.
 
Remediation actions: You may have to delete the current assessment and then try creating new assessment. If the issue persists, please [contact Microsoft for help](https://aka.ms/contactDMAO).
...
Remediation actions: You need to ensure that the logged in user has read and write permissions to the assessment data folder. In case you have changed the assessment data folder path, check the current assessment path mentioned in extension settings is correct and exists. Try to create a new assessment after closing any open assessment file(s).
...
Remediation actions: You may need to refer Oracle documentation to resolve this issue. If the issue persists, please [contact Microsoft for help](https://aka.ms/contactDMAO).
...
Remediation actions: Try to re-install the extension, close any open assessment file(s), and then create a new assessment. If the issue persists, please [contact Microsoft for help](https://aka.ms/contactDMAO).
...
Remediation actions: Try to create a new assessment with another AWR report. Also, you may try running the assessment while connected to Oracle instance. If the issue persists, please [contact Microsoft for help](https://aka.ms/contactDMAO). 
...
If the issue persists, please [contact Microsoft for help](https://aka.ms/contactDMAO). 
...
Remediation actions: Try to create a new assessment on a supported version of Oracle server. Current version is unsupported. Please refer https://aka.ms/prereq 
...
Remediation actions: You must upload the correct AWR report for the connected Oracle server so that the AWR report and Oracle database server name matches and then try to create a new assessment. If the issue persists, please [contact Microsoft for help](https://aka.ms/contactDMAO). 
...
Possible Causes: Assessment folder path provided does not exist locally.

Remediation actions: Verify the assessment folder path exists on local computer. In case you have changed the assessment data folder path, check the current assessment path mentioned in extension settings is correct.
...
Remediation actions: Check if the database is online, in a healthy state and ready to accept new connections. For more details refer to Oracle documentation for ORA-1034 error. 
...
Remediation actions: You may have to delete the current assessment and then try creating a new assessment. If the issue persists, please [contact Microsoft for help](https://aka.ms/contactDMAO). 
...
Remediation actions: You need to ensure that the logged in user has delete permissions to the assessment data folder. In case you have changed the assessment data folder path, check the current assessment path mentioned in extension settings is correct. Try to create a new assessment after closing any open assessment file(s).
...
Possible Causes: This is an uncategorized error.
...
Remediation actions: You need to ensure that the logged in user has write permissions on the assessment data folder. In case you have changed the assessment data folder path, check the current assessment path mentioned in extension settings is correct. Try to create a new assessment after closing any open assessment file(s).
...
Possible Causes: The generated assessment data could not be converted to JSON format. 
 
Remediation actions: You may try to run a new assessment. To investigate further, go through the [logs](https://aka.ms/logsDMAO) to understand the reason of error. If the issue persists, please [contact Microsoft for help](https://aka.ms/contactDMAO)
...
Remediation actions: You need to ensure that the logged in user has delete permissions on the assessment data folder. In case you have changed the assessment data folder path, check the current assessment path mentioned in extension settings is correct. Try to create a new assessment after closing any open assessment file(s).
...
1.	The user may not have the appropriate permission to access the assessment data folder.
2.	The assessment data folder does not exist or is in use by another program.
3.	The assessment data was generated by an older version of ADS extension which is not supported any more.
 
Remediation actions: You need to ensure that the logged in user has read and write permissions on the assessment data folder. In case you have changed the assessment data folder path, check the current assessment path mentioned in extension settings is correct. Try to delete the current assessment and then run a new assessment.
