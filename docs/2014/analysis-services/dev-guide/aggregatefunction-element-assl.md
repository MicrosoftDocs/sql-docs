...
# AggregateFunction Element (ASSL)
  Defines the type of aggregate function used by a [Measure](../../../2014/analysis-services/dev-guide/measure-element-assl.md) element.  
...
|------------------|-------------|  
|Parent elements|[Measure](../../../2014/analysis-services/dev-guide/measure-element-assl.md)|  
|Child elements|None|  
