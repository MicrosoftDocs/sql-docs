...
description: Learn how to provide another layer of protection against requests that are not valid by appling adequate exception handling through the use of try/catch blocks.
ms.date: 03/06/2017
