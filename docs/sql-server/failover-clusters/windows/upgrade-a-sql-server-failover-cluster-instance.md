...
description: "Learn how to upgrade a SQL Server failover cluster instance using installation media. Learn about rolling upgrades and upgrading a multi-subnet cluster." 
