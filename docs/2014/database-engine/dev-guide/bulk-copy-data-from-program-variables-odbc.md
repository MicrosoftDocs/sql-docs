...
5.  Call [bcp_bind](../../../2014/database-engine/dev-guide/bcp-bind.md) for each column in the bulk copy to bind the column to a program variable.  
  
6.  Fill the program variables with data, and call [bcp_sendrow](../../../2014/database-engine/dev-guide/bcp-sendrow.md) to send a row of data.  
  
7.  After several rows have been sent, call [bcp_batch](../../../2014/database-engine/dev-guide/bcp-batch.md) to checkpoint the rows already sent. It is good practice to call [bcp_batch](../../../2014/database-engine/dev-guide/bcp-batch.md) at least once per 1000 rows.  
  
8.  After all rows have been sent, call [bcp_done](../../../2014/database-engine/dev-guide/bcp-done.md) to complete the operation.  
  
 You can vary the location and length of program variables during a bulk copy operation by calling [bcp_colptr](../../../2014/database-engine/dev-guide/bcp-colptr.md) and [bcp_collen](../../../2014/database-engine/dev-guide/bcp-collen.md). Use [bcp_control](../../../2014/database-engine/dev-guide/bcp-control.md) to set various bulk copy options. Use [bcp_moretext](../../../2014/database-engine/dev-guide/bcp-moretext.md) to send `text`, `ntext`, and `image` data in segments to the server.  
