...
description: Learn how to create a report history in Reporting Services in SharePoint Integrated Mode, which is a collection of report snapshots that you create over time.
ms.date: 03/01/2017
