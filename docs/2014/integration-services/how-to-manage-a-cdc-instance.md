...
4.  From the **Actions** pane on the right side of the CDC Designer Console, click on the operation you want to carry out.  
    ...
    -   **Oracle Logging Script**: Click **Oracle Logging Script** to display the Oracle Logging script dialog box with the Oracle supplemental-logging script. For information on what you can do in this dialog box, see [Oracle Supplemental Logging Script](../../2014/integration-services/oracle-supplemental-logging-script.md).  
    ...
    -   **CDC Instance Deployment**: To generate a deployment script for the CDC Instance. For information about this dialog box, see [CDC Instance Deployment Script](../../2014/integration-services/cdc-instance-deployment-script.md).  
  
     For more information about these tasks, see [Manage a CDC Instance](../../2014/integration-services/manage-a-cdc-instance.md).  
  
 You can also select **Properties** to edit the CDC instance configuration properties. For more information about editing the CDC instance properties, see [Edit Instance Properties](../../2014/integration-services/edit-instance-properties.md).  
