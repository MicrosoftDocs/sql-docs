 ...
 **Power View for Multidimensional Models architecture**  
 ...
 ![Power View for Multidimensional Models Architecure](../../2014/analysis-services/media/daxmd-architecture.gif "Power View for Multidimensional Models Architecure")  
 ...
 **Measure groups in the Power View Field List**  
 ...
 ![Field List in Power View](../../2014/analysis-services/media/daxmd-powerviewfieldlist.gif "Field List in Power View")  
 ...
 **Measures and KPIs in a measure group**  
 ...
 ![Measure group in Power View Field List](../../2014/analysis-services/media/daxmd-fieldlist-group.gif "Measure group in Power View Field List")  
 ...
 **Measure as variant**  
 ...
 ![Non-aggregatable hierarchy in Power View](../../2014/analysis-services/media/daxmd-nonaggrattrib.gif "Non-aggregatable hierarchy in Power View")  
 ...
 **Dimension, attributes and hierarchies in SQL Server Data Tools (SSDT) and Power View Field List**  
 ...
 ![Dimensions in SSDT and in Power View Field List](../../2014/analysis-services/media/daxmd-ssdt-dimensions.gif "Dimensions in SSDT and in Power View Field List")  
 ...
 **Dimension attribute geography types in SSDT and Power View Field List**  
 ...
 ![Dimension attribute geography types](../../2014/analysis-services/media/daxmd-ssdt-attribute-geog-types.gif "Dimension attribute geography types")  
 ...
 **Power View report with calculated members**  
 ...
 ![Calculated members in Power View](../../2014/analysis-services/media/daxmd-calcmembersinpowerview.gif "Calculated members in Power View")  
 ...
 **ImageURL dimension attribute type in SSDT**  
 ...
 ![Dimension attribute properties](../../2014/analysis-services/media/daxmd-dimattribute-properties.gif "Dimension attribute properties")  
 ...
 **Parent-child hierarchies in Power View**  
 ...
 ![Parent-child hierarchies](../../2014/analysis-services/media/daxmd-ssdt-hierarchies.gif "Parent-child hierarchies")  
...
## Perspectives and translations  
 ...
 For more information, see [Create a Report Data Source](../../2014/analysis-services/create-a-report-data-source.md).  
 ...
 **Pinned Filters**  
 ...
 ![Pinned Filter](../../2014/analysis-services/media/daxmd-pinnedfilterinpowerview.gif "Pinned Filter")  
...
|VERSION|Yes|CSDL version requested by client. Multidimensional features and constructs are supported in version 2.0.|  
 ...
 For more detailed information about CSDLBI annotations for tabular models, see [Technical Reference for BI Annotations to CSDL](../../2014/analysis-services/dev-guide/technical-reference-for-bi-annotations-to-csdl.md) on MSDN, and [\[MS-CSDLBI\]: Conceptual Schema Definitions File Format with Business Intelligence Annotations](http://msdn.microsoft.com/library/jj161299\(SQL.105\).aspx).  
