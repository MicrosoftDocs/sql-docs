...
4.  Follow the steps of the wizard to create a maintenance plan. For more information, see [Use the Maintenance Plan Wizard](../../2014/database-engine/use-the-maintenance-plan-wizard.md).  
...
4.  Create a maintenance plan following the steps in [Create a Maintenance Plan &#40;Maintenance Plan Design Surface&#41;](../../2014/database-engine/create-a-maintenance-plan-maintenance-plan-design-surface.md).  
