...
description: "In SQL Server Management Studio, use the Query Store tab in the Database Properties dialog box to configure modes, intervals, thresholds, and other properties."
ms.custom: ""
ms.date: "11/09/2015"
ms.prod: sql
