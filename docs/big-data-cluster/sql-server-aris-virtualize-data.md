...
![Select a data source](media/sql-server-aris-virtualize-data/select-data-source.png)
...
![Create a database master key](media/sql-server-aris-virtualize-data/virtualize-data-master-key.png)
...
![External data source credentials](media/sql-server-aris-virtualize-data/data-source-credentials.png)
...
![Summary screen](media/sql-server-aris-virtualize-data/virtualize-data-summary.png)

If you click Create you will be able to see the External Data Source object created in the Destination database.

![External data sources](media/sql-server-aris-virtualize-data/external-data-sources.png)

If you click, **Generate Script** you will see the T-SQL query being generated for creating the External Data Source object.

![Generate script](media/sql-server-aris-virtualize-data/generated-script.png)
...
For more information on SQL Server Aris and related scenarios, see [What is SQL Server Aris?](sql-server-aris-overview.md).