...
SQL Server PDW logs alerts in the [sys.dm_pdw_component_health_alerts](https://msdn.microsoft.com/library/mt631629.aspx) DMV. The system retains a limit of 10,000 alerts and deletes the oldest alert first when the limit is exceeded.  
...
To view alerts by using system views, query [sys.dm_pdw_component_health_active_alerts](https://msdn.microsoft.com/library/mt631630.aspx). This DMV shows alerts that have not been corrected. For help with triaging alerts and errors, use the [sys.dm_pdw_errors](https://msdn.microsoft.com/library/mt203904.aspx) DMV.  
