...
If the problem is related to your [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] FileStream filegroup, then you will notice that only the full directory path is listed instead of a file name. An example is shown below: 
```
Error: 17207, Severity: 16, State: 1.
