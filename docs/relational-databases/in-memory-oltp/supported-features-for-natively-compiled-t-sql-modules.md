...
-   APPLY operator
    - **Applies to:** [!INCLUDE[ssSQLv14_md](../../includes/sssql17-md.md)].  
      Beginning with [!INCLUDE[ssSQLv14_md](../../includes/sssql17-md.md)], the APPLY operator is supported in natively compiled modules.
...
-   String functions: LEN, LTRIM, RTRIM, and SUBSTRING.  
    - **Applies to:** [!INCLUDE[ssSQLv14_md](../../includes/sssql17-md.md)].  
      Beginning with [!INCLUDE[ssSQLv14_md](../../includes/sssql17-md.md)], the following built-in functions are also supported: TRIM, TRANSLATE, and CONCAT_WS.  
...
-   JSON functions  
    - **Applies to:** [!INCLUDE[ssSQLv14_md](../../includes/sssql17-md.md)].  
      Beginning with [!INCLUDE[ssSQLv14_md](../../includes/sssql17-md.md)], the JSON functions are supported in natively compiled modules.
