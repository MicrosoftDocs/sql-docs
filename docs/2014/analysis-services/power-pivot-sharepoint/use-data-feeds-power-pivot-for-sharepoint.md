...
##  <a name="rsreport"></a> Create a Data Feed from a Reporting Services Report  
 ...
 For instructions on how to export a data feed from a report, see [Generate Data Feeds from a Report &#40;Report Builder and SSRS&#41;](../../reporting-services/generate-data-feeds-from-a-report-report-builder-and-ssrs.md) in the [Report Builder help file](http://go.microsoft.com/fwlink/?LinkId=154494).  
...
1.  Open a data feed library that was created by your site administrator. For more information, see [Create or Customize a Data Feed Library &#40;PowerPivot for SharePoint&#41;](../../relational-databases/spatial/point.md).  
