...
> [!NOTE]
> For more info about this procedure, including additional screen shots, see this walkthrough by SQL Server Marcos Freccia: [Adding SSISDB to AG for SQL Server 2016](https://marcosfreccia.wordpress.com/2017/04/28/adding-ssisdb-to-ag-for-sql-server-2016/).
