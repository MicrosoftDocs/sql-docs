...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 ...
 SQL Server performance counters values uses the Windows Performance Counter engine. Some values are not calculated directly by SQL Server engine. SQL Server just provide base values to performance counter engine and it will do the work for calculation (like show percentages, etc.). The [sys.dm_os_performance_counters &#40;Transact-SQL&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-os-performance-counters-transact-sql.md) dynamic management view provide all counters with original value generated by SQL Server, and the column `cntr_type` indicates the type of counter. How performance counter engine will process this value depend on this type. For more detailed about these types, [check WMI documentation about performance counters](https://docs.microsoft.com/en-us/windows/win32/wmisdk/wmi-performance-counter-types)
