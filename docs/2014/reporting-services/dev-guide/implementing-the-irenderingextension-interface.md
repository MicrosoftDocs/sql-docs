...
-   The *deviceInfo* parameter that contain the device settings. For more information, see [Passing Device Information Settings to Rendering Extensions](../../../2014/reporting-services/dev-guide/passing-device-information-settings-to-rendering-extensions.md).  
