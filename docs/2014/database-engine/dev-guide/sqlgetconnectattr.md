...
-   Diagnostic information in the data access tracing logs, when enabled.  
 ...
 For more information, see [Accessing Diagnostic Information in the Extended Events Log](../../../2014/database-engine/dev-guide/accessing-diagnostic-information-in-the-extended-events-log.md).  
