...
## In This Section  
 [Retrieving UDT Data](../../../2014/database-engine/dev-guide/retrieving-udt-data.md)  
 Describes how to retrieve UDT data and how to specify parameters.  
  
 [Updating UDT Columns with DataAdapters](../../../2014/database-engine/dev-guide/updating-udt-columns-with-dataadapters.md)  
