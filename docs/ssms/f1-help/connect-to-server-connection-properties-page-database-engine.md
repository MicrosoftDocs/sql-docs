...
**Options**  
Click to hide the **Connection Properties** and **Additional Connection Parameters** tabs and view the **Login** tab.
...
For more examples on how to connect and query, review the quickstart relevant to your database.
