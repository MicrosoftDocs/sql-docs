...
The `hdfs` shell capability in Azure Data CLI allows you to issue commands directly in a shell to manage HDFS permissions on files and directories. The underlying mechanism uses WebHdfs calls to issue the commands
...
## Create a directory in HDFS using Azure Data CLI
...
To set ACLs on files and directories in HDFS, use the Azure Data CLI commands.
