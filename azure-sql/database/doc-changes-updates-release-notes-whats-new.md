...
| ---| --- |--- |
| [Named Replicas](/azure/azure-sql/database/service-tier-hyperscale-replicas.md#named-replica) for Hyperscale databases | June 2022 | Named Replicas enable a broad variety of read scale-out scenarios, and easily implement near-real time Hybrid Transactional and Analytical Processing (HTAP) solutions. |
...
| Changes | Details |
| --- | --- |
| **Named Replicas for Hyperscale databases** | Named Replicas enable a broad variety of read scale-out scenarios, and easily implement near-real time Hybrid Transactional and Analytical Processing (HTAP) solutions. |
