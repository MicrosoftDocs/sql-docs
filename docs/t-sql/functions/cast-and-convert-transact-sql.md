...
|Value|Output|  
|-----------|------------|  
|**0** (default)|Translates ASCII characters to binary bytes or binary bytes to ASCII characters. Each character or byte is converted 1:1.<br /><br /> If the *data_type* is a binary type, the characters 0x are added to the left of the result.|  
