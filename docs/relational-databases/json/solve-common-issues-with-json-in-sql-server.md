---
title: "Solve Common Issues with JSON"
description: "Solve common issues with JSON in the SQL Database Engine."
...
[!INCLUDE [sqlserver2016-asdb-asdbmi-asa-serverless-pool-only-fabricsqldb](../../includes/applies-to-version/sqlserver2016-asdb-asdbmi-asa-serverless-pool-only-fabricsqldb.md)]
 ...
 Find answers here to some common questions about the built-in JSON support in the SQL Database Engine.
 ...
 **Answer.** The `OPENJSON` function is available only under compatibility level 130. If your database compatibility level is lower than 130, `OPENJSON` is hidden. Other JSON functions are available at all compatibility levels.
