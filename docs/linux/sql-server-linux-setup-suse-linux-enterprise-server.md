...
description: Describes how to install SQL Server vNext CTP 2.0 on SUSE Linux Enterprise Server.
author: rothja 
ms.author: jroth 
manager: jhubbard
ms.date: 03/17/2017
...
This topic provides a walkthrough of how to install SQL Server vNext CTP 2.0 on SUSE Linux Enterprise Server (SLES) v12 SP2.
