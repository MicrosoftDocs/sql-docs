...
# Analysis Services Trace Events
 ...
 Trace events can be started and captured using **[!INCLUDE[ssSqlProfiler](../includes/sssqlprofiler-md.md)]**, see [Use SQL Server Profiler to Monitor Analysis Services](../../2014/analysis-services/use-sql-server-profiler-to-monitor-analysis-services.md), or can be started from an XMLA command as **SQL Server Extended Events** and later analyzed, see [Use SQL Server Extended Events &#40;XEvents&#41; to Monitor Analysis Services](../../2014/analysis-services/use-sql-server-extended-events-xevents-to-monitor-analysis-services.md).  
 ...
 **[Errors and Warnings Event Category](../../2014/analysis-services/errors-and-warnings-event-category.md)**  
 ...
 **[Session Events Event Category](../../2014/analysis-services/session-events-event-category.md)**  
...
## See Also  
[Use SQL Server Profiler to Monitor Analysis Service](../../2014/analysis-services/use-sql-server-profiler-to-monitor-analysis-services.md)