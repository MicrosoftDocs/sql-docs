...
The In-Memory OLTP technology makes SQL really attractive for maintaining session state (for example, for an ASP.NET application) and for caching.
...
- [17-minute video explaining In-Memory OLTP and showing the demo](https://www.youtube.com/watch?v=UHhYhSCJil4)
