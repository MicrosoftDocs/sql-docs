...
```  
 ...
 For more information about permissions, see [Permissions &#40;Database Engine&#41;](../../2014/database-engine/permissions-database-engine.md) and [sys.fn_builtin_permissions &#40;Transact-SQL&#41;](~/relational-databases/system-functions/sys-fn-builtin-permissions-transact-sql.md).  
