...
|**rowversion**|Only a NULL value can be manually inserted into a **rowversion** column. However, because **rowversion**columns are automatically updated by [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], a NULL value is overwritten.|  
