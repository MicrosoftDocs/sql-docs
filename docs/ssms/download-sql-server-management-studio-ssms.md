...
- This version of SSMS works with all supported versions of SQL Server 2008 - [!INCLUDE[sql-server-2019](../includes/sssql19-md.md)] and provides the greatest level of support for working with the latest cloud features in Azure SQL Database and Azure Synapse Analytics.
