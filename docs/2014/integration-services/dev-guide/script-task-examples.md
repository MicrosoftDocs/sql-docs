...
### Example Topics  
 ...
 [Gathering a List for the ForEach Loop with the Script Task](../../../2014/integration-services/dev-guide/gathering-a-list-for-the-foreach-loop-with-the-script-task.md)  
 ...
 [Finding Installed Printers with the Script Task](../../../2014/integration-services/dev-guide/finding-installed-printers-with-the-script-task.md)  
 Locates installed printers that support a specific paper size, by using classes in the System.Drawing.Printing namespace.  
  
 [Sending an HTML Mail Message with the Script Task](../../../2014/integration-services/dev-guide/sending-an-html-mail-message-with-the-script-task.md)  
 ...
 [Sending to a Remote Private Message Queue with the Script Task](../../../2014/integration-services/dev-guide/sending-to-a-remote-private-message-queue-with-the-script-task.md)  
