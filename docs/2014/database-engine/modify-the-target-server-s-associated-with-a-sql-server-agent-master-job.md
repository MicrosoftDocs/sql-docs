...
5.  In the **Job Properties –***job_name* dialog box, under **Select a page**, select **Targets**. For more information on the available options on this page, see [Job Properties: New Job &#40;Targets Page&#41;](../../2014/database-engine/job-properties-new-job-targets-page.md).  
