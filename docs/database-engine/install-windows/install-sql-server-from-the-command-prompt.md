...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLMAXDOP=parameter <br /><br /> **Optional** If ommitted on unattended (silent) installs, MAXDOP will default to a maximum of 8. |Specifies the max degree of parallelism, which determines how many processors a single statement can utilize. Only available starting with SQL Server 2019. <br /><br /> Default value: maximum of 8| 
