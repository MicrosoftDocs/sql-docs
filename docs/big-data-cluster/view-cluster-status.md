...
After downloading the latest version of [Azure Data Studio](../azure-data-studio/download.md), you can view service endpoints and the status of a big data cluster with the SQL Server big data cluster dashboard. 
