...
> [!NOTE]  
>  To start an instance of the [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] with startup options, see [Configure Server Startup Options &#40;SQL Server Configuration Manager&#41;](../../2014/database-engine/configure-server-startup-options-sql-server-configuration-manager.md).  
...
-   Add startup options to the end of the **net start "SQL Server (MSSQLSERVER)"** statement, separated by a space. When started using **net start**, startup options use a slash (/) instead of a hyphen (-).  
    ...
    > [!NOTE]  
    >  For more information about startup options, see [Database Engine Service Startup Options](../../2014/database-engine/database-engine-service-startup-options.md).  
...
-   From a command prompt, enter one of the following commands. Replace *instancename* with the name of the instance you want to manage.  
 ...
 For information about how to run [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent in verbose mode for troubleshooting, see [sqlagent90 Application](../../2014/database-engine/sqlagent90-application.md).  
...
## See Also  
 [Start SQL Server with Minimal Configuration](../../2014/database-engine/start-sql-server-with-minimal-configuration.md)   
