                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Get an Azure VM with SQL Server</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                  ...
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              ...
                                              <ul class="noBullet">
                                              <li><a class="barLink" href="/sql/sql-server/index.yml"><strong>On-premises</strong></a></li>
                                              ...
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          ...
                                                          <p>Get started with documentation detailing how to install and upgrade both SQL Server and the services associated with it.</p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                              ...
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          ...
                                                          <p><b>High availability, Disaster Recover, Always On Availability Group, Always On Failover Cluster Instance, Database Mirroring, Backup and Restore</b></p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Security</h3>
                                                          <p><b>Permissions, Access Management, Always Encrypted, TDE, SSL</b></p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Learn about SQL Server</h3>
                                                          <p>Learn about the architectural internals of SQL Server with a series of guides and tutorials. </p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
