...
|Feature|Computed columns|Computed columns are not supported for memory-optimized tables. Remove the computed columns from the **CREATE TABLE** statement.<br/><br/>**Applies to:** [!INCLUDE[ssSQL14-md](../../includes/sssql14-md.md)] and [!INCLUDE[ssSQL15-md](../../includes/sssql15-md.md)]<br/>Beginning with [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)], computed columns are supported in memory-optimized tables and indexes.|  
