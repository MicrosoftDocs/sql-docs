...
## In This Section  
 [SQLXML Managed Classes Object Model](../../../2014/database-engine/dev-guide/sqlxml-managed-classes-object-model.md)  
 Documents SQLXML Managed Classes and their properties and methods.  
  
 [Using the SQLXML Managed Classes](../../../2014/database-engine/dev-guide/using-the-sqlxml-managed-classes.md)  
