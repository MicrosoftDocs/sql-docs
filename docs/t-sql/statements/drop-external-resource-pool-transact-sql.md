...
+ [SQL Server R Services](../../machine-learning/r-services/sql-server-r-services.md)
+ [Known Issues for SQL Server R Services](../../machine-learning/r-services/known-issues-for-sql-server-r-services.md)
