...
Use PowerShell to create your instance. For details, review [Use PowerShell to create a SQL managed instance](scripts/create-configure-managed-instance-powershell.md).
...
Use the Azure CLI to create your instance. For details, review [Create an Azure SQL Managed Instance using the Azure CLI](scripts/create-configure-managed-instance-cli.md).
...
2. On the **Overview** tab, locate the **Host** property. Copy the host name to your clipboard for the SQL managed instance for use in the next quickstart by selecting the **Copy to clipboard** button.
