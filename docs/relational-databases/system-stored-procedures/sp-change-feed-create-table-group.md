...
#### @workspace_id - Azure resourceID for the Synapse Workspace requesting creation of the new table group.

#### @destination_location - URL string of the landing zone folder.

#### @destination_credential - The credential name to access the landing zone.
