...
1.  [Monitor the Health Status](../../2014/database-engine/failover-policy-for-failover-cluster-instances.md#monitor)  
  
2.  [Determining Failures](../../2014/database-engine/failover-policy-for-failover-cluster-instances.md#determine)  
  
3.  [Responding to Failures](../../2014/database-engine/failover-policy-for-failover-cluster-instances.md#respond)  
  
###  <a name="monitor"></a> Monitor the Health Status  
 There are three types of health statuses that are monitored for the FCI:  
  
-   [State of the SQL Server service](../../2014/database-engine/failover-policy-for-failover-cluster-instances.md#service)  
  
-   [Responsiveness of the SQL Server instance](../../2014/database-engine/failover-policy-for-failover-cluster-instances.md#instance)  
  
-   [SQL Server component diagnostics](../../2014/database-engine/failover-policy-for-failover-cluster-instances.md#component)  
...
5.  events  
 ...
 Each rowset of information is also written to the SQL Server cluster diagnostics log. For more information, see [View and Read Failover Cluster Instance Diagnostics Log](../../2014/database-engine/view-and-read-failover-cluster-instance-diagnostics-log.md).  
