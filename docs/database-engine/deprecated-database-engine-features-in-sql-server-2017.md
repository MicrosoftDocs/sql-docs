...
- [Deprecated Database Engine features in SQL Server 2016 (13.x)](/previous-versions/sql/database-engine/deprecated-database-engine-features-in-sql-server-2016)
