...
-   **SharePoint mode:** If you want to access a report server that runs in SharePoint mode, use the web parts that are installed by the [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] Add-in for SharePoint products. For more information about the add-in, see [Where to find the Reporting Services add-in for SharePoint Products](../../2014/sql-server/install/where-to-find-the-reporting-services-add-in-for-sharepoint-products.md).  
...
-   > [!NOTE]  
 ...
 For more information about report server modes, see [Reporting Services Report Server](../../2014/reporting-services/reporting-services-report-server.md).  
