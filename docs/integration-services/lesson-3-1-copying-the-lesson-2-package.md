...
In this task, you'll create a copy of the Lesson 2.dtsx package from Lesson 2. If you didn't complete Lesson 2, you can add the completed lesson 2 package that is included with this tutorial to the project, and then copy it instead. You'll use this new copy throughout the rest of Lesson 3.
...
4.  In Solution Explorer, right-click **SSIS Packages**, and then select **Paste**.
    ...
    By default, the copied package will be named Lesson 3.dtsx.
...
## Add the completed Lesson 1 package
