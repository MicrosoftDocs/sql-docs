...
|Topic|Description|  
|-----------|-----------------|  
|[Attention Event Class](../../2014/database-engine/attention-event-class.md)|Indicates that an **Attention** event has occurred.|  
|[Background Job Error Event Class](../../2014/database-engine/background-job-error-event-class.md)|Indicates that a background job has terminated abnormally.|  
...
|[Sort Warnings Event Class](../../2014/database-engine/sort-warnings-event-class.md)|Indicates that sort operations do not fit into memory.|  
