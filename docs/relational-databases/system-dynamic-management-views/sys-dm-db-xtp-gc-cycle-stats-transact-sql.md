...
description: For in-memory OLTP tables, sys.dm_db_xtp_gc_cycle_stats returns the current state of committed transactions that deleted one or more rows from in-memory OLTP tables.
author: rwestMSFT
