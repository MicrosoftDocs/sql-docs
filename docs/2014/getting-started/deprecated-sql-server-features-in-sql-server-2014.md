...
|--------------|------------------------|-----------------|------------------|----------------|  
|Data Programmability|[sys.soap_endpoints &#40;Transact-SQL&#41;](../Topic/sys.soap_endpoints%20\(Transact-SQL\).md)|Windows Communications Foundation (WCF) or ASP.NET|Native XML Web Services|22|  
|Data Programmability|[sys.endpoint_webmethods &#40;Transact-SQL&#41;](../Topic/sys.endpoint_webmethods%20\(Transact-SQL\).md)|Windows Communications Foundation (WCF) or ASP.NET|Native XML Web Services|23|  
