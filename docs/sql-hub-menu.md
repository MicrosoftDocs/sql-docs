        ...
        <ul class="pivots">
            <li>
                ...
                <ul id="products">
                         ...
                         <ul id="products-sql-server" class="cardsC">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>Build intelligent, mission-critical applications using a scalable, hybrid database platform. It has everything built in: from in-memory performance and advanced security to in-database analytics.</p>
                                </div>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="#products-sql-server-azure">SQL Server on Azure VMs</a>
                        <ul id="products-sql-server-azure" class="cardsC">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>Host SQL Server, including SQL Server 2016 Enterprise Edition, on Azure virtual machines. Use gallery images or bring your own license. Migrate on-premises SQL Server workloads to the cloud.</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Learn about</h3>
                                                <p>Learn about SQL Server on Azure VMs</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Provision</h3>
                                                <p>Provision a SQL Server virtual machine in the Azure portal</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Migrate</h3>
                                                <p>Migrate a SQL Server database to SQL Server in an Azure virtual machine</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>High availability and disaster recovery for SQL Server in Azure virtual machines</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Scenarios for SQL Server on VMs</h3>
                                                <p>Learn how SQL Server virtual machines solve various business problems</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>FAQ</h3>
                                                <p>Get answers to common questions about SQL Server on Azure VMs</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>T-SQL</h3>
                                                <p><a href="https://msdn.microsoft.com/library/bb510741.aspx">Get started</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>ADO.NET</h3>
                                                <p><a href="/sql/connect/ado-net/microsoft-ado-net-for-sql-server">Get started</a></p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Drivers</h3>
                                                <p><a href="/sql/connect/sql-server-drivers">Get started</a></p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="/sql/ssms/download-sql-server-management-studio-ssms">Download SQL Server Management Studio</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="/sql/ssdt/download-sql-server-data-tools-ssdt">Download SQL Server Data Tools</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>VS Code &amp; SQL Extensions</h3>
                                                <p><a href="https://code.visualstudio.com/docs">Get started</a></p>
                                                <p><a href="https://code.visualstudio.com/">Download Visual Studio Code</a></p>
                                                <p><a href="https://marketplace.visualstudio.com/items?itemName=ms-mssql.mssql">SQL extension (mssql)</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
