...
description: Learn about administering a Reporting Services deployment, including backing up/restoring report server databases and managing encryption keys.
ms.date: 03/14/2017
