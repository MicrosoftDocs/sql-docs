...
# Partition Processing Destination Editor (Advanced Page)
 ...
 To learn more about the Partition Processing destination, see [Partition Processing Destination](../../2014/integration-services/partition-processing-destination.md).  
