...
:::image type="content" source="media/table-designer-azure-data-studio/table-designer-creating-a-node-graph-table.png" alt-text="Table Designer showing how to create a Cities node graph table":::

Let's do the same for our "Persons" node table

:::image type="content" source="media/table-designer-azure-data-studio/table-designer-creating-person-node-table.png" alt-text="Table Designer showing how to create a Persons node graph table":::
