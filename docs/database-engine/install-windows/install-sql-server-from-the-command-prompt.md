...
||AdvancedAnalytics <br/> - sql_inst_mr <br/> - sql_inst_mpy <br/> - sql_inst_java |Installs [SQL Server 2017 Machine Learning Services](https://docs.microsoft.com/sql/advanced-analytics/install/sql-machine-learning-services-windows-install) or [SQL Server 2016 R Services (In-Database)](https://docs.microsoft.com/sql/advanced-analytics/install/sql-r-services-windows-install).|  
...
||SQL_INST_JAVA |Applies to [SQL Server 2017 and grater Machine Learning Services](https://docs.microsoft.com/sql/advanced-analytics/install/sql-machine-learning-services-windows-install). Pair with **AdvancedAnalytics** to install extensions that enable integration with Java using standard T-SQL statements.|  
