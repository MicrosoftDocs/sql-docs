...
This error occurs when you try to execute a `sp_xml_preparedocument` stored procedure in Microsoft SQL Server in which the content of the xmltext parameter is a complex XML document, An error message similar to the following is reported to the user
