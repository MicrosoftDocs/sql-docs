...
> [!NOTE]  
> If the switch ERRORFILE_CREDENTIAL isn't specified, the copy command defaults to using the value specified in the CREDENTIAL switch to connect to this storage account.
