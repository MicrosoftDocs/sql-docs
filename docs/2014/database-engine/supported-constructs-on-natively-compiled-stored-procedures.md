...
# Supported Constructs on Natively Compiled Stored Procedures
 ...
 For information about unsupported constructs, see [Transact-SQL Constructs Not Supported by In-Memory OLTP](../../2014/database-engine/transact-sql-constructs-not-supported-by-in-memory-oltp.md).  
