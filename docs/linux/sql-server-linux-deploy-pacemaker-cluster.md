...
description: How to deploy a Pacemaker high availability cluster for SQL Server on Linux. 
author: MikeRayMSFT 
ms.author: mikeray 
manager: jhubbard
ms.date: 11/27/2017
