...
## In This Section    
 ...
 Discusses support for UTF-8 server encoding and precautions users should take for configurating the client code page and database collation when using an UTF-8 enabled column.
