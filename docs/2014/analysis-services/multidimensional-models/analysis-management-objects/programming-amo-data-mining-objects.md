...
# Programming AMO Data Mining Objects
 ...
 One thing to remember is that AMO is not for querying; AMO is for managing and administering your mining structures and models. To query your data, use [Developing with ADOMD.NET](../adomd-net/developing-with-adomd-net.md).  
