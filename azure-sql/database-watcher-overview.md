...
| You cannot export an ARM template from an existing watcher resource. | Use a quickstart [sample](/samples/azure/azure-quickstart-templates/create-watcher/) to create and configure a watcher using Bicep or an ARM template. |
...
| The **Geo-replicas** and **Replicas** datasets are not collected for Hyperscale databases. | None at this time. |
...
- Use the feedback button in Azure portal. The button is located in the portal header, next to your account details. The feedback you send this way is not public. When you submit feedback, you can optionally allow Microsoft to email you regarding this feedback for follow-ups and clarifications.
