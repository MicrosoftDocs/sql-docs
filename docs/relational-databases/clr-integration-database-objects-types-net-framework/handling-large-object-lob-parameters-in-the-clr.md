...
description: This article describes how to handle large object (LOB) values for parameters in SQL Server CRL integration. Use SqlBytes and SqlChars for LOB types.
ms.custom: ""
ms.date: "03/04/2017"
ms.prod: sql
ms.reviewer: ""
