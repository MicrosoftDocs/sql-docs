...
---
# row Element (XMLA)
  Contains a single row of data for a [root](../../../2014/analysis-services/dev-guide/root-element-xmla.md) element that contains tabular data returned by a [Discover](../../../2014/analysis-services/dev-guide/discover-method-xmla.md) or [Execute](../../../2014/analysis-services/dev-guide/execute-method-xmla.md) method call.  
...
|------------------|-------------|  
|Parent elements|[root](../../../2014/analysis-services/dev-guide/root-element-xmla.md) (using the [Rowset](../../../2014/analysis-services/dev-guide/rowset-data-type-xmla.md) data type)|  
...
```  
 ...
 For more information about column naming and schema information for tabular data, see [Rowset Data Type &#40;XMLA&#41;](../../../2014/analysis-services/dev-guide/rowset-data-type-xmla.md).  
