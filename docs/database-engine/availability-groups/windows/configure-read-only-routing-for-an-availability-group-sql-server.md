...
-   If using a SQL Login, make sure the account is configured correctly. For more information, see [Management of Logins and Jobs for the Databases of an Availability Group (SQL Server)](../../../2014/database-engine/logins-and-jobs-for-availability-group-databases.md#-logins-of-applications-that-use-sql-server-authentication-or-a-local-windows-login).
