...
|pdw_node_id|**int**|ID of the node this distribution is on.|See pdw_node_id in [sys.dm_pdw_nodes &#40;Transact-SQL&#41;](../system-dynamic-management-objects/sys-dm-pdw-nodes-transact-sql.md).|  
