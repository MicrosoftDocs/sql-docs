...
# UnaryOperator Element (XMLA)
  Contains the unary operator for an attribute member represented by the parent [Attribute](../../../2014/analysis-services/dev-guide/attribute-element-xmla.md) element.  
