...
This article describes how to install the language extensions for running Python scripts with [SQL Server.](../../linux/sql-server-linux-overview.md4)
...
+ [SQL Server 2019 of Linux.](../../linux/sql-server-linux-overview.md) 
