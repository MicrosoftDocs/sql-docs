...
| New feature or update | Details |
| :--- | :--- |
| Link to Azure SQL Managed Instance | Replicate your data between your SQL Server instance to Azure SQL Managed Instance for disaster recovery and migration. See [Link feature for Azure SQL Managed Instance](/azure/azure-sql/managed-instance/managed-instance-link-feature-overview). |
