...
For information specific to the use of external resource pools to govern machine learning jobs, see [Resource governance for machine learning in SQL Server](../../machine-learning/r/resource-governance-for-r-services.md)...
## Permissions
...
+ [Resource governance for machine learning in SQL Server](../../machine-learning/r/resource-governance-for-r-services.md)
