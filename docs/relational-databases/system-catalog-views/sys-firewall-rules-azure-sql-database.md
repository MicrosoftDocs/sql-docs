...
Returns information about the server-level firewall settings associated with your [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)].
...
To return information about the database-level firewall settings associated with your [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)], use [sys.database_firewall_rules (Azure SQL Database)](sys-database-firewall-rules-azure-sql-database.md).
