...
|[Using Always Encrypted with the PHP Drivers for SQL Server](../../connect/php/using-always-encrypted-with-the-php-drivers-for-sql-server.md)|Provides information about using Always Encrypted with the PHP Drivers.|  
