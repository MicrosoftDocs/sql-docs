...
# FILESTREAM DDL, Functions, Stored Procedures, and Views
 ...
 For the list of database objects that support the FileTable feature, see [FileTable DDL, Functions, Stored Procedures, and Views](../../2014/database-engine/filetable-ddl-functions-stored-procedures-and-views.md).  
