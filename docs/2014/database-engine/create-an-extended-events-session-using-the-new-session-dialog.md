...
6.  In the **Causality tracking** section, select the **Track how events are related to one another** check box to track work across multiple tasks.  
     ...
     For more information about causality tracking, see “Session Content and Characteristics” in the [SQL Server Extended Events Sessions](../../2014/database-engine/sql-server-extended-events-sessions.md) topic.  
