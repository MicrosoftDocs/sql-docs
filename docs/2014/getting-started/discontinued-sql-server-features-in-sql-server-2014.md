...
|SOAP and [!INCLUDE[ssSB](../../includes/sssb-md.md)] endpoints|Use [CREATE ENDPOINT](../Topic/CREATE%20ENDPOINT%20\(Transact-SQL\).md)and [ALTER ENDPOINT](../Topic/ALTER%20ENDPOINT%20\(Transact-SQL\).md).|  
