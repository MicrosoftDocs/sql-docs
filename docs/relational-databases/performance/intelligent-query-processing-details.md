...
For more information, see [APPROX_PERCENTILE_DISC (Transact-SQL)](../../t-sql/fapprox-percentile-disc-transact-sql.md) and [APPROX_PERCENTILE_CONT (Transact-SQL)](../../t-sql/fapprox-percentile-cont-transact-sql.md) 
