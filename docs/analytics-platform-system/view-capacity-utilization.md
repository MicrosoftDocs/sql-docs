...
If the free space within a volume drops below 30%, SQL Server PDW generates a **warning** alert in [sys.dm_pdw_component_health_active_alerts](https://msdn.microsoft.com/library/mt631630.aspx).  The alert remains until free space is made available.  
