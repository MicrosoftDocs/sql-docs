...
|Topic|Description|  
|-----------|-----------------|  
|[Optimize SQL Trace](../../2014/database-engine/optimize-sql-trace.md)|Contains information about ways you can reduce the effects of tracing on system performance.|  
|[Filter a Trace](../../2014/database-engine/filter-a-trace.md)|Contains information about using filters for tracing.|  
|[Limit Trace File and Table Sizes](../../2014/database-engine/limit-trace-file-and-table-sizes.md)|Contains information about how to limit the size of files and tables where trace data is written. Note that only [!INCLUDE[ssSqlProfiler](../includes/sssqlprofiler-md.md)] can write trace information to tables.|  
|[Schedule Traces](../../2014/database-engine/schedule-traces.md)|Contains information about how to set the start time and the end time for tracing.|  
