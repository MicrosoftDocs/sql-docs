...
## In This Section  
 ...
 [Data Encryption in SQL Server](../../connect/ado-net/data-encryption-in-sql-server.md)  
 Describes data encryption options in SQL Server and provides links to additional resources.  
  
 [CLR Integration Security in SQL Server](../../connect/ado-net/clr-integration-security-in-sql-server.md)  
