...
## Next Task  
 You have successfully created a report project called "Tutorial" and added a report definition (.rdl) file to the report project. Next, you will specify a data source to use for the report. See [Lesson 2: Specifying Connection Information &#40;Reporting Services&#41;](../../2014/tutorials/lesson-2-specifying-connection-information-reporting-services.md).  
