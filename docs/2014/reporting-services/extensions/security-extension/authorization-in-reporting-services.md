...
### Authorization Flow  
 ...
 ![Reporting Services security authorization flow](../../dev-guide/media/rosettasecurityextensionauthorizationflow.gif "Reporting Services security authorization flow")  
