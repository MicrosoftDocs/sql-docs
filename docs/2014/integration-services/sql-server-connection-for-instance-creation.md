...
-   **Advanced**: Click **Advanced** and type any additional connection properties into the Advanced Connection Properties dialog box, if necessary.  
     ...
     For information about the Advanced Connection Properties dialog box, see [Advanced Connection Properties](../../2014/integration-services/advanced-connection-properties.md).  
  
## See Also  
 [Create the SQL Server Change Database](../../2014/integration-services/create-the-sql-server-change-database.md)   
 [SQL Server Connection Required Permissions for the CDC Designer](../../2014/integration-services/sql-server-connection-required-permissions-for-the-cdc-designer.md)  
