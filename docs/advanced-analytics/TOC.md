...
#### [Download the sample data](tutorials/sqldev-download-the-sample-data.md)
#### [Import data and create objects](r/sqldev-import-data-to-sql-server-using-powershell.md)
#### [Visualize data using stored procedures](tutorials/sqldev-explore-and-visualize-the-data.md)
#### [Create data features using T-SQL functions](tutorials/sqldev-create-data-features-using-t-sql.md)
#### [Train and save a model to a SQL table](r/sqldev-train-and-save-a-model-using-t-sql.md)
#### [Wrap R code in a stored procedure](tutorials/sqldev-operationalize-the-model.md)
