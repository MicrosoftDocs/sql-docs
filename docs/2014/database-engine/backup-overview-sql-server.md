 ...
 **Types of Backups**  
 ...
 [database backup](../../2014/database-engine/full-database-backups-sql-server.md)  
 ...
 [differential backup](../../2014/database-engine/full-database-backups-sql-server.md)  
 ...
 [log backup](../../2014/database-engine/transaction-log-backups-sql-server.md)  
 ...
 [file backup](../../2014/database-engine/full-file-backups-sql-server.md)  
 A backup of one or more database files or filegroups.  
  
 [partial backup](../../2014/database-engine/partial-backups-sql-server.md)  
 ...
 **Backup Media Terms and Definitions**  
 ...
 [backup set](../../2014/database-engine/media-sets-media-families-and-backup-sets-sql-server.md)  
 The backup content that is added to a media set by a successful backup operation.  
  
 [media family](../../2014/database-engine/media-sets-media-families-and-backup-sets-sql-server.md)  
 Backups created on a single nonmirrored device or a set of mirrored devices in a media set  
  
 [media set](../../2014/database-engine/media-sets-media-families-and-backup-sets-sql-server.md)  
 ...
 [mirrored media set](../../2014/database-engine/mirrored-backup-media-sets-sql-server.md)  
