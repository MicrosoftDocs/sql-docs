...
1. Confirm the instance of the SQL Server Database Engine is installed and running.
    ...
    1. Using Configuration Manager:
      ...
      1. Make a note of the name of the instance that you are trying to connect to. Also, confirm that the instance is running, by looking for the green arrow. If the instance has a red square, right-click the instance and then click **Start**. It should turn green.
