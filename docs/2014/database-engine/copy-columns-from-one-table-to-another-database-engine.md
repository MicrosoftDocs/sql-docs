...
9. Specify the rows to copy by entering search conditions in the criteria pane. For details, see [Specify Search Conditions &#40;Visual Database Tools&#41;](../../2014/database-engine/specify-search-conditions-visual-database-tools.md).  
  
     If you do not specify a search condition, all rows from the source table will be copied to the destination table.  
  
10. If you want to copy summary information, specify **Group By** options. For details, see [Summarize or Aggregate Values for All Rows in a Table &#40;Visual Database Tools&#41;](../../2014/database-engine/summarize-or-aggregate-values-for-all-rows-in-a-table-visual-database-tools.md).  
