...
Azure SQL Database and Azure Synapse Analytics do not support time zone settings; it always follows UTC. Use [AT TIME ZONE](../../t-sql/queries/at-time-zone-transact-sql.md) in Azure SQL Database or Azure Synapse Analytics if you need to interpret date and time information in a non-UTC time zone.
