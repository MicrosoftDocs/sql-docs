...
4.  In the **New Full-Text Catalog** dialog box, specify the information for the catalog that you are re-creating. For more information, see [New Full-Text Catalog &#40;General Page&#41;](https://docs.microsoft.com/sql/relational-databases/search/create-and-manage-full-text-catalogs).  
