...
-   [Establishing a Connection to a Data Source](../../../2014/database-engine/dev-guide/establishing-a-connection-to-a-data-source.md)  
  
-   [Executing a Command](../../../2014/database-engine/dev-guide/executing-a-command.md)  
  
-   [Processing Results](../../../2014/database-engine/dev-guide/processing-results.md)  
  
-   [About OLE DB Properties](../../../2014/database-engine/dev-guide/about-ole-db-properties.md)  
  
-   [Using the OUTPUT Clause with OLE DB in SQL Server Native Client](../../../2014/database-engine/dev-guide/using-the-output-clause-with-ole-db-in-sql-server-native-client.md)  
