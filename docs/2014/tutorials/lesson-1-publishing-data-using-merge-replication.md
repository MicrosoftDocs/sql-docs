...
## Next Steps  
 You have successfully created the merge publication. Next, you will subscribe to this publication. See [Lesson 2: Creating a Subscription to the Merge Publication](../../2014/tutorials/lesson-2-creating-a-subscription-to-the-merge-publication.md).  
