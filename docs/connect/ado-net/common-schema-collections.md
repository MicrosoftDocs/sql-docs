...
This schema collection exposes information about the data types that are supported by the database that the Microsoft SqlClient Data Provider for SQL Server is currently connected to.  
...
This schema collection exposed information about the restrictions that are supported by the Microsoft SqlClient Data Provider for SQL Server that is currently used to connect to the database.  
...
This schema collection exposes information about the words that are reserved by the database that the Microsoft SqlClient Data Provider for SQL Server that is currently connected to.  
