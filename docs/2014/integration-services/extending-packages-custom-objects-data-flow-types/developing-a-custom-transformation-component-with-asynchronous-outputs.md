...
# Developing a Custom Transformation Component with Asynchronous Outputs
 ...
 This section explains in detail how to develop transformations with asynchronous outputs. For more information about source component development, see [Developing a Custom Source Component](../extending-packages-custom-objects-data-flow-types/developing-a-custom-source-component.md).  
...
## See Also  
 ...
 [Creating an Asynchronous Transformation with the Script Component](../data-flow/transformations/script-component.md)  
