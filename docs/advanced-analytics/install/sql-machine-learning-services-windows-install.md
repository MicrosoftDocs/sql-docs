...
+ Machine Learning Services is installed by default on SQL Server Big Data Clusters. If you use a Big Data Cluster, you do not need to follow the steps in this article. For more information, see [Use Machine Learning Services (Python and R) on a Big Data Cluster](../../big-data-cluster/machine-learning-services.md).
::: moniker-end
