...
1.  At either the Publisher or Subscriber, execute the [bcp Utility](../../../2014/database-engine/bcp-utility.md) or [BULK INSERT](~/t-sql/statements/bulk-insert-transact-sql.md) to insert data into a table published using merge replication.  
