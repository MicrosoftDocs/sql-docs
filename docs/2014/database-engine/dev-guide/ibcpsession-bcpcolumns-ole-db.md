...
## Remarks  
 Internally it calls [IBCPSession::BCPColFmt](../../../2014/database-engine/dev-guide/ibcpsession-bcpcolfmt-ole-db.md) to set the default values for field data. These default values are obtained from the SQL Server column information that the provider internally retrieves when the table name is specified through [IBCPSession::BCPInit](../../../2014/database-engine/dev-guide/ibcpsession-bcpinit-ole-db.md).  
