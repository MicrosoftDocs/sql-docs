...
Microsoft OLE DB Driver 19.3.0 for SQL Server is the latest general availability (GA) version. The Microsoft OLE DB Driver 19 for SQL Server will install side by side with Microsoft OLE DB Driver 18 for SQL Server.

:::image type="icon" source="../../includes/media/download.svg" border="false"::: **[Download Microsoft OLE DB Driver 19 for SQL Server (x64)](https://go.microsoft.com/fwlink/?linkid=2220017)**  
...
> [!Note]
> Installation of [Microsoft Visual C++ Redistributable](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist) is a prerequisite,
> and while the 64bit installer for Microsoft OLE DB Driver installs both the 64bit and 32bit driver, the 64bit installer for the Microsoft Visual C++ Redistributable
> does not and you will need to install both the 32bit and 64bit versions to use the OleDb provider in 32bit programs.
