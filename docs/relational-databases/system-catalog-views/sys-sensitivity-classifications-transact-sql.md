...
- This view provides visibility into the classification state of the database, and can be used for managing the database classifications, as well as for generating reports.
