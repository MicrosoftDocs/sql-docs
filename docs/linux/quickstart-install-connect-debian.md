---
title: Get started with SQL Server on Debian
titleSuffix: SQL Server
description: This quickstart shows how to install SQL Server 2017 or SQL Server 2019 on Debian 9 and then create and query a database with sqlcmd.
...
ms.assetid:
---
# Quickstart: Install SQL Server and create a database on Debian
...
In this quickstart, you install SQL Server 2017 or SQL Server 2019 preview on Debian 9. You then connect with **sqlcmd** to create your first database and run queries.

::: moniker-end
<!--SQL Server 2019 on Linux-->
::: moniker range=">= sql-server-linux-ver15 || >= sql-server-ver15 || =sqlallproducts-allversions"

In this quickstart, you install SQL Server 2019 preview on Debian 9. You then connect with **sqlcmd** to create your first database and run queries.
...
You must have a Debian 9 machine with **at least 2 GB** of memory.

To install Debian 9 on your own machine, go to [https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/](https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/). You can also create Ubuntu virtual machines in Azure. See [Create and Manage Linux VMs with the Azure CLI](https://docs.microsoft.com/azure/virtual-machines/linux/tutorial-manage-vm).
...
2. Register the Microsoft SQL Server Ubuntu repository:
   ...
   >
   > ```bash
   > curl https://packages.microsoft.com/config/ubuntu/16.04/mssql-server-preview.list | sudo tee /etc/apt/sources.list.d/mssql-server-preview.list
   > ```
