...
|DatabaseID|`int`|ID of the database in which the lock time-out occurred. [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] displays the name of the database if the ServerName data column is captured in the trace and the server is available. Determine the value for a database by using the DB_ID function.|3|Yes|  
...
## See Also  
 ...
 [Lock:Timeout &#40;timeout &#62; 0&#41; Event Class](../../2014/database-engine/lock-timeout-timeout-0-event-class.md)   
