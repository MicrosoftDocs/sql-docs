...
- Please ensure that the database names adhere to the naming convention and don’t contain reserve words. [See reserved words list for resource names.](/azure/azure-resource-manager/troubleshooting/error-reserved-resource-name) 
