...
# ParentObject Element (XMLA)
  Contains the identifier of the parent object under which to create the objects defined by the parent [Create](../../../2014/analysis-services/dev-guide/create-element-xmla.md) element.  
...
|------------------|-------------|  
|Parent elements|[Create](../../../2014/analysis-services/dev-guide/create-element-xmla.md)|  
