...
-   Lookup errors, which occur if a lookup operation fails to locate a match in the lookup table.  
 ...
 ![Data flow with error output](../../2014/integration-services/media/mw-dts-11.gif "Data flow with error output")  
 ...
 For more information, see [Data Flow](../../2014/integration-services/data-flow.md) and [Integration Services Paths](../../2014/integration-services/integration-services-paths.md).  
