...
---
# Tuple Element (XMLA)
  Contains a collection of [Member](member-element-xmla.md) elements contained by the parent [Tuples](tuples-element-xmla.md) element.  
...
|------------------|-------------|  
|Parent elements|[Tuples](tuples-element-xmla.md)|  
