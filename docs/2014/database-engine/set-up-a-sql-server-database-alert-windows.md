...
# Set Up a SQL Server Database Alert (Windows)
 ...
 Alerts also can be defined using Microsoft [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] and [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent. For more information, see [Alerts](../../2014/database-engine/alerts.md).  
...
## See Also  
 [Create a SQL Server Database Alert](../../2014/database-engine/create-a-sql-server-database-alert.md)  
