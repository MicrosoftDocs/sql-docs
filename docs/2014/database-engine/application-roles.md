...
|||  
|-|-|  
|Create an application role.|[Create an Application Role](../../2014/database-engine/create-an-application-role.md) and [CREATE APPLICATION ROLE &#40;Transact-SQL&#41;](~/t-sql/statements/create-application-role-transact-sql.md)|  
