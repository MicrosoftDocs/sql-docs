...
description: To create a UDT to install in SQL Server, first create a class a .NET Framework programming language, which conforms to the specifications for creating UDTs.
ms.custom: ""
ms.date: "03/16/2017"
ms.prod: sql
ms.reviewer: ""
