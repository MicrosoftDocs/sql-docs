...
# QueryNotification Element (ASSL)
  Contains information for the [ProactiveCaching](../../../2014/analysis-services/dev-guide/proactivecaching-element-assl.md) element about the query to execute to determine whether a data source has been modified.  
...
|------------------|-------------|  
|Parent elements|[QueryNotifications](../../../2014/analysis-services/dev-guide/querynotifications-element-assl.md)|  
|Child elements|[Query](../../../2014/analysis-services/dev-guide/query-element-assl.md)|  
