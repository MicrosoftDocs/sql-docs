...
description: Show comparisons or data changes over a period of time with a column chart. Display a series as a set of vertical bars grouped by category in Report Builder.
ms.date: 03/03/2017
