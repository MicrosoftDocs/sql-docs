...
:::image type="content" source="../../relational-databases/system-dynamic-management-objects/media/join-dm-exec-connections.svg" alt-text="Diagram of physical joins for sys.dm_exec_connections.":::
