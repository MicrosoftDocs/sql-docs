...
description: SQL Server CRL integration allows you to create custom aggregate functions in managed code. They must implement the required aggregation contract.
ms.custom: ""
ms.date: "03/17/2017"
ms.prod: sql
ms.reviewer: ""
