...
# RelationalDataSource Data Type (ASSL)
  Defines a derived data type that represents a [DataSource](../../../2014/analysis-services/dev-guide/datasource-element-assl.md) element based on a relational data source.  
