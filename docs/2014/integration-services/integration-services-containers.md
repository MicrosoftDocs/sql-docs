...
|---------------|-----------------|  
|[Foreach Loop Container](../../2014/integration-services/foreach-loop-container.md)|Runs a control flow repeatedly by using an enumerator.|  
|[For Loop Container](../../2014/integration-services/for-loop-container.md)|Runs a control flow repeatedly by testing a condition.|  
|[Sequence Container](../../2014/integration-services/sequence-container.md)|Groups tasks and containers into control flows that are subsets of the package control flow.|  
|[Task Host Container](../../2014/integration-services/task-host-container.md)|Provides services to a single task.|  
