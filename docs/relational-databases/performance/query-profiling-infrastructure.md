...
|---------------|---------------|---------------|
|Globally|xEvent session with the `query_post_execution_showplan` XE; Starting with [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]|Trace Flag 7412; Starting with [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SP1|
|Globally|SQL Trace and SQL Server Profiler with the `Showplan XML` trace event; Starting with SQL Server 2000|xEvent session with the `query_thread_profile` XE; Starting with [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] SP2|
|Globally|-|xEvent session with the `query_post_execution_plan_profile` XE; Starting with [!INCLUDE[sql-server-2019](../../includes/sssqlv15-md.md)]|
