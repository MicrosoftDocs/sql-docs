...
-   Connection Managers  
    ...
    -   [Azure Storage Connection Manager](../../2014/integration-services/azure-storage-connection-manager.md)  
  
    -   [Azure Subscription Connection Manager](../../2014/integration-services/azure-subscription-connection-manager.md)  
...
-   Tasks  
    ...
    -   [Azure Blob Upload Task](../../2014/integration-services/azure-blob-upload-task.md)  
  
    -   [Azure Blob Download Task](../../2014/integration-services/azure-blob-download-task.md)  
  
    -   [Azure HDInsight Hive Task](../../2014/integration-services/azure-hdinsight-hive-task.md)  
  
    -   [Azure HDInsight Pig Task](https://msdn.microsoft.com/library/mt146781(v=sql.120).aspx)
  
    -   [Azure HDInsight Create Cluster Task](../../2014/integration-services/azure-hdinsight-create-cluster-task.md)  
  
    -   [Azure HDInsight Delete Cluster Task](../../2014/integration-services/azure-hdinsight-delete-cluster-task.md)
    
    -   [Azure SQL DW Upload Task](../../2014/integration-services/azure-sql-dw-upload-task.md)    
    
    -   [Azure Data Lake Store File System Task](../../2014/integration-services/azure-data-lake-store-file-system-task.md)    
  
-   Data Flow Components  
  
    -   [Azure Blob Source](https://msdn.microsoft.com/library/mt146775(v=sql.120).aspx)  
  
    -   [Azure Blob Destination](../../2014/integration-services/azure-blob-destination.md)  
...
-   Azure Blob Enumerator & ADLS File Enumerator. See [Foreach Loop Container](../../2014/integration-services/foreach-loop-container.md).  
