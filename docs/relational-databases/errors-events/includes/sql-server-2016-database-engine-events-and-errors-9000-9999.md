...
| :--- | :--- | :--- | :--- |
| [9001](../mssqlserver-9001-database-engine-error.md) | 21 | Yes | The log for database '%.\*ls' is not available. Check the event log for related error messages. Resolve any errors and restart the database. |
...
| 9032 | 16 | Yes | PMM log file '%.\*ls' can only be removed when the database is in single user mode. |
