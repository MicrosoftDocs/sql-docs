...
SQL Server PDW logs alerts in the [sys.dm_pdw_component_health_alerts &#40;SQL Server PDW&#41;](../../mpp/sqlpdw/sys-dm-pdw-component-health-alerts-sql-server-pdw.md) DMV. The system retains a limit of 10,000 alerts and deletes the oldest alert first when the limit is exceeded.  
...
![PDW Admin Console Alerts](../../mpp/management/media/SQL_Server_PDW_AdminConsole_AlertsV2.png "SQL_Server_PDW_AdminConsole_AlertsV2")  
...
To view alerts by using system views, query [sys.dm_pdw_component_health_active_alerts &#40;SQL Server PDW&#41;](../../mpp/sqlpdw/sys-dm-pdw-component-health-active-alerts-sql-server-pdw.md). This DMV shows alerts that have not been corrected. For help with triaging alerts and errors, use the [sys.dm_pdw_errors &#40;SQL Server PDW&#41;](../../mpp/sqlpdw/sys-dm-pdw-errors-sql-server-pdw.md) DMV.  
