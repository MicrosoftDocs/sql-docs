...
1. Data Ingress: There's no cost associated with data ingress into Azure. See the [Azure guideline](https://azure.microsoft.com/en-us/pricing/details/bandwidth/) on the data migration cost.
