...
description: SQL Server CLR programming disallows a type or member with certain values for the HostProtectionResource enum. This table lists mscorlib.dll disallowed values.
ms.custom: ""
ms.date: "03/14/2017"
ms.prod: sql
ms.reviewer: ""
