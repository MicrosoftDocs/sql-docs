...
## Creating Predictions  
 ...
 For information about how to create queries against a data mining model, see [Data Mining Queries](../../2014/analysis-services/data-mining-queries.md). For examples of how to use queries with a clustering model, see [Clustering Model Query Examples](../../2014/analysis-services/clustering-model-query-examples.md).  
...
## See Also  
 ...
 [Mining Model Content for Clustering Models &#40;Analysis Services - Data Mining&#41;](../../2014/analysis-services/mining-model-content-for-clustering-models-analysis-services-data-mining.md)   
 [Clustering Model Query Examples](../../2014/analysis-services/clustering-model-query-examples.md)  
