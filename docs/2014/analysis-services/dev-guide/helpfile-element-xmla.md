...
# HelpFile Element (XMLA)
  Contains the path or URL to the Help file or topic that describes the parent [Error](../../../2014/analysis-services/dev-guide/error-element-xmla.md) element.  
...
|------------------|-------------|  
|Parent elements|[Error](../../../2014/analysis-services/dev-guide/error-element-xmla.md)|  
|Child elements|None|  
