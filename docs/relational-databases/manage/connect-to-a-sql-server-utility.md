...
4. In the Utility Explorer navigation pane, select :::image type="icon" source="media/connect-to-utility.gif" border="false"::: :::image type="icon" source="../../ssms/media/download-icon.png" border="false"::: ![Connect to Utility](../../relational-databases/manage/media/connect-to-utility.gif "Connect_to_Utility")**Connect to Utility**.
