...
- [SQL Server 2014 Reporting Services Deprecated Features](deprecated-features-in-sql-server-reporting-services-ssrs.md).aspx)

- [SQL Server 2012 Reporting Services Deprecated Features](deprecated-features-in-sql-server-reporting-services-ssrs.md).aspx)
