...
-   Right-click on the gauge pointer and select **Pointer Properties**. For **Value**, select a field from the dropdown list or define a field expression by clicking the **Expression** (*fx*) button.  
