...
## See Also  
 ...
 [Add an Existing Project to a Solution](../../2014/database-engine/add-an-existing-project-to-a-solution.md)   
 [Add New Items to a Project](../../2014/database-engine/add-new-items-to-a-project.md)   
 [Add Existing Items to a Project](../../2014/database-engine/add-existing-items-to-a-project.md)   
 [Change the Default Location for Projects](../../2014/database-engine/change-the-default-location-for-projects.md)   
 [Remove or Delete an Item or Project](../../2014/database-engine/remove-or-delete-an-item-or-project.md)   
 [Delete a Solution](../../2014/database-engine/delete-a-solution.md)  
