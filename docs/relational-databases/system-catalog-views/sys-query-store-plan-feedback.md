...
|**feature_desc**|nvarchar(60)|1 = CE feedback, 2 = memory grant feedback|
|**feedback_data**|nvarchar(max)|For CE feedback, displays query hints in use.<br><br>For memory grant feedback, displays JSON string containing operator-level grant values.<br>Format:   "[{"node_id": value}, {"node_id": value},….]"<br>Example: "[{"1": 2300}, {"5": 1500}]"| 
