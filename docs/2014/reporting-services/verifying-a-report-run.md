...
|-----------------------------|-----------------------------------------------|-----------------------------------------------|  
|A report that runs as a report snapshot.|On the Contents page. For more information, see [Contents Page &#40;Report Manager&#41;](../../2014/reporting-services/contents-page-report-manager.md).|1) Locate the folder that contains the report.<br />2) Set the folder in Details view.<br />3) 3) Note the date and time in the **When Run** column.|  
|A snapshot in report history.|On the History Properties page. For more information, see [Snapshot Options Properties Page &#40;Report Manager&#41;](../../2014/reporting-services/snapshot-options-properties-page-report-manager.md).|1) Open the report.<br />2) Click the **Properties** page.<br />3) Click the **History** tab.<br />4) Note the date and time in the **When Run** column.|  
