...
-   Define the data set used for training a model, by using [INSERT INTO &#40;DMX&#41;](~/dmx/insert-into-dmx.md) together with a data source query such as OPENROWSET.  
 ...
 For an example of how to enter parameters using the interface, see [Create a Singleton Prediction Query from a Template](data-mining/create-a-singleton-prediction-query-from-a-template.md).  
...
|Design queries of all kinds, using Prediction Query Builder.|[Create a Prediction Query Using the Prediction Query Builder](data-mining/create-a-prediction-query-using-the-prediction-query-builder.md)|  
