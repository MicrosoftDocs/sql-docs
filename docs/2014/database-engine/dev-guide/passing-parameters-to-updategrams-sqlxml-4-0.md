...
# Passing Parameters to Updategrams (SQLXML 4.0)
  Updategrams are templates; therefore, you can pass them parameters. For more information about passing parameters to templates, see [Updategram Security Considerations &#40;SQLXML 4.0&#41;](../../../2014/database-engine/dev-guide/updategram-security-considerations-sqlxml-4-0.md).  
...
2.  Prepare the SQLXML 4.0 test script (Sqlxml4test.vbs) in [Using ADO to Execute SQLXML 4.0 Queries](../../../2014/database-engine/dev-guide/using-ado-to-execute-sqlxml-4-0-queries.md) to execute the updategram by adding the following lines after the `cmd.Properties("Output Stream").Value = outStream`:  
