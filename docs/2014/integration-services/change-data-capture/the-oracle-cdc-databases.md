...
|----------|-------------|---------|---------|------------|-----------------|  
|trace|False|-|-|False|The available values:<br /><br /> **True**<br /><br /> **False**<br /><br /> **on**<br /><br /> **off**|  
|cdc_update_state_interval|10|1|120|False|The size (in Kbytes) of memory chunks allocated for a transaction (a transaction can allocate more than one chunk). See the memory_limit column in [cdc.xdbcdc_config](the-oracle-cdc-databases.md#bkmk_cdcxdbcdc_config) table.|  
