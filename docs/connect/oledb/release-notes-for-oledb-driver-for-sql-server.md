...
| Fixed adal issues. | Fixed the issues detected in OLE DB Driver 19.2.0, including fixing x86 adal.dll issue and downgrading adal.ll from version 3.6.0 to version 3.4.1. |
