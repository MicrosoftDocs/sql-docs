...
### [Extended Events for SQL Server Machine Learning Services](./r-services/extended-events-for-sql-server-r-services.md)  
...
### [Setup Machine Learning Server Standalone](./r-services/create-a-standalone-r-server.md)  
...
### [Performance Tuning Case Study](./r-services/performance-case-study-r-services.md)
...
### [Installing Machine Learning Components without Internet Access](./r-services/installing-ml-components-without-internet-access.md)  
### [Installing SQL Server Machine Learning Services on an Azure Virtual Machine](./r-services/installing-sql-server-r-services-on-an-azure-virtual-machine.md)  
...
## [Data Science End-to-End Walkthrough](./r-services/data-science-end-to-end-walkthrough.md)
...
### [Prepare the Data](./r-services/lesson-1-prepare-the-data-data-science-end-to-end-walkthrough.md)  
### [View and Explore the Data](./r-services/lesson-2-view-and-explore-the-data-data-science-end-to-end-walkthrough.md)  
#### [View and Summarize Data using R](./r-services/lesson-2-1-view-and-summarize-data-using-r.md)  
#### [Create Graphs and Plots Using R](./r-services/lesson-2-2-create-graphs-and-plots-using-r.md) 
### [Create Data Features](./r-services/lesson-3-create-data-features-data-science-end-to-end-walkthrough.md)  
### [Build and Save the Model](./r-services/lesson-4-build-and-save-the-model-data-science-end-to-end-walkthrough.md)  
### [Deploy and Use the Model](./r-services/lesson-5-deploy-and-use-the-model-data-science-end-to-end-walkthrough.md)    
...
#### [Create SQL Server Data Objects using RxSqlServerData](./r-services/lesson-1-1-create-sql-server-data-objects-using-rxsqlserverdata.md)  
#### [Query and Modify the SQL Server Data](./r-services/lesson-1-2-query-and-modify-the-sql-server-data.md)  
#### [Define and Use Compute Contexts](./r-services/lesson-1-3-define-and-use-compute-contexts.md)  

### [Lesson 2: Create and Run R Scripts](./r-services/lesson-2-create-and-run-r-scripts-data-science-deep-dive.md)
#### [Visualize SQL Server Data using R](./r-services/lesson-2-1-visualize-sql-server-data-using-r.md)  
#### [Create Models](./r-services/lesson-2-2-create-models.md)  
#### [Score New Data](./r-services/lesson-2-3-score-new-data.md)

### [Lesson 3: Transform Data Using R](./r-services/lesson-3-transform-data-using-r-data-science-deep-dive.md)
#### [Load Data into Memory using rxImport](./r-services/lesson-3-1-load-data-into-memory-using-rximport.md)  
#### [Create New SQL Server Table using rxDataStep](./r-services/lesson-3-2-create-new-sql-server-table-using-rxdatastep.md)  
#### [Perform Chunking Analysis using rxDataStep](./r-services/lesson-3-3-perform-chunking-analysis-using-rxdatastep.md)  
...
#### [Move Data between SQL Server and XDF File](./r-services/lesson-4-1-move-data-between-sql-server-and-xdf-file.md)  
