...
description: In Report Builder, you can publish a report to a report server. Other can view it. Each time you run the published report, you see the most current data.
ms.date: 03/01/2017
