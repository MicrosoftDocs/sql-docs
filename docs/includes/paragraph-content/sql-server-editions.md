...
| Evaluation | [!INCLUDE [ssevaluation-md](../ssevaluation-md.md)]  is a fully functional trial version of SQL Server software that automatically expires after 180 days. |
