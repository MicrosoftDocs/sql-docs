...
-   [Display the Estimated Execution Plan](../../2014/database-engine/display-the-estimated-execution-plan.md)  
  
-   [Display an Actual Execution Plan](../../2014/database-engine/display-an-actual-execution-plan.md)  
  
-   [Save an Execution Plan in XML Format](../../2014/database-engine/save-an-execution-plan-in-xml-format.md)  
