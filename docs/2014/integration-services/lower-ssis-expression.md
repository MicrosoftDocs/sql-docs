...
```  
 ...
 This example converts all characters from the **Color** input column, except the first character, to lowercase characters. If Color is YELLOW, the return result is "Yellow". For more information, see [SUBSTRING &#40;SSIS Expression&#41;](../../2014/integration-services/substring-ssis-expression.md).  
...
## See Also  
 [UPPER &#40;SSIS Expression&#41;](../../2014/integration-services/upper-ssis-expression.md)   
