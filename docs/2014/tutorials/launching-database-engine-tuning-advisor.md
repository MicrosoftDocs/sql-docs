...
2.  In the **Connect to Server** dialog box, verify the default settings, and then click **Connect**.  
 ...
 ![Database Engine Tuning Advisor default window](../../2014/tutorials/media/defaultdtagui.gif "Database Engine Tuning Advisor default window")  
...
## Next Task in Lesson  
 [Setting Tool Options and Layout](../../2014/tutorials/setting-tool-options-and-layout.md)  
