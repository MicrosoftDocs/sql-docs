...
# ManufacturingExtraMonthQuarter Element (ASSL)
  Defines the month of the manufacturing period to which an extra month is assigned for a [TimeBinding](../../../2014/analysis-services/dev-guide/timebinding-data-type-assl.md) element.  
...
|------------------|-------------|  
|Parent element|[TimeBinding](../../../2014/analysis-services/dev-guide/timebinding-data-type-assl.md)|  
|Child elements|None|  
