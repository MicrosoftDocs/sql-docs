...
|is_dropped_ledger_table_column|**bit**|**Applies to**: Starting with SQL Server 2022, [!INCLUDE[ssSDS_md](../../includes/sssds-md.md)].<br /><br /> Indicates a ledger table column that has been dropped.|
