...
**Applies to**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] through [current version](../../troubleshoot/sql/general/determine-version-edition-update-level.md) and Azure SQL Managed Instance.
