...
# RestrictionList Element (XMLA)
  Contains a collection of restriction columns and values used by the [Discover](../../../2014/analysis-services/dev-guide/discover-method-xmla.md) method.  
...
|------------------|-------------|  
|Parent elements|[Restrictions](../../../2014/analysis-services/dev-guide/restrictions-element-xmla.md)|  
