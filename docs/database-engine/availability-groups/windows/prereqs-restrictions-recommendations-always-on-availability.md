...
##  <a name="DotNetHotfixes"></a> .NET Hotfixes that Support Availability Groups  
 Depending on the [!INCLUDE[ssCurrent](../../../includes/ssnoversion-md.md)] components and features you will use with [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)], you may need to install additional .NET hotfixes identified in the following table. The hotfixes can be installed in any order.  
