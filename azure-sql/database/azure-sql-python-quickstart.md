...
1. Create a project folder, for example, *python-sql", and change directory to it.

1. In the project folder, add the sample code to the `app.py` file. This code creates an API that:
...
Append */all* path to the end of the URL to see a list of entries in the Person table. Append */person* to the URL to add a Person.  
