...
## Related Tasks  
 [Create Linked Servers &#40;SQL Server Database Engine&#41;](../../2014/database-engine/create-linked-servers-sql-server-database-engine.md)  
