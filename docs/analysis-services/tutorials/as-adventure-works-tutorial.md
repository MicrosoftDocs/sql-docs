---
title: "Analysis Services Adventure Works Tutorial | Microsoft Docs"
...
|----------|------------------------------|  
|[1 - Create a new tabular model project](../tutorials/as-lesson-1-create-a-new-tabular-model-project.md)|10 minutes|  
|[2 - Get data](../tutorials/as-lesson-2-get-data.md)|10 minutes|  
|[3 - Mark as Date Table](../tutorials/as-lesson-3-mark-as-date-table.md)|3 minutes|  
|[4 - Create relationships](../tutorials/as-lesson-4-create-relationships.md)|10 minutes|  
|[5 - Create calculated columns](../tutorials/as-lesson-5-create-calculated-columns.md)|15 minutes|
|[6 - Create measures](../tutorials/as-lesson-6-create-measures.md)|30 minutes|  
|[7 - Create Key Performance Indicators (KPI)](../tutorials/as-lesson-7-create-key-performance-indicators.md)|15 minutes|  
|[8 - Create perspectives](../tutorials/as-lesson-8-create-perspectives.md)|5 minutes|  
|[9 - Create hierarchies](../tutorials/as-lesson-9-create-hierarchies.md)|20 minutes|  
|[10 - Create partitions](../tutorials/as-lesson-10-create-partitions.md)|15 minutes|  
|[11 - Create roles](../tutorials/as-lesson-11-create-roles.md)|15 minutes|  
|[12 - Analyze in Excel](../tutorials/as-lesson-12-analyze-in-excel.md)|5 minutes| 
|[13 - Deploy](../tutorials/as-lesson-13-deploy.md)|5 minutes|  
...
|Lesson|Estimated time to complete|  
|----------|------------------------------|  
|[Detail Rows](../tutorials/as-supplemental-lesson-detail-rows.md)|10 minutes|
|[Dynamic security](../tutorials/as-supplemental-lesson-dynamic-security.md)|30 minutes|
|[Ragged hierarchies](../tutorials/as-supplemental-lesson-ragged-hierarchies.md)|20 minutes| 

  
## Next steps  
To get started, see [Lesson 1: Create a new tabular model project](../tutorials/as-lesson-1-create-a-new-tabular-model-project.md).  
