...
description: Find out about this function that returns the set of matching values for a specified name from a dataset that contains name  or value pairs.
ms.date: 03/07/2017
