...
# Optimization Element (XMLA)
  Specifies the optimization threshold percentage used by the [DesignAggregations](../../../2014/analysis-services/dev-guide/designaggregations-element-xmla.md) command to design aggregations.  
