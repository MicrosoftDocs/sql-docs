...
>  [!IMPORTANT]  
>   At this time, the only authentication method supported for database mirroring endpoint is CERTIFICATE. Active Directory (WINDOWS) authentication method will be enabled in a future release
