...
Currently,  Microsoft JDBC Driver 7.0 for SQL Server is Java 10 compatible, but it's not fully compliant for Java Database Connectivity API 4.3 specifications.
