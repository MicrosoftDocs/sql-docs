...
# [Filter Traces with SQL Server Profiler](filter-traces-with-sql-server-profiler.md)  # [Filter Events in a Trace (SQL Server Profiler)](filter-events-in-a-trace-sql-server-profiler.md)  
