...
For detailed steps to deploy a confidential VM, review the [Quickstart: Deploy a SQL Server on Azure VM](sql-vm-create-portal-quickstart.md?tab=confidential-vms). 
...
1. (Optional) Configure disk encryption. Follow the steps in the [Disk section of the Quickstart](sql-vm-create-portal-quickstart.md#disks?tab=confidential-vms). 
