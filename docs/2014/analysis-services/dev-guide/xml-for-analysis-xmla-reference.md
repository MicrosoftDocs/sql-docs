...
# XML for Analysis  (XMLA) Reference
 ...
 To support the discovery and manipulation of data in both multidimensional and tabular formats, the XMLA specification defines two generally accessible methods, [Discover](../../../2014/analysis-services/dev-guide/discover-method-xmla.md) and [Execute](../../../2014/analysis-services/dev-guide/execute-method-xmla.md), and a collection of XML elements and data types. Because XML allows for a loosely coupled client and server architecture, both methods handle incoming and outgoing information in XML format. Analysis Services is compliant with the XMLA 1.1. specification, but also extends it to include data definition and manipulation capability, implemented as annotations on the `Discover` and `Execute` methods. The extended XML syntax is referred to as Analysis Services Scripting Language (ASSL). ASSL builds on the XMLA specification without breaking it. Interoperability based on XMLA is ensured whether you use just XMLA, or XMLA and ASSL together.  
...
|Topic|Description|  
|-----------|-----------------|  
|[XML Elements &#40;XMLA&#41;](../../../2014/analysis-services/dev-guide/xml-elements-xmla.md)|Describes elements in the XMLA specification.|  
|[XML Data Types &#40;XMLA&#41;](../../../2014/analysis-services/dev-guide/xml-data-types-xmla.md)|Describes data types in the XMLA specification.|  
