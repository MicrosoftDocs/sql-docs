...
4.  Deploy the DLL to the server. For more information about deploying the DLL to the server, see [Creating Stored Procedures](../../../2014/analysis-services/dev-guide/creating-stored-procedures.md).  
