...
-   Type the XML data as it is stored in the database  
 ...
 You can use the intrinsic function XML_SCHEMA_NAMESPACE to retrieve the schema collection that is stored in the database. For more information, see [View a Stored XML Schema Collection](../../2014/database-engine/view-a-stored-xml-schema-collection.md).  
...
-   [Grant Permissions on an XML Schema Collection](../../2014/database-engine/grant-permissions-on-an-xml-schema-collection.md)  
...
-   [Revoke Permissions on an XML Schema Collection](../../2014/database-engine/revoke-permissions-on-an-xml-schema-collection.md)  
...
-   [Deny Permissions on an XML Schema Collection](../../2014/database-engine/deny-permissions-on-an-xml-schema-collection.md)  
...
## See Also  
 [View a Stored XML Schema Collection](../../2014/database-engine/view-a-stored-xml-schema-collection.md)   
 [Preprocess a Schema to Merge Included Schemas](../../2014/database-engine/preprocess-a-schema-to-merge-included-schemas.md)   
