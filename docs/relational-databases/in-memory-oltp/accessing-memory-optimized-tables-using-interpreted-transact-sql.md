...
description: Learn about accessing memory-optimized tables using interpreted Transact-SQL, which are Transact-SQL batches or stored procedures in SQL Server.
