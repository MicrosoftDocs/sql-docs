...
-   [Using Backup Task in SQL Server Management Studio](../../2014/database-engine/sql-server-backup-to-url.md#BackupTaskSSMS)  
  
-   [SQL Server Backup to URL Using Maintenance Plan Wizard](../../2014/database-engine/sql-server-backup-to-url.md#MaintenanceWiz)  
  
-   [Restoring from Windows Azure storage Using SQL Server Management Studio](../../2014/database-engine/sql-server-backup-to-url.md#RestoreSSMS)  
...
2.  On the general page the **URL** option is used to create a backup to Windows Azure storage. When you select this option, you see other options enabled on this page:  
 ...
 [Back Up Database &#40;Media Options Page&#41;](../../2014/database-engine/back-up-database-media-options-page.md)  
  
 [Back Up Database &#40;Backup Options Page&#41;](../../2014/database-engine/back-up-database-backup-options-page.md)  
  
 [Create Credential - Authenticate to Azure Storage](../../2014/database-engine/create-credential-authenticate-to-azure-storage.md)  
