---
title: "SQL Server PDW Catalog Views (SQL Server PDW)"
ms.custom: na
ms.date: 07/27/2016
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 3da883a4-7118-4e51-a942-cfe841878607
caps.latest.revision: 8
author: BarbKess
---
# SQL Server PDW Catalog Views (SQL Server PDW)
This topic lists the SQL Server PDW catalog views. These views provide information about the MPP system.  
  
## <a name="Alphabetized"></a>SQL Server PDW Catalog Views  
All SQL Server PDW catalog views begin with **sys.pdw**.  
