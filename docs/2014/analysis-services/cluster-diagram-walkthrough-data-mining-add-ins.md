...
## Build a Cluster Diagram  
 ...
 To follow along, you should have a clustering model already available. If you do not have a model, use the [Cluster Wizard &#40;Data Mining Add-ins for Excel&#41;](../../2014/analysis-services/cluster-wizard-data-mining-add-ins-for-excel.md) wizard and create a model using the Training data set in the sample workbook, using all the defaults.  
...
6.  If the connection is successful, on the page, **Options for cluster diagram**, you decide which type of cluster diagram to include in your Visio presentation:  
     ...
     **Show clusters with characteristics chart**  
     ...
     ![Example of cluster characteristics chart in Visio](../../2014/analysis-services/media/dm13-visio-cluster-samplecharshape.gif "Example of cluster characteristics chart in Visio")  
...
8.  Click **Advanced**.  
     ...
     ![click Advanced to choose shape colors](../../2014/analysis-services/media/dm13-visio-clusteroptions-advanced.gif "click Advanced to choose shape colors")  
...
9. Click **Finish** to create the graph.  
     ...
     ![a dependency network](../../2014/analysis-services/media/dm13-visiodepnet-defaultgraph.gif "a dependency network")  
...
## Explore and Modify the Finished Diagram  
 ...
 ![cluster diagram customized using Visio](../../2014/analysis-services/media/dm13-visio-clustercomplete1.gif "cluster diagram customized using Visio")  
...
4.  Click the **Add-Ins** ribbon, and then display one of the custom toolbars used for working with data mining diagrams:  
     ...
     **Description**  
     ...
     ![click Description to get details about the cluster](../../2014/analysis-services/media/dm13-visio-cluster-description-control.gif "click Description to get details about the cluster")  
