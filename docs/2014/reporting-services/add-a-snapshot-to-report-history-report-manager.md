...
3.  Click **New Snapshot**. A new snapshot is created in the **When Run** column.  
    ...
    > [!NOTE]  
    >  In order to do this, the report history must be configured by the administrator to **Allow history to be created manually**. For more information, see [Limit Report History &#40;Report Manager&#41;](../../2014/reporting-services/limit-report-history-report-manager.md).  
...
## See Also  
 [Configure Execution Properties for a Report  &#40;Report Manager&#41;](../../2014/reporting-services/configure-execution-properties-for-a-report-report-manager.md)   
