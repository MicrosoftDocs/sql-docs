...
|Property  |Description  |Notes  |
|---------|---------|---------|
|name|Name of the parameter.|<li>The parameter can be project parameter or package parameter. <li>The parameter will be skipped if it does not exist. <li>If the parameter is a connection manager property, the name should be in such format: **CM.\<Connection Manager Name>.\<Property Name>**. |
