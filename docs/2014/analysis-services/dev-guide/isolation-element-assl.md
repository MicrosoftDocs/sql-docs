...
# Isolation Element (ASSL)
  Indicates the isolation level for an element that is derived from the [DataSource](../../../2014/analysis-services/dev-guide/datasource-data-type-assl.md) data type.  
