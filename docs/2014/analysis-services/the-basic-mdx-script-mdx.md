...
-   [SCOPE](../Topic/SCOPE%20Statement%20\(MDX\).md)  
 ...
 For more information on MDX scripting statements, see [MDX Scripting Statements &#40;MDX&#41;](../Topic/MDX%20Scripting%20Statements%20\(MDX\).md).  
 ...
 Conditional statements add conditional logic to MDX scripts. This category includes the [CASE](../Topic/CASE%20Statement%20\(MDX\).md) and [IF](../Topic/IF%20Statement%20%20\(MDX\).md) statements.  
