...
# Exporting to Microsoft Word (Report Builder and SSRS)
 ...
 The Word renderer is compatible [!INCLUDE[ofprword](../../includes/ofprword-md.md)] 2007-2010 as well as [!INCLUDE[ofprword](../../includes/ofprword-md.md)] 2003 with the [!INCLUDE[msCoName](../../includes/msconame-md.md)] Office Compatibility Pack for Word, Excel, and PowerPoint installed. For more information about the Compatibility Pack, see [Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint](https://go.microsoft.com/fwlink/?LinkID=205622).  
