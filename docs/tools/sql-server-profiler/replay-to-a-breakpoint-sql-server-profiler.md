...
description: Make debugging easier by setting breakpoints so replays pause at specific events. Start using SQL Server Profiler to set breakpoints in a trace file or table.
ms.prod: sql
