...
-   Internal white space is preserved.  
 ...
 `Name` and `ID` properties have special limitations on valid characters in string elements. For additional information about `Name` and `ID` conventions, see [ASSL Objects and Object Characteristics](../../../2014/analysis-services/dev-guide/assl-objects-and-object-characteristics.md).  
...
-   It is not possible to determine programmatically whether the property of a child object has been set directly on the child object or inherited.  
 ...
 For more information on inherited defaults, see [ASSL Objects and Object Characteristics](../../../2014/analysis-services/dev-guide/assl-objects-and-object-characteristics.md).  
