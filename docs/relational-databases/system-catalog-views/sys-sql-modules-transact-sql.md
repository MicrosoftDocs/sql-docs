...
|**is_inlineable**|**bit**|**Applies to**: SQL Server 2019 (15.x) onwards.<br/><br />Indicates whether the module is inlineable or not. Inlineability is based on the conditions specified [here](../user-defined-functions/scalar-udf-inlining.md#inlineable-scalar-udfs-requirements).<br /><br /> 0 = not inlineable<br /><br /> 1 = is inlineable. <br /><br /> For scalar UDFs, the value will be 1 if the UDF is inlineable, and 0 otherwise. It always contains a value of 1 for inline TVFs, and 0 for all other module types.<br />|  
|**inline_type**|**bit**|**Applies to**: SQL Server 2019 (15.x) onwards.<br /><br />Indicates whether inlining is turned on for the module currently. <br /><br />0 = inlining is turned off<br /><br /> 1 = inlining is turned on.<br /><br /> For scalar UDFs, the value will be 1 if inlining is turned on (explicitly or implicitly). The value will always be 1 for inline TVFs, and 0 for other module types.<br />|  
