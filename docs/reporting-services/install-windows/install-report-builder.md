...
## Install [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion.md)] with Configuration Manager 
  
 An administrator can also use software such as Configuration Manager to push the program to your computer. To learn how to use specific software to install [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion.md)], consult the documentation for the software. For more information, see the [Microsoft Endpoint Configuration Manager site](https://docs.microsoft.com/configmgr/).  
