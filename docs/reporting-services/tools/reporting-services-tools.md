...
### SharePoint integrated mode  
 ...
 In SharePoint mode, the Reporting Services is a service application in the SharePoint architecture, and it is administered directly through SharePoint.  
