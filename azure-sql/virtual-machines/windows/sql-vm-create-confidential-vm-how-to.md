...
1. (Optional) Configure disk encryption. Follow the steps in the [Disk section of the Quickstart](sql-vm-create-portal-quickstart.md#disks?tabs=confidential-vm). 
