...
> [!IMPORTANT]  
> [!INCLUDE [ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)] To obtain information about locks in the [!INCLUDE [ssDEnoversion](../../includes/ssdenoversion-md.md)], use the [sys.dm_tran_locks](../system-dynamic-management-objects/sys-dm-tran-locks-transact-sql.md) dynamic management view.
