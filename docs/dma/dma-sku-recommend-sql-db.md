...
- **elasticStrategy** (_Optional_): Whether or not to use the elastic strategy for SKU recommendations based on resource usage profiling and cost-performance analysis. (Default: false)
