...
description: This sample creates a SQL Server Agent alert that respond to specific events. This simple alert saves XML deadlock graph events in a table for later analysis.
