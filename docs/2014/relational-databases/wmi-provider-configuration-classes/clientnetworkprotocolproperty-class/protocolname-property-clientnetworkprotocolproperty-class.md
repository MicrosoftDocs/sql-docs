...
---
# ProtocolName Property (ClientNetworkProtocolProperty Class)
  Gets the name of the protocol that owns the current property referenced by the [PropertyIdx Property (ClientNetworkProtocolProperty Class)](../../../database-engine/dev-guide/clientnetworkprotocolproperty-class.md) value.  
