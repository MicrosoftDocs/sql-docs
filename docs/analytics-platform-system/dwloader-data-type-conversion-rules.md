...
description: This article describes the input data formats and implicit data type conversions that dwloader Command-Line Loader supports when it loads data into Parallel Data Warehouse (PDW).
...
## <a id="InsertBinaryTypes"></a> Insert Literals into Binary Types
...
## <a id="InsertDateTimeTypes"></a> Insert Literals into Date and Time Types
...
## <a id="InsertNumerictypes"></a> Insert Literals into Numeric Types
...
## <a id="InsertStringTypes"></a> Insert Literals into String Types
