...
| `version` | **smallint** | The version of the availability group metadata stored in the Windows Server Failover Cluster. This version number is incremented when new features are added. |
