---
title: "SQLDataSources (Visual FoxPro ODBC Driver)"
...
For more information, see [SQLDataSources Function](../reference/syntax/sqldatasources-function.md) in the *ODBC Programmer's Reference*.
