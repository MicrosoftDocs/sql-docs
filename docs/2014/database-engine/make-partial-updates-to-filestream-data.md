...
> [!NOTE]  
>  This example requires the FILESTREAM-enabled database and table that are created in [Create a FILESTREAM-Enabled Database](../../2014/database-engine/create-a-filestream-enabled-database.md) and [Create a Table for Storing FILESTREAM Data](../../2014/database-engine/create-a-table-for-storing-filestream-data.md).  
  
 [!code-cpp[FILESTREAM#FS_CPP_FSCTL](../../snippets/cpp/SQL15/tsql/filestream/cpp/filestream.cpp#fs_cpp_fsctl)]  
