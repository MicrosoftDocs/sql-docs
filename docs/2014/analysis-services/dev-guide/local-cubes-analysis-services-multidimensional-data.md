...
# Local Cubes (Analysis Services - Multidimensional Data)
 ...
 ![Client architecture for local cubes and models](../../../2014/analysis-services/dev-guide/media/as-localcubearch9.gif "Client architecture for local cubes and models")  
...
-   When you add a measure, you must also include at least one dimension that is related to the measure being added. For more information about dimension relationships to measure groups, see [Dimension Relationships](../../../2014/analysis-services/dev-guide/dimension-relationships.md).  
...
### Security  
 In order for a user to create a local cube from a server cube, the user must be granted **Drillthrough and Local Cube** permissions on the server cube. For more information, see [Grant cube or model permissions &#40;Analysis Services&#41;](../../../2014/analysis-services/grant-cube-or-model-permissions-analysis-services.md).  
