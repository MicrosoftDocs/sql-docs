...
**Applies to**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ([!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] and later), [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)].
...
|**actual_state_additional_info**|**nvarchar(8000)**|Currently unused. May be implemented in the future.|
