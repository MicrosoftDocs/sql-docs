...
## Description  
 ...
 The SqlLocalDb utility can create new instances of `LocalDB`, start and stop an instance of `LocalDB`, and includes options to help you manage `LocalDB`.  For more information about the SqlLocalDb utility, see [SqlLocalDB Utility](../../2014/database-engine/sqllocaldb-utility.md).  
...
### Creating and Connecting to a Named Instances  
 In addition to the automatic instance, `LocalDB` also supports named instances. Use the SqlLocalDB.exe program to create, start, and stop an named instance of `LocalDB`. For more information about SqlLocalDB.exe, see [SqlLocalDB Utility](../../2014/database-engine/sqllocaldb-utility.md).  
