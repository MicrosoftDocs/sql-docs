...
|------------|------------------------|  
|**Server**|Follow Windows server naming conventions when naming a server object. See [Naming Conventions (Windows)](/windows/desktop/DNS/naming-conventions).aspx) for details.|  
|**DataSource**|: / \ * &#124; ? " () [] {} <>|  
|**Level** or **Attribute**|. , ; ' ` : / \ * &#124; ? " & % $ ! + = [] {} < >|  
