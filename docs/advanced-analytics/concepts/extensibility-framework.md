...
SQL Server has an extensibility framework for loading external language runtime environments. Currently, supported languages are R and Python. This article covers concepts, components, and component interaction for language extensions in SQL Server.
