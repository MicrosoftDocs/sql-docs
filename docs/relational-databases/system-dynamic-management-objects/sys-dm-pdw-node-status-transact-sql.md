...
[!INCLUDE [pdw](../../includes/applies-to-version/pdw.md)]
  ...
  Holds additional information (over [sys.dm_pdw_nodes &#40;Transact-SQL&#41;](sys-dm-pdw-nodes-transact-sql.md)) about the performance and status of all appliance nodes. It lists one row per node in the appliance.  
