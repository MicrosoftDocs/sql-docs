...
> [!NOTE]
> The argument *json_type_constraint* is not supported in Azure Synapse Analytics *<- this appears to no longer be true as at 10 Oct 2022: select isjson('[]', ARRAY) works fine in Azure Synapse Analytics*
