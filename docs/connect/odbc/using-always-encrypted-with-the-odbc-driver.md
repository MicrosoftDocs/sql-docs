...
> [!NOTE]
> The ODBC Driver only supports AKV authentication directly against Microsoft Entra ID. If you are using Microsoft Entra authentication to AKV and your Active Directory configuration requires authentication against an Active Directory Federation Services endpoint, authentication may fail.
