 ...
 *desttype*  
 Specifies the data type of the destination row column. This is the data type sent to the client. The data type must be specified even if the data is NULL, for more information, see [Data Types &#40;Extended Stored Procedure API&#41;](../../../2014/database-engine/dev-guide/data-types-extended-stored-procedure-api.md).  
...
## Remarks  
 ...
 For a description of data types and Extended Store Procedure API data type conversions, see[Data Types &#40;Extended Stored Procedure API&#41;](../../../2014/database-engine/dev-guide/data-types-extended-stored-procedure-api.md).  
  
 If the column name in your application is in Unicode, you need to convert it to the multibyte code page of the server before calling **srv_describe**. For more information, see [Unicode Data and Server Code Pages](../../../2014/database-engine/dev-guide/unicode-data-and-server-code-pages.md).  
...
## See Also  
 [srv_sendrow &#40;Extended Stored Procedure API&#41;](../../../2014/database-engine/dev-guide/srv-sendrow-extended-stored-procedure-api.md)   
 [srv_setutype &#40;Extended Stored Procedure API&#41;](../../../2014/database-engine/dev-guide/srv-setutype-extended-stored-procedure-api.md)   
 [srv_setcoldata &#40;Extended Stored Procedure API&#41;](../../../2014/database-engine/dev-guide/srv-setcoldata-extended-stored-procedure-api.md)  
