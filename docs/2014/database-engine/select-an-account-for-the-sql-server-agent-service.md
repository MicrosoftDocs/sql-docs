...
### Limitation 2: Using the Local System Account for Multiserver Administration  
 ...
 You can ignore this informational message. The enlistment operation should complete successfully. For more information, see [Create a Multiserver Environment](../../2014/database-engine/create-a-multiserver-environment.md).  
...
-   [Set the Service Startup Account for SQL Server Agent &#40;SQL Server Configuration Manager&#41;](../../2014/database-engine/set-service-startup-account-sql-server-agent-sql-server-configuration-manager.md)  
