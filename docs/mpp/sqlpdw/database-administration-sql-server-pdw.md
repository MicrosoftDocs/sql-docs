---
title: "Database Administration (SQL Server PDW)"
ms.custom: na
ms.date: 07/27/2016
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: c69d9a75-d2da-4d92-8346-fdcdb3e4f3c4
caps.latest.revision: 7
author: BarbKess
---
# Database Administration (SQL Server PDW)
These topics describe how database administrators can use the SQL Server PDW tools and processes to manage logins, server roles, and permissions, and to monitor the appliance health.  
