...
However, if you only have eight AHB licenses, and you deploy the same failover group configuration with each instance using 8 vCores, you won't be charged SQL Server licensing costs for the vCores used by the secondary instance. In this case, you'll see 8 vCores discounted from your monthly invoice. Likewise, pay-as-you-go customers that deploy the same configuration won't be charged for the vCores used by the secondary instance and will also see 8 vCores discounted from their invoice.
