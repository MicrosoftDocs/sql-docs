...
In this quickstart, you create a [ledger database](ledger-overview.md#ledger-database) in Azure SQL Database by using the Azure portal, Azure CLI or PowerShell. For more information about ledger, see [Azure SQL Database ledger](ledger-overview.md).
...
You'll create a resource group, a logical database server, a single ledger database, and configure uploading ledger digests using Azure CLI.
