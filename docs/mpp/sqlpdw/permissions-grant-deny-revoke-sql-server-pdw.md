---
title: "Permissions: GRANT, DENY, REVOKE (SQL Server PDW)"
ms.custom: na
ms.date: 07/27/2016
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 531f6b0c-1a96-4f91-8cfb-52275d0b4ea2
caps.latest.revision: 94
author: BarbKess
---
# Permissions: GRANT, DENY, REVOKE (SQL Server PDW)
Use SQL Server PDW**GRANT** and **DENY** statements to grant or deny a permission (such as **UPDATE**) on a securable (such as a database, table, view, etc.) to a security principal (a login, a database user, or a database role). Use **REVOKE** to remove the grant or deny of a permission.  
