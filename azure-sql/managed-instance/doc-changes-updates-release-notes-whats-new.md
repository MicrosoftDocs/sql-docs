...
| ---| --- |--- |
|[Restore database to SQL Server](restore-mi-database-to-sql-server.md) | November 2022 |  Restore your database from Azure SQL Managed Instance to SQL Server 2022. | 
