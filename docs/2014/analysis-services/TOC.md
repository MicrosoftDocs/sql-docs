...
## [What's New](what-s-new-in-analysis-services-and-business-intelligence.md)
...
#### [Configure Server Properties](configure-server-properties-in-analysis-services.md)
...
### [Tabular Modeling](tabular-modeling-ssas-tabular.md)
...
##### [Compatibility Level](compatibility-level-ssas-tabular-sp1.md)
##### [Tabular Model Projects](tabular-model-projects-ssas-tabular.md)
###### [Create a NewTabular Model Project](create-a-newtabular-model-project-ssas-tabular.md)
###### [Import from Analysis Services](import-from-analysis-services-ssas-tabular.md)
###### [Import from PowerPivot](import-from-powerpivot-ssas-tabular.md)
##### [Properties](properties-ssas-tabular.md)
###### [Power View Reporting Properties](power-view-reporting-properties-ssas-tabular.md)
####### [Configure Default Field Set for Power View Reports](configure-default-field-set-for-power-view-reports-ssas-tabular.md)
####### [Configure Table Behavior Properties for Power View Reports](configure-table-behavior-properties-for-power-view-reports-ssas-tabular.md)
...
###### [Partitions and DirectQuery Mode](partitions-and-directquery-mode-ssas-tabular.md)
###### [Enable DirectQuery Design Mode](enable-directquery-design-mode-ssas-tabular.md)
...
###### [Calculated Columns](calculated-columns-ssas-tabular.md)
####### [Create a Calculated Column](create-a-calculated-column-ssas-tabular.md)
...
### [Multidimensional Modeling](multidimensional-modeling-ssas.md)
...
###### [Supported Data Source Types](data-sources-supported-ssas-multidimensional.md)
...
###### [Parent-Child Hierarchies](parent-child-hierarchy.md)
...
##### [Translations](translations-in-multidimensional-models.md)
...
##### [Set Database Compatibility Level](set-the-compatibility-level-of-a-multidimensional-database-analysis-services.md)
...
###### [The Basic MDX Query](the-basic-mdx-query-mdx.md)
####### [EXISTING Keyword](existing-keyword-mdx.md)
###### [Restricting the Query with Query and Slicer Axes](restricting-the-query-with-query-and-slicer-axes-mdx.md)
####### [Specifying the Contents of a Query Axis](specifying-the-contents-of-a-query-axis-mdx.md)
####### [Specifying the Contents of a Slicer Axis](specifying-the-contents-of-a-slicer-axis-mdx.md)
####### [Using Query and Slicer Axes in a Simple Example](using-query-and-slicer-axes-in-a-simple-example-mdx.md)
...
###### [Building Named Sets in MDX](building-named-sets-in-mdx-mdx.md)
####### [Creating Query-Scoped Named Sets](creating-query-scoped-named-sets-mdx.md)
####### [Creating Session-Scoped Named Sets](creating-session-scoped-named-sets-mdx.md)
###### [Building Calculated Members in MDX](building-calculated-members-in-mdx-mdx.md)
####### [Creating Query-Scoped Calculated Members](creating-query-scoped-calculated-members-mdx.md)
####### [Creating Session-Scoped Calculated Members](creating-session-scoped-calculated-members-mdx.md)
###### [Building Cell Calculations in MDX](building-cell-calculations-in-mdx-mdx.md)
####### [Creating Query-Scoped Cell Calculations](creating-query-scoped-cell-calculations-mdx.md)
...
####### [Using Member Properties](using-member-properties-mdx.md)
######## [Intrinsic Member Properties](intrinsic-member-properties-mdx.md)
######## [User-Defined Member Properties](user-defined-member-properties-mdx.md)
####### [Using Cell Properties](using-cell-properties-mdx.md)
######## [FORMAT_STRING Contents](format-string-contents-mdx.md)
######## [FORE_COLOR and BACK_COLOR Contents](fore-color-and-back-color-contents-mdx.md)
######## [LANGUAGE and FORMAT_STRING on FORMATED_VALUE](language-and-format-string-on-formated-value.md)
###### [Manipulating Data](manipulating-data-mdx.md)
####### [Using DRILLTHROUGH to Retrieve Source Data](using-drillthrough-to-retrieve-source-data-mdx.md)
####### [Working with the RollupChildren Function](working-with-the-rollupchildren-function-mdx.md)
####### [Understanding Pass Order and Solve Order](understanding-pass-order-and-solve-order-mdx.md)
###### [Modifying Data](modifying-data-mdx.md)
####### [Using Cube Writebacks](using-cube-writebacks-mdx.md)
...
#### [Processing a Multidimensional Solution](multidimensional-model-object-processing.md)
...
###### [Sequence Clustering Model Query Examples](sequence-data-mining/clustering-model-query-examples.md)
...
##### [Filters for Mining Models](data-mining/filters-for-data-mining/mining-models-analysis-services-data-mining.md)
...
###### [View or Change Modeling Flags](view-or-change-data-mining/modeling-flags-data-mining.md)
...
###### [Change the Time-out Value for Data Mining Queries](data-mining/change-the-time-out-value-for-data-mining/data-mining-queries.md)
...
##### [Related Projects for Data Mining Solutions](related-projects-for-data-mining/data-mining-solutions.md)
##### [Deployment of Data Mining Solutions](deployment-of-data-mining/data-mining-solutions.md)
...
### [PowerPivot for SharePoint](powerpivot-for-sharepoint-ssas.md)
...
##### [Deploy PowerPivot Solutions](deploy-powerpivot-solutions-to-sharepoint.md)
##### [Create and Configure a PowerPivot Service Application](create-and-configure-a-powerpivot-service-application-in-central-administration.md)
##### [Connect a PowerPivot Service Application to a SharePoint Web Application](connect-power-pivot-service-app-to-sharepoint-web-app-in-ca.md)
##### [Activate PowerPivot Feature Integration for Site Collections](activate-power-pivot-integration-for-site-collections-in-ca.md)
##### [Add MSOLAP.5 as a Trusted Data Provider in Excel Services](add-msolap-5-as-a-trusted-data-provider-in-excel-services.md)
##### [Create a Trusted Location for PowerPivot Sites](create-a-trusted-location-for-powerpivot-sites-in-central-administration.md)
...
##### [Configure Disk Space Usage](configure-disk-space-usage-powerpivot-for-sharepoint.md)
##### [Configure Maximum File Upload Size](configure-maximum-file-upload-size-powerpivot-for-sharepoint.md)
##### [Configuration Setting Reference](configuration-setting-reference-powerpivot-for-sharepoint.md)
...
#### [Health Rules - Configure](powerpivot-health-rules-configure.md)
##### [Health Rules Reference](health-rules-reference-powerpivot-for-sharepoint.md)
...
##### [View PowerPivot Data Refresh History](view-data-refresh-history-powerpivot-for-sharepoint.md)
...
##### [Create or Customize a Data Feed Library](create-or-customize-a-data-feed-library-powerpivot-for-sharepoint.md)
##### [Use PowerPivot Data Feeds](use-data-feeds-powerpivot-for-sharepoint.md)
##### [Delete a PowerPivot Data Feed Library](delete-a-powerpivot-data-feed-library.md)
##### [Share PowerPivot Data Feeds in a Data Feed Library](share-data-feeds-using-a-data-feed-library-powerpivot-for-sharepoint.md)
...
##### [Add/Remove Tables Dialog Box](add-remove-tables-dialog-box-analysis-services-multidimensional-data.md)
