...
---
# Alias Element (ASSL)
  Defines an alias for an [Account](../../../2014/analysis-services/dev-guide/account-element-assl.md) element.  
...
|------------------|-------------|  
|Parent elements|[Aliases](../../../2014/analysis-services/dev-guide/aliases-element-assl.md)|  
|Child elements|None|  
