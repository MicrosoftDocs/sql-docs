...
6.  As needed, set properties on the **Advanced** tab. For more information about the properties, see [DQS Cleansing Transformation Editor Dialog Box](../../2014/integration-services/dqs-cleansing-transformation-editor-dialog-box.md).  
