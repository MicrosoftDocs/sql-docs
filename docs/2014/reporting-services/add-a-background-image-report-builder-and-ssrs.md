...
3.  In the Properties pane, expand **BackgroundImage**, and then do the following:  
    ...
    -   For an external image:  
         ...
         Set **Value** to a valid path to an image. This can be on a report server in native mode or SharePoint integrated mode, or it can be on any other Web site. For more information, see [Add an External Image &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/add-an-external-image-report-builder-and-ssrs.md).  
  
    -   For an image is that is contained in a field in the database to which the report item is connected:  
  
         Set **Source** to **Database**.  
  
         Set **Value** to the name of a field in the report dataset. For more information, see [Add a Data-Bound Image &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/add-a-data-bound-image-report-builder-and-ssrs.md).  
