...
## Remarks  
 Null key errors occur when a null value is encountered in a key column in which null values are not allowed, forcing the record to be discarded during processing. However, this error occurs only if the [NullProcessing](../../../2014/analysis-services/dev-guide/nullprocessing-element-assl.md) element for the `DataItem` ancestor of the `ErrorConfiguration` parent element is set to *Error*.  
...
## See Also  
 [ErrorConfiguration Element &#40;ASSL&#41;](../../../2014/analysis-services/dev-guide/errorconfiguration-element-assl.md)  
