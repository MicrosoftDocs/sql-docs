...
| ---| --- |--- |
|[Automated key rotation for TDE with CMK](../database/transparent-data-encryption-byok-overview.md#rotation-of-tde-protector) | October 2022 | Automatically switch to a new key when using a custom managed key (CMK) for TDE with Azure SQL Managed Instance. | 
