...
|**SET NOEXEC**|When **ON**, tells [!INCLUDE [ssnoversion-md](../includes/ssnoversion-md.md)] to compile each batch of Transact-SQL statements but not to execute them. When **OFF**, tells [!INCLUDE [ssnoversion-md](../includes/ssnoversion-md.md)] to execute all batches after compilation.For more information, see [SET NOEXEC](../t-sql/statements/set-noexec-transact-sql.md).|  
...
|**SET SHOWPLAN_TEXT**|Causes [!INCLUDE [ssnoversion-md](../includes/ssnoversion-md.md)] not to execute Transact-SQL statements. Instead, SQL Server returns detailed information about how the statements are executed. For more information, see [SET SHOWPLAN_TEXT](../t-sql/statements/set-showplan-text-transact-sql.md).|  
|**SET STATISTICS TIME**|Displays the number of milliseconds required to parse, compile, and execute each statement.|  
|**SET STATISTICS IO**|Causes [!INCLUDE [ssnoversion-md](../includes/ssnoversion-md.md)] to display information regarding the amount of disk activity generated by Transact-SQL statements.|  
|**SET TRANSACTION ISOLATION LEVEL**|Controls the default transaction locking behavior for all [!INCLUDE [ssnoversion-md](../includes/ssnoversion-md.md)] **SELECT** statements issued by a connection. For more information, see  [SET TRANSACTION ISOLATION LEVEL](../t-sql/statements/set-transaction-isolation-level-transact-sql.md).|  
