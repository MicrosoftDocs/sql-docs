...
For example, SSMS 19.2 was released in November 2023, and SSMS 19.3 was released in January 2024. If a customer is using SSMS 19.2 and encounters an issue, the customer must upgrade to SSMS 19.3 and determine if the issue still exists. If the issue still exists in SSMS 19.3, it should be [reported to the SSMS team](https://aka.ms/ssms-feedback). A fix may be then provided in a later release of SSMS.
...
| Version | November 2018 | June 2022 | January 2023 | January 2024 |
| ---: | :---: | :---: | :---: | :---: |
