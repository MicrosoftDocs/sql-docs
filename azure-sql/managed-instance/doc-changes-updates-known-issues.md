...
We recently introduced support for auto backups in `msdb`, but the table does not contain username information. Our dedicated team is already working on a fix.
