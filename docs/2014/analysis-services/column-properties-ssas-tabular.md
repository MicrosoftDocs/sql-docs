 ...
 **Reporting Properties**  
 ...
 For detailed information on setting [!INCLUDE[ssCrescent](../includes/sscrescent-md.md)] table behavior properties, see [Configure Table Behavior Properties for Power View Reports &#40;SSAS Tabular&#41;](configure-table-behavior-properties-for-power-view-reports-ssas-tabular.md).  
