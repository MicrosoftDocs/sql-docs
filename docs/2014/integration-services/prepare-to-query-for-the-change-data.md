 ...
 **Next topic:** [Create the Function to Retrieve the Change Data](../../2014/integration-services/create-the-function-to-retrieve-the-change-data.md)  
