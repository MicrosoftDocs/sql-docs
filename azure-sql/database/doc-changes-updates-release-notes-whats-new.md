...
| [Hyperscale short-term retention](hyperscale-automated-backups-overview.md#backup-storage-redundancy) | Retain backups up to 35 days for Hyperscale databases, and perform a point-in-time restore within the configured duration. |
