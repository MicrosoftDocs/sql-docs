...
| Premium-series hardware (preview) | Zone redundancy is currently not supported for premium-series and memory optimized premium-series hardware.|
| Premium-series hyperscale (preview) | Azure SQL Database maintenance window is currently not supported for premium-series and memory optimized premium-series. | 
