...
## Create an Extended Events Session  
 For more information about creating an Extended Events session, see [Create an Extended Events Session](../../2014/database-engine/create-an-extended-events-session.md).  
