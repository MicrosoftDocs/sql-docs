...
description: See how shape charts display value data as percentages of a whole in Report Builder. Shape charts are often used to show proportional comparisons between  values in a set. 
ms.date: 03/03/2017
