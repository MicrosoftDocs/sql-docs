...
-   A command language that sends action commands, such as `Create`, `Alter`, or `Process`, to an instance of Analysis Services. This command language is discussed in the [XML for Analysis  &#40;XMLA&#41; Reference](../../../2014/analysis-services/dev-guide/xml-for-analysis-xmla-reference.md).  
...
## See Also  
 [ASSL Objects and Object Characteristics](../../../2014/analysis-services/dev-guide/assl-objects-and-object-characteristics.md)   
 [ASSL XML Conventions](../../../2014/analysis-services/dev-guide/assl-xml-conventions.md)   
