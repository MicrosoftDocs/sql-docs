...
Azure confidential VMs are available in both the [General Purpose](performance-guidelines-best-pracatices-vm-size#general-purpose) and [memory optimized](performance-guidelines-best-pracatices-vm-size#memory-optimized) VM size series. 
