...
To create linked server with managed identity authentication execute following T-SQL. For this authentication method `ActiveDirectoryMSI` should be used in `@provstr` parameter.    ```sql
EXEC master.dbo.sp_addlinkedserver
