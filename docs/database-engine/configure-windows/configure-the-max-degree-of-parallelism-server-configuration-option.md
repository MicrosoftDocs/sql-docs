...
- To enable DOP feedback, enable the `DOP_FEEDBACK` database scoped configuration in a database. The Query Store must be enabled for every database where DOP feedback is used.
