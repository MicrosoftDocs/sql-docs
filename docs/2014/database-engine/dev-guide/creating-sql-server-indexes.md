...
|DBPROP_INDEX_FILLFACTOR|R/W: Read/write<br /><br /> Default: 0<br /><br /> Description: Specifies the percentage of an index page used for storage. For more information, see [CREATE INDEX](../Topic/CREATE%20INDEX%20\(Transact-SQL\).md).<br /><br /> The type of the variant is VT_I4. The value must be greater than or equal to 1 and less than or equal to 100.|  
