 ...
 *eOption*  
 ...
 BCPDELAYREADFMT  
 A Boolean, if set to true, will cause [bcp_readfmt](../../../2014/database-engine/dev-guide/bcp-readfmt.md) to read at execution. If false (the default), bcp_readfmt will immediately read the format file. A sequence error will occur if BCPDELAYREADFMT is true and you call bcp_columns or bcp_setcolfmt.  
