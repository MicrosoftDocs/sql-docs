...
The following release notes apply to [!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ver15.md)] cumulative update 20 (CU20).

## CU20 changes and new capabilities
...
For detailed SQL Server engine changes, check the [official SQL Server 2019 CU20 knowledge base article KB 5024276](https://support.microsoft.com/help/5024276).

## Tested configurations for CU20

[!INCLUDE[big-data-clusters-nover](../includes/ssbigdataclusters-ss-nover.md)] CU20 was tested on the following environment combinations:
