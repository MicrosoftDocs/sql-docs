...
:::image type="content" source="../../relational-databases/system-dynamic-management-objects/media/join-dm-fts-memory-buffers.svg" alt-text="Diagram of physical joins for sys.dm_fts_memory_buffers.":::
