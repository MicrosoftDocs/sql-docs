...
1. On the Toolbar select New Query to open a Query Editor window. Execute the following statement to determine the status of the test e-mail message:
