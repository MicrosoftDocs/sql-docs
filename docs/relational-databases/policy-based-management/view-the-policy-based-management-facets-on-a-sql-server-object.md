...
description: Describes how to view all of the Policy-Based Management facts applied to a specific SQL Serer object in SQL Server Management Studio (SSMS).
