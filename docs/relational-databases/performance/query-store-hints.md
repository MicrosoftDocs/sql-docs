...
> [!Note]
> This public preview feature is available in Azure SQL Database – including in Azure SQL single databases, elastic pools, managed instances, and Hyperscale databases.  
