...
3.  The repeated prefix values in the column are replaced by a reference to the corresponding prefix. If the value in a row does not exactly match the selected prefix value, a partial match can still be indicated.  
 ...
 ![Page before prefix compression](../../relational-databases/media/skt-tblcompression1c.gif "Page before prefix compression")  
 ...
 ![Page after prefix compression](../../relational-databases/media/tblcompression2.gif "Page after prefix compression")  
...
## Dictionary Compression  
 ...
 ![Page after dictionary compression](../../relational-databases/media/tblcompression3.gif "Page after dictionary compression")  
