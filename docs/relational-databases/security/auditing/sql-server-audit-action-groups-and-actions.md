...
|DATABASE_LOGOUT_GROUP|This event is raised when a contained database user logs out of a database. Equivalent to the [Audit Database Logout Event Class](../../..//relational-databases/event-classes/audit-logout-event-class.md).|  
