...
# Storage Element (XMLA)
  Specifies the maximum amount of storage, in bytes, used by the [DesignAggregations](../../../2014/analysis-services/dev-guide/designaggregations-element-xmla.md) command to design aggregations.  
...
|------------------|-------------|  
|Parent elements|[DesignAggregations](../../../2014/analysis-services/dev-guide/designaggregations-element-xmla.md)|  
|Child elements|None|  
