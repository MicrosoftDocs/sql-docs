...
# Enable and Disable Client-Side Printing for Reporting Services
 ...
 Previous versions of [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] used an ActiveX control that required downloading to the client computer from the report server. If you upgrade your report server to [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], the print control is not removed from the report server or client computers.  
