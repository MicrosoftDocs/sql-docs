...
Services (ADFS) with AAD in the cloud. Once this is set up as well as a Kerberos ticket, you can access Azure SQL DB without being prompted for credentials when you're logged in a domain joined machine. 
