...
[SQL Server 2019 documentation](https://docs.microsoft.com/sql/sql-server/index.yml?view=sql-server-ver15) is available on our main Docs address. Then use the versioning dropdown near the top of the page, to select another version of interest.
