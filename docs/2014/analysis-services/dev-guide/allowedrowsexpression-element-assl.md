...
|------------------|-------------|  
|Parent elements|[CellPermission](../../../2014/analysis-services/dev-guide/cellpermission-element-assl.md), [StandardAction](../../../2014/analysis-services/dev-guide/standardaction-data-type-assl.md)|  
|Child elements|None|  
  
## Remarks  
 For the `CellPermission` element, the `Expression` element contains a logical MDX expression that identifies cells applicable to the rights indicated by the [Access](../../../2014/analysis-services/dev-guide/access-element-assl.md) element of the `CellPermission` element. If the value of an `Expression` element for a `CellPermission` element is empty, the `CellPermission` element is ignored.  
