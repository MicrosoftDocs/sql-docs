 ...
 **Step 4 (Optional): Allow or deny access to interior cube objects**  
 ...
 You can also vary permissions based on user identity. This is often referred to as dynamic security, and is implemented using the [UserName &#40;MDX&#41;](../Topic/UserName%20\(MDX\).md) function  
