...
5.  Enter the required information in the New Instance wizard to create the new instance. For information about the information required for this wizard, see [Use the New Instance Wizard](../../2014/integration-services/use-the-new-instance-wizard.md).  
