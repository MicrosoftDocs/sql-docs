...
2.  In the **Server Properties** dialog box, click the **Advanced** page to view server information about full-text search. The full-text properties are as follows:  
    ...
    -   **Full-Text Upgrade Option**  
         ...
         **Reset**  
         ...
         For information about choosing a full-text upgrade option, see full-[Upgrade Full-Text Search](../../2014/database-engine/upgrade-full-text-search.md).  
...
|--------------|-----------------|--------------|  
|`IsFullTextInstalled`|Whether the full-text component is installed with the current instance of [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|[FULLTEXTSERVICEPROPERTY](../Topic/FULLTEXTSERVICEPROPERTY%20\(Transact-SQL\).md)<br /><br /> [SERVERPROPERTY](../Topic/SERVERPROPERTY%20\(Transact-SQL\).md)|  
