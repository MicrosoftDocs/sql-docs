 ...
 **Create a new CDC instance for the selected service**  
 ...
 Click **New Oracle CDC Instance** in the right pane to create a new instance for that service. The New Instance wizard opens to create the instance. For more information about the New Instance wizard, see [Use the New Instance Wizard](../../2014/integration-services/use-the-new-instance-wizard.md).  
