...
> [!NOTE]  
>  This option is not available in a contained database, [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)], or [!INCLUDE[ssazuresynapse-md](../../includes/ssazuresynapse-md.md)].  
