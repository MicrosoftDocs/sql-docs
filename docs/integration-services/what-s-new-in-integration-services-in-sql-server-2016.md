...
####  <a name="ssasrc0"></a> Analysis Services tasks support tabular models  
 ...
 The Dimension Processing Destination does not work for Tabular models with the SQL Server 2016 compatibility level.  The Analysis Services Processing Task and the Partition Processing Destination are all you need for tabular processing. 
