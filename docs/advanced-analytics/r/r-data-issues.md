...
description: Learn how to work with data types and data objects in R with SQL Server Machine Learning Services, including common issues that you may encounter.
ms.prod: sql
...
# Work with R and SQL data in SQL Server Machine Learning Services

This article discusses some of the common issues you may encounter when moving data between R and SQL in [SQL Server Machine Learning Services](../what-is-sql-server-machine-learning.md). The experience you gain through this exercise provides essential background when working with data in your own script.
...
For more information on supported and unsupported R data types, see [Data type mappings between R and SQL Server](r-libraries-and-data-types.md).
