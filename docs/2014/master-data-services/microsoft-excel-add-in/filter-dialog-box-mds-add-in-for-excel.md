...
|Down Arrow|Click to move the selected attribute down in the list. The top-to-bottom order corresponds to the left-to-right order the columns are displayed in the worksheet.|  
