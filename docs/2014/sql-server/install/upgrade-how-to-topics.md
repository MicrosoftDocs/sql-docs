...
|[Upgrade a SQL Server Failover Cluster Instance &#40;Setup&#41;](../../../2014/sql-server/install/upgrade-a-sql-server-failover-cluster-instance-setup.md)|The procedural topic to upgrade an instance of a [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] failover cluster to [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)].|  
|[Install SQL Server 2014 from the Command Prompt](../../../2014/sql-server/install/install-sql-server-2014-from-the-command-prompt.md)|Provides sample syntax for installing [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] at a command prompt.|  
