...
| Azure Active Directory authentication | Use [Azure Active Directory (Azure AD) authentication](../relational-databases/security/authentication-access/azure-ad-authentication-sql-server-overview.md) to connect to SQL Server.  <br /><br /> Starting with [!INCLUDE[sql-server-2022](../includes/sssql22-md.md)] Cumulative Update 7, you can configure [replication with Azure Active Directory authentication](../relational-databases/replication/configure-replication-with-azure-ad-authentication.md).  |
