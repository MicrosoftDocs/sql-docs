...
> [!NOTE]  
>  The examples in this topic require the Archive database that is created in [Create a FILESTREAM-Enabled Database](../../2014/database-engine/create-a-filestream-enabled-database.md).  
