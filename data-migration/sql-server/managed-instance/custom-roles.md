---
title: "Custom Roles: Online SQL Server to SQL Managed Instance Migrations Using DMS"
...
| `Microsoft.DataMigration/sqlMigrationServices/validateIR/action` | Validates integration runtime. |
