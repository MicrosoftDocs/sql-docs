...
## In This Section  
 [What's New in SQL Server Native Client](../../../2014/database-engine/dev-guide/what-s-new-in-sql-server-native-client.md)  
 Lists the significant new [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client features.  
  
 [When to Use SQL Server Native Client](../../../2014/database-engine/dev-guide/when-to-use-sql-server-native-client.md)  
 ...
 [Finding More SQL Server Native Client Information](../../../2014/database-engine/dev-guide/finding-more-sql-server-native-client-information.md)  
 ...
 [SQL Server Native Client Errors](../../../2014/database-engine/dev-guide/sql-server-native-client-errors.md)  
