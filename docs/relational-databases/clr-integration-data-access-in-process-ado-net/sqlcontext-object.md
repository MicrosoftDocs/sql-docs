...
description: When you invoke managed code in SQL Server in a user connection, access to the context of the caller is required, which is abstracted in a SqlContext object.
ms.custom: ""
ms.date: "03/14/2017"
ms.prod: sql
