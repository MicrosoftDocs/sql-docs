...
## Prerequisites  
 This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 10: Create Hierarchies](../../2014/tutorials/lesson-10-create-hierarchies.md).  
...
6.  Click **Validate**.  
     ...
     Notice a warning is displayed stating that certain columns are not present in source. This is because in [Lesson 3: Rename Columns](../../2014/tutorials/lesson-3-rename-columns.md), you renamed those columns in the Internet Sales table in the model to be different from those same columns at the source.  
...
## Next Steps  
 To continue this tutorial, go to the next lesson: Lesson: [Lesson 12: Create Roles](../../2014/tutorials/lesson-12-create-roles.md).  
