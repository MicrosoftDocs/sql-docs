...
Always Encrypted keys can be managed using [SQL Server Management Studio (SSMS)](https://msdn.microsoft.com/library/ms174173.aspx) and [PowerShell](/sql-docs/docs/relational-databases/scripting/sql-server-powershell):
