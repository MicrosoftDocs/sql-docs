# [Create program (Go to)](../../relational-databases/server-management-objects-smo/create-program/index.md?toc=%2fsql%2frelational-databases%2fserver-management-objects-smo%2fcreate-program%2ftoc.json)
