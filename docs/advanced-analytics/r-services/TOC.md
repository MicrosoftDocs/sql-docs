...
##### [R Package - Enable or Disable](how-to-enable-or-disable-r-package-management.md)  
...
# [SQL Server R Services Tutorials](tutorials/sql-server-r-services-tutorials.md)  
...
#### [Lesson 2-1 - View and Summarize Data using R](view-and-summarize-data-using-r-data-science-end-to-end-walkthrough.md)  
#### [Lesson 2-2 - Create Graphs and Plots Using R](create-graphs-and-plots-using-r-data-science-end-to-end-walkthrough.md) 
...
#### [Lesson 1-1 - Create SQL Server Data Objects using RxSqlServerData](create-sql-server-data-objects-using-rxsqlserverdata.md)  
#### [Lesson 1-2 - Query and Modify the SQL Server Data](query-and-modify-the-sql-server-data-data-science-deep-dive.md)  
#### [Lesson 1-3 - Define and Use Compute Contexts](define-and-use-compute-contexts-data-science-deep-dive.md)  

### [Lesson 2: Create and Run R Scripts](lesson-2-create-and-run-r-scripts-data-science-deep-dive.md)
#### [Lesson 2-1 - Visualize SQL Server Data using R](visualize-sql-server-data-using-r-data-science-deep-dive.md)  
#### [Lesson 2-2 - Create Models](create-models-data-science-deep-dive.md)  
#### [Lesson 2-3 - Score New Data](score-new-data-data-science-deep-dive.md)

### [Lesson 3: Transform Data Using R](lesson-3-transform-data-using-r-data-science-deep-dive.md)
#### [Lesson 3-1 - Load Data into Memory using rxImport](load-data-into-memory-using-rximport-data-science-deep-dive.md)  
#### [Lesson 3-2 - Create New SQL Server Table using rxDataStep](create-new-sql-server-table-using-rxdatastep-data-science-deep-dive.md)  
#### [Lesson 3-3 - Perform Chunking Analysis using rxDataStep](perform-chunking-analysis-using-rxdatastep-data-science-deep-dive.md)  
...
### [Step 2: Import Data to SQL Server using PowerShell](step-2-import-data-to-sql-server-using-powershell-in-database-advanced-analytics-tutorial.md)  
...
### [Step 5: Train and Save a Model using T-SQL](step-5-train-and-save-a-model-using-t-sql-in-database-advanced-analytics-tutorial.md)  
