---
title: Install Azure Data CLI
titleSuffix: 
description: Learn how to install the Azure Data CLI tool.
author: MikeRayMSFT 
ms.author: mikeray
...
Azure Data CLI is a command-line utility written in Python to bootstrap and manage the data services via REST APIs. 
