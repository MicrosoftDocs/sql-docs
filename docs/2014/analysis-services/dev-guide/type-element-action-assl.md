...
# Type Element (Action) (ASSL)
  Contains the type of the [Action](../../../2014/analysis-services/dev-guide/action-element-assl.md) element.  
...
|*DrillThrough*|Retrieves a rowset for drillthrough.<br /><br /> This value is identical to *Rowset* and identifies drillthrough actions. It can only be used on actions whose [TargetType](../../../2014/analysis-services/dev-guide/targettype-element-assl.md) value is set to *Cells*.|  
...
## See Also  
 [DrillThroughAction Data Type &#40;ASSL&#41;](../../../2014/analysis-services/dev-guide/drillthroughaction-data-type-assl.md)   
