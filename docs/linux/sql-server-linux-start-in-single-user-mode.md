---
title: "Start SQL Server in Single-User Mode on Linux"
description: "Learn about single-user mode in SQL Server on Linux. See when it is useful and how to use the startup option -m to start an instance of SQL Server in this mode."
author: rwestMSFT
...
Stop the [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Agent service before connecting to [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] in single-user mode. If you don't, the [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Agent will block your use of the connection.
