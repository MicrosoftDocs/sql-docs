...
description: Learn how to use a table, matrix, or list data region in a paginated report to span multiple pages horizontally or vertically in Report Builder. 
ms.date: 12/19/2019
