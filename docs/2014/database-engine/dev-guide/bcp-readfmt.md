...
## Remarks  
 After `bcp_readfmt` reads the format values, it makes the appropriate calls to [bcp_columns](../../../2014/database-engine/dev-guide/bcp-columns.md) and [bcp_colfmt](../../../2014/database-engine/dev-guide/bcp-colfmt.md). There is no need for you to parse a format file and make these calls.  
