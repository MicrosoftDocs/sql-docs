...
description: SQL Server Profiler captures event data. Learn how to save that data to a trace file, specify a maximum trace file size, and enable the file rollover option.
ms.prod: sql
