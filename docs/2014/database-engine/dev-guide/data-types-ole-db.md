...
-   [Data Type Mapping in Rowsets and Parameters](../../../2014/database-engine/dev-guide/data-type-mapping-in-rowsets-and-parameters.md)  
  
-   [Data Type Mapping in ITableDefinition](../../../2014/database-engine/dev-guide/data-type-mapping-in-itabledefinition.md)  
  
-   [SSVARIANT Structure](../../../2014/database-engine/dev-guide/ssvariant-structure.md)  
