...
For more information about changing resource class role membership, see [ALTER SERVER ROLE](../../docs/t-sql/statements/alter-server-role-transact-sql.md).  
