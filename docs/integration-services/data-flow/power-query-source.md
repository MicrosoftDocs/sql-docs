...
In **Power Query Connection Manager Editor**, you need to specify **Data Source Kind**, **Data Source Path**, and **Authentication Kind**, as well as assign the approriate access credentials. For **Data Source Kind**, you can currently select one of 22 kinds from the dropdown menu.
...
> [!NOTE]
> For **Oracle** data source, Oracle ADO.NET driver cannot currently be installed on Azure-SSIS IR. Install Oracle ODBC driver instead and use ODBC data source to connect to Oracle for now.
