...
||PolyBase <br/> - PolybaseCore <br/> - PolybaseJava  |Installs PolyBase components. PolybaseCore and PolybaseJava were added as children features of Polybase starting with SQL Server 2019. PolybaseCore includes technology that enables truly integrated querying across Oracle, Teradata, SQL Server and other relational and non-relational data using standard T-SQL statements. PolybaseJava includes the PolyBase Java Connector that enables truly integrated querying across HDFS data using standard T-SQL statements |
