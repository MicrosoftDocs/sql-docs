...
# Coding a Custom Foreach Enumerator
 ...
 For a working sample of a custom enumerator, see [Developing a User Interface for a Custom ForEach Enumerator](../../../2014/integration-services/dev-guide/developing-a-user-interface-for-a-custom-foreach-enumerator.md).  
...
## See Also  
 [Creating a Custom Foreach Enumerator](../../../2014/integration-services/dev-guide/creating-a-custom-foreach-enumerator.md)   
 [Developing a User Interface for a Custom ForEach Enumerator](../../../2014/integration-services/dev-guide/developing-a-user-interface-for-a-custom-foreach-enumerator.md)  
