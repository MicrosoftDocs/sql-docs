...
| Evaluation | [!INCLUDE [ssevaluation-md](../ssevaluation-md.md)]  is a fully functional trial version of [!INCLUDE [ssnoversion-md](../ssnoversion-md.md)] software that automatically expires after 180 days. |
