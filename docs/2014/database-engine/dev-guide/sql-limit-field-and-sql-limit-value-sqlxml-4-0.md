...
# sql:limit-field and sql:limit-value (SQLXML 4.0)
  XML Bulk Load processes the `sql:limit-field` and `sql:limit-value` annotations per their definition. For more information, see [Filtering Values Using sql:limit-field and sql:limit-value &#40;SQLXML 4.0&#41;](../../../2014/database-engine/dev-guide/filtering-values-using-sql-limit-field-and-sql-limit-value-sqlxml-4-0.md).  
