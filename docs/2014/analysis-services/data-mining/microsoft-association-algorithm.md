...
# Microsoft Association Algorithm
 ...
 ![A set of rules for an association model](../../../2014/reporting-services/prerequisites-for-tutorials-report-builder.md)analysis-services/media/association.gif "A set of rules for an association model")  
