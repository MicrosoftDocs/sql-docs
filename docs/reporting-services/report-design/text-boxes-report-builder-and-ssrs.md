...
description: Find out about cells in a table or matrix that also contains a text box, which you can format the same way as stand-alone text boxes in Report Builder.
ms.date: 03/14/2017
