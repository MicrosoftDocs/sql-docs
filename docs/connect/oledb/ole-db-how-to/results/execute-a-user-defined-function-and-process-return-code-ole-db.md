...
[!INCLUDE[Driver_OLEDB_Download](../../../../includes/driver_oledb_download.md)]
 ...
 This sample uses the AdventureWorks sample database as an example, which you can download from the [Microsoft SQL Server Samples and Community Projects](https://go.microsoft.com/fwlink/?LinkID=85384) home page. You can replace it with another database you have.
