...
|InstanceDefaultBackupPath|**Applies to**:  [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] through current version in updates beginning in 2019.<br /><br /> Name of the default path to the instance backup files.|  
