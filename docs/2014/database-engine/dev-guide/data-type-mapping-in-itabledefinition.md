...
|DBTYPE_UDT|**UDT**|The following information is used in `DBCOLUMNDESC` structures by **ITableDefinition::CreateTable** when UDT columns are required:<br /><br /> -   *pwSzTypeName* is ignored.<br />-   *rgPropertySets* must include a `DBPROPSET_SQLSERVERCOLUMN` property set as described in the section on `DBPROPSET_SQLSERVERCOLUMN`, in [Using User-Defined Types](../../../2014/database-engine/dev-guide/using-user-defined-types.md).|  
|DBTYPE_UI1|**tinyint**||  
...
## See Also  
 [Data Types &#40;OLE DB&#41;](../../../2014/database-engine/dev-guide/data-types-ole-db.md)  
