...
|--------------------|------------------------|  
|[Server](server-element-assl.md)|The name must follow the rules for [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Windows computer names. IP addresses are not valid.|  
