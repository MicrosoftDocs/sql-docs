...
| Serverless DBs and auto-pausing with Elastic Jobs. | Auto-pause enabled serverless database is not supported as a *Job Database*. Serverless databases targeted by elastic jobs do support auto-pausing, and will be resumed by any job connections.
