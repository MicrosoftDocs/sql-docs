...
<sup>1</sup> In the current implementation of the last writer conflict detection policy, the delete always win when there is an insert-delete or update-delete conflict. 
