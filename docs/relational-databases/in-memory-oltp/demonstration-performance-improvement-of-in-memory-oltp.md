...
### Step 1a: Prerequisite If Using [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
 The steps in this first subsection apply only if you're running in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], and doesn't apply if you're running in [!INCLUDE[ssSDSFull](../../includes/ssazure-sqldb.md)]. Do the following:  
...
### Step 1b: Prerequisite If Using [!INCLUDE[ssSDSFull](../../includes/ssazure-sqldb.md)]  
 This subsection applies only if you're using [!INCLUDE[ssSDSFull](../../includes/ssazure-sqldb.md)]. Do the following:  
