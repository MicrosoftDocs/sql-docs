...
|**EventClass**|**int**|Type of event = 107.|27|No|  
|**EventSequence**|**int**|Sequence of a given event within the request.|51|No|  
|**EventSubClass**|**int**|Type of event subclass.<br /><br /> 1=Password self changed<br /><br /> 2=Password changed<br /><br /> 3=Password self reset<br /><br /> 4=Password reset<br /><br /> 5=Password unlocked<br /><br /> 6=Password must change|21|Yes|  
