...
Use this page to set the default behavior of the output window. To access the settings, on the **Tools** menu, select **Options**, expand the **Output Window** folder.
