...
-   [Replace usage of the xp_sqlagent_proxy_account extended stored procedure with new stored procedures](../../relational-databases/native-client/ole-db/stored-procedures.md)  
