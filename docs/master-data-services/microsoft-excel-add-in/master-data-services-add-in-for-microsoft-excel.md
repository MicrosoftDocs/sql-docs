...
[!NOTE] Master Data Services Add-in for Excel requires Office Automation Security level to be set to 1 [Macros enabled (default)] or 2 [Use application macro security level]. 
