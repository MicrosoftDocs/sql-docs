...
> [!IMPORTANT]  
>  The output file might contain sensitive data about your database and the data that database contains. For suggestions about how to make this file more secure, see [Access to Files Used by Packages](../../2014/integration-services/access-to-files-used-by-packages.md).  
...
## See Also  
 ...
 [Data Profiling Task Editor &#40;Profile Requests Page&#41;](../../2014/integration-services/data-profiling-task-editor-profile-requests-page.md)  
