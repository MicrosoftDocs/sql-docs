...
## RSReportServer Configuration Settings for Application Domains  
 Configuration settings are specified in the in the [RSReportServer.config file](../../2014/reporting-services/rsreportserver-configuration-file.md). The following example shows the default configuration settings for planned application domain recycling behavior.  
