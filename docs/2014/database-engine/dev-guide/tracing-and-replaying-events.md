...
-   Replay trace files or trace tables.  
 ...
 The trace data from the `Trace` and `Replay` objects can be used by the SMO application, or it can be examined manually by using [SQL Server Profiler](../../../2014/database-engine/sql-server-profiler.md). The trace data is also compatible with the [SQL Trace](../../../2014/database-engine/sql-trace.md) stored procedures that also provide tracing capabilities.  
