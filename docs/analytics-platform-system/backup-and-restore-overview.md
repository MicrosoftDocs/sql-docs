...
A PDW database backup is created with the [BACKUP DATABASE](../t-sql/statements/backup-transact-sql.md?view=sql-server-ver15) t-sql statement and formatted for use with the [RESTORE DATABASE](../t-sql/statements/restore-statements-transact-sql.md?view=sql-server-ver15) statement; it is unusable for any other purpose. The backup can only be restored to an appliance with the same number or a greater number of Compute nodes.  
...
2.  User submits a [RESTORE DATABASE](../t-sql/statements/restore-statements-transact-sql.md?view=sql-server-ver15) tsql statement to the Control node.  
...
|Backup a database.|[BACKUP DATABASE](../t-sql/statements/backup-transact-sql.md?view=sql-server-ver15)|  
|Restore a database.|[RESTORE DATABASE](../t-sql/statements/restore-statements-transact-sql.md?view=sql-server-ver15)|    
