...
4.  On the **Dataset Properties** page, in the **Data source** box, select the **DataSet1** you created in [Lesson 2: Define a Data Connection and Data Table for Parent Report](../../2014/tutorials/lesson-2-define-a-data-connection-and-data-table-for-parent-report.md).  
