...
#### [Configure SQL Server Red Hat Enterprise Linux 7.0 shared disk cluster](sql-server-linux-configure-shared-disk-cluster-red-hat-7)
#### [Operate SQL Server on Red Hat Enterprise Linux 7.0 shared disk cluster](sql-server-linux-operate-shared-disk-cluster.md)
