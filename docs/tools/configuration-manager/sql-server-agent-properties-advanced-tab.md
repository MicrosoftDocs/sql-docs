...
description: Learn about the options on the Advanced tab in the SQL Server Agent Properties dialog box, such as the dump directory, the instance ID, and other properties.
