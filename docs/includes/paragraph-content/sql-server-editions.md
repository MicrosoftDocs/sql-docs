...
| Evaluation | [!INCLUDE [ssevaluation-md](../ssevaluation-md.md)]  is a fully functional trial version of SQL Server 2019 software that automatically expires after 180 days. |
