...
## Property Value/Return Value  
 An array of [SqlServiceAdvancedProperty Class](../../../2014/database-engine/dev-guide/sqlserviceadvancedproperty-class.md) objects that contain the advanced properties for the `SqlService` object.  
