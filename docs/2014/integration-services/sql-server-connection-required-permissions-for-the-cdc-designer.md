...
## See Also  
 [Access the CDC Designer Console](../../2014/integration-services/access-the-cdc-designer-console.md)   
 [SQL Server Connection for Instance Creation](../../2014/integration-services/sql-server-connection-for-instance-creation.md)  
