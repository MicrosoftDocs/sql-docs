...
##### <a id="XsiTypeValuesOfCOLUMN"></a> Xsi:type values of the \<COLUMN> element
...
### <a id="OrderFieldsAndColsDifferently"></a> B. Order data fields and table columns differently
...
### <a id="AdditionalExamples"></a> Additional examples
