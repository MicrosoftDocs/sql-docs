...
# Extending the Package with the Script Task
 ...
 The Script task and the infrastructure code that it generates for you simplify significantly the process of developing a custom task. However, to understand how the Script task works, you may find it useful to read the section [Developing a Custom Task](../../../2014/integration-services/dev-guide/developing-a-custom-task.md) to understand the steps that are involved in developing a custom task.  
...
## In This Section  
 ...
 [Configuring the Script Task in the Script Task Editor](../../../2014/integration-services/dev-guide/configuring-the-script-task-in-the-script-task-editor.md)  
 ...
 [Using Variables in the Script Task](../../../2014/integration-services/dev-guide/using-variables-in-the-script-task.md)  
 ...
 [Raising Events in the Script Task](../../../2014/integration-services/dev-guide/raising-events-in-the-script-task.md)  
 ...
 [Logging in the Script Task](../../../2014/integration-services/dev-guide/logging-in-the-script-task.md)  
 ...
 [Returning Results from the Script Task](../../../2014/integration-services/dev-guide/returning-results-from-the-script-task.md)  
...
## See Also  
 [Script Task](../../../2014/integration-services/script-task.md)   
 [Comparing the Script Task and the Script Component](../../../2014/integration-services/dev-guide/comparing-the-script-task-and-the-script-component.md)  
