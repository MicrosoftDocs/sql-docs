...
## Remarks  
 ...
 One missing index group may have several queries that needed the same index. For more information about individual queries that needed a specific index in this DMV, see [sys.dm_db_missing_index_group_stats_query](sys-dm-db-missing-index-group-stats-query-transact-sql.md).
