...
# AggregationType Element (ASSL)
  Defines the type of aggregation stored by the [Partition](../../../2014/analysis-services/dev-guide/partition-element-assl.md) element.  
...
|------------------|-------------|  
|Parent element|[AggregationInstance](../../../2014/analysis-services/dev-guide/aggregationinstance-element-assl.md)|  
|Child elements|None|  
