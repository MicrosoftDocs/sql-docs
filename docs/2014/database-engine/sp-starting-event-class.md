...
|ObjectType|`int`|The type of stored procedure being started. This value corresponds to the type column in the sys.objects catalog view. For values, see [ObjectType Trace Event Column](../../2014/database-engine/objecttype-trace-event-column.md).|28|Yes|  
