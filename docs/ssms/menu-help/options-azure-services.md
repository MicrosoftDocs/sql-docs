...
| Option | Information | Description |
|--------|-------------|-------------|
| Name | **Azure China Cloud** <br><br> **Azure Cloud** <br><br> **Azure US Government** <br><br> **Custom** | Select the Azure Cloud to which Management Studio connects to discover and manage resources. Select **Custom** to provide your own URLs and DNS suffixes. |
