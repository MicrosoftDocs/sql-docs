...
description: Learn about how to secure messages between databases participating in an Always On availability group or database mirroring session hosted on SQL Server.
