...
|total_cpu_idle_capped_ms|**bigint**|**Applies to**: [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)] <br><br> Instance CPU cap, will always be 0 for non-Azure versions of [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Is nullable.|
