...
|-|-|  
|**Description**|**Topic**|  
|Describes how to open Activity Monitor and how to set the Activity Monitor refresh interval.|[Open Activity Monitor &#40;SQL Server Management Studio&#41;](open-activity-monitor-sql-server-management-studio.md)|  
