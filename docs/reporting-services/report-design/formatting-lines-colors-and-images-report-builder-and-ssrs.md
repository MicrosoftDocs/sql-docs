...
description: Explore ways to use lines, colors, data regions, images, in Report Builder. Visually tie items together and to improve readability in Report Builder.
ms.date: 03/01/2017
