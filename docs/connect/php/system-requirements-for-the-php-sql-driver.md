...
For full details on support life cycles and requirements of the PHP drivers, see the [support matrix](microsoft-php-drivers-for-sql-server-support-matrix.md).
...
- If a Web server is used, your Web server must be configured to run PHP. For information about hosting PHP applications with various web servers, see [documentation on PHP's web site](https://www.php.net/manual/en/install.php).

    The [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)] are tested using IIS 10 with FastCGI.
...
|PHP driver version &#8594;<br />&#8595; ODBC driver version|5.13|5.12|5.11|5.10|5.9|5.8|5.6|5.3|5.2|4.3|4.0|3.2|
|------------------|---|---|---|---|---|---|---|---|---|---|---|---|
|ODBC Driver 18    |Yes|Yes|Yes|Yes|   |   |   |   |   |   |   |   |
|ODBC Driver 17    |Yes|Yes|Yes|Yes|Yes|Yes|Yes|Yes|Yes|   |   |   |
|ODBC Driver 13.1  |   |Yes|Yes|Yes|Yes|Yes|Yes|Yes|Yes|Yes|Yes|   |
|ODBC Driver 13    |   |   |   |   |   |   |   |   |   |   |Yes|   |
...
|---------------|:---------------:|:----------------:|---------------------|
|32-bit php_sqlsrv_83_nts.dll<br />32-bit php_pdo_sqlsrv_83_nts.dll|8.3|no |32-bit php8.dll|
|32-bit php_sqlsrv_83_ts.dll <br />32-bit php_pdo_sqlsrv_83_ts.dll |8.3|yes|32-bit php8ts.dll|
|64-bit php_sqlsrv_83_nts.dll<br />64-bit php_pdo_sqlsrv_83_nts.dll|8.3|no |64-bit php8.dll|
|64-bit php_sqlsrv_83_ts.dll <br />64-bit php_pdo_sqlsrv_83_ts.dll |8.3|yes|64-bit php8ts.dll|
|32-bit php_sqlsrv_84_nts.dll<br />32-bit php_pdo_sqlsrv_84_nts.dll|8.4|no |32-bit php8.dll|
|32-bit php_sqlsrv_84_ts.dll <br />32-bit php_pdo_sqlsrv_84_ts.dll |8.4|yes|32-bit php8ts.dll|
|64-bit php_sqlsrv_84_nts.dll<br />64-bit php_pdo_sqlsrv_84_nts.dll|8.4|no |64-bit php8.dll|
|64-bit php_sqlsrv_84_ts.dll <br />64-bit php_pdo_sqlsrv_84_ts.dll |8.4|yes|64-bit php8ts.dll|
|32-bit php_sqlsrv_85_nts.dll<br />32-bit php_pdo_sqlsrv_85_nts.dll|8.5|no |32-bit php8.dll|
|32-bit php_sqlsrv_85_ts.dll <br />32-bit php_pdo_sqlsrv_85_ts.dll |8.5|yes|32-bit php8ts.dll|
|64-bit php_sqlsrv_85_nts.dll<br />64-bit php_pdo_sqlsrv_85_nts.dll|8.5|no |64-bit php8.dll|
|64-bit php_sqlsrv_85_ts.dll <br />64-bit php_pdo_sqlsrv_85_ts.dll |8.5|yes|64-bit php8ts.dll|

On Linux, the following driver files are provided:

|Driver file|PHP version|Thread safe?|
|---------------|:---------------:|:----------------:|
|php_sqlsrv_83_nts.so<br />php_pdo_sqlsrv_83_nts.so|8.3|no |
|php_sqlsrv_83_ts.so <br />php_pdo_sqlsrv_83_ts.so |8.3|yes|
|php_sqlsrv_84_nts.so<br />php_pdo_sqlsrv_84_nts.so|8.4|no |
|php_sqlsrv_84_ts.so <br />php_pdo_sqlsrv_84_ts.so |8.4|yes|
|php_sqlsrv_85_nts.so<br />php_pdo_sqlsrv_85_nts.so|8.5|no |
|php_sqlsrv_85_ts.so <br />php_pdo_sqlsrv_85_ts.so |8.5|yes|
...
|32-bit php_sqlsrv_82_nts.dll<br />32-bit php_pdo_sqlsrv_82_nts.dll|8.2|no |32-bit php8.dll|
...
|php_sqlsrv_82_nts.so<br />php_pdo_sqlsrv_82_nts.so|8.2|no |
|php_sqlsrv_82_ts.so <br />php_pdo_sqlsrv_82_ts.so |8.2|yes|
|php_sqlsrv_83_nts.so<br />php_pdo_sqlsrv_83_nts.so|8.3|no |
|php_sqlsrv_83_ts.so <br />php_pdo_sqlsrv_83_ts.so |8.3|yes|
