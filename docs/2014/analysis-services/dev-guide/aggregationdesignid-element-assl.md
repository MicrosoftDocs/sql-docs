...
# AggregationDesignID Element (ASSL)
  Identifies the [AggregationDesign](../../../2014/analysis-services/dev-guide/aggregationdesign-element-assl.md) element associated with the [Partition](../../../2014/analysis-services/dev-guide/partition-element-assl.md) element.  
...
|------------------|-------------|  
|Parent elements|[Partition](../../../2014/analysis-services/dev-guide/partition-element-assl.md)|  
|Child elements|None|  
