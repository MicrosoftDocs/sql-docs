 ...
 *To view information about all of the availability replicas in an availability group, use to the server instance that hosts the primary replica.  
 ...
 For more information, see [Use AlwaysOn Policies to View the Health of an Availability Group &#40;SQL Server&#41;](../../2014/database-engine/use-alwayson-policies-to-view-the-health-of-an-availability-group-sql-server.md).  
