...
##  <a name="reltasks"></a> Related Tasks  
 [Enable and Configure FILESTREAM](../../2014/database-engine/enable-and-configure-filestream.md)  
  [Create a FILESTREAM-Enabled Database](../../2014/database-engine/create-a-filestream-enabled-database.md)  
  [Create a Table for Storing FILESTREAM Data](../../2014/database-engine/create-a-table-for-storing-filestream-data.md)  
  [Access FILESTREAM Data with Transact-SQL](../../2014/database-engine/access-filestream-data-with-transact-sql.md)  
  [Create Client Applications for FILESTREAM Data](../../2014/database-engine/create-client-applications-for-filestream-data.md)  
  [Access FILESTREAM Data with OpenSqlFilestream](../../2014/database-engine/access-filestream-data-with-opensqlfilestream.md)  
  [Make Partial Updates to FILESTREAM Data](../../2014/database-engine/make-partial-updates-to-filestream-data.md)  
  [Avoid Conflicts with Database Operations in FILESTREAM Applications](../../2014/database-engine/avoid-conflicts-with-database-operations-in-filestream-applications.md)  
  [Move a FILESTREAM-Enabled Database](../../2014/database-engine/move-a-filestream-enabled-database.md)  
  [Set Up FILESTREAM on a Failover Cluster](../../2014/database-engine/set-up-filestream-on-a-failover-cluster.md)  
  [Configure a Firewall for FILESTREAM Access](../../2014/database-engine/configure-a-firewall-for-filestream-access.md)  
