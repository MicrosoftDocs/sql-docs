...
## See Also  
 [Creating a SQL Server Native Client OLE DB Provider Application](../../../2014/database-engine/dev-guide/creating-a-sql-server-native-client-ole-db-provider-application.md)  
