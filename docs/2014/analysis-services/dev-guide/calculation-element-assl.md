...
# Calculation Element (ASSL)
  Asssociates a calculation with a [Perspective](../../../2014/analysis-services/dev-guide/perspective-element-assl.md) element.  
...
|--------------------|-----------------|  
|Data type and length|[PerspectiveCalculation](../../../2014/analysis-services/dev-guide/perspectivecalculation-data-type-assl.md)|  
|Default value|None|  
...
|------------------|-------------|  
|Parent elements|[Calculations](../../../2014/analysis-services/dev-guide/calculations-element-assl.md)|  
|Child elements|None|  
