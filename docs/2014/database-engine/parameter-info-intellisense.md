...
2.  Press the CTRL+SHIFT+SPACE keyboard shortcut.  
 ...
 For more information, see [Configure IntelliSense &#40;SQL Server Management Studio&#41;](../../2014/database-engine/configure-intellisense-sql-server-management-studio.md).  
