...
|Topic|Description|  
|-----------|-----------------|  
|[Assembly Load Event Class](../../2014/database-engine/assembly-load-event-class.md)|Indicates that a request to load an assembly has been executed.|  
|[Assembly Load Event Class](../../2014/database-engine/assembly-load-event-class.md)|Occurs when a request to load an assembly is executed.|  
