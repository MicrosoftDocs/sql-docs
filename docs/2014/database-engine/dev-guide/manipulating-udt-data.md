...
## Comparing Data  
 You can use comparison operators to compare values in your UDT if you have set the `IsByteOrdered` property to `true` when defining the class. For more information, see [Creating a User-Defined Type](../../../2014/database-engine/dev-guide/creating-a-user-defined-type.md).  
