...
-   [Allocating an Environment Handle](../../../2014/database-engine/dev-guide/allocating-an-environment-handle.md)  
  
-   [Allocating a Connection Handle](../../../2014/database-engine/dev-guide/allocating-a-connection-handle.md)  
  
-   [SQL Server Native Client ODBC Data Sources](../../../2014/database-engine/dev-guide/sql-server-native-client-odbc-data-sources.md)  
  
-   [Connecting to a Data Source &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/connecting-to-a-data-source-odbc.md)  
