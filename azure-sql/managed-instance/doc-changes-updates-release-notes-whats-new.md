...
| ---| --- |--- |
|[One-way Managed Instance link for SQL Server 2016 & 2019](managed-instance-link-feature-overview.md)| March 2023 | Online replication of SQL Server databases hosted anywhere to Azure SQL Managed Instance. |
...
|**Managed Instance link GA** | Online replication of SQL Server databases hosted anywhere to Azure SQL Managed Instance. One-way replication is now generally available for SQL Server 2017 and SQL Server 2019. Review [Managed Instance link](managed-instance-link-feature-overview.md) to learn more. |
