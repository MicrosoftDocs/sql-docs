...
|:---|:---|:---|
|Windows|[Installer](https://go.microsoft.com/fwlink/?linkid=XXXXXXX)<br>[.zip](https://go.microsoft.com/fwlink/?linkid=XXXXXXX)|September 24, 2018|
|macOS|[.zip](https://go.microsoft.com/fwlink/?linkid=XXXXXXX)|September 24, 2018 |
|Linux|[.deb](https://go.microsoft.com/fwlink/?linkid=XXXXXXX)<br>[.rpm](https://go.microsoft.com/fwlink/?linkid=XXXXXXX)<br>[.tar.gz](https://go.microsoft.com/fwlink/?linkid=XXXXXXX)|September 24, 2018 |
...
* Click the *Add Connection* button in Object Explorer and choose *SQL Server big data cluster* as the connection type
...
* To submit a Spark job against the cluster, right-click on the server node in the Object Explorer and choose *Submit Spark Job* to bring up the submission dialog
...
* Open a notebook in one of the following ways:
  ...
  * Open an existing .ipynb file from the File menu or file explorer *(NOTE: .ipynb files must be upgraded to version 4 or higher to load properly)*
...
* To log into Azure, click on the person icon in the bottom left of the Azure Data Studio and follow the dialogs to log into Azure
* Once logged in, click on the triangular Azure icon in the left bar of Azure Data Studio and expand the tree to show SQL resources associated with your subscriptions
...
* From a SQL Server 2019 instance the Create External Table Wizard may be opened in three ways:
  * Right click on a server, choose Manage, click on the tab for SQL Server 2019 (Preview), and choose Create External Table
  * With a SQL Server 2019 instance selected in the Object Explorer, bring up Create External Wizard via the Command Palette
  * Right click on a SQL Server 2019 database in the Object Explorer and choose Create External Table
* In this version of the extension, external tables may be created to access remote SQL Server and Oracle tables. *Note: While the External Table functionality is a SQL 2019 feature, the remote SQL Server may be running an earlier version of SQL Server*
