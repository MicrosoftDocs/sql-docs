...
######## [Create Delete Queries (Visual Database Tools)](../ssms/visual-db-tools/delete-queries-visual-database-tools.md)
...
######## [Show Query Properties (Visual Database Tools)](../ssms/visual-db-tools/query-properties-visual-database-tools.md)
...
####### [Full-Text Index Columns Dialog Box (Visual Database Tools)](../ssms/visual-db-tools/index-columns-dialog-box-visual-database-tools.md)
