 ...
 **sp_addmessage** can be used to add user-defined error messages with severities from 1 through 25 to the **sys.messages** catalog view. These user-defined error messages can be used by RAISERROR. For more information, see [sp_addmessage &#40;Transact-SQL&#41;](../Topic/sp_addmessage%20\(Transact-SQL\).md).  
