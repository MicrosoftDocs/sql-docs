...
[!INCLUDE [ssnoversion-md](../../includes/ssnoversion-md.md)], check the [sys.dm_column_encryption_enclave](../../relational-databases/system-dynamic-management-objects/sys-dm-column-encryption-enclave.md) view:
