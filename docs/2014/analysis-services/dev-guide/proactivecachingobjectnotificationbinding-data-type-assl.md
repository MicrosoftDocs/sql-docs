...
# ProactiveCachingObjectNotificationBinding Data Type (ASSL)
  Defines an abstract derived data type that represents information to the [ProactiveCaching](../../../2014/analysis-services/dev-guide/proactivecaching-element-assl.md) element about data source changes, either in specified tables and views or in tables and views identified through existing data bindings that require rebuilding the cache.  
...
|--------------------|-----------------|  
|Base data types|[ProactiveCachingBinding](../../../2014/analysis-services/dev-guide/proactivecachingbinding-data-type-assl.md)|  
|Derived data types|[ProactiveCachingInheritedBinding](../../../2014/analysis-services/dev-guide/proactivecachinginheritedbinding-data-type-assl.md), [ProactiveCachingTablesBinding](../../../2014/analysis-services/dev-guide/proactivecachingtablesbinding-data-type-assl.md)|  
...
|Child elements|[NotificationTechnique](../../../2014/analysis-services/dev-guide/notificationtechnique-element-assl.md)|  
