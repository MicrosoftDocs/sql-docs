...
Replication agent files are located under [!INCLUDE [ssinstallpath-md](../../../includes/ssinstallpath-md.md)]\COM. The following table lists the replication executable names and file names. Select the link for an agent to view its parameter reference.
