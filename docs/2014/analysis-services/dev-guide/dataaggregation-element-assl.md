...
# DataAggregation Element (ASSL)
  Determines whether the instance can aggregate persisted data or cached data for the [MeasureGroup](../../../2014/analysis-services/dev-guide/measuregroup-element-assl.md).  
...
|------------------|-------------|  
|Parent elements|[MeasureGroup](../../../2014/analysis-services/dev-guide/measuregroup-element-assl.md)|  
|Child elements|None|  
