...
description: Read an overview of how to extend data processing capabilities in Reporting Services by customizing report data, notification mechanisms, and security systems.
ms.date: 03/14/2017
