...
---
# ServerNetworkProtocolProperty Class
  The [ServerNetworkProtocolProperty Class](../../../2014/database-engine/dev-guide/servernetworkprotocolproperty-class.md) represents the properties of a server network protocol.  
  
 With the [ServerNetworkProtocolProperty Class](../../../2014/database-engine/dev-guide/servernetworkprotocolproperty-class.md), you can perform the following tasks:  
