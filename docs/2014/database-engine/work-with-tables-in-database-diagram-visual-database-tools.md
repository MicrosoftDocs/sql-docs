...
## In This Section  
 ...
 [Save Selected Tables on a Diagram &#40;Visual Database Tools&#41;](../../2014/database-engine/save-selected-tables-on-a-diagram-visual-database-tools.md)  
  
 [Copy Tables from One Database Diagrams to Another &#40;Visual Database Tools&#41;](../../2014/database-engine/copy-tables-from-one-database-diagrams-to-another-visual-database-tools.md)  
  
 [Remove Tables from Database Diagrams &#40;Visual Database Tools&#41;](../../2014/database-engine/remove-tables-from-database-diagrams-visual-database-tools.md)  
  
 [Map Many-to-Many Relationships &#40;Visual Database Tools&#41;](../../2014/database-engine/map-many-to-many-relationships-visual-database-tools.md)  
  
 [Draw Reflexive Relationships &#40;Visual Database Tools&#41;](../../2014/database-engine/draw-reflexive-relationships-visual-database-tools.md)  
  
## Reference  
 [Add Table Dialog Box &#40;Database Designer&#41; &#40;Visual Database Tools&#41;](../../2014/database-engine/add-table-dialog-box-database-designer-visual-database-tools.md)  
