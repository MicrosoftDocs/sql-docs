...
-   **INSERT INTO … SELECT \* FROM OPENROWSET(BULK …)**  
 ...
 For information about disabling the FileTable constraints, see [Manage FileTables](../../2014/database-engine/manage-filetables.md).  
  
###  <a name="disabling"></a> How To: Disable FileTable Constraints for Bulk Loading  
 To bulk load files into a FileTable without the overhead of enforcing the system-defined constraints, you can temporarily disable the constraints. For more information, see [Manage FileTables](../../2014/database-engine/manage-filetables.md).  
