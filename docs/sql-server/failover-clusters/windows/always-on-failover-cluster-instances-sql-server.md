...
description: Learn how Always On Failover Cluster Instances provides local high availability through redundancy at the server-instance level in SQL Server.
