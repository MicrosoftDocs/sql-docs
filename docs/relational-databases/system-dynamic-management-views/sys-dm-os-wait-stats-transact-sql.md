...
|ASYNC_SOCKETDUP_IO |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|<a name="backupio"></a>BACKUPIO |Occurs when a backup task is waiting for data, or is waiting for a buffer in which to store data. This type is not typical, except when a task is waiting for a tape mount.| 
...
|BLOB_METADATA |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|BPSORT |Occurs with parallel batch-mode plans when synchronizing the sorting of a dataset across multiple threads. If waiting is excessive and cannot be reduced by tuning the query (such as adding indexes), consider adjusting the cost threshold for parallelism or lowering the degree of parallelism. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|BROKER_START |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|CHECK_SCANNER_MUTEX |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|CHECK_TABLES_INITIALIZATION |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|CHECK_TABLES_SINGLE_SCAN |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|CHECK_TABLES_THREAD_BARRIER |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|COLUMNSTORE_COLUMNDATASET_SESSION_LIST |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|DIRTY_PAGE_TABLE_LOCK |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|DPT_ENTRY_LOCK |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|DTC |Occurs when a task is waiting on an event that is used to manage state transition. This state controls when the recovery of Microsoft Distributed Transaction Coordinator (MSDTC) transactions occurs after [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] receives notification that the MSDTC service has become unavailable.| 
|DTC_ABORT_REQUEST |Occurs in an MSDTC worker session when the session is waiting to take ownership of an MSDTC transaction. After MSDTC owns the transaction, the session can roll back the transaction. Generally, the session will wait for another session that is using the transaction.| 
...
|DTC_STATE |Occurs when a task is waiting on an event that protects changes to the internal MSDTC global state object. This state should be held for very short periods of time.| 
|DTC_TMDOWN_REQUEST |Occurs in an MSDTC worker session when [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] receives notification that the MSDTC service is not available. First, the worker will wait for the MSDTC recovery process to start. Then, the worker waits to obtain the outcome of the distributed transaction that the worker is working on. This may continue until the connection with the MSDTC service has been reestablished.| 
|DTC_WAITFOR_OUTCOME |Occurs when recovery tasks wait for MSDTC to become active to enable the resolution of prepared transactions.| 
|DTCNEW_ENLIST |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|DTCNEW_PREPARE |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|DTCNEW_RECOVERY |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|DTCNEW_TM |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|DTCNEW_TRANSACTION_ENLISTMENT |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|FILE_VALIDATION_THREADS |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|HADR_DATABASE_WAIT_FOR_RECOVERY |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|HADR_FILESTREAM_PREPROC |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|HADR_SEEDING_LIMIT_BACKUPS |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|HADR_SEEDING_SYNC_COMPLETION |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|HADR_SEEDING_TIMEOUT_TASK |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|HADR_SEEDING_WAIT_FOR_COMPLETION |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|<a name="hadr_sync_commit"></a>HADR_SYNC_COMMIT |Waiting for a transaction commit processing on the synchronized secondary databases to harden the log. This wait is also reflected by the Transaction Delay performance counter. This wait type is expected for synchronous-commit Availability Groups and indicates the time to send, write, and acknowledge log commit to the secondary databases. <br />For detailed information and troubleshooting HADR_SYNC_COMMIT, refer to [this blog post](https://techcommunity.microsoft.com/t5/sql-server/troubleshooting-high-hadr-sync-commit-wait-type-with-always-on/ba-p/385369)<br /><br /> **Applies to**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] and later.| 
...
|HCCO_CACHE |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|HK_RESTORE_FILEMAP |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|HKCS_PARALLEL_MIGRATION |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|HKCS_PARALLEL_RECOVERY |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|<a name="io_completion"></a>IO_COMPLETION |Occurs while waiting for I/O operations to complete. This wait type generally represents non-data page I/Os. Data page I/O completion waits appear as PAGEIOLATCH\_\* waits.| 
|IO_QUEUE_LIMIT |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|LOGMGR_PMM_LOG |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|NETWORKSXMLMGRLOAD |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|<a name="pageiolatch_ex"></a>PAGEIOLATCH_EX |Occurs when a task is waiting on a latch for a buffer that is in an I/O request. The latch request is in Exclusive mode - a mode used when the buffer is being written to disk. Long waits may indicate problems with the disk subsystem. <br /><br /> See this [SQL Server Slow I/O troubleshooting blog](https://techcommunity.microsoft.com/t5/sql-server-support/slow-i-o-sql-server-and-disk-i-o-performance/ba-p/333983) for more information.| 
|<a name="pageiolatch_kp"></a>PAGEIOLATCH_KP |Occurs when a task is waiting on a latch for a buffer that is in an I/O request. The latch request is in Keep mode. Long waits may indicate problems with the disk subsystem.| 
|PAGEIOLATCH_NL |Identified for informational purposes only. Not supported. Future compatibility is not guaranteed.| 
|<a name="pageiolatch_sh"></a>PAGEIOLATCH_SH |Occurs when a task is waiting on a latch for a buffer that is in an I/O request. The latch request is in Shared mode - a mode used when the buffer is being read from disk. Long waits may indicate problems with the disk subsystem.<br /><br /> See this [SQL Server Slow I/O troubleshooting blog](https://techcommunity.microsoft.com/t5/sql-server-support/slow-i-o-sql-server-and-disk-i-o-performance/ba-p/333983) for more information.| 
|<a name="pageiolatch_up"></a>PAGEIOLATCH_UP |Occurs when a task is waiting on a latch for a buffer that is in an I/O request. The latch request is in Update mode. Long waits may indicate problems with the disk subsystem.<br /><br /> See this [SQL Server Slow I/O troubleshooting blog](https://techcommunity.microsoft.com/t5/sql-server-support/slow-i-o-sql-server-and-disk-i-o-performance/ba-p/333983) for more information.| 
...
|PAGELATCH_SH |Occurs when a task is waiting on a latch for a buffer that is not in an I/O request. The latch request is in Shared mode which allows multiple threads to read, but not modify, a buffer (page). See [Latch Modes](../diagnose-resolve-latch-contention.md#sql-server-latch-modes-and-compatibility) for more information.| 
|PAGELATCH_UP |Occurs when a task is waiting on a latch for a buffer that is not in an I/O request. The latch request is in Update mode. Commonly this wait type may be observed when a system page (buffer) like PFS, GAM, SGAM is latched. See [Latch Modes](../diagnose-resolve-latch-contention.md#sql-server-latch-modes-and-compatibility) for more information. </br></br> For troubleshooting a common scenario with this latch, refer to [Reduce Allocation Contention in SQL Server tempdb database](/troubleshoot/sql/performance/recommendations-reduce-allocation-contention).| 
...
|PARALLEL_REDO_LOG_CACHE |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|PARALLEL_REDO_TRAN_LIST |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|PARALLEL_REDO_TRAN_TURN |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|PARALLEL_REDO_WORKER_SYNC |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|PARALLEL_REDO_WORKER_WAIT_WORK |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|POOL_LOG_RATE_GOVERNOR |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|PREEMPTIVE_HTTP_EVENT_WAIT |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|PREEMPTIVE_HTTP_REQUEST |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|PREEMPTIVE_OS_GETFINALFILEPATHBYHANDLE |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|PREEMPTIVE_OS_SQMLAUNCH |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] through [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)]. |  
|PREEMPTIVE_OS_VERIFYSIGNATURE |Internal use only.| 
|PREEMPTIVE_OS_VERIFYTRUST |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|PWAIT_DIRECTLOGCONSUMER_GETNEXT |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|PWAIT_EVENT_SESSION_INIT_MUTEX |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] and later.| 
|PWAIT_FABRIC_REPLICA_CONTROLLER_DATA_LOSS |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|PWAIT_HADRSIM |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|QDS_ASYNC_QUEUE |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|QDS_BCKG_TASK |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] and later.| 
|QDS_BLOOM_FILTER |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|QRY_PROFILE_LIST_MUTEX |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|RESERVED_MEMORY_ALLOCATION_EXT |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|<a name="resource_semaphore_query_compile"></a>RESOURCE_SEMAPHORE_QUERY_COMPILE |Occurs when the number of concurrent query compilations reaches a throttling limit. High waits and wait times may indicate excessive compilations, recompiles, or uncacheable plans.| 
...
|RESTORE_FILEHANDLECACHE_ENTRYLOCK |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|RESTORE_FILEHANDLECACHE_LOCK |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|RG_RECONFIG |Internal use only.| 
|ROWGROUP_OP_STATS |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|ROWGROUP_VERSION |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|SESSION_WAIT_STATS_CHILDREN |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|SHARED_DELTASTORE_CREATION |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|SLEEP_BUFFERPOOL_HELPLW |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|SLEEP_MEMORYPOOL_ALLOCATEPAGES |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|SLEEP_MSDBSTARTUP |Occurs when SQL Trace waits for the msdb database to complete startup.| 
|SLEEP_RETRY_VIRTUALALLOC |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|SLEEP_WORKSPACE_ALLOCATEPAGE |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|SLO_UPDATE |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] and later.| 
|SMSYNC |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|TDS_BANDWIDTH_STATE |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|XDB_CONN_DUP_HASH |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|XE_FILE_TARGET_TVF |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
...
|XTP_HOST_PARALLEL_RECOVERY |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|XTP_PREEMPTIVE_TASK |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
|XTP_TRUNCATION_LSN |Internal use only. <br /><br /> **Applies to**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] and later.| 
