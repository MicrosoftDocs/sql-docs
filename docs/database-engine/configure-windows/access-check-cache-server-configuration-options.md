...
The default values of 0 indicates that [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] is managing these options. Starting with [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)], the default values translate to the following internal configurations:
