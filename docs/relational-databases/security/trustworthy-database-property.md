...
We recommend that you leave the `TRUSTWORTHY` database property to `OFF` to mitigate certain threats that can exist as a result of attaching a database that contains one of the following objects:
