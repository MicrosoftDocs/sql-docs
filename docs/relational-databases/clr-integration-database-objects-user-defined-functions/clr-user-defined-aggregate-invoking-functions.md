...
description: In SQL Server CRL integration, use Transact-SQL SELECT to invoke CLR user-defined aggregates, subject to the rules that apply to system aggregate functions.
ms.custom: ""
ms.date: "01/15/2019"
ms.prod: sql
ms.reviewer: ""
