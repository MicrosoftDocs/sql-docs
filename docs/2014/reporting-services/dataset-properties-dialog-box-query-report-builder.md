 ...
 **Refresh Fields**  
 Run the query command to update the list of fields in the [Dataset Properties Dialog Box, Fields](../../2014/reporting-services/dataset-properties-dialog-box-fields-report-builder.md) page.  
