...
| 8577 | 16 | Yes | DTC for Azure SQL Managed Instance %ls is disabled. To learn how to enable DTC, see: https://learn.microsoft.com/azure/azure-sql/managed-instance/distributed-transaction-coordinator-dtc?view=azuresql. |
