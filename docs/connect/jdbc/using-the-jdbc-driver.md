...
The Microsoft JDBC Driver 8.2 for SQL Server provides **mssql-jdbc-8.2.1.jre8.jar**, **mssql-jdbc-8.2.1.jre11.jar**, and **mssql-jdbc-8.2.1.jre13.jar** class library files.
...
If using JDBC Driver 8.2, set the classpath to include the **mssql-jdbc-8.2.1.jre8.jar**, **mssql-jdbc-8.2.1.jre11.jar**, or **mssql-jdbc-8.2.1.jre13.jar**.
...
The **mssql-jdbc-8.2.1.jre8.jar**, **mssql-jdbc-8.2.1.jre11.jar**, or **mssql-jdbc-8.2.1.jre13.jar** files are installed in the following locations:
...
Make sure that the CLASSPATH statement contains only one [!INCLUDE[jdbcNoVersion](../../includes/jdbcnoversion_md.md)], such as either **mssql-jdbc-8.2.1.jre8.jar**, **mssql-jdbc-8.2.1.jre11.jar**, or **mssql-jdbc-8.2.1.jre13.jar**.
