...
|`Type`|Contains the type of the attribute. For more information, see [Configure Attribute Types](../../2014/analysis-services/configure-attribute-types.md).|  
