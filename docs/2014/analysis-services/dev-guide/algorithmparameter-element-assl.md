...
# AlgorithmParameter Element (ASSL)
  Defines a parameter for the algorithm used by a [MiningModel](../../../2014/analysis-services/dev-guide/miningmodel-element-assl.md) element.  
...
|------------------|-------------|  
|Parent elements|[AlgorithmParameters](../../../2014/analysis-services/dev-guide/algorithmparameters-element-assl.md)|  
...
## Remarks  
 ...
 Available algorithm parameters, including validation and display information, can be retrieved from the [DMSCHEMA_MINING_SERVICE_PARAMETERS](../../../2014/analysis-services/dev-guide/dmschema-mining-service-parameters-rowset.md) schema rowset.  
