...
# ProactiveCachingIncrementalProcessingBinding Data Type (ASSL)
  Defines a derived data type that represents a binding to the [ProactiveCaching](../../../2014/analysis-services/dev-guide/proactivecaching-element-assl.md) element about the status of the process of rebuilding the cache.  
...
|Child elements|[IncrementalProcessingNotification](../../../2014/analysis-services/dev-guide/incrementalprocessingnotification-element-assl.md), [RefreshInterval](../../../2014/analysis-services/dev-guide/refreshinterval-element-assl.md)|  
