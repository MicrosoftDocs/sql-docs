...
## Remarks  
 This function can be called only after [bcp_init](../../../2014/database-engine/dev-guide/bcp-init.md) has been called with a valid file name.  
 ...
 After calling `bcp_columns`, you must call [bcp_colfmt](../../../2014/database-engine/dev-guide/bcp-colfmt.md)for each column in the user file to completely define a custom file format.  
