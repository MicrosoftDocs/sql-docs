...
-   Transactional replication. For more information, see [Transactional Replication](../../../2014/relational-databases/replication/transactional-replication.md).  
  
-   Merge replication. For more information, see [Merge Replication](../../../2014/relational-databases/replication/merge-replication.md).  
  
-   Snapshot replication. For more information, see [Snapshot Replication](../../../2014/relational-databases/replication/snapshot-replication.md).  
