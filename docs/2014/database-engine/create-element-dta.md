...
|------------------|--------------|  
|**Parent element**|[Recommendation Element &#40;DTA&#41;](../../2014/database-engine/recommendation-element-dta.md)|  
|**Child elements**|[Index Element &#40;DTA&#41;](../../2014/database-engine/index-element-dta.md)<br /><br /> `Statistics` Element (see [Database Engine Tuning Advisor XML schema](http://schemas.microsoft.com/sqlserver/) for information)<br /><br /> `Heap` Element (see [Database Engine Tuning Advisor XML schema](http://schemas.microsoft.com/sqlserver/) for information)|  
