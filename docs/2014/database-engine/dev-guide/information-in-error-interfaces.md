...
|**GetCustomErrorObject**|Returns a reference on interfaces **ISQLErrorInfo,** and [ISQLServerErrorInfo](../../../2014/database-engine/dev-guide/isqlservererrorinfo-ole-db.md).|  
