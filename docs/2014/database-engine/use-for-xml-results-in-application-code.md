...
-   Query SQL tables for instances of [XML Data &#40;SQL Server&#41;](../../2014/database-engine/xml-data-sql-server.md) values  
  
-   Apply the [TYPE Directive in FOR XML Queries](../../2014/database-engine/type-directive-in-for-xml-queries.md) to return the result of queries that contain text or image typed data as XML  
