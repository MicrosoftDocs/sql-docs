...
# IsAggregatable Element (ASSL)
  Specifies whether the values of the [DimensionAttribute](../../../2014/analysis-services/dev-guide/dimensionattribute-data-type-assl.md) element can be aggregated.  
