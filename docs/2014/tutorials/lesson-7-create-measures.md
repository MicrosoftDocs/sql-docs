...
## Prerequisites  
 This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 6: Create Calculated Columns](../../2014/tutorials/lesson-6-create-calculated-columns.md).  
...
## Next Step  
 To continue this tutorial, go to the next lesson: [Lesson 8: Create Key Performance Indicators](../../2014/tutorials/lesson-8-create-key-performance-indicators.md).  
