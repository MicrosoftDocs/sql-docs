...
> [!NOTE]
>  Asynchronous programming is a core feature of the .NET Framework, and ADO.NET takes full advantage of the standard design patterns. For more information about the different asynchronous techniques available to developers, see [Calling Synchronous Methods Asynchronously](https://docs.microsoft.com/dotnet/standard/asynchronous-programming-patterns/calling-synchronous-methods-asynchronously).  
...
## In This Section  
 [Windows Applications Using Callbacks](../../connect/ado-net/windows-applications-using-callbacks.md)  
 ...
 [ASP.NET Applications Using Wait Handles](../../connect/ado-net/aspnet-apps-using-wait-handles.md)  
 ...
 [Polling in Console Applications](../../connect/ado-net/polling-in-console-applications.md)  
