...
CLR Integration enables you to implement complex features that are available in .Net Framework such as Regular expressions, code for accessing external resources (servers, web services), etc. The major benefits of this integration are:  
