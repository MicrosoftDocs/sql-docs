...
> [!NOTE]
> Uploaded certificate is not visible in the sys.certificates catalog view. To confirm successfull upload of the certificate you can run [RESTORE FILELISTONLY](https://learn.microsoft.com/en-us/sql/t-sql/statements/restore-statements-filelistonly-transact-sql) command.
