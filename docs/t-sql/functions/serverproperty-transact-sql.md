...
| `IsExternalAuthenticationOnly` | **Applies to**: Azure SQL Database and Azure SQL Managed Instance.<br /><br />Returns whether [Microsoft Entra-only authentication](/azure/azure-sql/database/authentication-azure-ad-only-authentication) is enabled.<br /><br />1 = Microsoft Entra-only authentication is enabled.<br /><br />0 = Microsoft Entra-only authentication is disabled.<br /><br />Base data type: **int** |
