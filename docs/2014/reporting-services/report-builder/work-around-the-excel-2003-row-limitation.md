...
2.  Right click the Data row in the table, and then click **Add Group** > **Parent Group** to add an outer table group.  
     ...
     ![Select the Parent Group](../../2014/reporting-services/media/datarow-selectparentgroup.png "Select the Parent Group")  
...
4.  Delete the group column by right-clicking on the column header, clicking **Delete Columns**, selecting **Delete columns only**, and then click **OK**.  
     ...
     ![Delete a group column](../../2014/reporting-services/media/groupcolumn-delete-updated.png "Delete a group column")  
  
5.  Right click **Group 1** in the **Row Groups** section, and then click **Group Properties**.  
  
     ![View group properties](../../2014/reporting-services/media/groupproperties-updated.png "View group properties")  
  
6.  On the **Sorting** page of the **Group Properties** dialog box, select the default sorting option and click **Delete**.  
  
     ![Delete default sorting](../../2014/reporting-services/media/groupproperties-sorting-updated.png "Delete default sorting")  
  
7.  On the **Page Breaks** page, click **Between each instance of a group** and then click **OK**.  
  
     ![Set page breaks](../../2014/reporting-services/media/groupproperties-pagebreaks-updated.png "Set page breaks")  
