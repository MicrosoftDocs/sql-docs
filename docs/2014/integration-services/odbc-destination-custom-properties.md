...
|InsertMethod|Integer (enumeration)|The method used for inserting the data. The possible values are Row by row (0) and Batch (1). The default value is Batch (1).<br /><br /> For more information about these options, see “Load Options” in [ODBC Destination](../../2014/integration-services/odbc-destination.md).|  
