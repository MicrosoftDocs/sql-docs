...
description: Learn about the rsconfig.exe utitlity that encrypts and stores report server database connection and account values in the RSReportServer.config file.
ms.date: 03/20/2017
