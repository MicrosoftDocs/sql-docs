...
2.  In the **Connect to Server** dialog box, verify the default settings, and then click **Connect**.  
 ...
 ![Database Engine Tuning Advisor default window](../../../tutorials/media/defaultdtagui.gif "Database Engine Tuning Advisor default window")  
