...
-   To convert Access objects to [!INCLUDE[tsql](../../includes/tsql-md.md)] syntax, to refresh metadata from [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)], or to save converted syntax to scripts, the account must have permission to log in to the instance of [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)].  
