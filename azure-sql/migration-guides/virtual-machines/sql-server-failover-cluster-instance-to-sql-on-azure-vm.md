...
:::image type="content" source="media/sql-server-availability-group-to-sql-on-azure-vm/replicating-servers.png" alt-text="Screenshot of the Monitor replication option.":::
