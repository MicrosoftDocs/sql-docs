...
# CellOrdinal Element (XMLA)
  Contains the ordinal position within a cube of a cell to be updated by an [UpdateCells](../../../2014/analysis-services/dev-guide/updatecells-element-xmla.md) command.  
...
|------------------|-------------|  
|Parent elements|[Cell](../../../2014/analysis-services/dev-guide/cell-element-xmla.md)|  
|Child elements|None|  
