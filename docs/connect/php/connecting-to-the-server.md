...
|[How to: Connect Using Microsoft Entra authentication](../../connect/php/azure-active-directory.md)|Describes how to set the authentication mode and connect using Microsoft Entra identities.|  
