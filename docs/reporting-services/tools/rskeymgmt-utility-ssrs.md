...
description: Learn about the reskeymgmt utitlity that Is used for managing the symmetric key that protects sensitive report server data against unauthorized access.
ms.date: 03/20/2017
