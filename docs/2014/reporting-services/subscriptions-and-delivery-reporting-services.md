...
-   [E-Mail Delivery in Reporting Services](../../2014/reporting-services/e-mail-delivery-in-reporting-services.md) Describes report server e-mail delivery operation and configuration.  
  
-   [File Share Delivery in Reporting Services](../../2014/reporting-services/file-share-delivery-in-reporting-services.md) Describes report server file share delivery operation and configuration.  
  
-   [SharePoint Library Delivery in Reporting Services](../../2014/reporting-services/sharepoint-library-delivery-in-reporting-services.md) Describes subscription delivery to a SharePoint library.  
  
-   [Data-Driven Subscriptions](../../2014/reporting-services/data-driven-subscriptions.md) Provides information about using data-driven subscriptions to customize report output at run time.  
