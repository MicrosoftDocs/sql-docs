...
##  <a name="TsqlProcedure"></a> **To modify a unique constraint**  
 ...
 To modify a UNIQUE constraint using Transact-SQL, you must first delete the existing UNIQUE constraint and then re-create it with the new definition. For more information, see [Delete Unique Constraints](../../2014/database-engine/delete-unique-constraints.md) and [Create Unique Constraints](../../2014/database-engine/create-unique-constraints.md).  
