...
-   Lookup errors, which occur if a lookup operation fails to locate a match in the lookup table.  
 ...
 For more information, see [Data Flow](data-flow/data-flow.md) and [Integration Services Paths](data-flow/integration-services-paths.md).  
