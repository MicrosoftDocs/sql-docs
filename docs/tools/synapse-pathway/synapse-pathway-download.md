...
> [!CAUTION]
> Azure Synapse Pathway is no longer supported or maintained. For migration, consider the [Fabric Migration Assistant for Data Warehouse](/fabric/data-warehouse/migration-assistant).
