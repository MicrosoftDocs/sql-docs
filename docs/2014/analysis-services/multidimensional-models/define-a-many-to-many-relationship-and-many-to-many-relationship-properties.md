...
##  <a name="bkmk_Learn"></a> Learn more  
 ...
 [How do I define a many-to-many dimension in Analysis Services](https://docs.microsoft.com/sql/analysis-services/lesson-5-3-defining-a-many-to-many-relationship?view=sql-server-2014)  
