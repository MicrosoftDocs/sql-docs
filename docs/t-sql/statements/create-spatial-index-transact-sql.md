...
|**geography**|GEOGRAPHY_AUTO_GRID|  
 ...
 ON *filegroup_name*      
 **Applies to**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ([!INCLUDE[sql2008-md](../../includes/sql2008-md.md)] and later) and [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)]  
...
### USING options
 ...
 GEOMETRY_AUTO_GRID      
 **Applies to**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ([!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] and later) and [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)]
