...
# Flexible Failover Policy for Automatic Failover of an Availability Group (SQL Server)
  A flexible failover policy provides granular control over the conditions that cause [automatic failover](../../2014/database-engine/failover-and-failover-modes-alwayson-availability-groups.md) for an availability group. By changing the failure conditions that trigger an automatic failover and the frequency of health checks, you can increase or decrease the likelihood of an automatic failover to support your SLA for high availability.  
...
-   [Change the Availability Mode of an Availability Replica &#40;SQL Server&#41;](../../2014/database-engine/change-the-availability-mode-of-an-availability-replica-sql-server.md) (automatic failover requires synchronous-commit availability mode)  
...
-   [How It Works: SQL Server AlwaysOn Lease Timeout](http://blogs.msdn.com/b/psssql/archive/2012/09/07/how-it-works-sql-server-alwayson-lease-timeout.aspx)  
