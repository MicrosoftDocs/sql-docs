...
-   **Nonclustered index on an indexed view**  
     ...
     After a unique clustered index has been created on a view, nonclustered indexes can be created. For more information, see [Create Indexed Views](../../2014/database-engine/create-indexed-views.md).  
