...
| General SSMS | Fixed an issue where database properties "Size" was displaying the MaxSize instead of the actual size of the database for SQL Azure DBs (note: for DW, it still shows the MaxSize) |
| General SSMS | Addressed 3 common sources of hangs in SSMS |
...
| Import/Export Data-Tier Application | Fixed an issue where the SSMS was throwing an error when trying to import a bacpac file. See https://feedback.azure.com/forums/908035/suggestions/40229137. |
...
| Reports | Fixed several standard reports that were broken on Linux (for example the Memory Consumption report was failing with an error similar to "/var/opt/mssql/log/log_116.trc\log.trc' is invalid…") |
...
| Xevent UI | Fixed long outstanding issue (introduced in SSMS 18.0) where "Save to XEL file…" was throwing an error. See https://feedback.azure.com/forums/908035/suggestions/37695592. |
...
|Import flat file | Updated Flat File Import Wizard to allow check all for the allow null column. See [UserVoice 38027137](https://feedback.azure.com/forums/908035/suggestions/38027137). |
...
| XEvent UI | Fixed an issue here items in the grid where being selected on hovering. See [UserVoice 38262124](https://feedback.azure.com/forums/908035/suggestions/38262124) and [UserVoice 37873921](https://feedback.azure.com/forums/908035-sql-server/suggestions/37873921). |

### Known issues (18.5)

- Database Diagram created from SSMS running on machine A cannot be modified from machine B (SSMS crashes). See [UserVoice 37992649](https://feedback.azure.com/forums/908035/suggestions/37992649) for more details.
