...
| Manage Azure extension for SQL Server | Use SQL Server Configuration Manager to manage Azure extension for SQL Server service. See [SQL Server Configuration Manager](../relational-databases/sql-server-configuration-manager.md). |
