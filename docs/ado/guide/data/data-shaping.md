...
-   [Reshaping](../../../ado/guide/data/reshaping.md)  
  
-   [Grandchild Aggregates](../../../ado/guide/data/grandchild-aggregates.md)  
  
-   [Parameterized Commands with Intervening COMPUTE Commands](../../../ado/guide/data/parameterized-commands-with-intervening-compute-commands.md)  
  
-   [Persisting Hierarchical Recordsets](../../../ado/guide/data/persisting-hierarchical-recordsets.md)  
