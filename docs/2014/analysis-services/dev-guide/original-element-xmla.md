...
# Original Element (XMLA)
  Contains the original file system storage location used by a [Folder](../../../2014/analysis-services/dev-guide/folder-element-xmla.md) element.  
...
|------------------|-------------|  
|Parent elements|[Folder](../../../2014/analysis-services/dev-guide/folder-element-xmla.md)|  
|Child elements|None|  
