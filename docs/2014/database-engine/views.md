...
|View Tasks|Topic|  
|----------------|-----------|  
|Describes how to create a view.|[Create Views](../../2014/database-engine/create-views.md)|  
|Describes how to create an indexed view.|[Create Indexed Views](../../2014/database-engine/create-indexed-views.md)|  
|Describes how to modify the view definition.|[Modify Views](../../2014/database-engine/modify-views.md)|  
|Describes how to modify data through a view.|[Modify Data Through a View](../../2014/database-engine/modify-data-through-a-view.md)|  
|Describes how to delete a view.|[Delete Views](../../2014/database-engine/delete-views.md)|  
|Describes how to return information about a view such as the view definition.|[Get Information About a View](../../2014/database-engine/get-information-about-a-view.md)|  
|Describes how to rename a view.|[Rename Views](../../2014/database-engine/rename-views.md)|  
  
## See Also  
 [Create Views over XML Columns](../../2014/database-engine/create-views-over-xml-columns.md)   
