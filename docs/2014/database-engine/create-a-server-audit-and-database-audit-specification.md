...
2.  Right-click the **Audits** folder and select **New Audit…**. For more information, see [Create a Server Audit and Server Audit Specification](../../2014/database-engine/create-a-server-audit-and-server-audit-specification.md).  
