---
title: Deprecated Full-Text Search Features in SQL Server
description: Learn about the deprecated full-text search features still available in SQL Server.
author: rwestMSFT
...
This article describes the deprecated full-text search features that are still available in SQL Server. These features are scheduled for removal in a future release. Don't use deprecated features in new applications.
...
| CREATE FULLTEXT CATALOG option:<br /><br />IN PATH '*rootpath*'<br /><br />ON FILEGROUP *filegroup* | None | CREATE FULLTEXT CATALOG IN PATH<br /><br />None<sup>*</sup> | 237<br /><br />None<sup>*</sup> |
...
<sup>*</sup> The **SQL Server:Deprecated Features** object doesn't monitor occurrences of `CREATE FULLTEXT CATALOG ON FILEGROUP <filegroup>`.
