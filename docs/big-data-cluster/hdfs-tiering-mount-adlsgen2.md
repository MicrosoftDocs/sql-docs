...
description: This article explains how to configure HDFS tiering to mount an external Azure Data Lake Storage file system into HDFS on a SQL Server 2019 Big Data Clusters.
author: nelgson
ms.author: negust
ms.reviewer: mikeray
ms.date: 11/05/2019
