...
- For [!INCLUDE[sql2008-md](../../includes/sql2008-md.md)] and [!INCLUDE[ssKilimanjaro](../../includes/ssKilimanjaro-md.md)], ESUs will be available until July 12, 2023 for customers who have migrated their workloads to Azure services. See the [Overview](#overview) for more information.
