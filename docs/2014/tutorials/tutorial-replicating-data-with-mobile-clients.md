...
## Requirements  
 This tutorial is intended for users familiar with fundamental database operations, but who have limited experience with replication. Before you start this tutorial, you must complete [Tutorial: Preparing the Server for Replication](../../2014/tutorials/tutorial-preparing-the-server-for-replication.md).  
...
-   [Lesson 1: Publishing Data Using Merge Replication](../../2014/tutorials/lesson-1-publishing-data-using-merge-replication.md)  
  
-   [Lesson 2: Creating a Subscription to the Merge Publication](../../2014/tutorials/lesson-2-creating-a-subscription-to-the-merge-publication.md)  
  
 [Start the Tutorial](../../2014/tutorials/lesson-1-publishing-data-using-merge-replication.md)  
