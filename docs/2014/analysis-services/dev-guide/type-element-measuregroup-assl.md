...
# Type Element (MeasureGroup) (ASSL)
  Specifies the type of the [MeasureGroup](../../../2014/analysis-services/dev-guide/measuregroup-element-assl.md).  
...
|------------------|-------------|  
|Parent element|[MeasureGroup](../../../2014/analysis-services/dev-guide/measuregroup-element-assl.md)|  
|Child elements|None|  
