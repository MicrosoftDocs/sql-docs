...
This article covers SqlPackage integration with Azure Blob Storage for storing data in parquet files.  This functionality is only available for Azure Synapse Analytics databases.
