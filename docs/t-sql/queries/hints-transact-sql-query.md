...
The list of all supported `USE HINT` names can be queried using the dynamic management view [sys.dm_exec_valid_use_hints](../../relational-databases/system-dynamic-management-objects/sys-dm-exec-valid-use-hints-transact-sql.md).
