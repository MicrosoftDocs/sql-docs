...
|[SQL Server Developer Center Community](https://docs.microsoft.com/sql/sql-server/sql-server-technical-documentation)|This site focuses on the newsgroups, forums, and other community resources that are useful to [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] developers.|  
