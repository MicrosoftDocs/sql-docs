...
## <a id="monitoring-overview-page-in-azure-portal"></a> Monitor overview page in Azure portal

View your Azure Monitor metrics for all connected resources by going to the Azure Monitor page directly in the Azure portal. Or, on the **Overview** page of a database, select **Metrics** under the Monitoring heading to reach Azure Monitor.
...
## <a id="monitoring-data"></a> Monitor data
