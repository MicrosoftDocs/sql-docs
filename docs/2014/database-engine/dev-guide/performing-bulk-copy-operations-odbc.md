...
-   [Bulk Copying from Program Variables](../../../2014/database-engine/dev-guide/bulk-copying-from-program-variables.md)  
  
-   [Managing Bulk Copy Batch Sizes](../../../2014/database-engine/dev-guide/managing-bulk-copy-batch-sizes.md)  
  
-   [Bulk Copying Text and Image Data](../../../2014/database-engine/dev-guide/bulk-copying-text-and-image-data.md)  
