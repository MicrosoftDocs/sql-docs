...
\* [DOP Feedback](intelligent-query-processing-degree-parallelism-feedback.md) is currently available in [!INCLUDE [ssazure-sqldb](../../includes/ssazure-sqldb.md)] as a limited preview.
