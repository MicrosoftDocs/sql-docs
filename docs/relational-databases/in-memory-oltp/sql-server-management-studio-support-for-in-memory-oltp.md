...
2.  To replace the template parameters, click **Specify Values for Template Parameters** on the **Query** menu.  
     ...
     For more information on how to use templates, see [Template Explorer](/ssms/template/template-explorer).  
