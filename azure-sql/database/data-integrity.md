...
`DBCC CHECKDB` isn't available in Azure SQL Database Hyperscale. As an alternative, use the `DBCC CHECKTABLE ('<TableName>') WITH TABLOCK` for individual tables in the database.
