...
> [!NOTE]
> For more info about this procedure, see the following walkthrough with additional screen shots by Data Platform MVP Marcos Freccia: Adding SSISDB to AG for SQL Server 2016.
