...
+ You should have a tool for running T-SQL commands. A query editor is necessary for post-install configuration and validation. We recommend [Azure Data Studio](../azure-data-studio/download-azure-data-studio.md?view=sql-server-2017#get-azure-data-studio-for-linux&preserve-view=true), a free download that runs on Linux.
