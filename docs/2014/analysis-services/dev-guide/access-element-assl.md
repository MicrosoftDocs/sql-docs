...
---
# Access Element (ASSL)
  Indicates the level of access given to a [CellPermission](../../../2014/analysis-services/dev-guide/cellpermission-element-assl.md) element.  
...
|------------------|-------------|  
|Parent elements|[CellPermission](../../../2014/analysis-services/dev-guide/cellpermission-element-assl.md)|  
|Child elements|None|  
