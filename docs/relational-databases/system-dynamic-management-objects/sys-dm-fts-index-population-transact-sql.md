...
|**outstanding_batch_count**|**int**|Current number of outstanding batches for this population. For more information, see [sys.dm_fts_outstanding_batches &#40;Transact-SQL&#41;](sys-dm-fts-outstanding-batches-transact-sql.md).|  
...
:::image type="content" source="../../relational-databases/system-dynamic-management-objects/media/join-dm-fts-index-population.svg" alt-text="Diagram of physical joins for sys.dm_fts_index_population.":::
