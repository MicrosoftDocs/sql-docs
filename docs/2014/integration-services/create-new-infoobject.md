...
# Create New InfoObject
 ...
 You can open the **Create InfoObject** dialog box from the **Connection Manager** page of the **SAP BW Destination Editor**. To learn more about the SAP BW destination, see [SAP BW Destination](../../2014/integration-services/sap-bw-destination.md).  
 ...
 **Add**  
 ...
 To add an existing InfoObject, click Add, and then use the **Look Up InfoObject** dialog box to find the InfoObject. For more information about this dialog box, see [Look Up InfoObject](../../2014/integration-services/look-up-infoobject.md).  
...
## See Also  
 [Create InfoCube for Transaction Data](../../2014/integration-services/create-infocube-for-transaction-data.md)   
 [Create InfoSource](../../2014/integration-services/create-infosource.md)   
 [Create InfoSource for Transaction Data](../../2014/integration-services/create-infosource-for-transaction-data.md)   
 [Create InfoSource for Master Data](../../2014/integration-services/create-infosource-for-master-data.md)   
