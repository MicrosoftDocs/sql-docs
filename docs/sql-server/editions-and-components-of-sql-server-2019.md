...
**Try [!INCLUDE [ssNoVersion](../includes/ssnoversion-md.md)]!: [Download SQL Server 2019 from the Evaluation Center](https://www.microsoft.com/evalcenter/evaluate-sql-server-2019)**
...
| Hybrid backup to Azure (backup to URL) | Yes | Yes | Yes | No | No |
