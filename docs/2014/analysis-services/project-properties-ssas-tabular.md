...
|**Query Mode**|**In-Memory**|Specifies the source from which query results are returned. For more information, see [DirectQuery Mode &#40;SSAS Tabular&#41;](../../2014/analysis-services/directquery-mode-ssas-tabular.md).|  
