...
description: SQL Server Reporting Services reports can be configured to run in either local mode or connected mode. This article describes the different modes.
description: 
ms.date: 09/25/2017
