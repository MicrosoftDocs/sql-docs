...
4.  Call [bcp_init](../../../2014/database-engine/dev-guide/bcp-init.md) to set the following information:  
...
5.  Call [bcp_columns](../../../2014/database-engine/dev-guide/bcp-columns.md) to set the number of columns.  
  
6.  Call [bcp_colfmt](../../../2014/database-engine/dev-guide/bcp-colfmt.md) for each column to define its characteristics in the data file.  
  
7.  Call [bcp_writefmt](../../../2014/database-engine/dev-guide/bcp-writefmt.md) to create a format file describing the data file to be created by the bulk copy operation.  
  
8.  Call [bcp_exec](../../../2014/database-engine/dev-guide/bcp-exec.md) to execute the bulk copy operation.  
...
## See Also  
 ...
 [Using Data Files and Format Files](../../../2014/database-engine/dev-guide/using-data-files-and-format-files.md)  
