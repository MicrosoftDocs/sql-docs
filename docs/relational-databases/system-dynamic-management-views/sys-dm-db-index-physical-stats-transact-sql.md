...
|inrow_version_record_count|**bigint**|Count of ADR version records kept in the data row for fast retrieval. <br /><br /> **Applies to**: SQL Server 2016 and later, Azure SQL Database, Azure SQL Managed Instance|  
