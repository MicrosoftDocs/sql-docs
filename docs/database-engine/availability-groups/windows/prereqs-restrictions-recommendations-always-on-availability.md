...
|Each server instance must be running the same version of SQL Server to participate in an Always On Availability Group.|For more information, see the list of editions and supported features at the end of this section.|  
