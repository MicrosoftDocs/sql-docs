...
# InheritedBinding Data Type (ASSL)
  Defines a derived data type that indicates that a [MeasureGroupAttribute](../../../2014/analysis-services/dev-guide/measuregroupattribute-data-type-assl.md) element inherits its bindings from the attribute.  
