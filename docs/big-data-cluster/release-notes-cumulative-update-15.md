---
title: SQL Server Big Data Clusters CU15 release notes
titleSuffix: SQL Server Big Data Clusters
description: This article describes the SQL Server Big Data Clusters Cumulative Update 15 contents.
...
The following release notes apply to [!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ver15.md)] cumulative update 15 (CU15).

## CU15 changes and new capabilities
...
For detailed SQL Server engine changes, check the [official SQL Server CU15 knowledge base article](https://support.microsoft.com/help/5008996).

## Tested configurations for CU15

[!INCLUDE[big-data-clusters-nover](../includes/ssbigdataclusters-ss-nover.md)] CU15 was tested on the following environment combinations:
...
_Packages from [CRAN as of 2021-09-21](https://cran.r-project.org/web/packages/available_packages_by_date.html)_
