...
1. To change retention for point-in-time restore backups, use the slider under **Point-in-time restore**
1. To change differential backup frequency, select **12 Hours** or **24 hours** from the drop down under **Differential backup frequency**  
