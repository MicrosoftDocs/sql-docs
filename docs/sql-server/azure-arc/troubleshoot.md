---
title: Troubleshoot Azure Arc-enabled SQL Server #Required; this page title is displayed in search results; Always include the word "troubleshoot" in this line.
description: Describes how to troubleshoot Azure Arc-enabled SQL Server.#Required; this article description is displayed in search results.
...
# Troubleshoot issues with Azure Arc-enabled SQL Server
