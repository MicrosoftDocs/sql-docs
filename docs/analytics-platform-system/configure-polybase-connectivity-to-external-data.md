...
![PolyBase logical](/media/polybase/polybase-logical.png "PolyBase logical")
...
See [features and limitation](https://docs.microsoft.com/en-us/sql/relational-databases/polybase/polybase-versioned-feature-summary) for a summary of PolyBase features available and known limitations on APS and other SQL Server products.
