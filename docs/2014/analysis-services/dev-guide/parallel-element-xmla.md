...
# Parallel Element (XMLA)
  Identifies commands to be run in parallel by the parent [Batch](../../../2014/analysis-services/dev-guide/batch-element-xmla.md) command.  
...
|------------------|-------------|  
|Parent elements|[Batch](../../../2014/analysis-services/dev-guide/batch-element-xmla.md)|  
|Child elements|[Process Element](../../../2014/analysis-services/dev-guide/process-element-xmla.md)|  
