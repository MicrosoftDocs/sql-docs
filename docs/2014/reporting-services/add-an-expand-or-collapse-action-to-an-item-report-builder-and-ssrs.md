...
1.  In report design view, click the table or matrix to select it. The Grouping pane displays the row and column groups.  
     ...
     ![Grouping Pane](../../2014/reporting-services/media/groupingpane.png "Grouping Pane")  
...
2.  Right-click anywhere in the title bar of the Grouping pane, and then click **Advanced**. The Grouping pane mode toggles to show the underlying display structure for rows and columns on the design surface.  
     ...
     ![Grouping Pane with Advanced Mode menu](../../2014/reporting-services/media/groupingpane-advancedmode.png "Grouping Pane with Advanced Mode menu")  
...
5.  In **ToggleItem**, from the drop-down box, select the name of a text box to which to add the toggle image.  
     ...
     ![Configuring a row group to be expanded](../../2014/reporting-services/media/expandcollapse-confighiddentoggleitemwithnumbers.png "Configuring a row group to be expanded")  
...
6.  To test the toggle, run the report and click the text box with the toggle image. The report display refreshes to show row groups and column groups with their toggled visibility.  
     ...
     ![Running report with expandable row group](../../2014/reporting-services/media/expandcollapse-runreport-rowgroup.png "Running report with expandable row group")  
...
4.  In **Display can be toggled by this report item**, from the drop-down box, type or select the name of a text box in the report in which to display a toggle image; for example, Textbox1.  
     ...
     ![Configure a report table to be expanded](../../2014/reporting-services/media/expandcollapse-reporttable.png "Configure a report table to be expanded")  
...
5.  To test the toggle, run the report and click the text box with the toggle image. The report display refreshes to show report items with their toggled visibility.  
     ...
     ![Running report with an expanding table](../../2014/reporting-services/media/expandcollapse-runreport-reporttable.png "Running report with an expanding table")  
  
## See Also  
 [Drilldown Action &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/drilldown-action-report-builder-and-ssrs.md)   
 [Hide an Item &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/hide-an-item-report-builder-and-ssrs.md)  
