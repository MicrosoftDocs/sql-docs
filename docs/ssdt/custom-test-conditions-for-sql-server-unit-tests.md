...
description: Learn how to install custom test conditions for SQL Server unit tests. View the risks involved with installing test conditions that you did not create.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
