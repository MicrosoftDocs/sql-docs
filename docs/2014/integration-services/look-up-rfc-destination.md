...
# Look Up RFC Destination
 ...
 Both the SAP BW source and the SAP BW destination use the **Look Up RFC Destination** dialog box. For more information about these components of the [!INCLUDE[msCoName](../../includes/msconame-md.md)] Connector 1.1 for SAP BW, see [SAP BW Source](../../2014/integration-services/sap-bw-source.md) and [SAP BW Destination](../../2014/integration-services/sap-bw-destination.md).  
