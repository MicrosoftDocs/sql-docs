...
## Related Tasks  
 For instructions about how to add a destination and a connection manager using the Source Assistant, see [Add a Destination using Destination Assistant](../../2014/integration-services/add-a-destination-using-destination-assistant.md).  
