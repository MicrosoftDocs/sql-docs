...
|avg_instance_cpu_percent|**decimal (5,2)**|Average database CPU usage in percentage.|
|avg_instance_memory_percent|**decimal (5,2)**|Average database memory usage in percentage.|
