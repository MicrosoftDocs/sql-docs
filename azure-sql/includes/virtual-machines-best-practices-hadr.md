...
* Configure cluster [quorum voting](../virtual-machines/windows/hadr-cluster-best-practices.md#quorum-voting) to use 3 or more odd number of votes. Do not assign votes to DR regions. 
