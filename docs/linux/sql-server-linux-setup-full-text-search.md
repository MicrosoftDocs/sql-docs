...
You can see a list of installed filters by calling **sp_help_fulltext_system_components 'filter'**. For SQL Server 2017 CTP 2.1, the following filters are installed:
