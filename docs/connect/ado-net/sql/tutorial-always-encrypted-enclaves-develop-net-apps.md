    ...
    namespace ConsoleApp1
    {
        class Program
        {
            static void Main(string[] args)
            {
                ...
                //string connectionString = "Data Source = myserver.database.windows.net; Initial Catalog = ContosoHR; Column Encryption Setting = Enabled;Attestation Protocol = AAS; Enclave Attestation Url = https://myattestationprovider.uks.attest.azure.net/attest/SgxEnclave; User ID={your_username}; Authentication="Active Directory Integrated";

                // Connection string for Azure SQL Database with VBS enclaves
                //string connectionString = "Data Source = myserver.database.windows.net; Initial Catalog = ContosoHR; Column Encryption Setting = Enabled;Attestation Protocol = None; User ID={your_username}; Authentication="Active Directory Integrated";
...
2. Update the database connection string.
    ...
    3. Set `Enclave Attestation URL` to an attestation URL for your environment. This parameter is not necessary for [!INCLUDE[ssSDSfull](../../../includes/sssdsfull-md.md)] VBS enclaves and can be removed.
