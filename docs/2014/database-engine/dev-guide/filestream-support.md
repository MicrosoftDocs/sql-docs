...
-   [FILESTREAM Support &#40;OLE DB&#41;](../../../2014/database-engine/dev-guide/filestream-support-ole-db.md)  
...
## Querying for FILESTREAM Columns  
 ...
 To create FILESTREAM columns or to detect which existing columns are FILESTREAM columns, you can use the `is_filestream` column of the [sys.columns](../Topic/sys.columns%20\(Transact-SQL\).md) catalog view.  
