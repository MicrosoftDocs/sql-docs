...
> [!NOTE]  
>  This topic only describes the the features and requirements of the Data Profiling task. For a walkthrough of how to use the Data Profiling task, see the section, [Data Profiling Task and Viewer](../../2014/integration-services/data-profiling-task-and-viewer.md).  
...
## Data Profiler Viewer  
 After using the task to compute data profiles and save them in a file, you can use the stand-alone Data Profile Viewer to review the profile output. The Data Profile Viewer also supports drilldown capability to help you understand data quality issues tha are identified in the profile output. For more information, see [Data Profile Viewer](../../2014/integration-services/data-profile-viewer.md).  
  
> [!IMPORTANT]  
>  The output file might contain sensitive data about your database and the data that the database contains. For suggestions about how to make this file more secure, see [Access to Files Used by Packages](../../2014/integration-services/access-to-files-used-by-packages.md).  
>   
...
## Custom Logging Messages Available on the Data Profililng Task  
 The following table lists the custom log entries for the Data Profiling task. For more information, see [Integration Services &#40;SSIS&#41; Logging](../../2014/integration-services/integration-services-ssis-logging.md) and [Custom Messages for Logging](../../2014/integration-services/custom-messages-for-logging.md).  
...
## Configuration of the Data Profiling Task  
 ...
 [General Page](../../2014/integration-services/data-profiling-task-editor-general-page.md)  
 On the **General** page, you specify the output file or variable. You can also select **Quick Profile** to configure the task quickly to compute profiles by using the default settings. For more information, see [Single Table Quick Profile Form &#40;Data Profiling Task&#41;](../../2014/integration-services/single-table-quick-profile-form-data-profiling-task.md).  
  
 [Profile Requests Page](../../2014/integration-services/data-profiling-task-editor-profile-requests-page.md)  
