...
|CREATE FULLTEXT CATALOG option:<br /><br /> IN PATH '*rootpath*'<br /><br /> ON FILEGROUP *filegroup*|None.|CREATE FULLTEXT CATALOG IN PATH<br /><br /> None.<sup>*</sup>|237<br /><br /> None.*|  
...
|sp_fulltext_service action values: resource_usage has no function.|None|sp_fulltext_service @action=resource_usage|200|  
 ...
 &#42;The **SQL Server:Deprecated Features** object does not monitor occurrences of CREATE FULLTEXT CATALOG ON FILEGROUP *filegroup*.  
