...
|   | [Java language extension](java/extension-java.md) on both Windows and Linux is new in SQL Server 2019 preview. By providing the classpath to your compiled Java in a [system stored procedure](https://docs.microsoft.com/sql/relational-databases/system-stored-procedures/sp-execute-external-script-transact-sql), any client app that can access SQL Server can now access your Java code using the same mechanisms. | 
