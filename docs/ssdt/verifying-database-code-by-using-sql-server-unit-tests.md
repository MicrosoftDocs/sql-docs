...
description: Learn about SQL Server unit tests. See which Visual Studio editions provide support for the tests, and view resources on using them to verify database code.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
