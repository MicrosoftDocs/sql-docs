...
# Report Server Status (SSRS Native Mode)
 ...
 To open this page, start the [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] Configuration Manager and connect to the report server instance. For more information, see [Reporting Services Configuration Manager &#40;del&#41;](../Topic/Reporting%20Services%20Configuration%20Manager%20\(del\).md).  
