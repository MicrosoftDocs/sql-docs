...
## Methods  
 For information about OLE DB methods that support table-valued parameters, see [OLE DB Table-Valued Parameter Type Support &#40;Methods&#41;](../../../2014/database-engine/dev-guide/ole-db-table-valued-parameter-type-support-methods.md).  
  
## Properties  
 For infornation about about OLE DB properties that support table-valued parameters, see [OLE DB Table-Valued Parameter Type Support &#40;Properties&#41;](../../../2014/database-engine/dev-guide/ole-db-table-valued-parameter-type-support-properties.md).  
