...
Global virtual network peering is [supported for instances hosted in subnets created since 9/22/2020](frequently-asked-questions-faq.yml#does-sql-managed-instance-support-global-vnet-peering).
