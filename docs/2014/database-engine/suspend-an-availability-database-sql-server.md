...
-   Resume the secondary database before the log fills up. For more information, see [Resume an Availability Database &#40;SQL Server&#41;](../../2014/database-engine/resume-an-availability-database-sql-server.md).  
  
-   Remove the secondary database. For more information, see [Remove a Secondary Database from an Availability Group &#40;SQL Server&#41;](../../2014/database-engine/remove-a-secondary-database-from-an-availability-group-sql-server.md).  
