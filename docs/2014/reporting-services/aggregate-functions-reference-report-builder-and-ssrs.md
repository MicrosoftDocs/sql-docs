...
|------------------|---------------------|  
|[Avg](../../2014/reporting-services/avg-function-report-builder-and-ssrs.md)|Returns the average of all non-null numeric values specified by the expression, evaluated in the given scope.|  
|[Count](../../2014/reporting-services/count-function-report-builder-and-ssrs.md)|Returns a count of non-null values specified by the expression, evaluated in the context of the given scope.|  
|[CountDistinct](../../2014/reporting-services/countdistinct-function-report-builder-and-ssrs.md)|Returns a count of all distinct non-null values specified by the expression, evaluated in the context of the given scope.|  
|[Max](../../2014/reporting-services/max-function-report-builder-and-ssrs.md)|Returns the maximum value of all non-null numeric values specified by the expression, in the context of the given scope. You can use this for specifying a chart axis maximum value to control the scale.|  
|[Min](../../2014/reporting-services/min-function-report-builder-and-ssrs.md)|Returns the minimum value of all non-null numeric values specified by the expression, in the context of the given scope. You can use this for specifying a chart axis minimum value to control the scale.|  
|[StDev](../../2014/reporting-services/stdev-function-report-builder-and-ssrs.md)|Returns the standard deviation of all non-null numeric values specified by the expression, evaluated in the given scope.|  
|[StDevP](../../2014/reporting-services/stdevp-function-report-builder-and-ssrs.md)|Returns the population standard deviation of all non-null numeric values specified by the expression, evaluated in the context of the given scope.|  
|[Sum](../../2014/reporting-services/sum-function-report-builder-and-ssrs.md)|Returns the sum of all the non-null numeric values specified by the expression, evaluated in the given scope.|  
|[Union](../../2014/reporting-services/union-function-report-builder-and-ssrs.md)|Returns the union of all the non-null spatial data values of type `SqlGeometry` or `SqlGeography` that are specified by the expression, evaluated in the given scope.|  
|[Var](../../2014/reporting-services/var-function-report-builder-and-ssrs.md)|Returns the variance of all non-null numeric values specified by the expression, evaluated in the given scope.|  
|[VarP](../../2014/reporting-services/varp-function-report-builder-and-ssrs.md)|Returns the population variance of all non-null numeric values specified by the expression, evaluated in the context of the given scope.|  
...
|**Function**|**Description**|  
|------------------|---------------------|  
|[RowNumber](../../2014/reporting-services/rownumber-function-report-builder-and-ssrs.md)|Returns a running count of the number of rows for the specified scope. The `RowNumber` function restarts counting at 1, not 0.|  
|[RunningValue](../../2014/reporting-services/runningvalue-function-report-builder-and-ssrs.md)|Returns a running aggregate of all non-null numeric values specified by the expression, evaluated for the given scope.|  
...
|**Function**|**Description**|  
|------------------|---------------------|  
|[CountRows](../../2014/reporting-services/countrows-function-report-builder-and-ssrs.md)|Returns the number of rows in the specified scope, including rows with null values.|  
...
|**Function**|**Description**|  
|------------------|---------------------|  
|[Lookup Function](../../2014/reporting-services/lookup-function-report-builder-and-ssrs.md)|Returns a value from a dataset for a specified expression.|  
|[LookupSet Function](../../2014/reporting-services/lookupset-function-report-builder-and-ssrs.md)|Returns a set of values from a dataset for a specified expression.|  
|[Multilookup Function](../../2014/reporting-services/multilookup-function-report-builder-and-ssrs.md)|Returns the set of first-match values for a set of names from a dataset that contains name/value pairs.|  
...
|**Function**|**Description**|  
|------------------|---------------------|  
|[First](../../2014/reporting-services/first-function-report-builder-and-ssrs.md)|Returns the first value in the given scope of the specified expression.|  
|[Last](../../2014/reporting-services/last-function-report-builder-and-ssrs.md)|Returns the last value in the given scope of the specified expression.|  
...
|**Function**|**Description**|  
|------------------|---------------------|  
|[Aggregate](../../2014/reporting-services/aggregate-function-report-builder-and-ssrs.md)|Returns a custom aggregate of the specified expression, as defined by the data provider.|  
...
|Function|Description|  
|--------------|-----------------|  
|[InScope](../../2014/reporting-services/inscope-function-report-builder-and-ssrs.md)|Indicates whether the current instance of an item is within the specified scope.|  
  
##  <a name="RetrievingRecursiveLevel"></a> Retrieving Recursive Level  
 The following built-in function retrieves the current level when a recursive hierarchy is processed. Use the result of this function with the `Padding` property in a text box to control the indent level of a visual hierarchy for a recursive group. For more information, see [Creating Recursive Hierarchy Groups &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/creating-recursive-hierarchy-groups-report-builder-and-ssrs.md).  
  
|Function|Description|  
|--------------|-----------------|  
|[Level](../../2014/reporting-services/level-function-report-builder-and-ssrs.md)|Returns the current level of depth in a recursive hierarchy.|  
