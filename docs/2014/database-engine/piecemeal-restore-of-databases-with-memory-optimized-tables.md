...
-   Piecemeal restore.  
    ...
    -   Using page repair, you can fix page corruption by specifically restoring the page. For more information, see [Restore Pages &#40;SQL Server&#41;](../../2014/database-engine/restore-pages-sql-server.md).  
...
## See Also  
 [Backup, Restore, and Recovery of Memory-Optimized Tables](../../2014/database-engine/backup-restore-and-recovery-of-memory-optimized-tables.md)  
