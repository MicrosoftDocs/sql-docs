...
## WMI Event Watcher Task Editor (General Page)
 ...
 For more information about WMI Query Language (WQL), see the Windows Management Instrumentation topic, [Querying with WQL](https://docs.microsoft.com/windows/win32/wmisdk/querying-with-wql), in the MSDN Library.  
