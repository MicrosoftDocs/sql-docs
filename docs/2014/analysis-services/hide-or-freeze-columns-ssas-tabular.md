...
> [!NOTE]  
>  If you have many columns to hide, you can create a perspective instead of hiding and unhiding columns. A perspective is a custom view of the data that makes it easier to work with subset of related data. For more information, see [Create and Manage Perspectives &#40;SSAS Tabular&#41;](create-and-manage-perspectives-ssas-tabular.md)  
