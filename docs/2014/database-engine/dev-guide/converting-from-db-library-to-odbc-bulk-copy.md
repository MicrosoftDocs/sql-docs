...
-   The DB-Library **bcp_colfmt***file_collen* and the ODBC [bcp_colfmt](../../../2014/database-engine/dev-guide/bcp-colfmt.md)*cbUserData* have the same issue as the **bcp_bind***varlen* and *cbData* parameters noted above. Change any DB-Library *file_collen* specifications of -1 to SQL_VARLEN_DATA and any *file_collen* specifications of 0 to SQL_NULL_DATA.  
  
-   The *iValue* parameter of the ODBC [bcp_control](../../../2014/database-engine/dev-guide/bcp-control.md) function is a void pointer. In DB-Library, *iValue* was an integer. Cast the values for the ODBC *iValue* to void *.  
