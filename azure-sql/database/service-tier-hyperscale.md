...
| Hyperscale service tier premium-series hardware (preview) | Premium-series and memory optimized premium-series hardware doesn't currently support:<br/><br/>- Zone redundancy<BR/><BR/>- Azure SQL Database maintenance window<BR/><BR/>- Serverless compute tier.| 
