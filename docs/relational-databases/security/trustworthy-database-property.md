...
The following code sample can be used to obtain a list of databases that have the `TRUSTWORTHY` bit set to `ON` and whose database owner belongs to the sysadmin server role.
