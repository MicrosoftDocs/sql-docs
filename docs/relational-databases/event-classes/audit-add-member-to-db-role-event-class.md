...
- [sys.sp_addrolemember (Transact-SQL)](../system-stored-procedures/sp-addrolemember-transact-sql.md)
- [sys.sp_droprolemember (Transact-SQL)](../system-stored-procedures/sp-droprolemember-transact-sql.md)
