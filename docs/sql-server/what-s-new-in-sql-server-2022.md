...
| Microsoft Entra authentication | Use [authentication](../relational-databases/security/authentication-access/azure-ad-authentication-sql-server-overview.md) with Microsoft Entra ID ([formerly Azure Active Directory](/azure/active-directory/fundamentals/new-name)) to connect to SQL Server.  <br /><br /> Starting with [!INCLUDE[sql-server-2022](../includes/sssql22-md.md)] Cumulative Update 6, you can configure [Transactional and Snapshot Replication with Microsoft Entra authentication](../relational-databases/replication/configure-replication-with-azure-ad-authentication.md) - currently in preview.  |
