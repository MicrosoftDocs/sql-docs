...
||SQL_INST_JAVA |Applies to [SQL Server Java Language Extension](../../language-extensions/install/windows-java) (2019 and later). Pair with **AdvancedAnalytics** to install extensions that enable integration with Java using standard T-SQL statements.|  
