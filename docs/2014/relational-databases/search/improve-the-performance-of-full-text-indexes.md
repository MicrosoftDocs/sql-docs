...
|--------------|---------------------------------------------------------------------|---------------------------------------------------------------|  
|x86|*F* **=** *Number of crawl ranges* **\**_ 50|_M* **=minimum(** *T* **,** 2000**)-*`F`*-** 500|  
|x64|*F* **=** *Number of crawl ranges* **\**_ 10 _*\*** 8|*M* **=** *T* **-** *F* **-** 500|  
  
 <sup>1</sup> If multiple full populations are in progress, calculate the fdhost.exe memory requirements of each separately, as *F1*, *F2*, and so forth. Then calculate *M* as *T***-** sigma**(**_F_i**)**.  
