...
-   Provide an expression for each input column or new column that will be changed. For more information, see [Integration Services &#40;SSIS&#41; Expressions](../../2014/integration-services/integration-services-ssis-expressions.md).  
...
-   If adding results to new columns and the data type is `string`, specify a code page. For more information, see [Comparing String Data](../../2014/integration-services/comparing-string-data.md).  
