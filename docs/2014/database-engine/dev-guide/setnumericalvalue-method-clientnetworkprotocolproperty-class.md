...
---
# SetNumericalValue Method (ClientNetworkProtocolProperty Class)
  Sets the numeric value of the current property referenced by the [PropertyIdx Property (ClientNetworkProtocolProperty Class)](../../../2014/database-engine/dev-guide/propertyidx-property-clientnetworkprotocolproperty-class.md) value.  
