...
- SQL Managed Instance can be moved to the subnet that is either:
 1. Empty
 2. In a peered vNet (if you are moving to a subnet in another vNet you must [establish the peering](https://docs.microsoft.com/en-us/azure/virtual-network/tutorial-connect-virtual-networks-portal))
