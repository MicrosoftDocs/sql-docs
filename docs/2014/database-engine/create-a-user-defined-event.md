...
-   [SQL Server Management Studio](../../2014/database-engine/create-an-alert-using-an-error-number.md)  
  
-   [Transact-SQL](../Topic/sp_add_alert%20\(Transact-SQL\).md)  
  
 **To create an alert based on severity levels**  
  
-   [SQL Server Management Studio](../../2014/database-engine/create-an-alert-using-severity-level.md)  
...
-   [Transact-SQL](../Topic/sp_addmessage%20\(Transact-SQL\).md)  
  
 **To modify a user-defined event error message**  
  
-   [Transact-SQL](../Topic/sp_altermessage%20\(Transact-SQL\).md)  
  
 **To delete a user-defined event error message**  
  
-   [Transact-SQL](../Topic/sp_dropmessage%20\(Transact-SQL\).md)  
  
 **To disable or reactivate an alert**  
  
-   [SQL Server Management Studio](../../2014/database-engine/disable-or-reactivate-an-alert.md)  
  
-   [Transact-SQL](../Topic/sp_update_alert%20\(Transact-SQL\).md)  
  
## See Also  
 [sp_update_alert &#40;Transact-SQL&#41;](../Topic/sp_update_alert%20\(Transact-SQL\).md)  
