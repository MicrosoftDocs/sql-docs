...
Make sure to migrate the __SQL Server - Azure Arc__ resource to `Microsoft.AzureArcData` following [these steps](release-notes.md#migrate-resource-to-microsoftazurearcdata)].
