---
title: Restore instance to Azure Arc #Required; page title is displayed in search results. Include the brand.
description: Restore Azure Arc-enabled SQL Server instance to Azure
...
# Restore Azure Arc-enabled SQL Server instance to Azure
