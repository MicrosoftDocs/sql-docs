...
description: "Describes the data types are used by ADO.Net data provider."
ms.date: "11/13/2020"
...
> [!NOTE]
> Null values for ADO.NET data provider data types are represented by `DBNull.Value`.  
