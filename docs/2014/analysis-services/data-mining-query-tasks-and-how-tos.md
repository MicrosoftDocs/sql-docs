...
-   [View and Save the Results of a Prediction Query](../../2014/analysis-services/view-and-save-the-results-of-a-prediction-query.md)  
  
-   [Manually Edit a Prediction Query](../../2014/analysis-services/manually-edit-a-prediction-query.md)  
  
-   [Apply Prediction Functions to a Model](../../2014/analysis-services/apply-prediction-functions-to-a-model.md)  
  
-   [Choose and Map Input Data for a Prediction Query](../../2014/analysis-services/choose-and-map-input-data-for-a-prediction-query.md)  
...
## Using Other Data Mining Query Tools  
 ...
 [Create a Singleton Prediction Query from a Template](../../2014/analysis-services/create-a-singleton-prediction-query-from-a-template.md)  
 ...
 [Change the Time-out Value for Data Mining Queries](../../2014/analysis-services/change-the-time-out-value-for-data-mining-queries.md)  
 Describes how to set properties on the server that control behavior related to data mining queries.  
  
 [Create a Content Query on a Mining Model](../../2014/analysis-services/create-a-content-query-on-a-mining-model.md)  
 ...
 [Create a Data Mining Query by Using XMLA](../../2014/analysis-services/create-a-data-mining-query-by-using-xmla.md)  
