...
>  Due to a known issue connection to the Oracle source database may fail if the CDC Designer is not run as an administrator. If connection fails, close and restart the CDC Designer using the **Run as administrator** option.  
 ...
 After you finish entering information on this page, click **Next** to [Select Oracle Tables and Columns](../../2014/integration-services/select-oracle-tables-and-columns.md).  
...
## See Also  
 ...
 [Edit Instance Properties](../../2014/integration-services/edit-instance-properties.md)  
