...
7.  On the Select Instance page, specify the [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] instance to upgrade to [!INCLUDE[ssnoversion](../../../includes/ssnoversion-md.md)]. **Click Next to continue**.  
...
1.  Follow the steps above to upgrade your cluster to [!INCLUDE[ssnoversion](../../../includes/ssnoversion-md.md)].  
