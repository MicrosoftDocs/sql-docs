...
| [sys.dm_database_encryption_keys](../../system-dynamic-management-objects/sys-dm-database-encryption-keys-transact-sql.md) | Dynamic management view that provides information about a database's encryption keys and state of encryption |
...
To view the state of the database, use the [sys.dm_database_encryption_keys](../../system-dynamic-management-objects/sys-dm-database-encryption-keys-transact-sql.md) dynamic management view.
