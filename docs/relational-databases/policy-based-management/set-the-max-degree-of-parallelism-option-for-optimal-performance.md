...
- [Configure the max degree of parallelism Server Configuration Options](../../database-engine/configure-windows/configure-the-max-degree-of-parallelism-server-configuration-option.md#recommendations)
