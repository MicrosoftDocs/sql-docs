...
### Circular nature of the transaction log
 ...
 ![A diagram that illustrates how a physical log file is divided into virtual logs.](../relational-databases/media/tranlog3.png)  
...
![A diagram that illustrates how a logical transaction log wraps around in its physical log file.](../relational-databases/media/tranlog4.png)   
...
![A diagram that illustrates an end-of-a-transaction log with two active transactions and a compacted checkpoint record.](../relational-databases/media/active-log.png) 
