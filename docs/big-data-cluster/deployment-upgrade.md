...
1. Install the latest version of **mssqlctl**. The following commands install **mssqlctl** for CTP 3.2:

   **Windows:**

   ```powershell
   pip3 install -r  https://mcr.microsoft.com/python/ctp3.2/mssqlctl/requirements.txt
   ```
