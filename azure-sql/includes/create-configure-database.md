...
---
  ...
  || [Deployment template](/azure/azure-sql/database/single-database-create-arm-template-quickstart?view=azuresql) | [Deployment template](/azure/azure-sql/database/arm-templates-content-guide?tabs=managed-instance&view=azuresql) | [Deployment template](../virtual-machines/windows/create-sql-vm-resource-manager-template.md) | [Deployment template](/azure/synapse-analytics/quickstart-deployment-template-workspaces) | 
