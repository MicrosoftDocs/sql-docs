...
|System Stored Procedures|sp_db_increased_partitions|None. Support for increased partitions is available by default in [!INCLUDE[ssnoversion](../includes/ssnoversion-md.md)].|sp_db_increased_partitions|253|  
...
|Table compression|The use of the vardecimal storage format.|Vardecimal storage format is deprecated. [!INCLUDE[ssnoversion](../includes/ssnoversion-md.md)] data compression, compresses decimal values as well as other data types. We recommend that you use data compression instead of the vardecimal storage format.|Vardecimal storage format|200|  
