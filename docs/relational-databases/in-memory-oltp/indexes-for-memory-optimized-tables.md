...
- [Hash Indexes for Memory-Optimized Tables](../sql-server-index-design-guide.md#hash_index)
- [Nonclustered Indexes for Memory-Optimized Tables](../sql-server-index-design-guide.md#inmem_nonclustered_index)
