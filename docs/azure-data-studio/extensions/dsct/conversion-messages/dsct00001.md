...
1) Conversion of a certain statement isn't yet implemented in the Database Schema Conversion Toolkit
2) Conversion of statement cannot be automated because of lack of context
3) Conversion of statement cannot be automated because target platform doesn't provide similar functionality, and this functionality cannot be emulated
...
You may also consider reaching out to [dscthelp@microsoft.com](mailto:dscthelp@microsoft.com?subject=DSCT%20feedback), providing the snippet of the SQL statement that cannot be converted currently to help us prioritize future improvements.
