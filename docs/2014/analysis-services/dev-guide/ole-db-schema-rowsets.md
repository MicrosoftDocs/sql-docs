...
|[DBSCHEMA_COLUMNS Rowset](../../../2014/analysis-services/dev-guide/dbschema-columns-rowset.md) <sup>1</sup>|Provides column information for all columns meeting the provided restriction criteria.|  
...
|[DBSCHEMA_PROVIDER_TYPES Rowset](../../../2014/analysis-services/dev-guide/dbschema-provider-types-rowset.md) <sup>1</sup>|Identifies the (base) data types supported by the data provider.|  
