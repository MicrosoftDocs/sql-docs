...
|------------------|-------------|  
|Parent elements|[Queries](queries-element-xmla.md)|  
|Child elements|None|  
...
> [!NOTE]  
>  Some attributes are excluded from consideration in the dataset. For more information about excluded attributes, see [Properties (XMLA)](query-element-xmla.md).  
