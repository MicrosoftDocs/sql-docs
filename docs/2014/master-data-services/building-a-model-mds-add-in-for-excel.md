...
-   Create entities. For more information about entities, see [Entities &#40;Master Data Services&#41;](../../2014/master-data-services/entities-master-data-services.md).  
...
|Create an entity.|[!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] web application, web service, or the [!INCLUDE[ssMDSXLS](../includes/ssmdsxls-md.md)]|[Create an Entity &#40;MDS Add-in for Excel&#41;](../../2014/master-data-services/create-an-entity-mds-add-in-for-excel.md)|  
|Create a domain-based attribute.|[!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] web application, web service, or the [!INCLUDE[ssMDSXLS](../includes/ssmdsxls-md.md)]|[Create a Domain-based Attribute &#40;MDS Add-in for Excel&#41;](../../2014/master-data-services/create-a-domain-based-attribute-mds-add-in-for-excel.md)|  
...
|Create subscription views.|[!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] web application or web service|[Create a Subscription View &#40;Master Data Services&#41;](../../2014/master-data-services/create-a-subscription-view-master-data-services.md)|  
