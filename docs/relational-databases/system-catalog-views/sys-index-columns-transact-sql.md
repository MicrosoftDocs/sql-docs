...
|**column_store_order_ordinal**</br> Applies to: Azure Synapse Analytics and [!INCLUDE[sssql22-md](../../includes/sssql22-md.md)]|**tinyint**|Ordinal (1-based) within set of order columns in an ordered clustered columnstore index.|
