...
:::image type="content" source="../reporting-services/media/ssrs-webportal-powerbi-notification.png" alt-text="Screenshot of the notification dropdown list showing the message, 'We couldn't refresh some tiles in Power BI'.":::
