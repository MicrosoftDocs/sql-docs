...
<div id="main" class="v2">
    <div class="container">
        <ul class="cardsY panelContent featuredContent">
            ...
            <li>
                <a href="https://azure.microsoft.com/en-us/services/virtual-machines/sql-server/?wt.mc_id=sqL16_vm">
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                <div class="cardImageOuter">
    ...
    <div class="container">
        <h1 class="screenReader">Migrate to SQL Server</h1>
        <ul class="pivots">
            <li>
               <a href="#products">Concepts</a>
                <ul id="products">
                    <li>
                        <a data-default="true" href="#BusinessContinuity">Features</a>
                        <ul id="BusinessContinuity" class="cardsA">
                            <li>
                                <a href="/sql/database-engine/install-windows/installation-for-sql-server/">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Prepare to install SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Database Migration Assistant</h3>
                                                    <p>An assistant that facilitates the migration to SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
