...
-   Export all your data using a tool such as the [bcp Utility](../../database-engine/bcp-utility.md). For more information, see [Bulk Import and Export of Data &#40;SQL Server&#41;](../../database-engine/bulk-import-and-export-of-data-sql-server.md).  
