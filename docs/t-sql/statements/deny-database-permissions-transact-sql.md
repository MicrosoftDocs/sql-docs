...
|ALTER ANY DATABASE EVENT SESSION<br /> **Applies to**: [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)].|ALTER|ALTER ANY EVENT SESSION|
...
|ALTER ANY SECURITY POLICY<br /> **Applies to**: [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] and later, [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)].|CONTROL|CONTROL SERVER|
