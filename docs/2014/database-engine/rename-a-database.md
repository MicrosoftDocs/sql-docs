...
2.  Make sure that no one is using the database, and then [set the database to single-user mode](../../2014/database-engine/set-a-database-to-single-user-mode.md).  
