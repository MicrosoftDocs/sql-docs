...
[!INCLUDE[sssql16](../../includes/sssql15-md.md)] introduces support for [!INCLUDE[ssNoVer](../../includes/ssnoversion-md.md)] on Linux. For information, see [[!INCLUDE[sscurrent](../../includes/sssqlv14-md.md)] on Linux](../../linux/sql-server-linux-overview.md). 
