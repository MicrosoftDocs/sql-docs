...
## Parts  
 *object*  
 A [CInstance Class](../../../2014/database-engine/dev-guide/cinstance-class.md) object that represents a [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] client instance.  
