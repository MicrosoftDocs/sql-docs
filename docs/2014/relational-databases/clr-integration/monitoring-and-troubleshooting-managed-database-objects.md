...
## Profiler Trace Events  
 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] provides SQL Trace and event notifications to monitor events that occur in the Database Engine. By recording specified events, SQL Trace helps you troubleshoot performance, audit database activity, gather sample data for a test environment, debug [!INCLUDE[tsql](../../../includes/tsql-md.md)] statements and stored procedures, and gather data for performance analysis tools. For more information, see [SQL Trace](../../database-engine/sql-trace.md) and [Extended Events](../../database-engine/extended-events.md).  
...
|[SQL:BatchStarting Event Class](../../database-engine/sql-batchstarting-event-class.md), [SQL:BatchCompleted Event Class](../../database-engine/sql-batchcompleted-event-class.md)|Provides information about [!INCLUDE[tsql](../../../includes/tsql-md.md)] batches that have started or completed.|  
|[SP:Starting Event Class](../../database-engine/sp-starting-event-class.md), [SP:Completed Event Class](../../database-engine/sp-completed-event-class.md)|Used to monitor the execution of [!INCLUDE[tsql](../../../includes/tsql-md.md)] stored procedures.|  
|[SQL:StmtStarting Event Class](../../database-engine/sql-stmtstarting-event-class.md), [SQL:StmtCompleted Event Class](../../database-engine/sql-stmtcompleted-event-class.md)|Used to monitor the execution of CLR and [!INCLUDE[tsql](../../../includes/tsql-md.md)] routines.|  
