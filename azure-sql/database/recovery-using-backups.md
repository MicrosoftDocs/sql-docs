...
This article provides steps to recover any database from a backup in Azure SQL Database, including Hyperscale databases. For Azure SQL Managed Instance, see [Recovery using backups](../managed-instance/recovery-using-backups.md).
