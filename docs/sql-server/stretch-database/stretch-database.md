...
## What does Stretch Database do?  
 After you enable Stretch Database for a SQL Server instance, a database, and add at least one table, Stretch Database silently begins to migrate your cold data to Azure.  
