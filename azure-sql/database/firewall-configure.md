...
2. Choose the **Public Access** tab and then select **Add your client IPv4 Address** under **Firewall Rules** to add your client IP. Select **Add a firewall rule** to add additional rules. 
