...
> [!NOTE]  
>  For the step-by-step instructions that correspond to the information presented in this topic, see [Create a Dimension Using the Dimension Wizard](../../2014/analysis-services/create-a-dimension-using-the-dimension-wizard.md).  
...
>  If the dimension type and standard attribute types are not set when you create the dimension, use the Business Intelligence Wizard to set these values after you create the dimension. For more information, see [Add Dimension Intelligence to a Dimension](../../2014/analysis-services/add-dimension-intelligence-to-a-dimension.md) or (for an Accounts type dimension) [Add Account Intelligence to a Dimension](../../2014/analysis-services/add-account-intelligence-to-a-dimension.md).  
 ...
 For more information about dimension and attribute types, see [Dimension Types](../../2014/analysis-services/dev-guide/dimension-types.md), [Configure Attribute Types](../../2014/analysis-services/configure-attribute-types.md).  
