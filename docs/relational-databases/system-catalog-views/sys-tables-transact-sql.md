...
|is_external|**bit**|**Applies to**: [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] through [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] and [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]<br /><br /> Indicates table is an external table.<br /><br /> 0 = The table is not an external table.<br /><br /> 1 = The table is an external table.| 
