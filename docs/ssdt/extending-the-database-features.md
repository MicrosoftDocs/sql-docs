...
description: Learn how to extend database features. View information on custom test conditions, build and deployment contributors, and other feature extensions.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
...
-   [How to: Install and Manage Feature Extensions](../ssdt/how-to-install-and-manage-feature-extensions.md)  
