...
```  
 ...
 For more information about creating the initial Web service proxy, see [Creating the Web Service Proxy](../../../2014/reporting-services/dev-guide/creating-the-web-service-proxy.md).  
