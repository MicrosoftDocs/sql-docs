...
-   [Analysis Services Processing Task](../../2014/integration-services/analysis-services-processing-task.md)  
...
-   [Data Profiling Task](../../2014/integration-services/data-profiling-task.md)  
  
 **Data Flow Components**  
  
-   [CDC Flow Components](../../2014/integration-services/cdc-flow-components.md)  
...
-   [Data Mining Model Training Destination](../../2014/integration-services/data-mining-model-training-destination.md)  
...
-   parameterization and formatting features that are available in [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)].  
 ...
 [Retrieve Data from a Data Mining Model &#40;DMX&#41; &#40;SSRS&#41;](../../2014/reporting-services/retrieve-data-from-a-data-mining-model-dmx-ssrs.md)  
 ...
 For more information about using Reporting Services as the presentation layer for data sources, see [Integrating Reporting Services into Applications](../../2014/reporting-services/dev-guide/integrating-reporting-services-into-applications.md).  
 ...
 **A computer-assisted data cleansing process that analyzes source data and proposes changes.**  
 ...
 For more information, see [Data Cleansing](../../2014/data-quality-services/data-cleansing.md).  
 ...
 **A knowledge base that represents three types of knowledge: out-of-the-box knowledge, knowledge generated by the DQS server, and knowledge generated by the user.**  
 ...
 For more information, see [DQS Knowledge Bases and Domains](../../2014/data-quality-services/dqs-knowledge-bases-and-domains.md).  
...
##  <a name="bkmk_FTSetc"></a> Full-Text Search  
 ...
 For more information about how full-text queries interact with the full-text index, see [Query with Full-Text Search](../../2014/database-engine/query-with-full-text-search.md).  
 ...
 You can also create and build a user thesaurus to store synonyms and enable better search results, or categorization of terms. By developing a thesaurus tailored to your full-text data, you can effectively broaden the scope of full-text queries on that data. For more information, see [Configure and Manage Thesaurus Files for Full-Text Search](../../2014/database-engine/configure-and-manage-thesaurus-files-for-full-text-search.md).  
...
-   Return similarity scores, and the terms that contribute to the score.  
 ...
 For more information, see [Find Key Phrases in Documents with Semantic Search](../../2014/database-engine/find-key-phrases-in-documents-with-semantic-search.md) and [Find Similar and Related Documents with Semantic Search](../../2014/database-engine/find-similar-and-related-documents-with-semantic-search.md).  
  
 For more information about the database objects that support semantic indexing, see [Enable Semantic Search on Tables and Columns](../../2014/database-engine/enable-semantic-search-on-tables-and-columns.md).  
...
-   Not all of the full-text languages support semantic indexing. For a list of supported languages, see [sys.fulltext_semantic_languages &#40;Transact-SQL&#41;](../Topic/sys.fulltext_semantic_languages%20\(Transact-SQL\).md).  
