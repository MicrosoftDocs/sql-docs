...
# Source Element (Synchronize) (XMLA)
  Represents a source database from which to synchronize a target database during a [Synchronize](../../../2014/analysis-services/dev-guide/synchronize-element-xmla.md) command.  
