...
# Lesson 6: Create Calculated Columns
  In this lesson, you will create new data in your model by adding calculated columns. A calculated column is based on data that already exists in the model. To learn more, see [Calculated Columns &#40;SSAS Tabular&#41;](../../2014/analysis-services/calculated-columns-ssas-tabular.md).  
...
## Prerequisites  
 This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 5: Create Relationships](../../2014/tutorials/lesson-5-create-relationships.md).  
...
4.  In the formula bar above the table, type the following formula. AutoComplete helps you type the fully qualified names of columns and tables, and lists the functions that are available.  
    ...
    > [!NOTE]  
    >  If you receive an error, verify the column names in the formula match the column names you changed in [Lesson 3: Rename Columns](../../2014/tutorials/lesson-3-rename-columns.md).  
...
## Next Step  
 To continue this lesson, go to the next lesson: [Lesson 7: Create Measures](../../2014/tutorials/lesson-7-create-measures.md).  
