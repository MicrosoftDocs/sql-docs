...
3. After your operating system is running in the desired language, [install the SSMS language you want](download-sql-server-management-studio-ssms.md#available-languages-ssms-180-ga). The first time you install a new SSMS language, use the full package. You can use the upgrade package for subsequent installs.
