...
### [Enabling Always Encrypted in a PHP Application](enabling-always-encrypted-php-application.md)
### [Inserting and Modifying Data with Always Encrypted](inserting-data-always-encrypted.md)
### [Retrieving Data with Always Encrypted](retrieving-data-always-encrypted.md)
### [Always Encrypted: Limitations](always-encrypted-limitations.md)
