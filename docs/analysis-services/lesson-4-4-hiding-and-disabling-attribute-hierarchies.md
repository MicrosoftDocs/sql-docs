...
4.  In the Properties window, set the value of the **AttributeHierarchyEnabled** property to **False** for the selected attributes.  
    ...
    ![AttributeHierarchyEnabled property set to False](../analysis-services/media/l4-hierarchyenabled-1.gif "AttributeHierarchyEnabled property set to False")  
...
4.  In the Properties window, set the value of the **AttributeHierarchyVisible** property to **False** for the selected attributes.  
    ...
    ![AttributeHierarchyVisible property set to False](../analysis-services/media/l4-hierarchyvisible-1.gif "AttributeHierarchyVisible property set to False")  
