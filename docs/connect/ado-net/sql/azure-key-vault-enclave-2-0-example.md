---
description: "Example demonstrating use of Azure Key Vault provider v2.0+ with Always Encrypted enabled with Secure Enclaves"
title: "Example demonstrating use of Azure Key Vault provider v2.0+ with Always Encrypted enabled with Secure Enclaves | Microsoft Docs"
ms.custom: ""
ms.date: 03/03/2021
ms.prod: sql
...
# Example demonstrating use of Azure Key Vault provider v2.0+ with Always Encrypted enabled with Secure Enclaves
