...
# EventID Element (ASSL)
  Uniquely identifies an [Event](../../../2014/analysis-services/dev-guide/event-element-assl.md) element that is to be captured as part of a [Trace](../../../2014/analysis-services/dev-guide/trace-element-assl.md) element.  
...
|------------------|-------------|  
|Parent elements|[Event](../../../2014/analysis-services/dev-guide/event-element-assl.md)|  
|Child elements|None|  
