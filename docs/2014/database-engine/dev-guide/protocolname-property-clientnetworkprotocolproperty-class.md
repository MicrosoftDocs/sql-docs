...
---
# ProtocolName Property (ClientNetworkProtocolProperty Class)
  Gets the name of the protocol that owns the current property referenced by the [PropertyIdx Property (ClientNetworkProtocolProperty Class)](../../../2014/database-engine/dev-guide/propertyidx-property-clientnetworkprotocolproperty-class.md) value.  
