...
## In This Section  
 [User-Defined Type Requirements](../../../2014/database-engine/dev-guide/user-defined-type-requirements.md)  
 Describes the requirements for coding user-defined types.  
  
 [Coding User-Defined Types](../../../2014/database-engine/dev-guide/coding-user-defined-types.md)  
 Demonstrates coding techniques involved in creating user-defined types.  
  
## Example  
 The following code listing defines the Point UDT, which is described in detail in [Coding User-Defined Types](../../../2014/database-engine/dev-guide/coding-user-defined-types.md).  
