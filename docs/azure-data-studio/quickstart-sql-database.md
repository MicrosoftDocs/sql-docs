...
2. This article uses SQL sign-in, but for Azure SQL Database AAD Universal MFA authentication is also supported. Fill in the following fields using the server name, user name, and password for your Azure SQL server:
