...
# Design Database Diagrams (Visual Database Tools)
 ...
 ![Database diagram illustrating table relationships](../../2014/database-engine/media/dv3w7c1.gif "Database diagram illustrating table relationships")  
 ...
 **Title Bar** The title bar shows the name of the table  
 ...
 If you have modified a table and have not yet saved it, an asterisk (*) appears at the end of the table name to indicate unsaved changes. For information about saving modified tables and diagrams, see [Work with Database Diagrams &#40;Visual Database Tools&#41;](../../2014/database-engine/work-with-database-diagrams-visual-database-tools.md)  
  
 **Row Selector** You can click the row selector to select a database column in the table. The row selector displays a key symbol if the column is in the table's primary key. For information about primary keys, see [Primary and Foreign Key Constraints](../../2014/database-engine/primary-and-foreign-key-constraints.md).  
 ...
 **Property Columns** The set of property columns is visible only in the certain views of your table. You can view a table in any of five different views to help you manage the size and layout of your diagram.  
 ...
 For more information about table views, see [Customize the Amount of Information Displayed in Diagrams &#40;Visual Database Tools&#41;](../../2014/database-engine/customize-the-amount-of-information-displayed-in-diagrams-visual-database-tools.md).  
 ...
 **Related Tables** The relationship line indicates that a foreign-key relationship exists between one table and another. For a one-to-many relationship, the foreign-key table is the table near the line's figure-eight symbol. If both endpoints of the line attach to the same table, the relationship is a reflexive relationship. For more information, see [Draw Reflexive Relationships &#40;Visual Database Tools&#41;](../../2014/database-engine/draw-reflexive-relationships-visual-database-tools.md).  
...
## In this Section  
 ...
 [Navigate in Database Diagram Designer &#40;Visual Database Tools&#41;](../../2014/database-engine/navigate-in-database-diagram-designer-visual-database-tools.md)  
 ...
 [Open Database Diagram Designer &#40;Visual Database Tools&#41;](../../2014/database-engine/open-database-diagram-designer-visual-database-tools.md)  
