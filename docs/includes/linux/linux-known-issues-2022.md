...
ms.topic: include
---
The following sections describe known issues with [!INCLUDE[sssql22](../sssql22-md.md)] on Linux.
...
Although TLS 1.3 is supported on [!INCLUDE [sssql22-md](../sssql22-md.md)] for Windows, you must use TLS 1.2 on Linux.
