...
## SQLColAttribute Support for Enhanced Date and Time Features  
 For the values returned for date/time types, see the "Information Returned in IRD Fields" section in [Parameter and Result Metadata](../../../2014/database-engine/dev-guide/parameter-and-result-metadata.md).  
...
## SQLColAttribute Support for Large CLR UDTs  
 `SQLColAttribute` supports large CLR user-defined types (UDTs). For more information, see [Large CLR User-Defined Types &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/large-clr-user-defined-types-odbc.md).  
...
## SQLColAttribute Support for Sparse Columns  
 ...
 For more information, see [Sparse Columns Support &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/sparse-columns-support-odbc.md).  
