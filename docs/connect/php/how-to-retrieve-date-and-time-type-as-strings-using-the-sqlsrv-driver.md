...
This feature was added in version 1.1 of the [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)] and is only valid when using the SQLSRV driver for the [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)]. It is an error to use the ReturnDatesAsStrings connection option with the PDO_SQLSRV driver.  
