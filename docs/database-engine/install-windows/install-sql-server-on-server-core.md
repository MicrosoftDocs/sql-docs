...
|Integration Services Server|Yes|For more information about the new Integration Services Server and its features in [!INCLUDE[ssCurrent](/sql-docs/docs/integration-services/what-s-new-in-integration-services-in-sql-server-2016).|  
