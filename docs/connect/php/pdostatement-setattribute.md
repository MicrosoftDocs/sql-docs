...
|PDO::SQLSRV_ATTR_QUERY_TIMEOUT|Integer|Sets the query timeout in seconds.<br /><br />By default, the driver waits indefinitely for results. Negative numbers are not allowed.<br /><br />0 means no timeout.|  
