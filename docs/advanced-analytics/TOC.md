...
### [Create multiple micro models using rxExecBy](r/creating-multiple-models-using-rxexecby.md)
### [Create multiple models based on partitions](r/create-models-per-partition.md)
