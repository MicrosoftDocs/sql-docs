...
> [!NOTE]
> For content related to previous versions of [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], see [Reorganize and Rebuild Indexes](https://msdn.microsoft.com/en-US/library/ms189858(SQL.120).aspx).
