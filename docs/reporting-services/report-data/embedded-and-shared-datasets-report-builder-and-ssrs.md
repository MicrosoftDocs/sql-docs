...
description: Learn about embedded and shared datasets. Datasets contain contains a query command, parameters, and data options that include case sensitivity and collation. 
ms.date: 03/01/2017
