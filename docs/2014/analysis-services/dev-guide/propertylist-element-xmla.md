...
# PropertyList Element (XMLA)
  Contains a collection of XML for Analysis (XMLA) properties used by the [Discover](../../../2014/analysis-services/dev-guide/discover-method-xmla.md) and [Execute](../../../2014/analysis-services/dev-guide/execute-method-xmla.md) methods.  
...
|------------------|-------------|  
|Parent elements|[Properties](../../../2014/analysis-services/dev-guide/properties-element-xmla.md)|  
