...
-   At least one attribute group must exist. For more information, see [Create an Attribute Group &#40;Master Data Services&#41;](../../2014/master-data-services/create-an-attribute-group-master-data-services.md).  
...
5.  Click the plus sign to expand **Leaf Groups**, **Consolidated Groups**, or **Collection Groups**, depending on the type of group you want to make visible.  
  
6.  Click the plus sign to expand the group you want to make visible.  
  
7.  Click either **Users** or **Groups**, depending on whether you are making the group visible to a user or a group.  
  
8.  Click **Edit selected item**.  
  
9. Click users or groups in the **Available** box and click the **Add** arrow. To add all, click the **Add All** arrow.  
