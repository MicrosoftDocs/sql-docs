...
|**HTML 4.0** (part of the HTML rendering extension)|HTML is the format used to initially render the report. If your browser supports HTML 4.0, that is the format that is used. Otherwise, HTML 3.2 is used.|  
