...
## Prerequisites  
 This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 2: Add Data](../../2014/tutorials/lesson-2-add-data.md).  
...
## Next Step  
 To continue this tutorial, go to the next lesson: [Lesson 4: Mark as Date Table](../../2014/tutorials/lesson-4-mark-as-date-table.md).  
