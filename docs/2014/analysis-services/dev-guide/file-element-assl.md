...
---
# File Element (ASSL)
  Defines one of the files that compose a [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] [ClrAssembly](../../../2014/analysis-services/dev-guide/clrassembly-data-type-assl.md) element.  
...
|--------------------|-----------------|  
|Data type and length|[ClrAssemblyFile](../../../2014/analysis-services/dev-guide/clrassemblyfile-data-type-assl.md)|  
|Default value|None|  
...
|------------------|-------------|  
|Parent elements|[Files](../../../2014/analysis-services/dev-guide/files-element-assl.md)|  
|Child elements|None|  
