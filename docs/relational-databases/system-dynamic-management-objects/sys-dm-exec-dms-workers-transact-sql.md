...
|step_index|`int`|Query step this DMS worker is part of.|See step index in [sys.dm_exec_distributed_request_steps &#40;Transact-SQL&#41;](sys-dm-exec-distributed-request-steps-transact-sql.md).|  
|dms_step_index|`int`|Step in the DMS plan that this worker is running.|See [sys.dm_exec_dms_workers (Transact-SQL)](sys-dm-exec-dms-workers-transact-sql.md)|  
|compute_node_id|`int`|Node that the worker is running on.|See [sys.dm_exec_compute_nodes &#40;Transact-SQL&#41;](sys-dm-exec-compute-nodes-transact-sql.md).|  
|distribution_id|`int`|||  
