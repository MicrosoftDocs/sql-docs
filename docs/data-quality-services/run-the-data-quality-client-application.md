...
1.  Click **Start**, point to **All Programs**, click **[!INCLUDE[ssnoversion](../includes/ssnoversion-md.md)]**, click **Data Quality Services**, and then click **Data Quality Client**.  
