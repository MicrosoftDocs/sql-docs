...
- Existing tables in a database that aren't ledger tables can't be converted to ledger tables. See [Migrate data from regular tables to ledger tables](ledger-how-to-convert-regular-tables-into-ledger-tables.md).
