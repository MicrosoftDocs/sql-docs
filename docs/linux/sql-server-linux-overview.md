...
SQL Server now runs on Linux! This latest release, SQL Server 2017 CTP 2.1, runs on Linux and is in
...
## See Also
- [Summary of what's new in the current release of SQL Server 2017](https://msdn.microsoft.com/library/mt788653(SQL.130).aspx)
