...
|------------------|--------------|  
|**Parent element**|[TuningOptions Element &#40;DTA&#41;](../../2014/database-engine/tuningoptions-element-dta.md)|  
|**Child elements**|None|  
...
## Example  
 For a usage example, see the [XML Input File Sample with Inline Workload &#40;DTA&#41;](../../2014/database-engine/xml-input-file-sample-with-inline-workload-dta.md).  
