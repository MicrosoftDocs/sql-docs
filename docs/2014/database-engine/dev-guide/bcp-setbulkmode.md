...
## Remarks  
 ...
 bcp_setbulkmode is an alternative to using [bcp_setcolfmt](../../../2014/database-engine/dev-guide/bcp-setcolfmt.md) and [bcp_columns](../../../2014/database-engine/dev-guide/bcp-columns.md), which only let you specify the format of one column per function call.  
