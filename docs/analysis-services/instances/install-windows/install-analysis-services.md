...
# Install Analysis Services
  [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] is an analytical database server that hosts Tabular models, multidimensional cubes, and data mining models that you can access from reports, spreadsheets, and dashboards.  
  
 [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] is multi-instance, which means that you can install more than one copy of [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] on a single computer, or run new and old versions  side-by-side. Any instance you install runs in one of three modes, as determined during setup: Multidimensional and Data Mining, Tabular, or SharePoint. If you want to use multiple modes, you'll need a separate instance for each one.  
