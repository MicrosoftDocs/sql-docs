...
description: Create tables, matrices, charts, and images to be published as separate report parts available for reuse in other paginated reports in Report Builder.
ms.date: 03/14/2017
