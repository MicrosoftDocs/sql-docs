...
9. Choose classifications.  
    ...
    ![Choose classifications](./media/configure-windows-server-update-services-wsus/sql_server_pdw_wsus_choose_classifications.png "sql_server_pdw_wsus_choose_classifications")  
