...
description: After you import data into SQL Server Mobile Report Publisher, mobile report creation and design is the same, whether data is from Excel files shared datasets.
ms.date: 02/08/2016
