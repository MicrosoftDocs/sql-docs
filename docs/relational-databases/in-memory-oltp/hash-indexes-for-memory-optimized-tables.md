...
- The bucket count should not be significantly lower than the number of unique index key values, as this affects most DML operations as well the time it takes to recover the database after server restart.  
