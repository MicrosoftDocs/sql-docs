...
-   Execute Transact-SQL scripts before or after the snapshot is applied. For more information, see [Execute Scripts Before and After the Snapshot Is Applied](snapshot-options.md#snapshot-options.md#execute-scripts-before-and-after-snapshot-is-applied.md).  
