...
-  Automated backup uses [backup compression](view-or-configure-the-backup-compression-default-server-configuration-option.md) by default and you cannot disable it.
