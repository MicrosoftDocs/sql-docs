...
|**Description**|**Topic**|  
|---------------------|---------------|  
|Describes how to incorporate the code from a template into a code editor window.|[Open a Template](../../2014/database-engine/open-a-template.md)|  
|Describes how to replace template parameter values after opening a template in a code editor.|[Replace Template Parameters](../../2014/database-engine/replace-template-parameters.md)|  
