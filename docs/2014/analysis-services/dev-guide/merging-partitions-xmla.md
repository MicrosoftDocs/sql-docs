...
---
# Merging Partitions (XMLA)
  If partitions have the same aggregation design and structure, you can merge the partition by using the [MergePartitions](../../../2014/analysis-services/dev-guide/mergepartitions-element-xmla.md) command in XML for Analysis (XMLA). Merging partitions is an important action to perform when you manage partitions, especially those partitions that contain historical data partitioned by date.  
...
## Specifying Partitions to Merge  
 When the `MergePartitions` command runs, the aggregation data stored in the source partitions specified in the [Source](../../../2014/analysis-services/dev-guide/source-element-xmla.md) property is added to the target partition specified in the [Target](../../../2014/analysis-services/dev-guide/target-element-xmla.md) property.  
