...
> [!NOTE]  
>  For this release of [!INCLUDE[ssnoversion](../../../includes/ssnoversion-md.md)], information about possible causes and solutions is located at [WSFC cluster service is offline](https://go.microsoft.com/fwlink/p/?LinkId=220849) on the TechNet Wiki.  
