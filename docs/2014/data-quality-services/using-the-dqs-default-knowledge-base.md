...
-   Use it in the [DQS Cleansing component in Integration Services](http://go.microsoft.com/fwlink/?LinkId=238830) and [Master Data Services Add-in for Excel](../../2014/master-data-services/data-quality-matching-in-the-mds-add-in-for-excel.md).  
