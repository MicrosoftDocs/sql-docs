...
We strongly encourage customers to move away from relying on **any individual Gateway IP address** (since these will be retired in the future). Instead allow network traffic to reach **all** the individual Gateway IP addresses and Gateway IP address subnets in a region region.
