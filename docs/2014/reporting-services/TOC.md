...
#### [Start Report Builder](start-report-builder-report-builder.md)
...
##### [Report Parameters](report-parameters-concept-report-builder-and-ssrs.md)
#### [Finding, Viewing, and Managing Reports](finding-viewing-and-managing-reports-report-builder-and-ssrs.md)
##### [Finding and Viewing Reports in Report Manager](finding-and-viewing-reports-in-report-manager-report-builder-and-ssrs.md)
...
#### [Add Data to a Report](add-data-to-a-report-report-builder-and-ssrs.md)
...
##### [Add and Verify a Data Connection or Data Source](add-and-verify-a-data-connection-or-data-source-report-builder-and-ssrs.md)
##### [Convert a Data Source from Embedded to Shared](convert-a-data-source-from-embedded-to-shared-report-builder-and-ssrs.md)
#### [Tables, Matrices, and Lists](tables-matrices-and-lists-report-builder-and-ssrs.md)
##### [Tables](tables-report-builder-and-ssrs.md)
##### [Matrices](matrices-report-builder-and-ssrs.md)
...
##### [Set Parameters on a Published Report](set-parameters-published-report-reporting-services-sharepoint-integrated-mode.md)
...
###### [Aggregate Functions Reference](aggregate-functions-reference-report-builder-and-ssrs.md)
####### [Aggregate Function](aggregate-function-report-builder-and-ssrs.md)
####### [Avg Function](avg-function-report-builder-and-ssrs.md)
####### [Count Function](count-function-report-builder-and-ssrs.md)
####### [CountDistinct Function](countdistinct-function-report-builder-and-ssrs.md)
####### [CountRows Function](countrows-function-report-builder-and-ssrs.md)
####### [First Function](first-function-report-builder-and-ssrs.md)
####### [InScope Function](inscope-function-report-builder-and-ssrs.md)
####### [Last Function](last-function-report-builder-and-ssrs.md)
####### [Level Function](level-function-report-builder-and-ssrs.md)
####### [Lookup Function](lookup-function-report-builder-and-ssrs.md)
####### [LookupSet Function](lookupset-function-report-builder-and-ssrs.md)
####### [Max Function](max-function-report-builder-and-ssrs.md)
####### [Min Function](min-function-report-builder-and-ssrs.md)
####### [Multilookup Function](multilookup-function-report-builder-and-ssrs.md)
####### [Previous Function](previous-function-report-builder-and-ssrs.md)
####### [RowNumber Function](rownumber-function-report-builder-and-ssrs.md)
####### [RunningValue Function](runningvalue-function-report-builder-and-ssrs.md)
####### [StDev Function](stdev-function-report-builder-and-ssrs.md)
####### [StDevP Function](stdevp-function-report-builder-and-ssrs.md)
####### [Sum Function](sum-function-report-builder-and-ssrs.md)
####### [Union Function](union-function-report-builder-and-ssrs.md)
####### [Var Function](var-function-report-builder-and-ssrs.md)
####### [VarP Function](varp-function-report-builder-and-ssrs.md)
...
###### [Built-in Collections in Expressions](built-in-collections-in-expressions-report-builder-and-ssrs.md)
####### [Built-in Globals and Users References](built-in-globals-and-users-references-report-builder-and-ssrs.md)
####### [Parameters Collection References](parameters-collection-references-report-builder-and-ssrs.md)
####### [Dataset Fields Collection References](dataset-fields-collection-references-report-builder-and-ssrs.md)
####### [DataSources and DataSets Collection References](datasources-and-datasets-collection-references-report-builder-and-ssrs.md)
####### [Report and Group Variables Collections References](report-and-group-variables-collections-references-report-builder-and-ssrs.md)
####### [ReportItems Collection References](reportitems-collection-references-report-builder-and-ssrs.md)
...
#### [Exporting Reports](exporting-reports-report-builder-and-ssrs.md)
...
##### [Install the Stand-Alone Version of Report Builder](install-the-stand-alone-version-of-report-builder-report-builder.md)
##### [Uninstall the Stand-Alone Version of Report Builder](uninstall-the-stand-alone-version-of-report-builder-report-builder.md)
...
##### [Report Builder Options Dialog Box, Settings](report-builder-options-dialog-box-settings-report-builder.md)
...
###### [PowerPivot Connection Type](powerpivot-connection-type-ssrs.md)
...
###### [Query Design Tools in Report Designer in SQL Server Data Tools](query-design-tools-in-report-designer-sql-server-data-tools-ssrs.md)
