...
**mssql-conf** is a configuration script that installs with SQL Server vNext CTP 1.1 for both Red Hat Enterprise Linux and Ubuntu. You can use this utility to set the following parameters:
