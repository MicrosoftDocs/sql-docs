...
# ImpersonationMode Element (ASSL)
  Contains a value that indicates the method of impersonation for elements that are derived from the [ImpersonationInfo](../../../2014/analysis-services/dev-guide/impersonationinfo-data-type-assl.md) data type.  
