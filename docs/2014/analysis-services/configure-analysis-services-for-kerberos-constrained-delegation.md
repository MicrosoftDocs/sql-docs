...
-   Verify the SPN registered for Analysis Services is valid. For instructions, see [SPN registration for an Analysis Services instance](../../2014/analysis-services/spn-registration-for-an-analysis-services-instance.md)  
