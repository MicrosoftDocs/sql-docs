                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>BCP</h3>
                                                    <p>Bulk copy data between a data file, in a format that you specify, and your SQL database.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Use the wizard as a simple way to copy data from a flat file (.csv, .txt) into your SQL database. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Use the Wizard as a simple way to copy data from a wide variety of sources into your SQL database. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
