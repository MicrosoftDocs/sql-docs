...
## Behavior Changes in Full-Text Search in [!INCLUDE[ssSQL11](../includes/sssql11-md.md)]  
 [!INCLUDE[ssSQL11](../includes/sssql11-md.md)] installs a new version of the word breakers and stemmers for US English (LCID 1033) and UK English (LCID 2057). However you can switch to the previous version of these components if you want to retain the previous behavior. For more information, see [Change the Word Breaker Used for US English and UK English](../../2014/database-engine/change-the-word-breaker-used-for-us-english-and-uk-english.md).  
...
1.  There are new word breakers for English. If you have to retain the previous behavior, see [Change the Word Breaker Used for US English and UK English](../../2014/database-engine/change-the-word-breaker-used-for-us-english-and-uk-english.md).  
...
-   [Change the Word Breaker Used for US English and UK English](../../2014/database-engine/change-the-word-breaker-used-for-us-english-and-uk-english.md)  
...
## See Also  
 ...
 [Upgrade Full-Text Search](../../2014/database-engine/upgrade-full-text-search.md)   
