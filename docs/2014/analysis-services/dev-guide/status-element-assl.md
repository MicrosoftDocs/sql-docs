...
---
# Status Element (ASSL)
  Contains a Multidimensional Expressions (MDX) expression that returns a status indicator for a [Kpi](../../../2014/analysis-services/dev-guide/kpi-element-assl.md) element.  
...
|------------------|-------------|  
|Parent element|[Kpi](../../../2014/analysis-services/dev-guide/kpi-element-assl.md)|  
|Child elements|None|  
