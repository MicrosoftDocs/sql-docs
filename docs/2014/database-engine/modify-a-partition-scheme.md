 ...
 **To modify a partition scheme:**  
 ...
 This specific action cannot be performed using [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]. In order to modify a partition scheme, you must first delete the scheme and then create a new one with the desired properties using the Create Partition Wizard. For more information, see [Create Partitioned Tables and Indexes](../relational-databases/indexes/indexes.md)[Using SQL Server Management Studio](../relational-databases/indexes/indexes.md#SSMSProcedure) under **Create Partitioned Tables and Indexes**.  
