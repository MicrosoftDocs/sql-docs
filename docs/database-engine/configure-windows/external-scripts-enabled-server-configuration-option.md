...
For more information, see [Set up SQL Server Machine Learning](../../machine-learning/r/set-up-sql-server-r-services-in-database.md).
...
[SQL Server Machine Learning Services](../../machine-learning/r/sql-server-r-services.md)
