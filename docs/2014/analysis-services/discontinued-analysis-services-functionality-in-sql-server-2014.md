...
|--------------|------------------------|-----------------|  
|Local cubes|InsertInto connection string property|Original connection string syntax for populating local cubes is replaced by the Create Global Cube statement. For more information, see [CREATE GLOBAL CUBE Statement  &#40;MDX&#41;](../Topic/CREATE%20GLOBAL%20CUBE%20Statement%20%20\(MDX\).md).|  
|Local cubes|CreateCube connection string property|Original connection string syntax for populating local cubes is replaced by the Create Global Cube statement. For more information, see [CREATE GLOBAL CUBE Statement  &#40;MDX&#41;](../Topic/CREATE%20GLOBAL%20CUBE%20Statement%20%20\(MDX\).md).|  
