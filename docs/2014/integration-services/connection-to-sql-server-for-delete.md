...
## See Also  
 [SQL Server Connection Required Permissions for the CDC Service](../../2014/integration-services/sql-server-connection-required-permissions-for-the-cdc-service.md)  
