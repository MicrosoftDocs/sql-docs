---
title: "Report Server Execution Log and the ExecutionLog3 View | Microsoft Docs"
ms.custom: ""
ms.date: "06/13/2017"
...
# Report Server Execution Log and the ExecutionLog3 View
 ...
 Report servers configured for SharePoint mode, can also utilize the SharePoint ULS logs. For more information, see [Turn on Reporting Services events for the SharePoint trace log &#40;ULS&#41;](../../2014/reporting-services/turn-on-reporting-services-events-for-the-sharepoint-trace-log-uls.md)  
...
|RequestType|Possible Values:<br />**Interactive**<br />**Subscription**<br /><br /> <br /><br /> Analyzing log data filtered by RequestType=Subscription and sorted by TimeStart may reveal periods of heavy subscription usage and you may want to modify some of the report subscriptions to a different time.|  
...
##  <a name="bkmk_additionalinfo"></a> The AdditionalInfo Field  
 ...
 The following tables are examples  of the contents of the AddtionalInfo field for both standard and verbose logging:  
...
## See Also  
 [Turn on Reporting Services events for the SharePoint trace log &#40;ULS&#41;](../../2014/reporting-services/turn-on-reporting-services-events-for-the-sharepoint-trace-log-uls.md)   
