...
> [!NOTE]
> This feature is available starting from SQL Server BDC CU13 release, the following steps are required to perform if you're currently on BDC prevous versions:
