...
> [!NOTE]  
>  If the file paths are identical on every server instance that hosts an availability replica for an availability group, the [New Availability Group Wizard](../../2014/database-engine/use-the-availability-group-wizard-sql-server-management-studio.md), [Add Replica to Availability Group Wizard](../../2014/database-engine/use-the-add-replica-to-availability-group-wizard-sql-server-management-studio.md), or [Add Database to Availability Group Wizard](../../2014/database-engine/use-the-add-database-to-availability-group-wizard-sql-server-management-studio.md) might be able to automatically start data synchronization for you.  
...
-   [Use the Add Replica to Availability Group Wizard &#40;SQL Server Management Studio&#41;](../../2014/database-engine/use-the-add-replica-to-availability-group-wizard-sql-server-management-studio.md)  
  
-   [Use the Add Database to Availability Group Wizard &#40;SQL Server Management Studio&#41;](../../2014/database-engine/use-the-add-database-to-availability-group-wizard-sql-server-management-studio.md)  
