...
# Tasks and Permissions
 ...
 ![Permissions and task diagram](../../2014/reporting-services/media/report-securityobjects.gif "Permissions and task diagram")  
...
|--------------|-----------------|  
|[Item-Level Tasks](../../2014/reporting-services/item-level-tasks.md)|Actions that are performed on items managed by a report server, such as folders, reports, report models, and resources.<br /><br /> Item-level tasks are scoped to the report server folder namespace. All items that you access through the folders on a report server or through URL access are secured by role assignments that include item-level tasks.|  
|[System-Level Tasks](../../2014/reporting-services/system-level-tasks.md)|Actions that are performed at the system level, such as managing jobs or shared schedules that can be used with many items. System-level tasks are scoped outside of the report server folder namespace.|  
