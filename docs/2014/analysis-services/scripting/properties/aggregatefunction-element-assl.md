...
# AggregateFunction Element (ASSL)
  Defines the type of aggregate function used by a [Measure](../../dev-guide/measure-element-assl.md) element.  
...
|------------------|-------------|  
|Parent elements|[Measure](../../dev-guide/measure-element-assl.md)|  
|Child elements|None|  
