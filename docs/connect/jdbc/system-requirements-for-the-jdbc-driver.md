...
## Java Runtime Environment requirements  
 ...
 As of Microsoft JDBC Driver 13.6 for SQL Server, the driver supports Java Development Kit (JDK) 26.0 and Java Runtime Environment (JRE) 26.0.
...
The JDBC Driver 13.6 includes two JAR class libraries in each installation package: **mssql-jdbc-13.6.0.jre8.jar** and **mssql-jdbc-13.6.0.jre11.jar**.

The JDBC Driver 13.6 is designed to work with, and supports all major Java virtual machines, but is tested only on OpenJDK 1.8, OpenJDK 11.0, OpenJDK 17.0, OpenJDK 21.0, OpenJDK 25.0, OpenJDK 26.0, Azul Zulu JRE 1.8, Azul Zulu JRE 11.0, and Azul Zulu JRE 17.0.

The following chart summarizes support provided by the two JAR files included with Microsoft JDBC Drivers 13.6 for SQL Server:

| JAR | JDBC Version Compliance | Recommended Java Version | Description |  
|---------|-----------------------------|----------------------|-----------------|  
|mssql-jdbc-13.6.0.jre8.jar|4.2|8|Requires a Java Runtime Environment (JRE) 1.8. Using JRE 1.7 or lower throws an exception. |
|mssql-jdbc-13.6.0.jre11.jar|4.3 (partially)|26|Requires a Java Runtime Environment (JRE) 11.0 or higher. Using JRE 10.0 or lower throws an exception. |

The JDBC Driver 13.6 is available on the Maven Central Repository, and you can add it to a Maven project by including the following code in the POM.XML:
...
|mssql-jdbc-13.4.0.jre11.jar|4.3 (partially)|25|Requires a Java Runtime Environment (JRE) 11.0 or higher. Using JRE 10.0 or lower throws an exception. |
...
**Microsoft JDBC Driver 8.2 for SQL Server:**  
  ...
  |JAR|JDBC Version Compliance|Recommended Java Version|Description|  
|---------|-----------------------------|----------------------|-----------------|  
|mssql-jdbc-8.2.2.jre8.jar|4.2|8|Requires a Java Runtime Environment (JRE) 1.8. Using JRE 1.7 or lower throws an exception.<br /><br /> New Features in 8.2 include: JDK 13 support, Always Encrypted with secure enclaves, and temporal data type performance improvements. |
|mssql-jdbc-8.2.2.jre11.jar|4.3|11|Requires a Java Runtime Environment (JRE) 11.0. Using JRE 10.0 or lower throws an exception.<br /><br /> New Features in 8.2 include: JDK 13 support, Always Encrypted with secure enclaves, and temporal data type performance improvements. |
|mssql-jdbc-8.2.2.jre13.jar|4.3|13|Requires a Java Runtime Environment (JRE) 13.0. Using JRE 11.0 or lower throws an exception.<br /><br /> New Features in 8.2 include: JDK 13 support, Always Encrypted with secure enclaves, and temporal data type performance improvements. |
