...
| **Migrate log to Ultra Disk** | Learn how you can [migrate your log file to an Ultra Disk](storage-migrate-to-ultradisk.md) to use high performance and low latency. | 
