...
|InstanceDefaultBackupPath|**Applies to**:  [!INCLUDE[ssSQL2019](../../includes/sssqlv15-md.md)] and later.<br /><br /> Name of the default path to the instance backup files.|  
...
|IsPolyBaseInstalled|**Applies to**: [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)].<br /><br /> Returns whether the server instance has the PolyBase feature installed.<br /><br /> 0 = PolyBase is not installed.<br /><br /> 1 = PolyBase is installed.<br /><br /> Base data type: **int**|  
