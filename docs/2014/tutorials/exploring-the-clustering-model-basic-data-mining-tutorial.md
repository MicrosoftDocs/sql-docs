...
> [!NOTE]  
>  Unless you set an initial value for **holdoutseed**, results will vary each time you process the model. For more information, see [HoldoutSeed Element](https://docs.microsoft.com/analysis-services/assl/properties/holdoutseed-element?view=asallproducts-allversions)  
