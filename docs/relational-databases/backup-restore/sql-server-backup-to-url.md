...
Supported format for URL: [Storage Account URL]/[Container] (Container paths with folders are not supported.)
...
Supported format for Credential: [Storage Account URL]/[Container] (Container paths with folders are not supported.)
