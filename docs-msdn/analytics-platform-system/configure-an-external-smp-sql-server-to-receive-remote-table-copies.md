...
1.  Follow best practices as documented in SQL Server product documentation. For example, enable data encryption. For more information about securing SQL Server, see [Securing SQL Server](https://docs.microsoft.com/sql/relational-databases/security/securing-sql-server) on MSDN.  
