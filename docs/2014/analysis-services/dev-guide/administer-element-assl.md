...
# Administer Element (ASSL)
  Indicates whether the associated permission includes the right to administer a [Database](../../../2014/analysis-services/dev-guide/database-element-assl.md) element.  
...
|------------------|-------------|  
|Parent elements|[DatabasePermission](../../../2014/analysis-services/dev-guide/databasepermission-element-assl.md)|  
|Child elements|None|  
