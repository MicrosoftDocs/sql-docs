...
|SQLDmp\<guid>.mdmp files|Crashes and exceptions|Deep troubleshooting|No|  
 ...
 We highly recommend the following link for additional information resources not covered in this topic: [Initial data collection tips from Microsoft Support](https://docs.microsoft.com/archive/blogs/as_emea/data-collection-for-troubleshooting-analysis-services-issues).  
...
-   Review this blog post from Microsoft Customer Support to learn what resources they use to get information about server operations: [Initial Data Collection](https://docs.microsoft.com/archive/blogs/as_emea/data-collection-for-troubleshooting-analysis-services-issues)  
