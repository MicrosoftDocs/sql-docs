...
[Options (Text Editor/Editor Tab and Status Bar Page)](https://docs.microsoft.com/sql/ssms/f1-help/database-engine-query-editor-sql-server-management-studio)  
