...
|----------------|-----------------|  
|**Read-only**|The entity is displayed but the user cannot add, remove, or change members.|  
|**Update**|The entity is displayed and the user can add, remove, and change members.|  
