...
description: RDL sandboxing you can detect and restrict the usage of types of resources by tenants where multiple tenants use a single web farm of report servers.
ms.date: 09/25/2017
