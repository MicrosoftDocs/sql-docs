...
|percent_complete|**int**|Percentage of operation that has completed. Values are integer and continuous and indicate completion status of the operation. Not NULL.<br/><br/>0 = Operation not started<br/>1 to 99 = Operation in progress and indicates completion status of the operation in percentage<br/>100 = Operation complete|  
