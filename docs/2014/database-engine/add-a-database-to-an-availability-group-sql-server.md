...
3.  Right-click the availability group, and select one of the following commands:  
    ...
    -   To launch the Add Database to Availability Group Wizard, select the **Add Database** command. For more information, see [Use the Add Database to Availability Group Wizard &#40;SQL Server Management Studio&#41;](../../2014/database-engine/use-the-add-database-to-availability-group-wizard-sql-server-management-studio.md).  
    ...
    -   To add one or more databases by specifying them in the **Availability Group Properties** dialog box, select the **Properties** command. The steps for adding a database are as follows:  
        ...
        2.  Enter the name of a database that meets the availability-databases prerequisites.  
         ...
         After you use the **Availability Group Properties** dialog box to add a database to an availability group, you need to configure the corresponding secondary database on each server instance that hosts a secondary replica. For more information, see [Start Data Movement on an AlwaysOn Secondary Database &#40;SQL Server&#41;](../../2014/database-engine/start-data-movement-on-an-alwayson-secondary-database-sql-server.md).  
...
3.  After you add a database to an availability group, you need to configure the corresponding secondary database on each server instance that hosts a secondary replica. For more information, see [Start Data Movement on an AlwaysOn Secondary Database &#40;SQL Server&#41;](../../2014/database-engine/start-data-movement-on-an-alwayson-secondary-database-sql-server.md).  
