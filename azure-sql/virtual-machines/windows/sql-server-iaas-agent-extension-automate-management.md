...
- SQL Server images. The SQL IaaS Agent extension is not supported with the following images: SQL Server Reporting Services, SQL Server Power BI Report Server, SQL Server Analysis Services. 
