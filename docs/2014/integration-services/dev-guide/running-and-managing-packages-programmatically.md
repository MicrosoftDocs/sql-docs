...
## In This Section  
 ...
 [Loading and Running a Local Package Programmatically](../../../2014/integration-services/dev-guide/loading-and-running-a-local-package-programmatically.md)  
 Describes how to execute an existing package from a client application on the local computer.  
  
 [Loading and Running a Remote Package Programmatically](../../../2014/integration-services/dev-guide/loading-and-running-a-remote-package-programmatically.md)  
 Describes how to execute an existing package from a client application and to ensure that the package runs on the server.  
  
 [Loading the Output of a Local Package](../../../2014/integration-services/dev-guide/loading-the-output-of-a-local-package.md)  
 ...
 [Managing Running Packages Programmatically](../../../2014/integration-services/dev-guide/managing-running-packages-programmatically.md)  
 Describes how to list packages that are currently running, examine their properties, and stop a running package.  
  
 [Managing Package Roles Programmatically &#40;SSIS Service&#41;](../../../2014/integration-services/dev-guide/managing-package-roles-programmatically-ssis-service.md)  
