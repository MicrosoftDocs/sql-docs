...
|Traditional model|Contained database user model|
|-----------------------|-----------------------------------|
|To change password, in the context of the master database:<br /><br /> `ALTER LOGIN login_name  WITH PASSWORD = 'strong_password';`|To change password, in the context of the user database:<br /><br /> `ALTER USER user_name  WITH PASSWORD = 'strong_password';`|
