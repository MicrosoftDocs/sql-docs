...
description: Learn details about device information settings for the Atom rendering extension that supports submittal of the Atom feed name and character encoding to use.
ms.date: 03/16/2017
