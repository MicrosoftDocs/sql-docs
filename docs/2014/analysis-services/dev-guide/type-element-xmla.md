...
---
# Type Element (XMLA)
  Determines the type of processing to be performed by the [Process](../../../2014/analysis-services/dev-guide/process-element-xmla.md) element.  
...
|------------------|-------------|  
|Parent elements|[Process](../../../2014/analysis-services/dev-guide/process-element-xmla.md)|  
|Child elements|None|  
