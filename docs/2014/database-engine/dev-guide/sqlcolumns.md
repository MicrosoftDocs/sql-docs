...
|SS_UDT_ASSEMBLY_TYPE_NAME|The assembly-qualified name of the UDT.|  
 ...
 For UDTs, the existing TYPE_NAME column is used to indicate the name of the UDT; therefore no additional column for it should be added to the result set of `SQLColumns` or [SQLProcedureColumns](../../../2014/database-engine/dev-guide/sqlprocedurecolumns.md). The DATA_TYPE for a UDT column or parameter is SQL_SS_UDT.  
...
## SQLColumns Support for Enhanced Date and Time Features  
 For information about the values returned for date/time types, see [Catalog Metadata](../../../2014/database-engine/dev-guide/catalog-metadata.md).  
...
|SS_IS_COLUMN_SET|`Smallint`|If the column is the `column_set` column, this is SQL_TRUE; otherwise, SQL_FALSE.|  
 ...
 For more information about sparse columns in ODBC, see [Sparse Columns Support &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/sparse-columns-support-odbc.md).  
