...
## Locking Table Hints  
 Locking hints ([Table Hints &#40;Transact-SQL&#41;](../Topic/Table%20Hints%20\(Transact-SQL\).md)) such as HOLDLOCK and XLOCK can be used with disk-based tables to have [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] take more locks than are required for the specified isolation level.  
