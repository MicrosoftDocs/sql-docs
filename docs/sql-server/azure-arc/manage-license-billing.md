...
> [!IMPORTANT]
- The pay-as-you-go hourly charges are issued only when _SQL Server_ is running on the machine at any point within a given hour. If the virtual machine is offline, the pay-as-you-go hourly charges are suspended until it is back online.   
