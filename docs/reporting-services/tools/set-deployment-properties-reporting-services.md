...
description: Learn how to set the deployment properties that are used by SQL Server Data Tools (SSDT) or Visual Studio need to build, preview, and deploy reports.
