...
# Deploy Model Solutions Using XMLA
 ...
 For more information about the **Script Database As** command, see [Document and Script an Analysis Services Database](../../2014/analysis-services/document-and-script-an-analysis-services-database.md).  
