...
# Processing Requirements and Considerations (Data Mining)
  This topic describes some technical considerations to keep in mind when processing data mining objects. For a general explanation of what processing is, and how it applies to data mining, see [Processing Data Mining Objects](../../2014/analysis-services/processing-data-mining-objects.md).  
...
##  <a name="bkmk_ProcessStructures"></a> Processing Mining Structures  
 ...
 For more information, see [Process a Mining Structure](../../2014/analysis-services/process-a-mining-structure.md).  
 ...
 Also, if you clear the cache, you will not be able to use the holdout test set, if you defined one, and the definition of the test set partition will be lost. For more information about holdout test sets, see [Training and Testing Data Sets](../../2014/analysis-services/training-and-testing-data-sets.md).  
...
##  <a name="bkmk_ProcessModels"></a> Processing Mining Models  
 ...
 For more information, see [Process a Mining Model](../../2014/analysis-services/process-a-mining-model.md).  
 ...
 **Deployment of a project**: Depending on the project settings and the current state of the project, the mining models in the project are typically processed in full when the project is deployed.  
 ...
 For more information about how to set [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] deployment properties that control how mining models are deployed, see [Deployment of Data Mining Solutions](../../2014/analysis-services/deployment-of-data-mining-solutions.md).  
...
-   The mining structure definition was also exported by using the WITH DEENDENCIES keyword.  
 ...
 For more information, see [Export and Import Data Mining Objects](../../2014/analysis-services/export-and-import-data-mining-objects.md).  
