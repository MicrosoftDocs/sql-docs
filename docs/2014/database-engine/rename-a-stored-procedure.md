...
-   Changing the name or definition of a procedure can cause dependent objects to fail when the objects are not updated to reflect the changes that have been made to the procedure. For more information, see [View the Dependencies of a Stored Procedure](../../2014/database-engine/view-the-dependencies-of-a-stored-procedure.md).  
...
3.  [Determine the dependencies of the stored procedure](../../2014/database-engine/view-the-dependencies-of-a-stored-procedure.md).  
