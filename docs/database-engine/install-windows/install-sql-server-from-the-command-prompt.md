...
||SQL_INST_MR |Applies to [SQL Server 2017 and greater Machine Learning Services](https://docs.microsoft.com/sql/advanced-analytics/install/sql-machine-learning-services-windows-install). Pair with **AdvancedAnalytics** to install R Open and proprietary R packages.|  
||SQL_INST_MPY|Applies to [SQL Server 2017 and greater Machine Learning Services](https://docs.microsoft.com/sql/advanced-analytics/install/sql-machine-learning-services-windows-install). Pair with **AdvancedAnalytics** to install Anaconda and proprietary Python packages.|  
||SQL_INST_JAVA |Applies to [SQL Server 2017 and greater Machine Learning Services](https://docs.microsoft.com/sql/advanced-analytics/install/sql-machine-learning-services-windows-install). Pair with **AdvancedAnalytics** to install extensions that enable integration with Java using standard T-SQL statements.|  
