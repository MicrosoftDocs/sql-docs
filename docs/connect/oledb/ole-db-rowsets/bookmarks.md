...
description: Learn how bookmarks let consumers quickly return to a row OLE DB Driver for SQL Server by accessing rows randomly based on the bookmark value.
ms.custom: ""
ms.date: "06/14/2018"
ms.prod: sql
