...
-   **SQLTables**  
 ...
 The two-part *linked_server_name***.***catalog* is also supported for *FKCatalogName* and *PKCatalogName* on [SQLForeignKeys](../../../2014/database-engine/dev-guide/sqlforeignkeys.md).  
