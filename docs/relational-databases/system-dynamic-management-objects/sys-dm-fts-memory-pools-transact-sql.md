...
:::image type="content" source="../../relational-databases/system-dynamic-management-objects/media/join-dm-fts-memory-pools.svg" alt-text="Diagram of physical joins for sys.dm_fts_memory_pools.":::
