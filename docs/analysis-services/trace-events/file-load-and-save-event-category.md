...
|PageIn End|97|PageIn End|  
 ...
 For information about the columns associated with each of the File Load and Save event classes, see [File Load and Save Data Columns](../../analysis-services/trace-events/file-load-and-save-data-columns.md).  
