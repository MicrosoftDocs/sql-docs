...
For a reference of resource log types collected for Azure SQL Managed Instance, see [Streaming export of Azure SQL Managed Instance Diagnostic telemetry for export](metrics-diagnostic-telemetry-logging-streaming-export-configure.md#diagnostic-telemetry-for-export)
