...
## In This Section  
 ...
 [Data Collector Programming](../../../2014/database-engine/dev-guide/data-collector-programming.md)  
 Describes the Data Collector object model.  
  
 [Exception Message Box Programming](../../../2014/database-engine/dev-guide/exception-message-box-programming.md)  
