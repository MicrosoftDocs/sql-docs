...
description: The Report Server File Sync feature of Reporting Services uses SharePoint event handlers to synch the report server catalog with items in document libraries.
ms.date: 09/25/2017
