...
```  
 ...
 When you migrate code, you might have to modify the code. This is because several features have been deprecated in newer versions of [!INCLUDE [ssnoversion-md](../../includes/ssnoversion-md.md)]. For more information about deprecated features, see [Deprecated Database Engine features in SQL Server 2025 (17.x)](../../database-engine/deprecated-database-engine-features-in-sql-server-2025.md).
