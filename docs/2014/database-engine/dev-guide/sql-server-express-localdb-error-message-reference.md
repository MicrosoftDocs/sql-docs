...
# SQL Server Express LocalDB Error Message Reference
 ...
 [LOCALDB_ERROR_AUTO_INSTANCE_CREATE_FAILED](../../../2014/database-engine/dev-guide/localdb-error-auto-instance-create-failed.md)  
 ...
 [LOCALDB_ERROR_CANNOT_CREATE_INSTANCE_FOLDER](../../../2014/database-engine/dev-guide/localdb-error-cannot-create-instance-folder.md)  
 A folder cannot be created under %userprofile%.  
  
 [LOCALDB_ERROR_CANNOT_CREATE_SQL_PROCESS](../../../2014/database-engine/dev-guide/localdb-error-cannot-create-sql-process.md)  
 ...
 [LOCALDB_ERROR_INSTANCE_ALREADY_SHARED](../../../2014/database-engine/dev-guide/localdb-error-instance-already-shared.md)  
 ...
 [LOCALDB_ERROR_INSTANCE_EXISTS_WITH_LOWER_VERSION](../../../2014/database-engine/dev-guide/localdb-error-instance-exists-with-lower-version.md)  
 ...
 [LOCALDB_ERROR_INSTANCE_STOP_FAILED](../../../2014/database-engine/dev-guide/localdb-error-instance-stop-failed.md)  
 ...
 [LOCALDB_ERROR_SHARED_NAME_TAKEN](../../../2014/database-engine/dev-guide/localdb-error-shared-name-taken.md)  
 The specified shared name is already taken.  
  
 [LOCALDB_ERROR_SQL_SERVER_STARTUP_FAILED](../../../2014/database-engine/dev-guide/localdb-error-sql-server-startup-failed.md)  
 A SQL Server process was started, but SQL Server startup failed.  
  
 [LOCALDB_ERROR_TOO_MANY_SHARED_INSTANCES](../../../2014/database-engine/dev-guide/localdb-error-too-many-shared-instances.md)  
 There are too many shared instances.  
  
 [LOCALDB_ERROR_UNKNOWN_ERROR_CODE](../../../2014/database-engine/dev-guide/localdb-error-unknown-error-code.md)  
 The requested message does not exist.  
  
 [LOCALDB_ERROR_UNKNOWN_INSTANCE](../../../2014/database-engine/dev-guide/localdb-error-unknown-instance.md)  
 The instance does not exist.  
  
 [LOCALDB_ERROR_UNKNOWN_LANGUAGE_ID](../../../2014/database-engine/dev-guide/localdb-error-unknown-language-id.md)  
 The message is not available in the requested language.  
  
 [LOCALDB_ERROR_UNKNOWN_VERSION](../../../2014/database-engine/dev-guide/localdb-error-unknown-version.md)  
 The specified version is not available.  
  
 [LOCALDB_ERROR_VERSION_REQUESTED_NOT_INSTALLED](../../../2014/database-engine/dev-guide/localdb-error-version-requested-not-installed.md)  
 ...
 [LOCALDB_ERROR_XEVENT_FAILED](../../../2014/database-engine/dev-guide/localdb-error-xevent-failed.md)  
