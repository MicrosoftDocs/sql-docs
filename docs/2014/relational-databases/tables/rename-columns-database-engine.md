...
## <a name="TsqlExample"></a> Using Transact-SQL

### To rename a column

The following example renames the column `TerritoryID` in the table `Sales.SalesTerritory` in the AdventureWorks database to `TerrID`.
