...
### Obtaining Documentation for [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
 The documentation for [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] is available online. For more information, see [Use Product Documentation for SQL Server](../Topic/Use%20Product%20Documentation%20for%20SQL%20Server.md).  
