...
4.  Set formatting options. For example, on the **General** tab:  
    ...
    -   **Markup type** Select an option to indicate how the selected text will be rendered:  
         ...
         **HTML**  Display the selected text as HTML. If the expression value of the placeholder contains valid HTML tags, these tags will be rendered as HTML. For more information, see [Importing HTML into a Report &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/importing-html-into-a-report-report-builder-and-ssrs.md).  
