...
The focus of this release cycle is deeper integration and parity, with the ability to use and deploy Python and R code under more of the methodologies available to the database engine. To learn more about this release, see [What's new in SQL Server vNext](../sql-server/what-s-new-in-sql-server-vnext.md)
...
+ [Install SQL Server Machine Learning Services](python/setup-python-machine-learning-services.md)
