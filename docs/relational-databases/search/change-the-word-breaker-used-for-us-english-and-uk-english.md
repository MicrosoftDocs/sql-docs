...
[!INCLUDE [SQL Server Azure SQL Database](../../includes/applies-to-version/sql-asdb.md)]
  ...
  Beginning with [!INCLUDE[sssql11-md](../../includes/sssql11-md.md)], setup installs a new version of the word breaker and stemmer for the English language, replacing the previous version of these components. For information about the changed behavior of the new components, see [Behavior Changes to Full-Text Search](https://docs.microsoft.com/previous-versions/sql/2014/database-engine/behavior-changes-to-full-text-search?view=sql-server-2014#behavior-changes-in-full-text-search-in--1&preserve-view=true). This topic describes how to switch from the new version of these components to the previous version, or to switch back from the previous version to the new version. For cluster installations, these changes should be made on all the primary and passive nodes.  
