...
| Hyperscale service tier premium-series hardware (preview) | Premium-series and memory optimized premium-series hardware does not currently support:<br/><br/>- Zone redundancy<BR/><BR/>- Serverless compute tier.| 
