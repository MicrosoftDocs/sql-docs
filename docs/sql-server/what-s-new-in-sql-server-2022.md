...
| [Bit manipulation functions](../t-sql/functions/bit-manipulation-functions-overview.md) | - [LEFT_SHIFT (Transact SQL)](../t-sql/functions/left-shift-transact-sql.md)<br />- [RIGHT_SHIFT (Transact SQL)](../t-sql/functions/right-shift-transact-sql.md)<br />- [BIT_COUNT (Transact SQL)](../t-sql/functions/bit-count-transact-sql.md)<br />- [GET_BIT (Transact SQL)](../t-sql/functions/get-bit-transact-sql.md)<br />- [SET_BIT (Transact SQL)](../t-sql/functions/set-bit-transact-sql.md) |
