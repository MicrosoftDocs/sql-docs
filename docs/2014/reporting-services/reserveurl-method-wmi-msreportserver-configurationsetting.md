...
## Remarks  
 *UrlString* does not include the virtual directory name. The [SetVirtualDirectory](../../2014/reporting-services/setvirtualdirectory-method-wmi-msreportserver-configurationsetting.md) method is provided for that purpose.  
