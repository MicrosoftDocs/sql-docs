 ...
 **Look up**  
 Look up the InfoPackage by using the **Look Up InfoPackage** dialog box. For more information about this dialog box, see [Look Up InfoPackage](../../2014/integration-services/look-up-infopackage.md).  
...
|Object Type|Result|  
|-----------------|------------|  
|**InfoObject**|Create a new InfoObject by using the **Create New InfoObject** dialog box. For more information about this dialog box, see [Create New InfoObject](../../2014/integration-services/create-new-infoobject.md).|  
|**InfoCube**|Create a new InfoCube by using the **Create InfoCube for Transaction Data** dialog box. For more information about this dialog box, see [Create InfoCube for Transaction Data](../../2014/integration-services/create-infocube-for-transaction-data.md).|  
|**InfoSource**|Create a new InfoSource by using the **Create InfoSource** dialog box, and then by using the **Create InfoSource for Transaction Data** or the **Create InfoSource for Master Data** dialog box. For more information about these dialog boxes, see [Create InfoSource](../../2014/integration-services/create-infosource.md), [Create InfoSource for Transaction Data](../../2014/integration-services/create-infosource-for-transaction-data.md) and [Create InfoSource for Master Data](../../2014/integration-services/create-infosource-for-master-data.md).|  
|**InfoPackage**|Create a new InfoPackage by using the **Create InfoPackage** dialog box. For more information about this dialog box, see [Create InfoPackage](../../2014/integration-services/create-infopackage.md).|  
