...
5.  Retry the task in the configuration tool by clicking **Validate** followed by **Run**.  
 ...
 Alternatively, you can use PowerShell to remove features and solutions from the farm. For more information, see [PowerShell Reference for PowerPivot for SharePoint](../../relational-databases/spatial/point.md).  
