...
The following SQL statement shows how to use the [sys.dm_pdw_component_health_active_alerts &#40;SQL Server PDW&#41;](../sqlpdw/sys-dm-pdw-component-health-active-alerts-sql-server-pdw.md) system view to find the name of the server that failed.  
