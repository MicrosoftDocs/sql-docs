...
# Choosing Between URL Access and SOAP
 ...
 ![Reporting Services programming scenarios](../../../2014/reporting-services/dev-guide/media/bk-ext-04.gif "Reporting Services programming scenarios")  
...
>  Report server URL access supports HTML Viewer and the extended functionality of the report toolbar. The SOAP API does not support this type of rendered report. You need to design and develop your own report toolbar, if you render reports using SOAP.  
 ...
 For more information about the Reporting Services SOAP API, see [Report Server Web Service](../../../2014/reporting-services/dev-guide/report-server-web-service.md).  
