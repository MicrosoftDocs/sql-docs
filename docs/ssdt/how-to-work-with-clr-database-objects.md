...
For more information on the requirements of building CLR database objects, see [Building Database Objects with Common Language Runtime (CLR) Integration](http://msdn.microsoft.com/en-us/library/ms131046.aspx).  
