...
Python is a language that offers great flexibility and power for a variety of machine learning tasks. Open source libraries for Python include several platforms for neural networks and natural language processing. Now, this popular language is supported in SQL Server vNext CTP 2.0.
