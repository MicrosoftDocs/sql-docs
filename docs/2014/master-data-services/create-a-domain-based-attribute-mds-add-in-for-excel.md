...
1.  In Excel, load the entity that contains the column (attribute) you want to constrain. For more information, see [Load Data from MDS into Excel](../../2014/master-data-services/load-data-from-mds-into-excel.md).  
...
-   To add and delete values in the constrained list, load the entity that the attribute is based on. For more information on loading entities, see [Load Data from MDS into Excel](../../2014/master-data-services/load-data-from-mds-into-excel.md).  
  
## See Also  
 [Domain-Based Attributes &#40;Master Data Services&#41;](../../2014/master-data-services/domain-based-attributes-master-data-services.md)   
 [Create an Entity &#40;MDS Add-in for Excel&#41;](../../2014/master-data-services/create-an-entity-mds-add-in-for-excel.md)   
