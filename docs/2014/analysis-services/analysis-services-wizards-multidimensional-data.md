...
|Topic|Description|  
|-----------|-----------------|  
|[Aggregation Design Wizard F1 Help](../../2014/analysis-services/aggregation-design-wizard-f1-help.md)|Use the Aggregation Design Wizard to define aggregations for an aggregation design, used to create aggregation instances for partitions in a measure group.|  
|[Business Intelligence Wizard F1 Help](../../2014/analysis-services/business-intelligence-wizard-f1-help.md)|Use the Business Intelligence Wizard to add advanced business intelligence features, such as account intelligence and currency conversion, to a cube or dimension.|  
|[Cube Wizard F1 Help](../../2014/analysis-services/cube-wizard-f1-help.md)|Use the Cube Wizard to create a new cube.|  
