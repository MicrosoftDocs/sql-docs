---
title: Quickstart for running R using T-SQL on SQL Server | Microsoft Docs
description: Learn the basics for running R code using T-SQL and stored procedures on a SQL Server database engine instance for which R integration is enabled.
ms.prod: sql
