...
## Next Step  
 After discovering available components, the next step is to add and configure the components, which is discussed in the next topic, [Adding Data Flow Components Programmatically](../../../2014/integration-services/dev-guide/adding-data-flow-components-programmatically.md).  
