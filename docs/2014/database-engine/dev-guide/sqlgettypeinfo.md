...
## SQLGetTypeInfo and Table-Valued Parameters  
 ...
 For more information, about retrieving metdata for table-valued parameters, see [Statement Attributes that Affect Table-Valued Parameters](../../../2014/database-engine/dev-guide/statement-attributes-that-affect-table-valued-parameters.md).  
...
## SQLGetTypeInfo Support for Large CLR UDTs  
 `SQLGetTypeInfo` supports large CLR user-defined types (UDTs). For more information, see [Large CLR User-Defined Types &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/large-clr-user-defined-types-odbc.md).  
