...
> [!NOTE]
> Using Temporal with memory optimized tables only applies to [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] and does not apply to [!INCLUDE[sssds](../../includes/sssds-md.md)].
