---
title: "sys.sp_describe_cursor_columns (Transact-SQL)"
...
- [sys.sp_describe_cursor (Transact-SQL)](sp-describe-cursor-transact-sql.md)
- [sys.sp_cursor_list (Transact-SQL)](sp-cursor-list-transact-sql.md)
- [sys.sp_describe_cursor_tables (Transact-SQL)](sp-describe-cursor-tables-transact-sql.md)
