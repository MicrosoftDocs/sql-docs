...
# Print Query Results (Visual Database Tools)
  To print the results of your query, you can copy the contents of the [Results pane](../../2014/database-engine/results-pane-visual-database-tools.md) to another Windows program, such as a word processing program, then format and print it there.  
