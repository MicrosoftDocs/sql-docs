...
## See Also  
 ...
 [Export a Data-tier Application](../../2014/database-engine/export-a-data-tier-application.md)   
 [Import a BACPAC File to Create a New User Database](../../2014/database-engine/import-a-bacpac-file-to-create-a-new-user-database.md)  
