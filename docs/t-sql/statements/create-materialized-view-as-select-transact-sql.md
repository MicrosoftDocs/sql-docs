...
Once created, materialized views are visible within [SQL Server Management Studio](/ssms/sql-server-management-studio-ssms) under the views folder of the [!INCLUDE[ssazuresynapse-md](../../includes/ssazuresynapse-md.md)] instance.
...
- [DROP VIEW (Transact-SQL)](drop-view-transact-sql.md?view=azure-sqldw-latest&preserve-view=true)
