...
description: Discover drillthrough reports, which open when you select a link within another report, to get details about an item in an original summary report.
ms.date: 03/07/2017
