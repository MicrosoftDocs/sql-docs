---
title: "Scan:Started Event Class | Microsoft Docs"
ms.custom: ""
ms.date: "06/13/2017"
...
|EventClass|`int`|Type of event = 51.|27|No|  
|EventSequence|`int`|Sequence of a given event within the request.|51|No|  
|GroupID|`int`|ID of the workload group where the SQL Trace event fires.|66|Yes|  
|HostName|`nvarchar`|Name of the computer on which the client is running. This data column is populated if the client provides the host name. To determine the host name, use the HOST_NAME function.|8|Yes|  
|IndexID|`int`|The index that is being scanned (if an index).|24|Yes|  
...
|ObjectID|`int`|System-assigned ID of the object being scanned.|22|Yes|  
