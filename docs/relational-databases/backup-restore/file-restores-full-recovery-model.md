...
description: A file restore in SQL Server is a single restore sequence that copies, rolls forward, and recovers data without restoring the whole database.
ms.custom: ""
ms.date: "03/14/2017"
ms.prod: sql
