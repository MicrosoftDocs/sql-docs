...
> **Error message:** “Keyword not supported ‘applicationintent’”  
 ...
 For information on other [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)] requirements, see [Prerequisites, Restrictions, and Recommendations for AlwaysOn Availability Groups &#40;SQL Server&#41;](availability-groups/windows/prereqs-restrictions-recommendations-always-on-availability.md).  
...
-   SQL Client, with the .Net hotfix applied to the report server.  
 ...
 ![SSRS Datasource using AG groups](../../2014/database-engine/media/rs-alwayson-basic.gif "SSRS Datasource using AG groups")  
...
-   For more information on availability group listeners, see [Create or Configure an Availability Group Listener &#40;SQL Server&#41;](availability-groups/windows/create-or-configure-an-availability-group-listener-sql-server.md).  
