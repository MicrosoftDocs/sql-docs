...
## User Action  
 ...
 Use [sp_help_jobstep](../Topic/sp_help_jobstep%20\(Transact-SQL\).md) to view the current setting for the maximum number of times the **Run agent** step for the specified replication agent will retry. You can use the **@retry_attempts** parameter of the [sp_update_jobstep](../Topic/sp_update_jobstep%20\(Transact-SQL\).md) stored procedure to adjust the number of times a job step retries.  
