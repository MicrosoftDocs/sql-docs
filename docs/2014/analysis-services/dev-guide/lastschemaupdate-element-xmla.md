...
# LastSchemaUpdate Element (XMLA)
  Contains the date and time that the metadata of the cube represented by the parent [Cube](../../../2014/analysis-services/dev-guide/cube-element-olapinfo-xmla.md) element was last updated.  
...
|------------------|-------------|  
|Parent elements|[Cube](../../../2014/analysis-services/dev-guide/cube-element-olapinfo-xmla.md)|  
|Child elements|None|  
