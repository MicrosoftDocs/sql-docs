...
# Data Quality Services
 ...
 For information about installing DQS, see [Install Data Quality Services](../../2014/sql-server/install/install-data-quality-services.md). If you want to upgrade your existing version of DQS to [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)], see [Upgrade Data Quality Services](../../2014/sql-server/install/upgrade-data-quality-services.md).  
