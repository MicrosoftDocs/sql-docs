...
Though we continuously strive to provide availability, there are times when the Azure SQL Database service incurs outages that cause the unavailability of your database and thus affects your application. When our service monitoring detects issues that cause widespread connectivity errors, failures or performance issues, the service automatically declares an outage to keep you informed.  
