...
Extensions are provided by the Azure Data Studio team at Microsoft and the third-party community, like yourself.
...
For an in-depth guide on how to get started with your extension template, see [Creating an extension](./tutorial-create-extension.md?view=sql-server-ver15). This article walks you through the creation of a keymap extension.
...
1. Select **F5**, or select the Debug icon and select **Start**.
1. A new instance of Azure Data Studio starts in the Extension Development Host mode. This new instance is now aware of your extension.

## Create an extension package

After you write your extension, you need to create a VSIX package to install the extension in Azure Data Studio. You can use Visual Studio Code Extensions ([vsce](https://github.com/Microsoft/vscode-vsce)) to create the VSIX package.
...
1. We currently don't have support to host third-party extensions. Instead of downloading the extension, Azure Data Studio has the option to browse to a download page. To set a download page for your extension, set the value of the asset **Microsoft.AzureDataStudio.DownloadPage**.
1. Create a pull request against release/extensions branch.
1. Send a review request to the team.
