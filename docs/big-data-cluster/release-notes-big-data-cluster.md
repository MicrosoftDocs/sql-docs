...
|-----------------------|-----------------|--------------|
| [CU5](#cu5)           | 15.0.40xx.x     | 2020-05-31   |
...
Cumulative Update 5 (CU5) release for SQL Server 2019. The SQL Server Database Engine version for this release is 15.0.40xx.x.

|Package version | Image tag |
|-----|-----|
|15.0.40xx.x |[2019-CU5-ubuntu-16.04]
