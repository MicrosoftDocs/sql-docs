...
>  If multiple items are selected, pressing this key affects all selected items. Select multiple items by holding down the CTRL key while clicking them.  
 ...
 For more information, see [Diagram Pane &#40;Visual Database Tools&#41;](../../2014/database-engine/diagram-pane-visual-database-tools.md).  
...
>  If multiple items are selected, pressing this key affects all selected items.  
 ...
 For more information, see [Criteria Pane &#40;Visual Database Tools&#41;](../../2014/database-engine/criteria-pane-visual-database-tools.md).  
...
>  You can only insert text; there is no overstrike mode.  
 ...
 For more information, see [SQL Pane &#40;Visual Database Tools&#41;](../../2014/database-engine/sql-pane-visual-database-tools.md).  
...
>  If multiple items are selected, pressing this key affects all selected items.  
 ...
 For more information, see [Results Pane &#40;Visual Database Tools&#41;](../../2014/database-engine/results-pane-visual-database-tools.md).  
