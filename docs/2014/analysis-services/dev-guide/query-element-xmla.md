...
---
# Query Element (XMLA)
  Contains a query within the [Queries](../../../2014/analysis-services/dev-guide/queries-element-xmla.md) collection used by the [DesignAggregations](../../../2014/analysis-services/dev-guide/designaggregations-element-xmla.md) command during usage-based optimization.  
...
|------------------|-------------|  
|Parent elements|[Queries](../../../2014/analysis-services/dev-guide/queries-element-xmla.md)|  
|Child elements|None|  
...
> [!NOTE]  
>  Some attributes are excluded from consideration in the dataset. For more information about excluded attributes, see [Properties (XMLA)](../../../2014/analysis-services/dev-guide/query-element-xmla.md).  
