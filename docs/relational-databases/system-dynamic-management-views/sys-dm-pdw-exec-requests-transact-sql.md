...
| `error_id` | **nvarchar(36)** | Unique ID of the error associated with the request, if any. | See [sys.dm_pdw_errors](sys-dm-pdw-errors-transact-sql.md); set to `NULL` if no error occurred. |
