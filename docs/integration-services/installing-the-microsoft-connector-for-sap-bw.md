...
To use the [!INCLUDE [msCoName](../includes/msconame-md.md)] Connector for SAP BW, you don't have to install the SAP Front End software (SAP GUI) on the local computer.
