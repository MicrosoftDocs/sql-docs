...
description: Install components on the server that is runs SQL Server to support MySQL database conversion with SSMA, including the SSMA extension pack and MySQL providers.
ms.prod: sql
ms.custom: ""
ms.date: "01/19/2017"
ms.reviewer: ""
