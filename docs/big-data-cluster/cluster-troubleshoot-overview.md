---
title: Troubleshooting Big Data Clusters (BDC) Overview
titleSuffix: SQL Server big data clusters
description: This article explains how to troubleshoot Big Data Clusters (BDC) with all available provided options.
author: cloudmelon
