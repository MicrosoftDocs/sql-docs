...
1. Connect to your Azure SQL database by using [SQL Server Management Studio](/ssms/sql-server-management-studio-ssms), and validate the migration by reviewing the data and schema.
