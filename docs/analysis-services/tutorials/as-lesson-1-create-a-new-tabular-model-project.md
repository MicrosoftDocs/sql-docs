...
This topic is the first lesson in a tabular model authoring tutorial. To complete this lesson, there are several prerequisites you need to have in-place. To learn more, see [Analysis Services - Adventure Works tutorial](../tutorials/as-adventure-works-tutorial.md).  
...
6.  In **Compatibility level**, select **SQL Server 2017 / Azure Analysis Services (1400)**.   
    ...
    ![as-lesson1-tmd](../tutorials/media/as-lesson1-tmd.png)
...
![as-lesson1-tme](../tutorials/media/as-lesson1-tme.png)
...
![as-lesson1-se](../tutorials/media/as-lesson1-se.png)
...
![as-lesson1-properties](../tutorials/media/as-lesson1-properties.png)
...
## What's next?
[Lesson 2: Get data](../tutorials/as-lesson-2-get-data.md).
