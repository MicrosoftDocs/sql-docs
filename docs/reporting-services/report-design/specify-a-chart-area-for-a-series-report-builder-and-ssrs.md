...
description: Find out about the the chart area as a top-level container that includes the outer border, the chart title, and the legend in Report Builder.
ms.date: 03/01/2017
