...
|**is_inlineable**|**bit**|**Applies to**: [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)] onwards.<br/><br />Indicates whether the module is inlineable or not. Inlineability is based on the conditions specified [here](../performance/scalar-udf-inlining.md#inlineable-scalar-udfs-requirements).<br /><br /> 0 = not inlineable<br /><br /> 1 = is inlineable. <br /><br /> For scalar UDFs, the value will be 1 if the UDF is inlineable, and 0 otherwise. It always contains a value of 1 for inline TVFs, and 0 for all other module types.<br />|  
