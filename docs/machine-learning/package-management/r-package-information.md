...
| [sqlrutils](../r/reference/sqlrutils/sqlrutils) | 1.0.0 | Used for including R script in stored procedures. |
...
| [olapR](../r/reference/olapr/olapr) | 1.0.0 | Used for writing MDX statements in R. |
