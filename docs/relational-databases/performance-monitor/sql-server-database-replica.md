...
|------------------|-----------------|--------------|  
|**Database Flow Control Delay**|Duration spent in database flow control wait. **Applies to**: SQL Server 2014 Service Pack 2 and later, SQL Server 2016 Service Pack 1 and later||
...
|**Redones/sec**| The number of redo events per sec. ||
