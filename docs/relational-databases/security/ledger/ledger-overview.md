...
> [!NOTE]
> Automatic digest management is supported in Azure SQL Database and [!INCLUDE [sssql22-md](../../../includes/sssql22-md.md)]. Managing digests manually is supported both in Azure SQL Database and SQL Server.
