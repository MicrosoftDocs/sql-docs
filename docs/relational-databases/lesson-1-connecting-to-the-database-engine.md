...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 ...
 > For content related to previous versions of SQL Server, see [Lesson 1: Connecting to the Database Engine](lesson-1-connecting-to-the-database-engine.md).aspx).
