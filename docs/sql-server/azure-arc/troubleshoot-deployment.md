...
Remove and reinstall the extension using azcmagent commands: [Link](https://learn.microsoft.com/en-us/azure/azure-arc/servers/azcmagent-extension#azcmagent-extension-remove)
