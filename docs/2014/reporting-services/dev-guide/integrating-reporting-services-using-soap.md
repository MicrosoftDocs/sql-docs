...
## In This Section  
 [Using the SOAP API in a Windows Application](../../../2014/reporting-services/dev-guide/using-the-soap-api-in-a-windows-application.md)  
 ...
 [Using the SOAP API in a Web Application](../../../2014/reporting-services/dev-guide/using-the-soap-api-in-a-web-application.md)  
