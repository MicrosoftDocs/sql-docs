...
description: Learn about SQL Server unit tests. View sources of information on how to create and run them, troubleshoot problems, and perform other related tasks.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
