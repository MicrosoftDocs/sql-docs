...
|**is_inlineable**|**bit**|**Applies to**: [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)] onwards.<br /><br />Indicates whether the module is inlineable or not. This is based on the conditions specified [here](../performance/scalar-udf-inlining#inlineability-of-scalar-udfs.md)<br /><br /> 0 = not inlineable<br /><br /> 1 = is inlineable. <br /><br /> Always contains a value of 1 for inline TVFs.<br />|  
