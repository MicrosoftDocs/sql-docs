---
title: "Run a package with Transact-SQL (VS Code) | Microsoft Docs"
ms.date: "08/21/2017"
ms.topic: "article"
...
This quick start demonstrates how to use Visual Studio Code to connect to the SSIS Catalog database on an Azure SQL database server, and then use Transact-SQL statements to run an SSIS package stored in the SSIS Catalog.
