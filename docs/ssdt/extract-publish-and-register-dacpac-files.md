...
description: "Learn about actions that you can perform with data-tier applications (DACs). Examples include extracting, publishing, and registering snapshot (.dacpac) files."
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
f1_keywords: 
