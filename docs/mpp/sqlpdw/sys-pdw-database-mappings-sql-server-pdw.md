...
|database_id|**int**|The object ID for the database. See [sys.databases &#40;SQL Server PDW&#41;](../../mpp/sqlpdw/sys-databases-sql-server-pdw.md).<br /><br />**physical_name** and **database_id** form the key for this view.||  
