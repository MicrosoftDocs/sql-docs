...
# Build database projects using SQL Server Management Studio (SSMS)
...
Solution Explorer is a tool for developers creating and reusing scripts related to the same project. If a similar task is required later, you can use a group of scripts stored in a project. If you've created applications using [!INCLUDE[msCoName](../includes/msconame_md.md)] [!INCLUDE[vsprvs](../includes/vsprvs-md.md)], you can find the Solution Explorer very familiar.  
