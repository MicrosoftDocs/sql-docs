...
description: Learn about breaking changes in Reporting Services that might break applications, scripts, or functionalities based on earlier versions of SQL Server.
ms.date: 07/02/2017
