...
---
  ...
  || [Deployment template](/azure/azure-sql/database/single-database-create-arm-template-quickstart) | [Deployment template](/azure/azure-sql/database/arm-templates-content-guide?tabs=managed-instance) | [Deployment template](../virtual-machines/windows/create-sql-vm-resource-manager-template.md) | [Deployment template](/azure/synapse-analytics/quickstart-deployment-template-workspaces) |
