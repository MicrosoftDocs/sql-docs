...
//<snippetOCSv2_CS_Utility>
    public class Utility
    {
        ...
        //Return the Ce1 connection string. 
        public string Ce1ConnString
        {

            get { return @"Data Source='SyncSampleCe1.sdf'"; }

        }

        //Return the Ce2 connection string. 
        public string Ce2ConnString
        {

            get { return @"Data Source='SyncSampleCe2.sdf'"; }
        ...
        //synchronization.
        public void MakeDataChangesOnPeer(string peerConnString, string tableName)
        {
            int rowCount = 0;

            using (SqlConnection peerConn = new SqlConnection(peerConnString))
            {
                SqlCommand sqlCommand = peerConn.CreateCommand();

                if (tableName == "Customer")
                {
                    
                    if (peerConnString == this.Peer1ConnString) 
                    {
                        sqlCommand.CommandText =
                        "INSERT INTO Sales.Customer (CustomerName, SalesPerson, CustomerType) " +
                        "VALUES ('Cycle Mart', 'James Bailey', 'Retail')";
                    }
                    else if (peerConnString == this.Peer2ConnString)
                    {
                        sqlCommand.CommandText =
                        "UPDATE Sales.Customer " +
                        "SET  SalesPerson = 'James Bailey' " +
                    ...
                    else if (peerConnString == this.Peer3ConnString)
        ...
        //synchronization.
        public void MakeConflictingChangesOnPeer(string peerConnString, string tableName)
        {
            int rowCount = 0;
            ...
            using (SqlConnection peerConn = new SqlConnection(peerConnString))
            {
                ...
                if (tableName == "Customer")
                {
                    ...
                    if (peerConnString == this.Peer1ConnString)
                    {
                        sqlCommand.CommandText =
                        "UPDATE Sales.Customer " +
                        "SET  SalesPerson = 'ChangeFromPeerOne' " +
                        "WHERE CustomerName = 'Tandem Bicycle Store' ";
                    }
                    else if (peerConnString == this.Peer2ConnString)
                    {
                        sqlCommand.CommandText =
                        "UPDATE Sales.Customer " +
                        "SET  SalesPerson = 'ChangeFromPeerTwo' " +
                        "WHERE CustomerName = 'Tandem Bicycle Store' ";
                    }
                    else if (peerConnString == this.Peer3ConnString)
                        ...
                        sqlCommand.CommandText =
                        "UPDATE Sales.Customer " +
                        "SET  SalesPerson = 'ChangeFromPeerThree' " +
                        "WHERE CustomerName = 'Tandem Bicycle Store' ";
                }
        ...
        public void MakeFailingChangeOnPeer(string peerConnString)
        {
            int rowCount = 0;
            ...
            using (SqlConnection peerConn = new SqlConnection(peerConnString))
            {
                ...
                if (peerConnString == this.Peer2ConnString)
                {
                    sqlCommand.CommandText =
        ...
        public void CleanUpPeer(string peerConnString)
        {          
            using(SqlConnection peerConn = new SqlConnection(peerConnString))
            {
                SqlCommand sqlCommand = peerConn.CreateCommand();
        ...
        public void RecreateCePeerDatabase(string sqlCeConnString)
        {
            ...
            if (sqlCeConnString == this.Ce1ConnString)
            {
