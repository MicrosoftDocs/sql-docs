...
2.  Stop the appliance services by using the **Services Status** page in the Configuration Manager. See [PDW Services Status &#40;Analytics Platform System&#41;](../management/pdw-services-status-analytics-platform-system.md) for instructions.  
...
![DWConfig Appliance Time](../management/media/SQL_Server_PDW_DWConfig_ApplTopTime.png "SQL_Server_PDW_DWConfig_ApplTopTime")  
