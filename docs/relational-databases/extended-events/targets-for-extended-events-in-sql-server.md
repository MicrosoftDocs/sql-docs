...
> [!NOTE]
> [!INCLUDE[ssazuremi_md](../../includes/ssazuremi_md.md)] and [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)] do not support the `etw_classic_sync_target` target. Instead, use event_file .xel files, stored in Azure Blob Storage.
::: moniker-end
...
> [!NOTE]
> [!INCLUDE[ssazuremi_md](../../includes/ssazuremi_md.md)] and [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)] only support storing `xel` files on Azure Blob Storage. 
>
