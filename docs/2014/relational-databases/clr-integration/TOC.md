...
## [Architecture of CLR Integration](../../database-engine/architecture-of-clr-integration.md)
...
# [CLR Stored Procedures](../../database-engine/clr-stored-procedures.md)
...
# [Overview of CLR Integration Custom Attributes](../../database-engine/overview-of-clr-integration-custom-attributes.md)
...
## [User Defined Type](../../database-engine/user-defined-type.md)
## [UTF8 String User-Defined Data Type (UDT)](../../database-engine/utf8-string-user-defined-data-type-udt.md)
...
## [Links in CLR Integration Security(../../database-engine/links-in-clr-integration-security.md)
## [Impersonation and CLR Integration Security](../../database-engine/impersonation-and-clr-integration-security.md)
## [Allowing Partially Trusted Callers](../../database-engine/allowing-partially-trusted-callers.md)
## [Application Domains and CLR Integration Security(../../database-engine/application-domains-and-clr-integration-security.md)
...
# [Usage Scenarios and Examples for Common Language Runtime (CLR) Integration](../../database-engine/usage-scenarios-and-examples-for-common-language-runtime-clr-integration.md)
## [Accessing Native Code from a CLR UDF](../../database-engine/accessing-native-code-from-a-clr-udf.md)
## [Array Parameter Sample](../../database-engine/array-parameter-sample.md)
## [Calendar-Aware Date/Time UDT Sample](../../database-engine/calendar-aware-date-and-time-udt-sample.md)
## [CLR Transactions Sample](../../database-engine/clr-transactions-sample.md)
## [Contact Creation using CLR and XML](../../database-engine/contact-creation-using-clr-and-xml.md)
## [Currency Type and Conversion Function](../../database-engine/currency-type-and-conversion-function.md)
## [Handling Large Objects Using CLR](../../database-engine/handling-large-objects-using-clr.md)
## [Hello World Ready Sample](../../database-engine/hello-world-ready-sample.md)
## [Hello World Sample](../../database-engine/hello-world-sample.md)
## [In-Process Data Access Sample](../../database-engine/in-process-data-access-sample.md)
## [Result Set Sample](../../database-engine/result-set-sample.md)
## [Send DataSet Sample](../../database-engine/send-dataset-sample.md)
## [String Utility Functions Sample](../../database-engine/string-utility-functions-sample.md)
## [Supplementary-Aware String Manipulation Sample](../../database-engine/supplementary-aware-string-manipulation-sample.md)
# [UDT Utilities](../../database-engine/udt-utilities.md)
# [Unused Assembly Cleanup](../../database-engine/unused-assembly-cleanup.md)
