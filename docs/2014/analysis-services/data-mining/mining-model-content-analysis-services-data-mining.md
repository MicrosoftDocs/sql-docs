...
|18|Prerendered string|Represents a custom value that the algorithm renders as a string. No formatting was applied by the object model.|  
 ...
 The value types are derived from the ADMOMD.NET enumeration. For more information, see [Microsoft.AnalysisServices.AdomdServer.MiningValueType](/previous-versions/sql/sql-server-2014/ms144375).  
