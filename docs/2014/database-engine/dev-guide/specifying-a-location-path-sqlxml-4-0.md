...
-   **Relative location path**  
    ...
    > [!NOTE]  
    >  In the SQLXML 4.0 implementation of XPath, every XPath query begins at the root context, even if the XPath is not explicitly absolute. For example, an XPath query beginning with "Customer" is treated as "/Customer". In the XPath query **Customer[Order]**, Customer begins at the root context, but Order begins at the Customer context. For more information, see [Introduction to Using XPath Queries &#40;SQLXML 4.0&#41;](../../../2014/database-engine/dev-guide/introduction-to-using-xpath-queries-sqlxml-4-0.md).  
...
## In This Section  
 [Specifying an Axis &#40;SQLXML 4.0&#41;](../../../2014/database-engine/dev-guide/specifying-an-axis-sqlxml-4-0.md)  
 Provides examples of specifying an axis.  
  
 [Specifying a Node Test in the Location Path &#40;SQLXML 4.0&#41;](../../../2014/database-engine/dev-guide/specifying-a-node-test-in-the-location-path-sqlxml-4-0.md)  
 Provides examples of specifying a node test.  
  
 [Specifying Selection Predicates in the Location Path &#40;SQLXML 4.0&#41;](../../../2014/database-engine/dev-guide/specifying-selection-predicates-in-the-location-path-sqlxml-4-0.md)  
