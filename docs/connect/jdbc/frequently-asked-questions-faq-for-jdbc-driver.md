...
| -------------------------- | ----------------------------- | ----------- |
| mssql-jdbc-9.2.1.jre15.jar | JDBC 4.3 (partially), and 4.2 | JDK 15.0    |
| mssql-jdbc-9.2.1.jre11.jar | JDBC 4.3 (partially), and 4.2 | JDK 11.0    |
