...
You don't need to perform this step if you are using external libraries. In fact, the recommended way of working is using external libraries. For help creating an extenral library from your jar file, see [Use External Libraries](#ext-library)
