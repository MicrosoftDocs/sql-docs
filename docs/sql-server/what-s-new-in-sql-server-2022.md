...
|Data virtualization | Enhances data virtualization capabilities by integrating PolyBase with S3-compatible object storage, also adding the support to querying parquet files with T-SQL.|

## Availability

| New feature or update | Details |
|:---|:---|
| Link to Azure SQL Managed Instance | Connect your SQL Server instance to Azure SQL Managed Instance. See [Link feature for Azure SQL Managed Instance (preview)](/azure/azure-sql/managed-instance/managed-instance-link-feature-overview.md). To experience this feature you can [register here](https://aka.ms/mi-link-2022-signup).|
