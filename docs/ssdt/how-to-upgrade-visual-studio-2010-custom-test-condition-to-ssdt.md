...
description: Learn how to upgrade a Visual Studio 2010 custom test condition for use in SQL Server Data Tools. See which changes to make and how to install the condition.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
