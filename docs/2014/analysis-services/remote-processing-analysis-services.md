...
-   [SQL Server Agent Components](../../2014/database-engine/sql-server-agent.md#Components) suggests alternative fixed server roles if granting **sysadmin** permissions is not possible.  
