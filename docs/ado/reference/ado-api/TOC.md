...
# [ActualSize and DefinedSize Example (VJ++)](actualsize-and-definedsize-properties-example-vj.md)
...
# [BeginTrans, CommitTrans, RollbackTrans Example (VJ++)](begintrans-committrans-and-rollbacktrans-methods-example-vj.md)
...
# [AbsolutePage, PageCount, PageSize Example (VJ++)](absolutepage-pagecount-and-pagesize-properties-example-vj.md)
