...
|:---|:---|:---|:---|:---|
|Windows|[MSI Installer](https://go.microsoft.com/fwlink/?linkid=2069405)|February 1, 2019|18.1|15.0.4316.1|
...
1. Download and run the [DacFramework.msi installer for Windows](https://go.microsoft.com/fwlink/?linkid=2069405).
...
1. Download [sqlpackage for macOS](https://go.microsoft.com/fwlink/?linkid=2069126).
...
1. Download [sqlpackage for Linux](https://go.microsoft.com/fwlink/?linkid=2069122) by using one of the installers or the tar.gz archive:
2. To extract the file and launch sqlpackage, open a new Terminal window and type the following commands:
