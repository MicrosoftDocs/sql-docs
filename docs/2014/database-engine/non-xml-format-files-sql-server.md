...
-   You can create a format file for a particular data type such as character data or native data.  
     ...
     You can create a non-XML format file that contains interactively specified attributes for each data field. For more information, see [Specify Data Formats for Compatibility when Using bcp &#40;SQL Server&#41;](../../2014/database-engine/specify-data-formats-for-compatibility-when-using-bcp-sql-server.md).  
  
> [!NOTE]  
>  XML format files offer several advantages over non-XML format files. For more information, see [XML Format Files &#40;SQL Server&#41;](../../2014/database-engine/xml-format-files-sql-server.md).  
