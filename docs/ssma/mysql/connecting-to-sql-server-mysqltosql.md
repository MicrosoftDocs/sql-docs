...
description: Learn how to connect to a target instance of SQL Database to migrate MySQL databases. SSMA obtains metadata about databases in SQL Database.
ms.prod: sql
ms.custom: ""
ms.date: "01/19/2017"
ms.reviewer: ""
