...
SQL Server Compact Edition Connection Manager is not supported from VS2022.  Details refer to [Microsoft SQL Server Compact Lifecycle](/lifecycle/products/microsoft-sql-server-compact-40). 
