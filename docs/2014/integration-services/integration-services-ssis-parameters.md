...
-   [Configure Dialog Box](../../2014/integration-services/configure-dialog-box.md)  
...
#### Environment Variables  
 ...
 To view the environment variables that are assigned to parameter values, query the catalog.object_parameters view. For more information, see [catalog.object_parameters &#40;SSISDB Database&#41;](../Topic/catalog.object_parameters%20\(SSISDB%20Database\).md).  
...
#### Determining Execution Parameter Values  
 ...
 [catalog.execution_parameter_values &#40;SSISDB Database&#41;](../Topic/catalog.execution_parameter_values%20\(SSISDB%20Database\).md)(view)  
 Shows the actual parameter values that will be used by a specific execution  
  
 [catalog.get_parameter_values &#40;SSISDB Database&#41;](../Topic/catalog.get_parameter_values%20\(SSISDB%20Database\).md) (stored procedure)  
 Resolves and shows the actual values for the specified package and environment reference  
  
 [catalog.object_parameters &#40;SSISDB Database&#41;](../Topic/catalog.object_parameters%20\(SSISDB%20Database\).md) (view)  
 ...
 You can also use the dtexec `/Parameter` option to modify a parameter value. For more information, see [dtexec Utility](../../2014/integration-services/dtexec-utility.md).  
...
### Parameter Validation  
 ...
 For more information, see [Validate Dialog Box](../../2014/integration-services/validate-dialog-box.md).  
...
## Related Tasks  
 [Create Parameters](../../2014/integration-services/create-parameters.md)  
