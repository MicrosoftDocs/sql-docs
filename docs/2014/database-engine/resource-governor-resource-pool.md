...
|----------------------|-----------|  
|Describes how to create a resource pool.|[Create a Resource Pool](../../2014/database-engine/create-a-resource-pool.md)|  
|Describes how to change resource pool settings.|[Change Resource Pool Settings](../../2014/database-engine/change-resource-pool-settings.md)|  
|Describes how to delete a resource pool.|[Delete a Resource Pool](../../2014/database-engine/delete-a-resource-pool.md)|  
