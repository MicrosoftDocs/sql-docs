...
# Edition Element (ASSL)
  Contains the read-only edition of the instance of [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] represented by the [Server](../../dev-guide/server-element-assl.md) element.  
...
|------------------|-------------|  
|Parent elements|[Server](../../dev-guide/server-element-assl.md)|  
|Child elements|None|  
