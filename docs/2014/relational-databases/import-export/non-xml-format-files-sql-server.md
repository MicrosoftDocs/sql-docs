...
> [!NOTE]  
>  XML format files offer several advantages over non-XML format files. For more information, see [XML Format Files &#40;SQL Server&#41;](xml-format-files-sql-server.md).  
...
##  <a name="Structure"></a> Structure of Non-XML Format Files  
 ...
 ![Identifies the fields of a non-XML format file](../../2014/database-engine/media/mydepart-fmt-ident-c.gif "Identifies the fields of a non-XML format file")  
