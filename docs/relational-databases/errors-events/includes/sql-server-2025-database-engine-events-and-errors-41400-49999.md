...
| 41672 | 17 | No | Failed to obtain if the application is the HyperScale reverse migration target. Application name: '%ls'. HRESULT \[%d\]. |
...
| 41680 | 17 | No | An error has occurred while executing an asynchronous operation (HRESULT 0x%08x). |
| 41681 | 16 | No | SQL Server cannot generate grip tds redirection url of the replica with ID %ls (Windows Fabric partition ID %ls). |
| 41682 | 10 | No | Fabric Service '%ls', partition (ID %ls), replica (ID 0x%08X) failed to initialize RBIO transport when openning the replica for database '%ls' with error (HRESULT 0x%08x). If this condition persists, contact the system administrator. |
| 41683 | 10 | No | Fabric Service '%ls', partition (ID %ls), replica (ID 0x%08X) failed to setup SDA RBIO connections for database '%ls' with error (HRESULT 0x%08x). If this condition persists, contact the system administrator. |
| 41684 | 10 | No | Fabric Service '%ls', partition (ID %ls), replica (ID 0x%08X), database '%ls' failed to transition to GxM state. |
...
| 41877 | 16 | Yes | A user defined function referencing memory optimized tables on a MARS connection with an explicit user transaction is currently disallowed. Use a statement level transaction instead. |
| 41878 | 10 | No | In-Memory OLTP database '%.\*ls' is Checkpoint V2 Undeployed. No further action is necessary. |
| 41879 | 16 | Yes | Cannot perform operation since In-Memory OLTP database undeployment is in progress. Complete database undeployment before running the file operation. |
| 41880 | 16 | Yes | In-Memory OLTP database undeployment failed. There are in-memory database objects present, or being created. |
...
| 41979 | 16 | No | Managed database cannot be replicated from Managed Instance to SQL Server, as this managed database is encrypted with service managed key. Either unencrypt the database on Managed Instance, or switch the encryption service protector to customer-managed (BYOK) and try again. |
| 41980 | 16 | No | Database cannot be encrypted using the service managed key as it is being replicated from Managed Instance to SQL Server. Switch the encryption protector from service managed to customer managed (BYOK) on Managed Instance and ensure the encryption key from Managed Instance is imported on SQL Server. |
| 41981 | 16 | No | Switching the encryption protector from customer managed (BYOK) to service managed is not allowed as there exists database replication from Managed Instance to SQL Server supporting customer managed encryption only. |
| 41982 | 16 | No | Database cannot be replicated from Managed Instance to SQL Server as there already exists database geo-replication from this Managed Instance to another Managed Instance using auto-failover groups. Disconnect this Managed Instance from the failover group, and try again. |
| 41983 | 16 | No | In-Memory OLTP database undeployment is not allowed on SQL Database Managed Instance. |
| 41984 | 16 | No | The link cannot be created because database format of the source SQL Managed Instance is not compatible with database format of the destination SQL Server. |
| 41985 | 16 | No | Forced failover is not supported on this managed instance link. For database migration, please delete the link instead. |
...
| 41987 | 16 | No | Managed Instance link cannot be created because Managed Instance side AG name '%.\*ls' is already used on Managed Instance '%.\*ls'. Choose different name and retry to create link. |
...
| 42114 | 16 | No | Azure SQL Database supports a maximum of 256 IPv6 firewall rules. |
...
| 42121 | 16 | No | The operation could not be completed on because attempts to connect were denied by the configured Network Security Perimeter. |
| 42122 | 16 | No | Cannot resume database '%.\*ls' in any elastic pool because all eligible pools are at capacity. |
| 42123 | 16 | No | Login failed as it was determined that the common alias login was invoked, but the common alias login is not currently supported. |
| 42124 | 16 | No | Login failed as it was determined that the common alias login was invoked, but the database name has not been provided. |
| 42125 | 16 | No | Enabling IPv6 is currently not supported on your server, detailed reason is: %.\*ls. |
| 42126 | 16 | No | This serverless database is paused and cannot be resumed by this connection. |
| 42127 | 16 | No | The login failed due to proxy throttling |
| 42128 | 16 | No | Database '%ls' cannot be converted to Hyperscale because it has more than one geo-secondary replica. Reduce the number of geo-secondary replicas to at most one and retry the operation. |
| 42129 | 16 | No | Database '%ls' cannot be converted to Hyperscale because it has chained geo-secondary replicas. Remove chained geo-secondaries and retry the operation. |
| 42130 | 16 | No | A geo-secondary replica '%ls' cannot be converted to Hyperscale. To convert both the primary and geo-secondary replicas to Hyperscale, retry the operation on the primary replica. |
| 42131 | 16 | No | This SQL database has been disabled. Please reach out to your Fabric Capacity administrator for more information. |
...
| 42205 | 16 | No | The vector types '%ls' and '%ls' do not match. |
| 42206 | 16 | No | The vector is invalid. Error details: '%ls'. |
| 42207 | 16 | No | The distance metric specified for vector_distance is unsupported. Please provide a valid string for distance metric. |
| 42208 | 16 | No | The vector LOB type is not supported. Please use a supported vector type. |
| 42209 | 16 | No | A system error occurred. |
| 42210 | 16 | No | The requested norm function '%.\*hs' is not supported by vector_norm/vector_normalize. Please provide a valid norm function. |
| 42211 | 16 | No | Truncation of vector is not allowed during the conversion. Ensure the vector size is appropriate before conversion. |
| 42212 | 16 | No | Cannot create alias types from a vector datatype. |
| 42213 | 16 | No | The vector data types cannot be compared or sorted, except when using the IS NULL operator. |
...
| 42221 | 16 | No | DROP VECTOR INDEX does not support any options. |
...
| 42229 | 16 | No | Cannot create partitioned index on a table having a vector index. |
| 42230 | 16 | No | Cannot create vector index on column '%.\*ls' because it already has an existing vector index. |
| 42231 | 16 | No | Data modification statement failed because table '%.\*ls' has a vector index on it. |
| 42232 | 16 | No | TRUNCATE TABLE statement failed because table '%.\*ls' has a vector index on it. |
| 42233 | 16 | No | Query join hint incompatible with vector search. |
| 42234 | 16 | No | Internal SQL error during DiskANN graph build. |
| 42235 | 16 | No | Invalid value for optional parameter L (%hu) and R (%hu). Please ensure L \>= R. |
| 42236 | 16 | No | The value of R (%hu) is too low. Please ensure R is greater than or equal to %d. |
| 42237 | 16 | No | The vector index cannot be created because filegroup '%.\*ls' does not exist or the filegroup name is incorrectly specified. |
...
| 42303 | 16 | No | Chunking type other than 'fixed' is not supported. |
| 42304 | 16 | No | Chunk size specified for a column of semantic index cannot be less than 1. |
| 42305 | 16 | No | Supported range for chunk overlap value is between 0 and 50. |
| 42306 | 16 | No | Column '%.\*ls' has been specified more than once in semantic index DDL command. |
...
| 45203 | 16 | No | The parameter @state cannot be NULL, and should be 1 or 0. Specify 1 to start SQL Server Managed Backup to Azure, or 0 to pause. |
...
| 45207 | 16 | No | %ls |
| 45208 | 16 | No | SQL Server Managed Backup to Azure master switch is not turned on. |
...
| 45336 | 16 | No | The operation could not be completed because '%ls' is an invalid Server Key name. Please provide a key name in the format of 'vault_key_version' or 'vault_key'. For example, if the keyId is `https://YourVaultName.vault.azure.net/keys/YourKeyName/YourKeyVersion`, then the Server Key Name should be formatted as: YourVaultName_YourKeyName_YourKeyVersion. Or if the keyId is `https://YourVaultName.vault.azure.net/keys/YourKeyName`, then the Server Key Name should be formatted as: YourVaultName_YourKeyName. |
...
| 45599 | 16 | Yes | Standby replicas are not supported in DTU based purchasing models and for serverless databases. Neither source nor target for standby replicas can be DTU based or on serverless service level objective. |
...
| 45611 | 16 | No | Configuration of backup retention policy is not supported on Named Replica. |
| 45612 | 16 | No | It is not possible to stop the instance that has Managed Instance link configured. Refer to the following article for limits of managed instance start/stop feature: [https://go.microsoft.com/fwlink/?linkid=2169085](https://go.microsoft.com/fwlink/?linkid=2169085) |
| 45613 | 16 | No | The ImportExport operation failed because of invalid storage credentials. |
| 45614 | 16 | No | The ImportExport operation failed because of invalid storage auth type. |
| 45615 | 16 | No | The ImportExport operation failed because of invalid storage key format. |
| 45616 | 16 | No | The ImportExport operation failed because the storage URI is too long. |
| 45617 | 16 | No | The Export operation failed because database is larger than max supported size. |
| 45618 | 16 | No | The ImportExport operation failed because it is targeting a '%ls' edition. |
| 45619 | 16 | No | The ImportExport operation failed because the storage URI is invalid. |
...
| 45622 | 16 | No | Geo-redundant backup storage is not permitted for databases under subscription '%s'. |
| 45623 | 16 | No | Managed Instance start/stop feature is available only for instances that are running with Feature Wave November 2022. Refer to the following article for limits of managed instance start/stop feature: [https://go.microsoft.com/fwlink/?linkid=2169085](https://go.microsoft.com/fwlink/?linkid=2169085) |
| 45624 | 16 | No | TR-CMS geo-secondary server/database does not exist. |
| 45625 | 16 | No | The ImportExport operation failed because the SQL authentication type is invalid. Please use either SQL Server or Active Directory. |
| 45626 | 16 | No | The ImportExport operation failed because the storage blob already exists. |
| 45627 | 16 | No | Restoring a Hyperscale database to an elastic pool which is not Hyperscale or restoring a database which is not Hyperscale to a Hyperscale elastic pool is not supported. |
| 45628 | 16 | No | The specified target database name, '%ls', is reserved and cannot be used in a restore operation. |
| 45629 | 16 | No | Restore and database recovery are not supported for system databases. |
| 45630 | 16 | No | The source database, '%ls', dropped on '%ls', has not existed long enough to support restores. |
| 45631 | 16 | No | The source database, '%ls', has not yet accomplished its first backup in order to support restore operations. Please wait until at least the indicated earliest restore date '%ls' and resubmit the request. |
| 45632 | 16 | No | For point-in-time restores, the target logical server must be the same as the source logical server. Consider restoring to the source database's server, or using database copy or database recovery. |
| 45633 | 16 | No | Same-server recovery is currently not supported. Consider using point-in-time restore or recovering to a different server. |
| 45634 | 16 | No | Restore from long-term retention backup to '%ls' edition not supported. |
| 45635 | 16 | No | Restore from external backup to '%ls' edition not supported. |
| 45636 | 16 | No | Enabling long-term backup retention for a serverless database is not supported if auto-pause is enabled. |
| 45637 | 16 | No | Enabling long-term backup retention for a database during migration to the Hyperscale service tier is not supported. |
| 45638 | 16 | No | Enabling long-term backup retention for a database during a reverse migration from Hyperscale is not supported. |
| 45639 | 16 | No | Enabling auto-pause for a serverless database is not supported if long-term backup retention is enabled. |
| 45640 | 16 | No | The subscription ID is required to delete a long-term retention backup. |
| 45641 | 16 | No | The server name is required to delete a long-term retention backup. |
| 45642 | 16 | No | The database name is required to delete a long-term retention backup. |
| 45643 | 16 | No | The provided long-term retention backup resource ID or backup name is incorrect. |
| 45644 | 16 | No | A restore request with the same target database name '%ls' on server '%ls' already exists. |
| 45645 | 16 | No | The external backup storage container URI is malformed. |
| 45646 | 16 | No | The host name for the external backup storage container URI is not allowed. |
| 45647 | 16 | No | The external backup storage container URI uses an invalid scheme or port. Please use https and port 443. |
| 45648 | 16 | No | Hyperscale does not support external backup restore requests. |
| 45649 | 16 | No | For database '%ls', specified point-in-time '%ls' is prior to the Hyperscale migration time of '%ls'. Please specify a target edition or service level objective which is not Hyperscale when restoring to a point earlier than the Hyperscale migration. |
...
| 45654 | 16 | No | Azure Key Vault key URI '%s' is required to successfully restore the database '%s' under server '%s'. |
| 45655 | 16 | No | Restore of Hyperscale database where source database is geo-secondary is not allowed. |
| 45656 | 16 | No | The operation could not be completed because the Azure Key Vault Key name '%ls' is currently set as encryption protector on geo-primary. |
| 45657 | 16 | No | DTC for Azure SQL Managed Instance not ready at the moment. |
| 45658 | 16 | No | This operation cannot start because specified target managed instance '%ls' already has maximum number of user databases. |
| 45659 | 16 | No | No backups were found to restore the database to the point in time %s (UTC). Please contact support to restore the database. |
| 45660 | 16 | No | Target server '%ls' does not have access to all AKV Uris created between %s (UTC) and %s (UTC). Please retry operation after restoring all AKV Uris. |
| 45661 | 16 | No | Unable to connect to the instance in order to perform restore operation. |
| 45662 | 16 | No | Backup set in %ld is broken. Sql error code is %d. Error message: %ls |
| 45663 | 16 | No | A timeout was encountered while trying to connect to the restore target. Please retry or retry with a higher service objective for higher reliability. After restore, the database can be downgraded to the original service objective. |
| 45664 | 16 | No | The restore plan is broken because firstLsn (%ls) of log backup '%ls' is not equal to lastLsn (%ls) of prev log backup %ls. Restore to point in time: %ls (UTC) failed. |
| 45665 | 16 | No | Full backup '%ls' is missing checksum. Please provide full backup with checksum. |
| 45666 | 16 | No | Migration cannot be completed because provided backup file name '%ls' should be the last restore backup file '%ls'. |
| 45667 | 16 | No | The database backup contains incompatible physical layout. Non-online data files exist. |
...
| 45675 | 16 | No | Combination of unspecified target edition (sku.name/sku.tier parameters) and the value TRUE for the isGeneralPurposeV2 parameter is not allowed in the create operation. |
| 45676 | 16 | No | Combination of unspecified target edition (sku.name/sku.tier parameters) and the value TRUE for the isGeneralPurposeV2 parameter is not allowed in the update operation of General Purpose V1 Managed Instance. |
| 45677 | 16 | No | Combination of unspecified target edition (sku.name/sku.tier parameters) and the value FALSE for the isGeneralPurposeV2 parameter is not allowed in the update operation of General Purpose V2 Managed Instance. |
| 45678 | 16 | No | Combination of General Purpose target edition (sku.name/sku.tier parameters) and unspecified value for the isGeneralPurposeV2 parameter is not allowed in the update operation of General Purpose V2 Managed Instance. |
| 45679 | 16 | No | Combination of Business Critical target edition (sku.name/sku.tier parameters) with a specified isGeneralPurposeV2 parameter is not allowed in the create/update operation. |
| 45680 | 16 | No | Combination of unspecified target edition (sku.name/sku.tier parameters) with a specified isGeneralPurposeV2 parameter is not allowed in the update operation of Business Critical Managed Instance. |
| 45681 | 16 | No | Standby replicas are not supported for hyperscale databases. |
| 45682 | 16 | No | No backups were found to restore the database to the point in time %s (UTC). Please retry the operation. If the problem persists, contact support to restore the database. |
| 45683 | 16 | No | Memory size in GB parameter is not allowed in the instance create/update operation. |
| 45684 | 16 | No | Memory size in GB parameter is not allowed in the instance create/update operation for the service tier or hardware generation. |
| 45685 | 16 | No | Could not perform the operation due to capacity group resource constraint based on the requested service level objective and storage size. Plus try again in 24 hours. |
| 45686 | 16 | No | Could not complete the operation due to capacity group resource constraint check failed due to the following reason: {0). |
| 45687 | 16 | No | General Purpose v2 edition of Managed Instance is not compatible with the specified subnet. Target subnet must be either empty, or all instances in it must run with November 2022 Feature Wave. |
| 45688 | 16 | No | The specified memory value is invalid. Please ensure the memory size in GB is within the allowable range of 28 to 870 and corresponds appropriately to the number of vCores and service tier. The available memory sizes for the selected vCores and service tier are {0}. For details around resource limits visit: [https://go.microsoft.com/fwlink/?linkid=2293407](https://go.microsoft.com/fwlink/?linkid=2293407) |
| 45689 | 16 | No | Cannot enable public endpoint for the failover group because managed instance '%ls' doesn't have public endpoint enabled. Please enable public endpoint on the managed instance and try again. |
| 45690 | 16 | No | Another operation is in progress on virtual network firewall rule {0} on server {1}. |
| 45691 | 16 | No | The operation could not be completed because there is at least one database whose number of files is exceeding the limit of %ls files per database on General Purpose v2 edition. |
| 45692 | 16 | No | The operation could not be completed because Next-Gen General Purpose edition doesn't support Custom Maintenance Window |
| 45693 | 16 | No | The database '%.\*ls' on server '%.\*ls' is already being dropped. |
| 45694 | 16 | No | Database '%ls' was not found on SQL managed instance '%ls'. Please check the database name and ensure it matches a database that is currently in 'Restoring' state, then try again. |
| 45695 | 16 | No | Database '%ls' is not in 'Restoring' state on SQL managed instance '%ls'. Please check the database name and ensure it matches a database that is currently in 'Restoring' state, then try again. |
| 45696 | 16 | No | Database '%ls' was already restored on SQL managed instance '%ls'. Please check the database name and ensure it matches a database that is currently in 'Restoring' state, then try again. |
| 45697 | 16 | No | An existing complete restore request for database '%ls' is already in progress on SQL managed instance '%ls'. Please wait for the current request to complete, or try again with a different database that is in 'Restoring' state. |
| 45698 | 16 | No | Cannot create a database with special characters in its name. Special Characters include \u003C, \u003E, \u002A, \u0025, \u0026, \u003A, \u005C, \u002F, \u003F. |
| 45699 | 16 | No | Database copy and geo replication are blocked on databases migrated by whiteglove restore. |
...
| 45746 | 16 | No | The operation could not be completed because the Azure Key Vault Key name '%ls' is currently in use. |
| 45747 | 16 | No | The operation could not be completed because the Azure Key Vault Key material is different than the current encryption protector key. |
| 45748 | 16 | No | Using an old version of AKV key as TDE protector is not allowed. Please use the latest version of the AKV key as the encryption protector. |
| 45749 | 16 | No | Per Database CMK identity not setup on the target database. |
| 45750 | 16 | No | The create elastic pool operation cannot be performed at this time due to ongoing Transparent Data Encryption (TDE) key rotation on the server. Please try the operation again later. |
...
| 45771 | 16 | No | Import/Export with Private Link cannot be used on resources with locks. Please remove locks on the following resources and try again. %ls. |
| 45772 | 16 | No | Perform cutover action is not supported at this time. Details: '%.\*ls'. |
| 45773 | 16 | No | The action failed because no active update-slo operation detected for server: '%.\*ls', database: '%.\*ls'. Please retry the operation by specifying valid parameters. |
| 45774 | 16 | No | Invalid use of manual-cutover option for server: '%.\*ls', database: '%.\*ls'. Please check current and requested service objective and retry the operation by specifying valid parameters. |
| 45775 | 17 | No | One or more apps involved in UpdateSLO management operation are unhealthy for database: '%.\*ls', on server: '%.\*ls'. |
| 45777 | 16 | No | %ls is not yet enabled. %ls |
| 45781 | 16 | No | Database: {0}, on server: {1}, in resource group: {2}, in subscription: {3}, is a data warehouse and cannot use upgrade me now. |
| 45782 | 16 | No | Database: {0}, on server: {1}, in resource group: {2}, in subscription: {3}, belongs to an elastic pool and cannot use upgrade me now. |
| 45783 | 16 | No | Database: {0}, on server: {1}, in resource group: {2}, in subscription: {3}, was not found. |
| 45784 | 16 | No | Database: {0}, on server: {1}, in resource group: {2}, in subscription: {3}, does not have UpgradeMeNow enabled. |
...
| 45914 | 16 | No | Restore operation cannot be performed because database format of the source instance is not compatible with the database format of the destination instance. See [https://go.microsoft.com/fwlink/?linkid=2251601](https://go.microsoft.com/fwlink/?linkid=2251601) for more details. |
| 45915 | 16 | No | Failover operation cannot be performed because of database format mismatch between the instances in the failover group. Consider upgrading the database format of the primary instance or deleting the failover group to promote current secondary instance to a stand-alone instance. See [https://go.microsoft.com/fwlink/?linkid=2251601](https://go.microsoft.com/fwlink/?linkid=2251601) for more details. |
| 45917 | 16 | No | Subscription {0} already has Free SQL Managed Instance. Only one free SQL Managed Instance is allowed per subscription. |
| 45918 | 16 | No | The '%.\*ls' operation cannot be completed as there exists a database in a process of creation through failover group deployment. Please wait for the failover group deployment to complete, or alternatively delete the failover group and retry the operation again. |
| 45919 | 16 | No | Converting to Free SQL Managed instance is not allowed. You can only apply Free offer when you create a new SQL Managed Instance. |
| 45920 | 16 | No | Upgrade failed. To successfully upgrade to a paid offer, ensure that you're not making any other changes to your SQL Managed Instance configuration, such as adjusting vCores or storage. |
| 45921 | 16 | No | You cannot stop the instance that has running operation on it's instance pool. Please wait for ongoing operation to finish or cancel ongoing operation, then try again. ErrorCause: Stop cannot be executed due to conflicting operation on instance pool. |
| 45922 | 16 | No | Maintenance window is set at instance pool level and cannot be set individually per pooled instance. |
| 45923 | 16 | No | Cannot move the instance into the pool due to pool database count limit. |
| 45924 | 16 | No | Cannot move a zone-redundant instance into the pool as zone-redundancy is not supported in pools. |
...
| 45932 | 16 | No | Cannot change continuous copy primary to a database that is outside of the failover group. |
| 45933 | 16 | No | Instance maintenance window must be set to match instance pool maintenance window. |
| 45934 | 16 | No | All databases in geo replication must contain the same key material as the encryption protector of the source database. Please add the key '%ls' with the same key material to the target database '%ls'. |
| 45935 | 16 | No | When the automatic-rotation of database level TDE Protector is enabled, both source and target databases must be connected to the same key vault. Please add key '%ls' (from the same key vault that is connected to source database) to the target database '%ls'. |
| 45936 | 16 | No | While attempting to replicate a database configured with database level encryption protector, the current keys being used by the primary database must be passed to the secondary database '%ls'. |
...
| 46548 | 15 | No | '%ls' contains an unsupported connector location prefix. Refer to product documentation for a list of supported connector location prefixes. |
...
| 46554 | 18 | No | External Table '%.\*ls' contains corrupted metadata. Drop external table and create a new one. |
| 46555 | 16 | No | CREATE EXTERNAL MODEL failed because the user "%.\*ls" specified in the authorization clause does not exist. |
| 46556 | 16 | No | Cannot drop the credential '%.\*ls' because it is used by an external model. |
...
| 46671 | 16 | No | INTERNAL TABLE |
| 46672 | 16 | No | API_FORMAT |
| 46673 | 16 | No | MODEL_TYPE |
| 46674 | 16 | No | MODEL |
| 46675 | 16 | No | PARAMETERS |
| 46676 | 16 | No | SET_PARAMETER |
| 46677 | 16 | No | LOCAL_RUNTIME_PATH |
...
| 46954 | 16 | No | Number of columns specified in '%ls' exceeds the number of columns in external table. |
| 46955 | 16 | No | External table not found or you do not have permission to access it. Underlying data description: %ls. |
| 46956 | 16 | No | Failed to extract rows from external table. Underlying data description: %ls. |
| 46957 | 16 | No | Error encountered while extracting data from external table '%ls'. Underlying data description: %ls. |
| 46958 | 16 | No | Columns '%ls' were not found when querying external table. Underlying data description: %ls. |
| 46959 | 16 | No | Error encoutered in '%S_MSG' parameter. Expected three part name, but found '%ls'. |
| 46960 | 16 | No | Try to reuse default credential name '%.\*ls' but its IDENTITY attribute is not 'USER IDENTITY'. |
| 46961 | 16 | No | Try to reuse default external data source name '%.\*ls' but its LOCATION attribute does not match table location. |
| 46962 | 16 | No | Try to reuse default external file format name '%.\*ls' but its FORMAT_TYPE attribute '%.\*ls' is not consistent with the default file format name. |
| 46963 | 16 | No | Try to use a default external file format for file '%.\*ls' but could not deduce a supported FORMAT_TYPE for the given extension. |
| 46964 | 16 | No | Fail to create the default credential, data source or file format. |
...
| 47614 | 10 | No | Reason: The database failover caused the login failure. |
| 47615 | 10 | No | Reason: The instance could not start up properly because it does not have access to critical resources and it does not allow user connections. Only backend connections are allowed. |
| 47616 | 10 | No | Reason: The login cannot obtain a LOCK resource at this time because the database is being updated. |
...
| 49421 | 16 | Yes | Any ALTER operation on foreign file through pageserver is not supported. |
| 49422 | 16 | Yes | Updating database '%.\*ls' physical id failed. The usage is not impacted, please contact product group for manual mitigation. |
| 49423 | 17 | Yes | There was a failure in the log service with physical database ID '%ls' while executing an operation. HRESULT '0x%x'. Reason: '%ls'. |
| 49424 | 16 | Yes | Transformation of the log file to Hyperscale format failed. |
| 49425 | 16 | Yes | Oldest begin LSN is smaller than foreign redo LSN which will prevent Page Server creation. Operation will be rolled back. |
| 49426 | 16 | Yes | Grow of existing striped file failed. |
| 49427 | 10 | Yes | Foreign File Validator encountered an exception: '%ls'. Logical DBID: '%ls', Physical DBID: '%ls'. |
...
| 49518 | 10 | No | %.\*ls: Page %d:%d was in use and could not be moved by shrink. Please retry shrink later. |
| 49519 | 16 | No | DBCC SHRINKDATABASE is not supported in this version of SQL Server. Contact Customer Support Services for more information. |
| 49520 | 16 | No | Specifying the database_id parameter in DBCC SHRINKFILE is not supported in this version of SQL Server. |
| 49521 | 16 | No | DBCC SHRINKFILE cannot shrink data files when used with database_id parameter. |
| 49522 | 10 | No | DBCC operation on database id %d could not add new cache entries for Index Repair. |
| 49523 | 16 | No | The operation failed because the Index Repair Manager is not available. |
| 49524 | 16 | No | The operation failed because the Index Repair Feature is not supported for the object type %S_MSG (object ID %ld). |
| 49525 | 14 | No | User '%.\*ls' does not have permission to use the Index Repair Feature for object ID %ld. |
| 49526 | 16 | No | An internal error occurred. Unable to get lock on the cache used by the Index Repair Manager. |
| 49527 | 16 | No | The operation failed because the Index Repair Feature is not supported for temp tables. |
| 49528 | 16 | No | The input row handle could not be decoded. Please use the sys.dm_db_logical_index_corruptions DMV to obtain the row handle. |
| 49529 | 16 | No | Index repair failed. Please verify that the corruption exists using DBCC CHECK commands and use the sys.dm_db_logical_index_corruptions DMV to get the row handle for the repair. Please contact support if the error persists. |
| 49530 | 10 | No | The requested repair finished successfully. |
| 49531 | 16 | No | The operation failed because the internal repair command is invalid. |
| 49532 | 16 | No | DBCC SHRINKFILE for data files is not supported in a Hyperscale database when the database is not encrypted or protector change is in progress. Enable transparent data encryption or wait for protector change to complete and try again. Refer sys.dm_database_encryption_keys for more details. |
| 49533 | 16 | No | DBCC SHRINKDATABASE is not supported in a Hyperscale database when the database is not encrypted or protector change is in progress. Enable transparent data encryption or wait for protector change to complete and try again. Refer sys.dm_database_encryption_keys for more details. |
| 49534 | 16 | No | The input row handle is invalid for the given object ID and index ID. Please verify that the corruption exists using DBCC CHECK commands and use the output of the sys.dm_db_logical_index_corruptions DMV for the repair. |
...
| 49923 | 16 | No | Managed Server '%s' is disabled. Please enable it and try again. |
...
| 49952 | 10 | No | [https://go.microsoft.com/fwlink/?LinkId=746388](https://go.microsoft.com/fwlink/?LinkId=746388). |
