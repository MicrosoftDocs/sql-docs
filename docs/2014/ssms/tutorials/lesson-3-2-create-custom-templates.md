...
11. Edit the template script (the script in step 7), replacing the product name Blade with the parameter **_<_product_name**, `nvarchar(50)`, **name_>_**, in four places.  
