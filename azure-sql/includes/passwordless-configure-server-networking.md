...
1) For local development connections, make sure your logical server is configured to allow your local machine IP address and other Azure services to connect:
    ...
    * Make sure the **Allow Azure services and resources to connect to this server** checkbox is selected.
        ...
        > [!WARNING]
        > Enabling the **Allow Azure services and resources to connect to this server** setting is not a recommended security practice for production scenarios. Real applications should implement more secure approaches, such as stronger firewall restrictions or virtual network configurations.
        >
        > [Configure a virtual network with private endpoints](/azure/private-link/tutorial-private-endpoint-sql-portal).
        >
        > [Configure Azure SQL Database firewall rules](/azure/azure-sql/database/firewall-configure?view=azuresql).
