...
[!INCLUDE[applies-to-version/asa-pdw](../../includes/applies-to-version/asa-pdw.md)]
  ...
  This stores network credentials in [!INCLUDEssazuresynapse-md(../../includes/ssazuresynapse-md.md)] and associates them with a server. For example, use this stored procedure to give [!INCLUDEssazuresynapse-md(../../includes/ssazuresynapse-md.md)] appropriate read/write permissions to perform database backup and restore operations on a target server, or to create a backup of a certificate used for TDE.  
...
## Arguments  
 '*target_server_name*'  
 Specifies the target server host name or IP address. [!INCLUDEssazuresynapse-md(../../includes/ssazuresynapse-md.md)] will access this server by using the username and password credentials passed to this stored procedure.  
