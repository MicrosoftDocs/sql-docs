...
4. Edit project by adding or removing Table, View, Store Proc or custom scripts in the project 
...
3. Source control integration and new project creation do not create .gitignore or .gitattributes files by default 
