...
-   All instances comprising the `MultiPolygon` instance are accepted `Polygon` instances. For more information on accepted `Polygon` instances, see [Polygon](../../2014/database-engine/polygon.md).  
...
1.  All of the instances comprising the `MultiPolygon` instance are valid `Polygon` instances. For valid `Polygon` instances, see [Polygon](../../2014/database-engine/polygon.md).  
