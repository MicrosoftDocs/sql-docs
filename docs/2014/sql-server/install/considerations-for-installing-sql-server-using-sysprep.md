...
-   [Complete Image](#BKMK_CompleteImage)  
 ...
 For more information about how to install [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] using SysPrep, see [Install SQL Server 2014 Using SysPrep](../../../2014/sql-server/install/install-sql-server-2014-using-sysprep.md).  
...
## Supported [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Installations  
 ...
 For information about supported editions of [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)], see [Features Supported by the Editions of SQL Server 2014](../../../2014/getting-started/features-supported-by-the-editions-of-sql-server-2014.md).  
