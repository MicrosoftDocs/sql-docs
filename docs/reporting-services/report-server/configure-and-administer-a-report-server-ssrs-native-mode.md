...
description: Learn about approaches that you can use to configure Reporting Services and find topics about how to configure components, features, or server capabilities.
ms.date: 05/15/2019
