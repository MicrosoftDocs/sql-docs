...
- [Transport security in availability groups and database mirroring](../../database-engine/database-mirroring/transport-security-database-mirroring-always-on-availability.md)
