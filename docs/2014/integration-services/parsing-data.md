...
-   Fast parse is a fast, simple set of parsing routines that does not support locale-specific data type conversions, and supports only the most frequently used date and time formats. For more information, see [Fast Parse](../../2014/integration-services/fast-parse.md).  
  
-   Standard parse is a rich set of parsing routines that supports all the data type conversions that are provided by the Automation data type conversion APIs available in Oleaut32.dll and Ole2dsip.dll. For more information, see [Standard Parse](../../2014/integration-services/standard-parse.md).  
