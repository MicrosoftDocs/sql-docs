...
| ---| --- |--- |
| [DC-series hardware up to 40 vCores](resource-limits-vcore-single-databases.md) | July 2023 | DC-series hardware on Intel Ice Lake processors is now available for up to 40 vCore counts in General Purpose, Business Critical, and Hyperscale provisioned compute. |
