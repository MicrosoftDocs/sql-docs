...
## Table-Valued Parameter with Fully Bound Multirow Buffers (Send Data as a TVP with All Values in Memory)  
 ...
 Sample code for this scenario is in the procedure `demo_fixed_TVP_binding` in [Use Table-Valued Parameters &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/use-table-valued-parameters-odbc.md).  
...
## Table-Valued Parameter with Row Streaming (Send Data as a TVP Using Data-At-Execution)  
 ...
 Sample code for this scenario is in the routine `demo_variable_TVP_binding` in [Use Table-Valued Parameters &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/use-table-valued-parameters-odbc.md).  
...
## Retrieving Table-Valued Parameter Metadata from the System Catalog  
 ...
 Sample code for this scenario is in the routine `demo_metadata_from_catalog_APIs` in [Use Table-Valued Parameters &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/use-table-valued-parameters-odbc.md).  
...
## Retrieving Table-Valued Parameter Metadata for a Prepared Statement  
 ...
 Sample code for this use case is in the routine `demo_metadata_from_prepared_statement` in [Use Table-Valued Parameters &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/use-table-valued-parameters-odbc.md).  
