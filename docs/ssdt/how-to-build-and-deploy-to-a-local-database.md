...
description: Learn about the local server instance that SQL Server 2012 provides. See how to use it for building, testing, and debugging development projects.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
