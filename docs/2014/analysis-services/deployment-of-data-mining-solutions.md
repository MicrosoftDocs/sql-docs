...
-   Use the models to create predictions and make business decisions. For information about the tools you can use to create queries, see [Data Mining Query Interfaces](../../2014/analysis-services/data-mining-query-interfaces.md).  
...
## In This Section  
 [Deploy a Data Mining Solution to Previous Versions of SQL Server](../../2014/analysis-services/deploy-a-data-mining-solution-to-previous-versions-of-sql-server.md)  
