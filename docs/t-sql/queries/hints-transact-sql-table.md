...
> [!NOTE]  
> [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)] supports automatic use of indexed views without specifying the `NOEXPAND` hint.
