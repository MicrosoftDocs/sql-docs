...
-   The following columns have been added to [sys.dm_clr_appdomains](../Topic/sys.dm_clr_appdomains%20\(Transact-SQL\).md): `total_processor_time_ms`, `total_allocated_memory_kb`, and `survived_memory_kb`.  
