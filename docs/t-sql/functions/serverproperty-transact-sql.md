...
| `IsExternalGovernanceEnabled` | **Applies to**: [!INCLUDE[sql-server-2022](../../includes/sssql22-md.md)] and later.<br /><br />Returns 1 or 0.<br /><br />1 = External Governance is enabled.<br /><br />0 = External Governance is disabled.<br /><br />Base data type: **int** |
