...
## Next Steps  
If you want to analyze the conversion of Sybase ASE objects into [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] or SQL Azure objects, you can [Create a conversion report](http://msdn.microsoft.com/eb996b7c-1eef-4f73-b5e6-2fa6faf7336c). Otherwise you can [Convert the ASE database object definitions](http://msdn.microsoft.com/509cb65d-2f54-427a-83d7-37919cc4e3e3) into [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] or SQL Azure object definitions.  
