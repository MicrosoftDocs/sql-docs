...
- Identify any missing indexes using one of these methods:
  ...
  - Review recommendations in the [Database Advisor](database-advisor-implement-performance-recommendations.md) for single and pooled databases in Azure SQL Database. You may also choose to enable [automatic tuning options for tuning indexes](automatic-tuning-overview.md#automatic-tuning-options) for Azure SQL Database.
