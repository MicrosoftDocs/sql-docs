...
# Microsoft Sequence Clustering Algorithm Technical Reference
 ...
 For more general information about the algorithm, including how to browse and query sequence clustering models, see [Microsoft Sequence Clustering Algorithm](../../2014/analysis-services/microsoft-sequence-clustering-algorithm.md).  
...
## Implementation of the Microsoft Sequence Clustering Algorithm  
 ...
 By default, the Microsoft Sequence Clustering algorithm uses the Expectation Maximization (EM) method of clustering. For more information, see [Microsoft Clustering Algorithm Technical Reference](../../2014/analysis-services/microsoft-clustering-algorithm-technical-reference.md).  
...
### Modeling Flags  
 ...
 For more information about the use of Missing values in mining models, and how missing values affect probability scores, see [Missing Values &#40;Analysis Services - Data Mining&#41;](../../2014/analysis-services/missing-values-analysis-services-data-mining.md).  
