---
title: Validate Azure Arc-enabled SQL Server onboard #Required; page title is displayed in search results. Include the brand.
description: Demonstrates how to validate Azure Arc-enabled SQL Server onboard #Required; article description that is displayed in search results. 
...
ms.date: 01/02/2023 #Required; mm/dd/yyyy format.
