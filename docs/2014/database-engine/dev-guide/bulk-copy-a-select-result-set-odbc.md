...
5.  Call [bcp_control](../../../2014/database-engine/dev-guide/bcp-control.md), set eOption to BCPHINTS and place in iValue a pointer to a SQLTCHAR array containing the SELECT statement.  
  
6.  Call [bcp_exec](../../../2014/database-engine/dev-guide/bcp-exec.md) to execute the bulk copy operation.  
  
 When using these steps the file is created in native format. You can convert the data values to other data types by using [bcp_colfmt](../../../2014/database-engine/dev-guide/bcp-colfmt.md). For more information, see [Create a Bulk Copy Format File &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/create-a-bulk-copy-format-file-odbc.md).  
