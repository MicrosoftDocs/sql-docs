...
---
# Steps Element (XMLA)
  Specifies the maximum number of steps used by the [DesignAggregations](../../../2014/analysis-services/dev-guide/designaggregations-element-xmla.md) command to design aggregations.  
