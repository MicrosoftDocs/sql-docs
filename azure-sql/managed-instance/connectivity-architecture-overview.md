...
- **Replication traffic**: Replication traffic for auto-failover groups between two instances of SQL Managed Instance should be direct and not routed through a hub network.
