...
# Table-Valued Parameters (SQL Server Native Client)
 ...
 For information about table-valued parameters and OLE DB, see [Table-Valued Parameters &#40;OLE DB&#41;](../../../2014/database-engine/dev-guide/table-valued-parameters-ole-db.md).  
