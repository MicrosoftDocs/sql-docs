 ...
 **Data type**  
 Choose the data type for **Value**. When possible, choose a data type that matches the data type for **Expression**. For more information, see [Filter Equation Examples &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/filter-equation-examples-report-builder-and-ssrs.md).  
