...
## Partition source  
 ...
 If the partition is based on a query, click the browse (**...**) button to edit the query. This edits the **Source** property for the partition. For more information, see [Change a partition source to use a different fact table](../../2014/analysis-services/change-a-partition-source-to-use-a-different-fact-table.md).  
...
## See Also  
 ...
 [Designing Aggregations &#40;Analysis Services - Multidimensional&#41;](../../2014/analysis-services/designing-aggregations-analysis-services-multidimensional.md)   
