...
##### [Grant administrator permissions](grant-server-administrator-permissions-analysis-services.md)
...
###### [Querying the Data Mining Schema Rowsets](querying-the-data-mining-schema-rowsets-analysis-services-data-mining.md)
