...
SQL Server Compact Edition Connection Manager is not supported from VS2022.  Details refer to [Microsoft SQL Server Compact Lifecycle](https://learn.microsoft.com/en-us/lifecycle/products/microsoft-sql-server-compact-40). 
