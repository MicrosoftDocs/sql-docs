...
> [!NOTE]
> The standard R `install.packages` command is not recommended for adding R packages on SQL Server 2019 and later. Instead, use **sqlmlutils** as described in this article.
