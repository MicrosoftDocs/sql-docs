...
description: ALTER DATABASE (Transact-SQL) syntax for SQL Server, Azure SQL Database, and Azure Synapse Analytics.
...
dev_langs:
  - "TSQL"
monikerRange: ">=sql-server-2017 || >=sql-server-linux-2017 || =azuresqldb-current || =azuresqldb-mi-current || =azure-sqldw-latest || =fabric"
---
