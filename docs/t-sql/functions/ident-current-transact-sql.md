...
description: IDENT_CURRENT returns the last identity value generated for a specified table or view.
author: VanMSFT
ms.author: vanto
ms.reviewer: wiassaf
ms.date: 08/19/2026
...
The `IDENT_CURRENT` system function returns the last identity value generated for a specified table or view. The last identity value generated can be for any session and any scope.  
...
The name of the table or view whose identity value is returned. *table_or_view* is **varchar**, with no default.
...
> [!IMPORTANT]
> Use caution when using `IDENT_CURRENT` to predict the next generated identity value. The actual generated value can be different from `IDENT_CURRENT` plus `IDENT_INCR` because of insertions performed by other sessions.  

The `IDENT_CURRENT` function is not available for [identity columns in Fabric Data Warehouse](/fabric/data-warehouse/identity).

## Examples

<a id="a-returning-the-last-identity-value-generated-for-a-specified-table"></a>

### A. Return the last identity value generated for a specified table
...
<a id="b-comparing-identity-values-returned-by-ident_current-identity-and-scope_identity"></a>

### B. Compare identity values returned by IDENT_CURRENT, @@IDENTITY and SCOPE_IDENTITY
