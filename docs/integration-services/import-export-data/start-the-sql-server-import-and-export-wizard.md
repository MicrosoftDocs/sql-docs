...
> [!TIP]
> Another way to import data is on [Azure Data Studio](../../azure-data-studio/what-is-azure-data-studio.md) with [SQL Server Import extension](../../azure-data-studio/extensions/sql-server-import-extension.md).
