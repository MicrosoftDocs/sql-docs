...
- Place data, log, and tempdb files on separate drives.
    - For the data drive, only use [premium P30 and P40 disks](/azure/virtual-machines/disks-types#premium-ssds) to ensure the availability of cache support
...
Ultra disk is not supported on all VM series and has other limitations such as region availability, redundancy, and support for Azure Backup. To learn more, see [Using Azure ultra disks](/azure/virtual-machines/disks-enable-ultra-ssd) for a full list of limitations.
...
- Use the [Standard_M32ms](/azure/virtual-machines/m-series) which has a max uncached disk throughput of 20,000 IOPS and 500 MBps.
...
There are a number of restrictions to using Write Acceleration. To learn more, see [Restrictions when using Write Accelerator](/azure/virtual-machines/how-to-enable-write-accelerator#restrictions-when-using-write-accelerator).
