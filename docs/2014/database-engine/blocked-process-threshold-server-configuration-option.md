...
# blocked process threshold Server Configuration Option
 ...
 You can define an [alert](../../2014/database-engine/alerts.md) to be executed when this event is generated. So for example, you can choose to page the administrator to take appropriate action to handle the blocking situation.  
