...
# DataSourceView Element (XMLA)
  Contains an out-of-line data source view binding for the parent [Batch](../../../2014/analysis-services/dev-guide/batch-element-xmla.md) or [Process](../../../2014/analysis-services/dev-guide/process-element-xmla.md) element.  
