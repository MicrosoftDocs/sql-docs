...
# Statistics for Memory-Optimized Tables
 ...
 Statistics are created automatically, but can also be created manually. For example, statistics are created automatically for index key columns when the index is created. For more information about creating statistics see [Statistics](../../2014/database-engine/statistics.md).  
 ...
 Statistics on memory-optimized tables are not updated by default. Instead, you need to update them manually. Use [UPDATE STATISTICS &#40;Transact-SQL&#41;](~/t-sql/statements/update-statistics-transact-sql.md) for individual columns, indexes, or tables. Use [sp_updatestats &#40;Transact-SQL&#41;](~/relational-databases/system-stored-procedures/sp-updatestats-transact-sql.md) to update statistics for all user and internal tables in the database.  
  
 When using [CREATE STATISTICS &#40;Transact-SQL&#41;](~/t-sql/statements/create-statistics-transact-sql.md) or [UPDATE STATISTICS &#40;Transact-SQL&#41;](~/t-sql/statements/update-statistics-transact-sql.md), you must specify `NORECOMPUTE` to disable automatic statistics update for memory-optimized tables. For disk based tables, [sp_updatestats &#40;Transact-SQL&#41;](~/relational-databases/system-stored-procedures/sp-updatestats-transact-sql.md) only updates statistics if the table has been modified since the last [sp_updatestats &#40;Transact-SQL&#41;](~/relational-databases/system-stored-procedures/sp-updatestats-transact-sql.md). For memory-optimized tables, [sp_updatestats &#40;Transact-SQL&#41;](~/relational-databases/system-stored-procedures/sp-updatestats-transact-sql.md) always generates updated statistics. [sp_updatestats &#40;Transact-SQL&#41;](~/relational-databases/system-stored-procedures/sp-updatestats-transact-sql.md) is a good option for memory-optimized tables; otherwise you need to know which tables have significant changes so you can update statistics individually.  
 ...
 Disk-based tables use sampled statistics by default. Memory-optimized tables only support fullscan statistics. When using [CREATE STATISTICS &#40;Transact-SQL&#41;](~/t-sql/statements/create-statistics-transact-sql.md) or [UPDATE STATISTICS &#40;Transact-SQL&#41;](~/t-sql/statements/update-statistics-transact-sql.md), you must specify the `FULLSCAN` option for memory-optimized tables.  
...
-   Use [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] to [Create a Maintenance Plan](../../2014/database-engine/create-a-maintenance-plan.md) with an [Update Statistic Task](../../2014/database-engine/update-statistics-task-maintenance-plan.md)  
...
```  
 ...
 To update statistics for all tables in the database, run [sp_updatestats &#40;Transact-SQL&#41;](~/relational-databases/system-stored-procedures/sp-updatestats-transact-sql.md).  
