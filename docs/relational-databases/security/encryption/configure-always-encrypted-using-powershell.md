...
The SqlServer PowerShell module provides cmdlets for configuring [Always Encrypted](../../../relational-databases/security/encryption/always-encrypted-database-engine.md) in both [!INCLUDE[ssSDSFull](../../../includes/ssazure-sqldb.md)] or [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].
