...
-   [PowerShell cmdlets for Reporting Services SharePoint Mode](../../2014/reporting-services/powershell-cmdlets-for-reporting-services-sharepoint-mode.md) Includes the following examples:  
...
-   See the section “Access the WMI classes using PowerShell” in [Access the Reporting Services WMI Provider](../../2014/reporting-services/access-the-reporting-services-wmi-provider.md).  
...
-   [Sample Reporting Services rs.exe Script to Migrate Content between Report Servers](../../2014/reporting-services/sample-reporting-services-rs-exe-script-to-copy-content-between-report-servers.md).  
...
## See Also  
 ...
 [Script with the rs.exe Utility and the Web Service](../../2014/reporting-services/script-with-the-rs-exe-utility-and-the-web-service.md)  
