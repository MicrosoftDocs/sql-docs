...
|------------------|-------------|  
|Parent element|[IncrementalProcessingNotification](../../../2014/analysis-services/dev-guide/incrementalprocessingnotification-element-assl.md)|  
|Child elements|None|  
  
## Remarks  
 The table in the [DataSourceView](../../../2014/analysis-services/dev-guide/datasourceview-element-assl.md) that is referenced by the `ProcessingQuery` is identified by the sibling element, [TableID](../../../2014/analysis-services/dev-guide/tableid-element-assl.md).  
