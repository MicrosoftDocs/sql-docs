...
# Perspective Representation (Tabular)
 ...
 See [Perspective Representation (Tabular)](../../../2014/analysis-services/dev-guide/perspective-representation-tabular.md) for a detailed explanation on how to create and manipulate the perspective representation.  
