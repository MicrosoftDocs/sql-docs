...
-   **PRIMARY KEY or UNIQUE constraint**  
     ...
     For more information, see [Unique Constraints and Check Constraints](../../2014/database-engine/unique-constraints-and-check-constraints.md) and [Primary and Foreign Key Constraints](../../2014/database-engine/primary-and-foreign-key-constraints.md).  
...
-   A unique nonclustered index can contain included nonkey columns. For more information, see [Create Indexes with Included Columns](../../2014/database-engine/create-indexes-with-included-columns.md).  
