...
## Predefined Role Assignments  
 ...
 For more information about the predefined role assignments that provide default security, see [Predefined Roles](../../2014/reporting-services/predefined-roles.md).  
