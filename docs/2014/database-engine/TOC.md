...
####### [Configure IntelliSense (SQL Server Management Studio)](../relational-databases/scripting/configure-../relational-databases/scripting/intellisense-sql-server-management-studio.md)
...
####### [Troubleshooting IntelliSense (SQL Server Management Studio)](troubleshooting-../relational-databases/scripting/intellisense-sql-server-management-studio.md)
...
####### [Run the Transact-SQL Debugger](../relational-databases/scripting/run-the-../relational-databases/scripting/transact-sql-debugger.md)
...
##### [Enable Resource Governor](../relational-databases/resource-governor/enable-../relational-databases/resource-governor/resource-governor.md)
##### [Disable Resource Governor](../relational-databases/resource-governor/disable-../relational-databases/resource-governor/resource-governor.md)
...
##### [Create and Run Traces Using Transact-SQL Stored Procedures](../relational-databases/native-client-odbc-queries/executing-statements/procedures.md)
...
##### [Create Partitioned Tables and Indexes](create-../relational-databases/native-client-ole-db-tables-indexes/tables-and-indexes.md)
...
##### [Specify Query Parameterization Behavior by Using Plan Guides](specify-query-parameterization-behavior-by-using-../relational-databases/performance/plan-guides.md)
...
##### [Use SQL Server Profiler to Create and Test Plan Guides](use-sql-server-profiler-to-create-and-test-../relational-databases/performance/plan-guides.md)
...
####### [Options (SQL Server Object Explorer/Commands)](../relational-databases/native-client-ole-db-commands/commands.md)
...
######## [Job Activity Monitor](../relational-databases/performance-monitor/activity-monitor.md)
...
###### [Back Up the Service Master Key](../relational-databases/security/encryption/back-up-the-../relational-databases/security/encryption/service-master-key.md)
###### [Restore the Service Master Key](../relational-databases/security/encryption/restore-the-../relational-databases/security/encryption/service-master-key.md)
