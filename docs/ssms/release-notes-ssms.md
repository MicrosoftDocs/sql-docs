...
| Availability Group Dashboard | Connecting to the Availability Group Dashboard for an AG on SQL Server 2016 and below results in "unknown property Cluster Type" error. | Use SSMS 18.11 to access the AG Dashboard for SQL Server 2016 and earlier. |
