...
:::image type="icon" source="../../includes/media/download.svg" border="false"::: **[Download Microsoft OLE DB Driver 19 for SQL Server (ARM64 Preview)](https://go.microsoft.com/fwlink/?linkid=2224283)**  
...
Microsoft OLE DB Driver 19.3.0 for SQL Server (ARM64 Preview):  
