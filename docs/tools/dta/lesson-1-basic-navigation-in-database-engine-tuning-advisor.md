...
- Download [AdventureWorks2017 sample databases.](../../samples/adventureworks-install-configure.md?view=sql-server-2017&preserve-view=true)


Instructions for restoring databases in SSMS are here: [Restore a database.](../../relational-databases/backup-restore/restore-a-database-backup-using-ssms.md?view=sql-server-2017&preserve-view=true)
