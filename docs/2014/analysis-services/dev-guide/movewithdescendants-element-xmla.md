...
# MoveWithDescendants Element (XMLA)
  Indicates whether the descendants of attribute members are also updated by the parent [Update](../../../2014/analysis-services/dev-guide/update-element-xmla.md) command.  
...
|------------------|-------------|  
|Parent elements|[Update](../../../2014/analysis-services/dev-guide/update-element-xmla.md)|  
|Child elements|None|  
  
## Remarks  
 The `MoveWithDescendants` element determines whether the `Update` command should not just update the attribute members identified by the [Attributes](../../../2014/analysis-services/dev-guide/attributes-element-xmla.md) element, but also that the descendants of those attribute members are to be updated as well.  
