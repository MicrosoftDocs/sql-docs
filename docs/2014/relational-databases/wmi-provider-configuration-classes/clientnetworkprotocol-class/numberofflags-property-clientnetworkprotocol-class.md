...
---
# NumberOfFlags Property (ClientNetworkProtocol Class)
  Gets the number of flag options required by the client network protocol specified by the [SetOrderValue Method (ClientNetworkProtocol Class)](../../../database-engine/dev-guide/clientnetworkprotocol-class.md).  
