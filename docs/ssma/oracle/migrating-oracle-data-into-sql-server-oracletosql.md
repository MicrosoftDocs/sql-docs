...
description: Learn to migrate data from an Oracle database to SQL Server, after you synchronize the converted objects with the SSMA for Oracle application.
ms.prod: sql
ms.custom: ""
ms.date: "01/19/2017"
ms.reviewer: ""
