...
-   If you are browsing to a local report server and you see errors similar to the following, see: [Configure a Native Mode Report Server for Local Administration &#40;SSRS&#41;](../../2014/reporting-services/configure-a-native-mode-report-server-for-local-administration-ssrs.md)  
...
-   If you see error messages similar to the following, see [Configure a Report Server for Remote Administration](../../2014/reporting-services/configure-a-report-server-for-remote-administration.md).  
