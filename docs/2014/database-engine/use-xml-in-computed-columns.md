...
|Topic|Description|  
|-----------|-----------------|  
|[Promote Frequently Used XML Values with Computed Columns](../../2014/database-engine/promote-frequently-used-xml-values-with-computed-columns.md)|Describes how to use property promotion with computed columns and property tables.|  
