...
|StatementTimeout|Integer|The number of seconds to wait for a SQL statement to execute before returning, with an error, to the application. The default value is 120.|  
