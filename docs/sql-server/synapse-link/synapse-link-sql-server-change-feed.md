...
- In Azure Synapse Link, the data will be cached in memory to be consumed and eventually written to a landing zone in Azure Storage. 
...
When an existing SQL Server table containing data is added to the Azure Synapse Link, a full snapshot of the initial set of data is generated. The initial snapshot file is a .parquet format file that is transmitted to the landing zone in ADLS Gen2. 
