...
# Analysis Services Trace Events
 ...
 Trace events can be started and captured using **[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]**, see [Use SQL Server Profiler to Monitor Analysis Services](../instances/use-sql-server-profiler-to-monitor-analysis-services.md), or can be started from an XMLA command as **SQL Server Extended Events** and later analyzed, see [Use SQL Server Extended Events &#40;XEvents&#41; to Monitor Analysis Services](../../relational-databases/extended-events/extended-events.md).  
...
## See Also  
[Use SQL Server Profiler to Monitor Analysis Service](../instances/use-sql-server-profiler-to-monitor-analysis-services.md)