...
# CaptionIsMdx Element (ASSL)
  Defines whether the caption for the [Action](../../../2014/analysis-services/dev-guide/action-element-assl.md) element is a Multidimensional Expressions (MDX) expression.  
...
|------------------|-------------|  
|Parent element|[Action](../../../2014/analysis-services/dev-guide/action-element-assl.md)|  
|Child elements|None|  
