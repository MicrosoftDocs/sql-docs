...
1.  Is an accepted `LineString`, `CircularString`, or `CompoundCurve` instance. For more information on accepted instances, see [LineString](../../2014/database-engine/linestring.md), [CircularString](../../2014/database-engine/circularstring.md), and [CompoundCurve](../../2014/database-engine/compoundcurve.md).  
...
```  
 ...
 CurvePolygon instances have the same validity rules as Polygon instances with the exception that CurvePolygon instances may accept the new circular arc segment types. For more examples of instances that are valid or not valid, see [Polygon](../../2014/database-engine/polygon.md).  
