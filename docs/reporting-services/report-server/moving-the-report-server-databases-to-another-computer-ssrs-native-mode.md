...
To restore the databases, open SQL Server Management Studio, and then run the following statements in a query window. To avoid access errors, run SQL Server Management Studio as an administrator.
