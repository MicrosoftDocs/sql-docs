...
|![A node for which we have complete information](../../relational-databases/replication/media/p2pwizard-complete.gif "A node for which we have complete information") or a later version, for which replication has complete information. To specify configuration options, right-click the node.|  
