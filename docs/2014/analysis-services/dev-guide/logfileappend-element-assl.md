...
# LogFileAppend Element (ASSL)
  Determines whether the [Trace](../../../2014/analysis-services/dev-guide/trace-element-assl.md) element appends its logging output to the existing log file, or overwrites it.  
...
|------------------|-------------|  
|Parent element|[Trace](../../../2014/analysis-services/dev-guide/trace-element-assl.md)|  
|Child elements|None|  
...
## See Also  
 [Traces Element &#40;ASSL&#41;](../../../2014/analysis-services/dev-guide/traces-element-assl.md)   
