...
```  
 ...
 For more information about adding a view to a query, see [Add Tables to Queries &#40;Visual Database Tools&#41;](../../2014/database-engine/add-tables-to-queries-visual-database-tools.md).  
...
```  
 ...
 For more information about adding a query to a query, see [Add Tables to Queries &#40;Visual Database Tools&#41;](../../2014/database-engine/add-tables-to-queries-visual-database-tools.md).  
