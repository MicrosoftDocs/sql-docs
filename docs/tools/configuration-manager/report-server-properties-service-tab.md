...
This service is the [!INCLUDE [ssnoversion-md](../../includes/ssnoversion-md.md)] [!INCLUDE [ssrsnoversion-md](../../includes/ssrsnoversion-md.md)] ([!INCLUDE [ssrs](../../includes/ssrs.md)]) service. This service must be running for [!INCLUDE [ssrs](../../includes/ssrs.md)] to work properly. The property values in light gray can't be changed by using this application.
...
Displays the name of the computer or cluster running the [!INCLUDE [ssrs](../../includes/ssrs.md)] service.
