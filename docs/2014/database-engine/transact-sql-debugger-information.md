...
-   A SELECT statement that returns a single value, such as SELECT CharCol FROM MyTable WHERE PrimaryKey = 1.  
 ...
 In debug mode, when you move the mouse pointer over an identifier, a **Quick Info** pop up is displayed with the name of the expression and its current value. For more information, see [Quick Info &#40;IntelliSense&#41;](../../2014/database-engine/quick-info-intellisense.md).  
  
## Breakpoints  
 You can use the **Breakpoints** window to view and manage the currently set breakpoints. For more information, see [Step Through Transact-SQL Code](../../2014/database-engine/step-through-transact-sql-code.md).  
...
## See Also  
 ...
 [Breakpoints Window](../../2014/database-engine/breakpoints-window.md)   
 [Call Stack Window](../../2014/database-engine/call-stack-window.md)   
 [Threads Window](../../2014/database-engine/threads-window.md)   
 [Output Window](../../2014/database-engine/output-window.md)   
