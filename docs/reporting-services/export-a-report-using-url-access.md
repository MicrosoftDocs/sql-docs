...
description: Learn how to export a report using URL access, specifically by specifying the format in which to render a report by using the rs:Format URL parameter. 
ms.date: 03/01/2017
