...
## Remarks  
 Use the **Source** property to specify a data source for a **Recordset** object using one of the following: a **Command** object variable, a SQL statement, a stored procedure, or a table name.  
 ...
 If the **Source** property is a SQL statement, a stored procedure, or a table name, you can optimize performance by passing the appropriate *Options* argument with the [Open](./open-method-ado-recordset.md) method call.  
