...
-   Have an Azure account?  Then go **[Here](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016ctp2evaluationwindowsserver2012r2/?wt.mc_id=sqL16_vm)** to spin up a Virtual Machine with [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] already installed.  
...
> [!WARNING]  
>  When running the [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] setup program, the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance is stopped and restarted as part of running the pre-upgrade checks.  
...
-   An x86 installation of SQL Server as [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] does not support x86 installations.  
...
-   SQL Server 2005 as [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] does not support the in-place upgrade of SQL Server 2005 to [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]. For more information, see [Are you upgrading from SQL Server 2005?](../../database-engine/install-windows/are-you-upgrading-from-sql-server-2005.md).  
