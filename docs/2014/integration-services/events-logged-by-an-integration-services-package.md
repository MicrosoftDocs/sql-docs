...
# Events Logged by an Integration Services Package
 ...
 For general information about how to run [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] packages, see [Execution of Projects and Packages](../../2014/integration-services/execution-of-projects-and-packages.md).  
  
 For information about how to troubleshoot running packages, see [Troubleshooting Tools for Package Execution](../../2014/integration-services/troubleshooting-tools-for-package-execution.md).  
...
## Related Tasks  
 For information about how to view log entries in real time, see [View Log Entries in the Log Events Window](../../2014/integration-services/view-log-entries-in-the-log-events-window.md).  
  
## See Also  
 [Events Logged by the Integration Services Service](../../2014/integration-services/events-logged-by-the-integration-services-service.md)  
