...
description: Discover how to modify trace templates in SQL Server Profiler by adding or removing event classes and data columns and by changing filters.
ms.prod: sql
