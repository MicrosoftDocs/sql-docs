...
# Extract Change Data Using the CDC Source
 ...
 For more information about the CDC Control task, see [CDC Control Task](../../2014/integration-services/cdc-control-task.md).  
...
9. Select the SSIS string package variable that maintains the CDC state for the current CDC context. For more information about the CDC state variable, see [Define a State Variable](../../2014/integration-services/define-a-state-variable.md).  
