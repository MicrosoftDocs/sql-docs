...
|**Replication**|Specifies a replication login. When enabled, triggers with the `NOT FOR REPLICATION` option won't fire on the connection. Recognized values are "yes" and "no". The default is "no". |  
