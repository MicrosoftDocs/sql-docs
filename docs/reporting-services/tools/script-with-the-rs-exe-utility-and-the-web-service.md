...
description: Learn about the RS.exe utitlity that can be used to programmatically administer a report server using scripts written with Microsoft Visual Basic.
ms.date: 03/14/2017
