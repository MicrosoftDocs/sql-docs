...
Creates the new table as a FileTable. You do not specify columns because a FileTable has a fixed schema. For more information about FileTables, see [FileTables](../../relational-databases/blob/filetables-sql-server.md).
