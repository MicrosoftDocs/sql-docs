...
5.  Choose **OK** twice to create the relationship.  
 ...
 When you run queries against a table, you can use a reflexive relationship to create a self-join. For information about querying tables with joins, see [Query with Joins &#40;Visual Database Tools&#41;](../../2014/database-engine/query-with-joins-visual-database-tools.md).  
