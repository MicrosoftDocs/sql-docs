...
You can optimize your queries over JSON documents using standard b-tree indexes. 

> [!TIP]
> Instead of older b-tree indexes, you can create native JSON indexes with [CREATE JSON INDEX (Transact-SQL)](../../t-sql/statements/create-json-index-transact-sql.md) in SQL Server 2025 and later versions, Azure SQL Database, Azure SQL Managed Instance, and SQL database in Fabric.
