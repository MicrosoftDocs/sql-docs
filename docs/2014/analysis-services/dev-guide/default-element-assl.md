...
# Default Element (ASSL)
  Determines whether the [DrillThroughAction](../../../2014/analysis-services/dev-guide/drillthroughaction-data-type-assl.md) is the default drillthrough action.  
...
|------------------|-------------|  
|Parent elements|[DrillThroughAction](../../../2014/analysis-services/dev-guide/drillthroughaction-data-type-assl.md)|  
|Child elements|None|  
