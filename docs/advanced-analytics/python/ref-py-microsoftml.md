...
> [!NOTE]
> Full product release versions are Windows-only, starting with SQL Server 2017. Linux support for **microsoftml** is new in [SQL Server 2019](../../linux/sql-server-linux-setup-machine-learning.md).
