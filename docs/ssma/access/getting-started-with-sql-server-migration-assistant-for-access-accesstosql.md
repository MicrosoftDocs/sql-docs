...
description: Get started using SSMA to convert Access database objects to SQL Server or Azure SQL DB objects, upload the resulting objects, and migrate data.
ms.prod: sql
ms.custom: ""
ms.date: "08/15/2017"
ms.reviewer: ""
