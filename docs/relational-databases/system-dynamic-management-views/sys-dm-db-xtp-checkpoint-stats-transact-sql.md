...
description: Returns statistics about the In-Memory OLTP checkpoint operations in the current database. Learn how this differs for versions of SQL Server.
ms.custom: ""
ms.date: "03/20/2017"
ms.prod: sql
