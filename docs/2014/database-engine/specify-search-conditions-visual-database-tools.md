...
2.  Locate the row containing the data column or expression to search, and then in the **Filter** column, enter a search condition.  
 ...
 The Query and View Designer updates the SQL statement in the [SQL Pane](../../2014/database-engine/sql-pane-visual-database-tools.md) by adding or modifying the WHERE clause.  
