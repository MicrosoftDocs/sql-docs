...
## Parts  
 *object*  
 A [ServerSettingsGeneralFlag Class](../../../2014/database-engine/dev-guide/serversettingsgeneralflag-class.md) object that represents a general flag for the server settings.  
