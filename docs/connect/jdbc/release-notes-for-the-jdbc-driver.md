...
| Added credential caching when using Managed Identity Credential or Default Azure Credential | In order to improve performance and driver reliability, caching of the mentioned credentials has been allowed. |
