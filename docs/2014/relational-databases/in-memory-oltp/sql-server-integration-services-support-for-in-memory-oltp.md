...
# SQL Server Integration Services Support for In-Memory OLTP
  You can use a memory-optimized table, a view referencing memory-optimized tables, or a natively compiled stored procedure as the source or destination for your [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)][!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] (SSIS) package. You can use [ADO NET Source](../../integration-services/ado-net-source.md), [OLE DB Source](../../integration-services/ole-db-source.md), or [ODBC Source](../../integration-services/odbc-source.md) in the data flow of an SSIS package and configure the source component to retrieve data from a memory-optimized table or a view, or specify a SQL statement to execute a natively compiled stored procedure. Similarly, you can use [ADO NET Destination](../../integration-services/ado-net-destination.md), [OLE DB Destination](../../integration-services/ole-db-destination.md), or [ODBC Destination](../../integration-services/odbc-destination.md) to load data into a memory-optimized table or a view, or specify a SQL statement to execute a natively compiled stored procedure.  
