...
|DATABASE|ALTER ANY SENSITIVITY CLASSIFICATION|ALSP<br />Applies to SQL Server (SQL Server vNext (15.x) through current), SQL Database.|DATABASE|CONTROL SERVER|
