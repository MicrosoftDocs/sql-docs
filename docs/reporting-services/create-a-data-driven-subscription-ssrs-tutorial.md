...
| (4)     | The reports are created in the file formats specified in the Orderinfo table. |
  ...
  :::image type="content" source="../reporting-services/media/ssrs-tutorial-datadriven-flow.png" alt-text="Diagram that shows the the basic workflow of the tutorial.":::
