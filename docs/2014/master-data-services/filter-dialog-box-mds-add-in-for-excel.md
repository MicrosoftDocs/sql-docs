...
|------------------|-----------------|  
|Attribute type|An attribute type describes the type of members you want to work with. In most cases, this is **Leaf**. For more information about member types, see [Members &#40;Master Data Services&#41;](../../2014/master-data-services/members-master-data-services.md).|  
