...
|Copy to the Clipboard|CTRL+C<br /><br /> or<br /><br /> CTRL+INSERT|CTRL+C<br /><br /> or<br /><br /> CTRL+INSERT|  
|Paste from the Clipboard at the insertion point|CTRL+V<br /><br /> or<br /><br /> SHIFT+INSERT|CTRL+V<br /><br /> or<br /><br /> SHIFT+INSERT|  
|Pastes an item from the Clipboard Ring at the insertion point and automatically selects the pasted item|CTRL+SHIFT+V<br /><br /> or<br /><br /> CTRL+enseSHIFT+INSERT|No equivalent|  
