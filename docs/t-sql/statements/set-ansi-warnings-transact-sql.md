...
The setting of ANSI_WARNINGS is defined at execute or run time and not at parse time. Like all [SET Statements](../../t-sql/statements/set-statements-transact-sql.md), SET ANSI_WARNINGS affects the current session.
