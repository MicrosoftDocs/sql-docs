...
4.  In Health Rule Settings, modify the following settings:  
     ...
     For more information about usage data collection, see [Configure Usage Data Collection for &#40;PowerPivot for SharePoint](power-pivot-sharepoint/configure-usage-data-collection-for-power-pivot-for-sharepoint.md).  
...
## See Also  
 [Configure Disk Space Usage &#40;PowerPivot for SharePoint&#41;](power-pivot-sharepoint/configure-disk-space-usage-power-pivot-for-sharepoint.md)   
