...
-   While the default value of 5 is retained for backwards compatibility, a different value may be appropriate. Perform application testing with higher and lower values if needed to optimize application performance.
