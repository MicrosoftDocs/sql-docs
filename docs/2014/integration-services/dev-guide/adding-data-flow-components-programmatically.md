...
## Next Step  
 After adding and configuring the component, the next step is to create paths between components, which is discussed in the topic, [Creating a Path Between Two Components](../../../2014/integration-services/dev-guide/connecting-data-flow-components-programmatically.md).  
