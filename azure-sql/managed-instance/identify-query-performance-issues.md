...
- A new feature introduced with SQL Server 2022 (16.x) is [Parameter Sensitive Plan optimization](../../docs/relational-databases/performance/parameter-sensitivity-plan-optimization.md), which attempts to mitigate most suboptimal query plans caused by parameter sensitivity. This is enabled with database compatibility level 160.
