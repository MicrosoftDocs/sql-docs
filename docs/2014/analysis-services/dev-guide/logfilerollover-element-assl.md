...
# LogFileRollover Element (ASSL)
  Specifies whether logging of [Trace](../../../2014/analysis-services/dev-guide/trace-element-assl.md) output should roll over to a new file or should stop when the maximum log file size that is specified in [LogFileSize](../../../2014/analysis-services/dev-guide/logfilesize-element-assl.md) is reached.  
