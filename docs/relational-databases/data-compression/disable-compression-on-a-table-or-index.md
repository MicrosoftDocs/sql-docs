...
monikerRange: "=azuresqldb-current || =azure-sqldw-latest || >=sql-server-2017 || =fabric-sqldb"
---
...
1. To disable compression on an index, expand the table that contains the index and then expand the **Indexes** folder.
