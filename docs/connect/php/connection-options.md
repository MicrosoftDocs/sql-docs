...
|Authentication|One of the following:<br /><br />'' (empty string)<br /><br />'SqlPassword'<br /><br />'ActiveDirectoryPassword'|Specifies the authentication mode.|Not set.|  
...
|Encrypt|1 or **true** for encryption on.<br /><br />0 or **false** for encryption off.|Specifies whether the communication with SQL Server is encrypted (1 or **true**) or unencrypted (0 or **false**)<sup>2</sup>.|**true** (1) if **Authentication** is set, **false** (0) otherwise|  
