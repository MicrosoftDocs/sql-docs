...
- The larger set of SQL technologies including SQL Azure are here: 
	...
	- [SQL Server on Azure VMs](sql-hub-menu.md?toc=%2fsql%2ftoc.json#pivot=products&panel=products-sql-server-azure)
	- [SQL Server on Linux](linux/index.md)
	- [SQL Server R Services](advanced-analytics/r-services/index.md)
	- [Azure SQL Database](/azure/sql-database)
	- [Azure SQL Data Warehouse](/azure/sql-data-warehouse)
	- [Tools and SDKs](sql-hub-menu.md?toc=%2fsql%2ftoc.json#pivot=sdkstools)
	- [Architectural recommendations](sql-hub-menu.md?toc=%2fsql%2ftoc.json#pivot=architecture)
