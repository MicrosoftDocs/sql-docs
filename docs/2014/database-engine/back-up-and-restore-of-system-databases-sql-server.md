...
-   Under some circumstances, problems recovering the model database may require rebuilding the system databases or replacing the mdf and ldf files for the model database. For more information, see [Rebuild System Databases](../../2014/database-engine/rebuild-system-databases.md).  
...
-   [Restore the master Database &#40;Transact-SQL&#41;](../../2014/database-engine/restore-the-master-database-transact-sql.md)  
