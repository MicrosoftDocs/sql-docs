...
=======
| `azdata` command changes | `azdata cluster` commands have been renamed to `azdata bdc`. For more information, see the [`azdata` reference](reference-mssqlctl.md). |
| New `azdata` status commands and removal of the Cluster Administration Portal. | The Cluster Administration Portal is removed in this release. New status commands have been added to `azdata` that complement existing monitoring commands. |
>>>>>>> 9dc5f02e20988a0dec013a9be895d4f34a3875e0
