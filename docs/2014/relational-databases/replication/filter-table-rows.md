...
-   Use join filters to extend filters on merge table articles to related table articles.  
 ...
 For more information about filtering options, see [Filter Published Data](publish/filter-published-data.md). Filtering can be changed in the **Filter Rows** page of the **Publication Properties** dialog box.  
