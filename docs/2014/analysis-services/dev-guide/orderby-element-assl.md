...
|*AttributeKey*|Order by the member key of the attribute specified in the [OrderByAttributeID](../../../2014/analysis-services/dev-guide/orderbyattributeid-element-assl.md) element of `DimensionAttribute`.|  
