...
> - SSDT for Visual Studio 2017 after 15.8 can’t design SSIS packages that contain Teradata Source/Destination and this issue will be fixed in the near future. Please use SSDT for Visual Studio 2017 (15.8) or the previous versions for designing SSIS packages that contain Teradata Source/Destination.
