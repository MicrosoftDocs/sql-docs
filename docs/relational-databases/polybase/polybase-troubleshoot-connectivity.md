...
> This tool is completely independent from [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. It is available as a Jupyter Notebook and requires [Azure Data Studio](../../../azure-data-studio/what-is).
