...
- Currently, Authenticating to SQL VM through AAD authentication using [FIDO2 method](https://learn.microsoft.com/azure/active-directory/authentication/howto-authentication-passwordless-faqs) is not supported.
