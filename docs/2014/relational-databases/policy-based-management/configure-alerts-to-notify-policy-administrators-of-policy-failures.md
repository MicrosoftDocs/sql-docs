...
-   [Create an Operator](../../database-engine/create-an-operator.md)  
  
-   [Create an Alert Using an Error Number](../../database-engine/create-an-alert-using-an-error-number.md)  
  
-   [Assign Alerts to an Operator](../../database-engine/assign-alerts-to-an-operator.md)  
...
-   If the action you want to take includes sending an e-mail message, you must configure a mail account. We recommend that you use Database Mail. For more information about how to set up Database Mail, see [Create a Database Mail Account](../database-mail/create-a-database-mail-account.md).  
