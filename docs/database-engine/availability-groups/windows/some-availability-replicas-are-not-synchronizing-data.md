...
> [!NOTE]  
>  For this release of [!INCLUDE[ssnoversion](../../../includes/ssnoversion-md.md)], information about possible causes and solutions is located at [Some availability replicas are not synchronizing data](https://go.microsoft.com/fwlink/p/?LinkId=220852) on the TechNet Wiki.  
