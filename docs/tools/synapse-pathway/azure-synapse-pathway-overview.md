...
## Supported sources
- **IBM Netezza** : Azure Synapse Pathway supports code conversion for database, schemas, tables. DDL statements like create & drop are supported. Function translation is also supported.
