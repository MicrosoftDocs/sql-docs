...
description: Learn how client statistics, execution plans, and Code Analysis in SQL Server Data Tools can help improve query, stored procedure, and script performance.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
