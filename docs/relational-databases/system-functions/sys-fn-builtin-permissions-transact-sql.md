...
|AL|ALTER|CONTRACT|
|AL|ALTER|DATABASE|
|AL|ALTER<br /><br />**Applies to**: [!INCLUDE [sssql17-md](../../includes/sssql17-md.md)] and later versions, and [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)]. |DATABASE SCOPED CREDENTIAL|
|AL|ALTER|ENDPOINT|
...
|CL|CONTROL|CONTRACT|
|CL|CONTROL|DATABASE|
|CL|CONTROL<br /><br />**Applies to**: [!INCLUDE [sssql17-md](../../includes/sssql17-md.md)] and later versions, and [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)]. |DATABASE SCOPED CREDENTIAL|
|CL|CONTROL|ENDPOINT|
...
|IN|INSERT|OBJECT|
|IN|INSERT|SCHEMA|
|KIDC|KILL DATABASE CONNECTION<br /><br />**Applies to**: [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)].|DATABASE|
|RC|RECEIVE|OBJECT|
...
|RF|REFERENCES<br /><br />**Applies to**: [!INCLUDE [sssql17-md](../../includes/sssql17-md.md)] and later versions, and [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)]. |DATABASE SCOPED CREDENTIAL|
...
|TO|TAKE OWNERSHIP<br /><br />**Applies to**: [!INCLUDE [sssql17-md](../../includes/sssql17-md.md)] and later versions, and [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)]. |DATABASE SCOPED CREDENTIAL|
...
|VW|VIEW DEFINITION<br /><br />**Applies to**: [!INCLUDE [sssql17-md](../../includes/sssql17-md.md)] and later versions, and [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)]. |DATABASE SCOPED CREDENTIAL|
