...
description: Learn how to back up a database master key in SQL Server by using Transact-SQL. This key encrypts other keys and certificates, so you should back it up.
ms.custom: ""
ms.date: "01/02/2019"
ms.prod: sql
ms.reviewer: vanto
