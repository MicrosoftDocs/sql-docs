...
# RowBinding Data Type (ASSL)
  Defines a derived data type that represents a binding to the rows of a table in a [DataSourceView](../../../2014/analysis-services/dev-guide/datasourceview-element-assl.md) element.  
...
|Child elements|[TableID](../../../2014/analysis-services/dev-guide/tableid-element-assl.md)|  
