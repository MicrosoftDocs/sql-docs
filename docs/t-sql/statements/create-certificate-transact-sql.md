...
> [!IMPORTANT]
> [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)] does not support creating a certificate from a file or using private key files.
...
> [!IMPORTANT]  
> This option is not available in a contained database or in [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)].  
...
> [!IMPORTANT]
> [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)] does not support creating a certificate from a file.
