...
## Remarks  
 Null conversion errors occur when a null value is encountered in a key column and interpreted as the `Unknown` member. However, this error occurs only if the [NullProcessing](../../../2014/analysis-services/dev-guide/nullprocessing-element-assl.md) element for the [DataItem](../../../2014/analysis-services/dev-guide/dataitem-data-type-assl.md) ancestor of the `ErrorConfiguration` parent element is set to *UnknownMember*.  
