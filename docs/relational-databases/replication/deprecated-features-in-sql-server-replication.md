...
|Feature|Description|  
|-------------|-----------------|  
|[!INCLUDE[sql2008-md](../../includes/sql2008-md.md)]|Replication is supported if each [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] endpoint is within two major versions of the current version of [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Consequently, [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] does not support replication to or from [!INCLUDE[sql2008-md](../../includes/sql2008-md.md)] or [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)].|  
