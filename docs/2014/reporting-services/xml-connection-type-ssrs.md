...
##  <a name="Query"></a> Queries  
 ...
 For more information about the text-based query designer, see [Text-based Query Designer User Interface &#40;Report Builder&#41;](../../2014/reporting-services/text-based-query-designer-user-interface-report-builder.md).  
...
##  <a name="Parameters"></a> Parameters  
 ...
 To add parameters, you must create them manually through the **Parameter** page on the [Dataset Properties](../../2014/reporting-services/dataset-properties-dialog-box-parameters-report-builder.md) dialog box.  
