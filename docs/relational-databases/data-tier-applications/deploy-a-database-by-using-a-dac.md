---
title: "Deploy a Database By Using a DAC"
...
[!INCLUDE [SQL Server Azure SQL Database](../../includes/applies-to-version/sql-asdb.md)]
  Use the **Deploy Database to Microsoft Azure SQL Database** Wizard to deploy a database between an instance of the [!INCLUDE[ssDE](../../includes/ssde-md.md)] and a [!INCLUDE[ssSDSFull](../../includes/ssazure-sqldb.md)] server, or between two [!INCLUDE[ssSDSFull](../../includes/ssazure-sqldb.md)]servers.  
...
1.  Connect to the location of the database you want to deploy. You can specify either an instance of [!INCLUDE[ssDE](../../includes/ssde-md.md)] or a [!INCLUDE[ssSDSFull](../../includes/ssazure-sqldb.md)] server.  
