...
|[Migration guide: Oracle to Azure SQL Managed Instance]([../../ssma/oracle/migrating-oracle-databases-to-sql-server-oracletosql.md](https://learn.microsoft.com/azure/azure-sql/migration-guides/managed-instance/oracle-to-managed-instance-guide?view=azuresql))|This guide teaches you to migrate your Oracle schemas to Azure SQL Managed Instance by using SQL Server Migration Assistant for Oracle.|  
