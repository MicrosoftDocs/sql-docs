...
-   **Let SQL Server Manage backups to Windows Azure:** Configure SQL Server to manage the backup strategy and schedule backups for a single database, or several databases, or set defaults at the instance level. This feature is referred to as  **[!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)]**. For more information see [SQL Server Managed  Backup to Windows Azure](../../2014/database-engine/sql-server-managed-backup-to-windows-azure.md). This feature is available in SQL Server 2014 or later.  
