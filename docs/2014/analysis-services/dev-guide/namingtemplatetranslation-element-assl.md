...
# NamingTemplateTranslation Element (ASSL)
  Provides a localized translation of the [NamingTemplate](../../../2014/analysis-services/dev-guide/namingtemplate-element-assl.md) element for a parent [DimensionAttribute](../../../2014/analysis-services/dev-guide/dimensionattribute-data-type-assl.md) data type.  
...
|------------------|-------------|  
|Parent elements|[NamingTemplateTranslations](../../../2014/analysis-services/dev-guide/namingtemplatetranslations-element-assl.md)|  
|Child elements|None|  
  
## Remarks  
 The value of the `NamingTemplateTranslation` element is used only by parent attributes (in other words, the value of the [Usage](../../../2014/analysis-services/dev-guide/usage-element-dimensionattribute-assl.md) element of the `DimensionAttribute` parent is set to *Parent*) to store the localized translation of the `NamingTemplate` value for a given language.  
...
## See Also  
 [NamingTemplate Element &#40;ASSL&#41;](../../../2014/analysis-services/dev-guide/namingtemplate-element-assl.md)   
