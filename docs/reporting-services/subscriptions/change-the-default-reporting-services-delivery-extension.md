...
## Default native mode report server configuration  
 ...
 :::image type="content" source="../../reporting-services/subscriptions/media/ssrs-default-delivery.png" alt-text="Screenshot that shows the default list of delivery extensions." lightbox="../../reporting-services/subscriptions/media/ssrs-default-delivery.png"::: 
...
1.  The steps in this procedure modify the configuration so that file share delivery is listed as the first option in the UI and it's the default selection.  
     ...
     :::image type="content" source="../../reporting-services/subscriptions/media/ssrs-modified-delivery.png" alt-text="Screenshot that shows a modified list of delivery extensions." lightbox="../../reporting-services/subscriptions/media/ssrs-modified-delivery.png":::
