...
|**PacketSize**|SSPROP_INIT_PACKETSIZE|TDS packet size. The default is 0 (the actual value will be determined by the server).|  
...
|**Packet Size**|SSPROP_INIT_PACKETSIZE|TDS packet size. The default is 0 (the actual value will be determined by the server).|  
