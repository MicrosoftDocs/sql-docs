...
## In This Section  
 ...
 [Working with the WMI Provider for Server Events](../../../2014/database-engine/dev-guide/working-with-the-wmi-provider-for-server-events.md)  
 ...
 [Sample: Creating a SQL Server Agent Alert by Using the WMI Provider for Server Events](../../../2014/database-engine/dev-guide/sample-creating-a-sql-server-agent-alert-with-the-wmi-provider.md)  
 ...
 [Sample: Use the WMI Event Provider with the .NET Framework](../../../2014/database-engine/dev-guide/sample-using-the-wmi-event-provider-with-the-net-framework.md)  
 Provides an example of using the WMI Provider to return event data in a C# application.  
  
 [WMI Provider for Server Events Classes and Properties](../../../2014/database-engine/dev-guide/wmi-provider-for-server-events-classes-and-properties.md)  
