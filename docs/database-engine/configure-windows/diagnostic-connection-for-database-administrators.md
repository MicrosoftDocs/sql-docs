...
> [!TIP]  
> [!INCLUDE[ssSDSFull](../../includes/sssdsfull-md.md)] listens for dedicated admin connection(DAC) ONLY on TCP Port 1434 and additional port range  11500 to 11999 should be allowed if connection policy is redirect.
