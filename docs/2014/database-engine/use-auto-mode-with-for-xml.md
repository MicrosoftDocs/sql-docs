...
# Use AUTO Mode with FOR XML
  As described in [FOR XML &#40;SQL Server&#41;](../../2014/database-engine/for-xml-sql-server.md), AUTO mode returns query results as nested XML elements. This does not provide much control over the shape of the XML generated from a query result. The AUTO mode queries are useful if you want to generate simple hierarchies. However, [Use EXPLICIT Mode with FOR XML](../../2014/database-engine/use-explicit-mode-with-for-xml.md) and [Use PATH Mode with FOR XML](../../2014/database-engine/use-path-mode-with-for-xml.md) provide more control and flexibility in deciding the shape of the XML from a query result.  
...
-   [Use the BINARY BASE64 Option](../../2014/database-engine/use-the-binary-base64-option.md)  
  
-   [AUTO Mode Heuristics in Shaping Returned XML](../../2014/database-engine/auto-mode-heuristics-in-shaping-returned-xml.md)  
