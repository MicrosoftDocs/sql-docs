...
+ SQL Server 2017 is required if you want to install Machine Learning Services with language support for R, Python, or both. If instead you have SQL Server 2016 installation media, you must install [SQL Server 2016 R Services (In-Database)](sql-r-services-windows-install.md). Python support for machine learning workloads is not available in SQL Server 2016.
