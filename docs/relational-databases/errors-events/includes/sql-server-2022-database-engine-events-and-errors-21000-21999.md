...
| 21431 | 16 | No | Cannot add more %s agent in MI, number of continuous mode agents has hit limits of %d. Otherwise some agents may not running due to desktop heap used up. |
| 21432 | 16 | No | Cannot allow ReplDistpatcherUsers connect to NamePipe with error msg: %s |
...
| 21900 | 16 | No | Unable to find listener name with the value provided for property redirected_publisher. |
| 21901 | 16 | No | The publication property '%s' cannot be changed when publication is not enabled for peer-to-peer. |
