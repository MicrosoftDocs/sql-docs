...
For the versions in the table below, consider using [Extended Security Updates](/sql/sql-server/end-of-support/sql-server-end-of-support-overview) described in this article, or other migration options. For more information, see [End of support options](sql-server-end-of-support-overview.md).
...
Not at this stage. Please refer to the [Supported regions](#supported-regions) for more information.
