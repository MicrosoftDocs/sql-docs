...
```  
 ...
 ![Screenshot of the R M L Cmd Prompt showing output from the ostress tool. The last line indicates that the command ran without any errors.](../../2014/database-engine/media/SQLServer2014RTMIn-MemoryOLTP02.jpg)  
