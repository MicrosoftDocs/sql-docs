...
10. To configure an error output, click **Configure Error Output**. For more information, see [Configure an Error Output in a Data Flow Component](../../2014/integration-services/configure-an-error-output-in-a-data-flow-component.md).  
