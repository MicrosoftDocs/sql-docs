...
In SQL Server 2019 Release Candidate 1, Java is supported. The default Java runtime is Zulu Open JRE. You can also use another Java JRE or SDK.
...
## Limitations in Release Candidate 1

SQL Server Language Extensions is currently in public preview. There are some limitations in Release Candidate 1:
