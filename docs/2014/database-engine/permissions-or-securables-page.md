...
# Permissions or Securables Page
 ...
 To understand the possible combinations of securables and principals, see the securable-specific syntax links in the topic [GRANT &#40;Transact-SQL&#41;](../Topic/GRANT%20\(Transact-SQL\).md). For more information, see [Securables](../../2014/database-engine/securables.md).  
