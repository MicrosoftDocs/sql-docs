...
To release the trigger for a command that does not change any rows, employ the system variable  [ROWCOUNT_BIG](https://docs.microsoft.com/it-it/sql/t-sql/functions/rowcount-big-transact-sql). 
