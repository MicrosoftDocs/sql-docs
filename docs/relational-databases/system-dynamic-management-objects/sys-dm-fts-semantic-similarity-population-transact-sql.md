...
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
 ...
 The population step follows the extraction step. For status information about the similarity extraction step, see [sys.dm_fts_index_population &#40;Transact-SQL&#41;](sys-dm-fts-index-population-transact-sql.md).  
...
## General Remarks  
 For more information, see [Manage and Monitor Semantic Search](../search/manage-and-monitor-semantic-search.md).  
  
## Metadata  
 For more information about the status of semantic indexing, query [sys.dm_fts_index_population &#40;Transact-SQL&#41;](sys-dm-fts-index-population-transact-sql.md).  
