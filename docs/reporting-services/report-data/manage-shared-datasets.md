...
|Verify default values for dataset parameters.|Open in Report Builder or use URL access syntax.|For example:<br /><br /> `https://localhost/reportserver/?/Datasets/AdventureWorksDataset&rs:command=GetShareddatasetDefinition`
|Enable caching|web portal|[Cache Shared Datasets &#40;SSRS&#41;](../../reporting-services/report-server/cache-shared-datasets-ssrs.md)<br /><br /> [Cache Shared Datasets (SSRS)](../../reporting-services/report-server/cache-shared-datasets-ssrs.md)|  
