...
|[Breaking Changes to Full-Text Search](../relational-databases/search/full-text-search.md)|Full-text search changes that might require changes to applications.|  
