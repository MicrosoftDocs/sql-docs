...
3.  Complete an action from the following table:  
    ...
    |Define a fill factor|Expand the **Fill Specification** category and type an integer from 0 to 100 in the **Fill factor** box. For more information about fill factors and their uses, see [Specify Fill Factor for an Index](../../2014/database-engine/specify-fill-factor-for-an-index.md).|  
 ...
 **To modify a primary key**  
 ...
 To modify a PRIMARY KEY constraint using Transact-SQL, you must first delete the existing PRIMARY KEY constraint and then re-create it with the new definition. For more information, see [Delete Primary Keys](../../2014/database-engine/delete-primary-keys.md) and [Create Primary Keys](../../2014/database-engine/create-primary-keys.md).  
