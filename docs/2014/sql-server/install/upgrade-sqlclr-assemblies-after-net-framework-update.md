...
4.  Rest of the steps are same as steps 2-6 in the [Run DQSInstaller.exe from Start Screen, Start Menu or Windows Explorer](../../../2014/sql-server/install/run-dqsinstaller-exe-to-complete-data-quality-server-installation.md#WindowsExplorer) section in [Run DQSInstaller.exe to Complete Data Quality Server Installation](../../../2014/sql-server/install/run-dqsinstaller-exe-to-complete-data-quality-server-installation.md).  
  
## See Also  
 [Install Data Quality Services](../../../2014/sql-server/install/install-data-quality-services.md)   
 [Upgrade DQS Databases Schema After Installing SQL Server Update](../../../2014/sql-server/install/upgrade-dqs-databases-schema-after-installing-sql-server-update.md)  
