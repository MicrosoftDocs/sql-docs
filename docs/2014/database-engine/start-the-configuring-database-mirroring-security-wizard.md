...
3.  Right-click the database, select **Tasks**, and then click **Mirror**. This opens the [Mirroring Page](../../2014/database-engine/database-properties-mirroring-page.md) of the **Database Properties** dialog box.  
