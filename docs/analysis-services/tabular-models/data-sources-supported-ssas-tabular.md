...
|Access databases|Microsoft Access 2010 and later.|.accdb or .mdb|ACE 14 OLE DB provider<a name="dnu"> **[1]**</a>|  
...
|Text files|(not applicable)|.txt, .tab, .csv|ACE 14 OLE DB provider<a name="dnu"> **[1]**</a> |  
|Microsoft Excel files|Excel 2010 and later|.xlsx, xlsm, .xlsb, .xltx, .xltm|ACE 14 OLE DB provider<a name="dnu"> **[1]**</a>|  
