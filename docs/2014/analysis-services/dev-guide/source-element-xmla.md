...
---
# Source Element (XMLA)
  Represents a source partition to be merged during a [MergePartitions](../../../2014/analysis-services/dev-guide/mergepartitions-element-xmla.md) command.  
...
|------------------|-------------|  
|Parent elements|[Sources](../../../2014/analysis-services/dev-guide/sources-element-xmla.md)|  
