...
# Set the Locale for a Report or Text Box (Reporting Services)
 ...
 You can also specify the **Language** property for a report in a URL. For more information, see [Set the Language for Report Parameters in a URL](../../2014/reporting-services/set-the-language-for-report-parameters-in-a-url.md).  
