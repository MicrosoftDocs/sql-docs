...
| -------------------------- | ----------------------------- | ----------- |
| mssql-jdbc-7.2.0.jre11.jar | JDBC 4.3 (partially), and 4.2 | JDK 11.0    |
