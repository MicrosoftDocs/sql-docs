...
All of these keystore providers are described in more detail in the section which follow. You only need to implement one keystore provider to use Always Encrypted.
