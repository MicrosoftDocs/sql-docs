...
# Native Compilation of Tables and Stored Procedures
 ...
 Native compilation of memory optimized table types is also supported. For more information, see [Memory-Optimized Table Variables](../../2014/database-engine/memory-optimized-table-variables.md).  
...
## Native Compilation of Stored Procedures  
 ...
 For more information about natively compiled stored procedures, see [Natively Compiled Stored Procedures](../../2014/database-engine/natively-compiled-stored-procedures.md).  
