...
## The Breakpoints Window  
 The **Breakpoints** window lists information such as which line of code the breakpoint is located on. In the **Breakpoints** window, you can also delete, disable, and enable breakpoints. For more information about the **Breakpoints** window, see [Breakpoints Window](../../2014/database-engine/breakpoints-window.md)  
...
## See Also  
 [Toggle a Breakpoint](../../2014/database-engine/toggle-a-breakpoint.md)  
