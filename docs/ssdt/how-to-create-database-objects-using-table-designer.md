...
description: Learn how to create a new database in SQL Server Object Explorer. See how to create new tables, check constraints, and foreign key references in Table Designer.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
f1_keywords: 
