...
- Starting from the extension version `1.1.2620.127`, SQL failover cluster instances which use a different network name than the one configured during installation are supported.
