...
-   [CloudBlobContainer.GetSharedAccessSignature Method](https://docs.microsoft.com/en-us/dotnet/api/microsoft.azure.storage.blob.cloudblobcontainer.getsharedaccesssignature) in the Windows Azure SDK.  
