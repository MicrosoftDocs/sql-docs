...
# FILESTREAM Support (OLE DB)
  Beginning with [!INCLUDE[ssKatmai](../../../includes/sskatmai-md.md)] and [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 10.0, OLE DB supports the enhanced FILESTREAM feature. For more information about this feature, see [FILESTREAM Support](../../../2014/database-engine/dev-guide/filestream-support.md). For samples, see [Filestream and OLE DB](../../../2014/database-engine/dev-guide/filestream-and-ole-db.md).  
