...
# OData Connection Manager
  An OData connection manager enables a package to connect to an OData source. An OData Source component connects to an OData source using an OData connection manager and consumes data from the service. See [OData Source](../../2014/integration-services/odata-source.md)section for detailed information including the installation instructions for these components.  
...
## See Also  
 [OData Connection Manager Editor](../../2014/integration-services/odata-connection-manager-editor.md)  
