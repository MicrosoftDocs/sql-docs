...
> [!NOTE]  
>  For more information about the query that uses calls the **cdc.fn_cdc_get_net_changes_<capture_instance>** function, see [Create the Function to Retrieve the Change Data](../../2014/integration-services/create-the-function-to-retrieve-the-change-data.md).  
 ...
 **Next topic:** [Apply the Changes to the Destination](../../2014/integration-services/apply-the-changes-to-the-destination.md)  
