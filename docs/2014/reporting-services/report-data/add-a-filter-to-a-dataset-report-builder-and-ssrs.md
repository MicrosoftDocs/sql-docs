...
8.  In the **Value** box, type the expression or value against which you want the filter to evaluate the value in **Expression**.  
     ...
     For examples of filter equations, see [Filter Equation Examples &#40;Report Builder and SSRS&#41;](../report-design/filter-equation-examples-report-builder-and-ssrs.md).  
...
## See Also  
 ...
 [Add a Filter &#40;Report Builder and SSRS&#41;](../report-design/add-a-filter-report-builder-and-ssrs.md)  
