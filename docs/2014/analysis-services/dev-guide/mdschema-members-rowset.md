...
|`MEMBER_TYPE`|`DBTYPE_I4`||The type of the member:<br /><br /> -   `MDMEMBER_TYPE_REGULAR` (`1`)<br />-   `MDMEMBER_TYPE_ALL` (`2`)<br />-   `MDMEMBER_TYPE_MEASURE` (`3`)<br />-   `MDMEMBER_TYPE_FORMULA` (`4`)<br />-   `MDMEMBER_TYPE_UNKNOWN` (`0`)<br />-   `MDMEMBER_TYPE_FORMULA` takes precedence over `MDMEMBER_TYPE_MEASURE`. For example, if there is a formula (calculated) member on the Measures dimension, it is listed as `MDMEMBER_TYPE_FORMULA`.|  
