...
|**connect timeout**|Time-out value in seconds for connecting to a linked server.<br /><br /> If **0**, use the **sp_configure** default value for the "remote login timeout" setting.|  
