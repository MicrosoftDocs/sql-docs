...
||DT_R8|The numeric data type is mapped to DT_R8 when at least one of the following is true:<br /><br />Precision is greater than 38<br /><br />Scale is less than zero<br /><br />Scale is greater than 38<br /><br />Scale is greater than Precision|  
...
||DT_R8|The decimal data type is mapped to DT_R8 when at least one of the following is true:<br /><br />Precision is greater than 38<br /><br />Scale is less than zero<br /><br />Scale is greater than 38<br /><br />Scale is greater than Precision|  
