...
## In This Section  
 [Data Type Support for ODBC Date and Time Improvements](../../../2014/database-engine/dev-guide/data-type-support-for-odbc-date-and-time-improvements.md)  
 ...
 [datetime Data Type Conversions &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/datetime-data-type-conversions-odbc.md)  
 Describes how to convert between datetime and datetimeoffset values.  
  
 [sql_variant Support for Date and Time Types](../../../2014/database-engine/dev-guide/sql-variant-support-for-date-and-time-types.md)  
 ...
 [Enhanced Date and Time Type Behavior with Previous SQL Server Versions &#40;ODBC&#41;](../../../2014/database-engine/dev-guide/enhanced-date-and-time-type-behavior-with-previous-sql-server-versions-odbc.md)  
 ...
 [ODBC API Support for Enhanced Date and Time Features](../../../2014/database-engine/dev-guide/odbc-api-support-for-enhanced-date-and-time-features.md)  
