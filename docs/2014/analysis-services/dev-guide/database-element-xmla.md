...
# Database Element (XMLA)
  Identifies the database that contains the dimension represented by the parent [Object](../../../2014/analysis-services/dev-guide/object-element-dimension-xmla.md) element.  
