...
### SQL MI regional availability

Zone redundancy for SQL Managed Instance is currently in preview, only available in the Business Critical service tier, and supported in the following regions: 
