...
### Metadata Discovery  
 ...
 The [SET FMTONLY](../Topic/SET%20FMTONLY%20\(Transact-SQL\).md) option for determining the format of a response without actually running the query is replaced with [sp_describe_first_result_set &#40;Transact-SQL&#41;](../Topic/sp_describe_first_result_set%20\(Transact-SQL\).md), [sp_describe_undeclared_parameters &#40;Transact-SQL&#41;](../Topic/sp_describe_undeclared_parameters%20\(Transact-SQL\).md), [sys.dm_exec_describe_first_result_set &#40;Transact-SQL&#41;](../Topic/sys.dm_exec_describe_first_result_set%20\(Transact-SQL\).md), and [sys.dm_exec_describe_first_result_set_for_object &#40;Transact-SQL&#41;](../Topic/sys.dm_exec_describe_first_result_set_for_object%20\(Transact-SQL\).md).  
...
```  
 ...
 To determine whether a spatial object is empty, call the [STIsEmpty &#40;geometry Data Type&#41;](../Topic/STIsEmpty%20\(geometry%20Data%20Type\).md) method.  
  
### LOG Function Has New Optional Parameter  
 The `LOG` function now has an optional *base* parameter. For more information, see [LOG &#40;Transact-SQL&#41;](../Topic/LOG%20\(Transact-SQL\).md).  
...
### DBCC CHECKIDENT Revised Message  
 ...
 In earlier versions, the message is "Checking identity information: current identity value '\<current identity value>', current column value '\<current column value>'. DBCC execution completed. If DBCC printed error messages, contact your system administrator." The message is unchanged when DBCC CHECKIDENT is specified with NORESEED, without a second parameter, or without a reseed value. For more information, see [DBCC CHECKIDENT &#40;Transact-SQL&#41;](../Topic/DBCC%20CHECKIDENT%20\(Transact-SQL\).md).  
