...
## Choosing the Right JAR file  
 The Microsoft JDBC Driver 7.0 for SQL Server provides **mssql-jdbc-7.0.0.jre8.jar**, and **mssql-jdbc-7.0.0.jre10.jar** class library files to be used depending on your preferred Java Runtime Environment (JRE) settings.  
...
### For Microsoft JDBC Driver 7.0
 ...
 You must make sure that the CLASSPATH statement contains only one [!INCLUDE[jdbcNoVersion](../../includes/jdbcnoversion_md.md)], such as either mssql-jdbc-7.0.0.jre8.jar or mssql-jdbc-7.0.0.jre10.jar.   
...
### For Microsoft JDBC Driver 6.4
 ...
 You must make sure that the CLASSPATH statement contains only one [!INCLUDE[jdbcNoVersion](../../includes/jdbcnoversion_md.md)], such as either mssql-jdbc-6.4.0.jre7.jar, mssql-jdbc-6.4.0.jre8.jar or mssql-jdbc-6.4.0.jre9.jar.   
