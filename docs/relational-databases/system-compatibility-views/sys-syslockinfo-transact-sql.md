...
|**rsc_type**|**tinyint**|See description for `resource_type` in [sys.dm_tran_locks (Transact-SQL)](../system-dynamic-management-views/sys-dm-tran-locks-transact-sql.md).|  
