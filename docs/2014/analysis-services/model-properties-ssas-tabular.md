...
|**Compatibility Level**|Default or other selected when creating the project.|Applies to SQL Server 2012 Analysis Services SP1 or later. Specifies the features and settings available for this model. For more information, see [Compatibility Level &#40;SSAS Tabular SP1&#41;](compatibility-level-ssas-tabular-sp1.md).|  
