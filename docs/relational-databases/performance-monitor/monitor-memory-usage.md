...
## <a id="configuring-include-ssnoversionincludesssnoversion-mdmd-max-memory"></a> Configure [!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)] max memory
...
## <a id="isolating-memory-used-by-include-ssnoversionincludesssnoversion-mdmd"></a> Isolate memory used by [!INCLUDE [ssNoVersion](../../includes/ssnoversion-md.md)]
...
### <a id="determining-current-memory-allocation"></a> Determine current memory allocation
...
### <a id="determining-current-sql-server-memory-utilization"></a> Determine current SQL Server memory utilization
...
### <a id="determining-page-life-expectancy"></a> Determine page life expectancy
