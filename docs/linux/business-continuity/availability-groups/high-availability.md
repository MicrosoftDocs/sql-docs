...
:::image type="content" source="media/high-availability/3-three-replica.png" alt-text="Diagram of an availability group with a primary replica synchronizing data to two secondary replicas.":::
...
:::image type="content" source="media/high-availability/1-read-scale-out.png" alt-text="Diagram of an availability group with a primary replica synchronizing data to one secondary replica.":::
