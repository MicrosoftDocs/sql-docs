...
|**Compatibility Level**|Default or other selected when creating the project.|Applies to SQL Server 2012 Analysis Services SP1 or later. Specifies the features and settings available for this model. For more information, see [Compatibility Level &#40;SSAS Tabular SP1&#41;](../../2014/analysis-services/compatibility-level-ssas-tabular-sp1.md).|  
...
|**DirectQuery Mode**|Off|Specifies whether or not this model operates in DirectQuery Mode. For more information, see [DirectQuery Mode &#40;SSAS Tabular&#41;](../../2014/analysis-services/directquery-mode-ssas-tabular.md).|  
