...
---
# Trend Element (ASSL)
  Contains a Multidimensional Expressions (MDX) expression that returns a trend indicator for a [Kpi](../../../2014/analysis-services/dev-guide/kpi-element-assl.md) element.  
