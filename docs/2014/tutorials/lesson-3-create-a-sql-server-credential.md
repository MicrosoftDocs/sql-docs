...
# Lesson 3: Create a SQL Server Credential
 ...
 For general information about credentials, see [Credentials &#40;Database Engine&#41;](../../2014/database-engine/credentials-database-engine.md).  
  
> [!IMPORTANT]  
>  The requirements for creating a SQL Server credential described below are specific to the [SQL Server Data Files in Windows Azure](../../2014/database-engine/sql-server-data-files-in-windows-azure.md) feature. For information on creating credentials for backup processes in Azure storage, see [Lesson 2: Create a SQL Server Credential](../../2014/tutorials/lesson-2-create-a-sql-server-credential.md).  
