...
# Lesson 5: Executing Prediction Queries
  In this lesson, you will use the [SELECT FROM \<model> PREDICTION JOIN (DMX)](../Topic/SELECT%20FROM%20%3Cmodel%3E%20PREDICTION%20JOIN%20\(DMX\).md) form of the SELECT statement to create two different types of predictions based on the decision tree model you created in [Lesson 2: Adding Mining Models to the Association Mining Structure](../../2014/tutorials/lesson-2-adding-mining-models-to-the-market-basket-mining-structure.md). These prediction types are defined below.  
 ...
 The [SELECT FROM \<model> PREDICTION JOIN (DMX)](../Topic/SELECT%20FROM%20%3Cmodel%3E%20PREDICTION%20JOIN%20\(DMX\).md) form of the SELECT statement contains three parts:  
...
## Singleton Query  
 The first step is to use the [SELECT FROM &#60;model&#62; PREDICTION JOIN &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E%20PREDICTION%20JOIN%20\(DMX\).md) in a singleton prediction query. The following is a generic example of the singleton statement:  
...
## Batch Query  
 The next step is to use the [SELECT FROM &#60;model&#62; PREDICTION JOIN &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E%20PREDICTION%20JOIN%20\(DMX\).md) in a batch prediction query. The following is a generic example of a batch statement:  
...
```  
 ...
 You have several options for the method of retrieving the source data, but in this tutorial, you will use OPENQUERY. For more information about the options available, see [&#60;source data query&#62;](../Topic/%3Csource%20data%20query%3E.md).  
