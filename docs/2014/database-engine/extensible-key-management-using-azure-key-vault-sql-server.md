...
2.  Setup a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] credential for a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] administrator login to use the key vault in order to setup and manage [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] encryption scenarios.  
    ...
    ```  
     ...
     For an example of using variables for the `CREATE CREDENTIAL` arguments and programmatically removing the hyphens from the Client ID, see [CREATE CREDENTIAL &#40;Transact-SQL&#41;](../Topic/CREATE%20CREDENTIAL%20\(Transact-SQL\).md).  
...
## See Also  
 ...
 [Backup Encryption](../../2014/database-engine/backup-encryption.md)   
 [Create an Encrypted Backup](../../2014/database-engine/create-an-encrypted-backup.md)  
