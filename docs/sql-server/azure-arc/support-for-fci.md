...
- SQL FCIs with multiple network names are not supported at this time.
- SQL FCIs which use a different network name than the one configured during installation are not supported at this time.
