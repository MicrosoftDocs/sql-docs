...
-   **[!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]**  
    ...
    -   [Back Up Database (Options Page)](../../2014/database-engine/back-up-database-backup-options-page.md)  
    ...
    -   [Log Shipping Transaction Log Backup Settings](../../2014/database-engine/log-shipping-transaction-log-backup-settings.md)  
  
         You can control the backup compression behavior of log backups.  
  
  
## See Also  
 [Backup Compression &#40;SQL Server&#41;](../../2014/database-engine/backup-compression-sql-server.md)  
