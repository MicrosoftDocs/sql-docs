...
-   Maintain a list of Extended Events sessions and manage access to that list.  
 ...
 The following illustration shows a simplified view of an Extended Events session. For more information, see [SQL Server Extended Events Sessions](../../2014/database-engine/sql-server-extended-events-sessions.md).  
