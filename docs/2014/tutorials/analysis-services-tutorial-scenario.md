...
-   Present a localized experience to business users outside the United States.  
 ...
 The lessons in the Analysis Services tutorial provide guidance in building a cube database that meets all of these goals. To get started, continue to the first lesson: [Lesson 1: Create a New Tabular Model Project](../../2014/tutorials/lesson-1-create-a-new-tabular-model-project.md).  
