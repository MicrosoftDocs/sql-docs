...
# DatabasePermission Element (ASSL)
  Defines the default permissions in a [Database](../../../2014/analysis-services/dev-guide/database-element-assl.md) element for a specific [Role](../../../2014/analysis-services/dev-guide/role-element-assl.md) element.  
...
|------------------|-------------|  
|Parent elements|[DatabasePermissions](../../../2014/analysis-services/dev-guide/databasepermissions-element-assl.md)|  
|Child elements|[Administer](../../../2014/analysis-services/dev-guide/administer-element-assl.md)|  
