---
title: "sys.sp_column_privileges_ex (Transact-SQL)"
...
dev_langs:
  - "TSQL"
---
# sys.sp_column_privileges_ex (Transact-SQL)
...
- [sys.sp_table_privileges_ex (Transact-SQL)](sp-table-privileges-ex-transact-sql.md)
