...
# Statistics for Memory-Optimized Tables
 ...
 Statistics on memory-optimized tables are not updated by default. Instead, you need to update them manually. Use [UPDATE STATISTICS &#40;Transact-SQL&#41;](../Topic/UPDATE%20STATISTICS%20\(Transact-SQL\).md) for individual columns, indexes, or tables. Use [sp_updatestats &#40;Transact-SQL&#41;](../Topic/sp_updatestats%20\(Transact-SQL\).md) to update statistics for all user and internal tables in the database.  
  
 When using [CREATE STATISTICS &#40;Transact-SQL&#41;](../Topic/CREATE%20STATISTICS%20\(Transact-SQL\).md) or [UPDATE STATISTICS &#40;Transact-SQL&#41;](../Topic/UPDATE%20STATISTICS%20\(Transact-SQL\).md), you must specify `NORECOMPUTE` to disable automatic statistics update for memory-optimized tables. For disk based tables, [sp_updatestats &#40;Transact-SQL&#41;](../Topic/sp_updatestats%20\(Transact-SQL\).md) only updates statistics if the table has been modified since the last [sp_updatestats &#40;Transact-SQL&#41;](../Topic/sp_updatestats%20\(Transact-SQL\).md). For memory-optimized tables, [sp_updatestats &#40;Transact-SQL&#41;](../Topic/sp_updatestats%20\(Transact-SQL\).md) always generates updated statistics. [sp_updatestats &#40;Transact-SQL&#41;](../Topic/sp_updatestats%20\(Transact-SQL\).md) is a good option for memory-optimized tables; otherwise you need to know which tables have significant changes so you can update statistics individually.  
 ...
 Disk-based tables use sampled statistics by default. Memory-optimized tables only support fullscan statistics. When using [CREATE STATISTICS &#40;Transact-SQL&#41;](../Topic/CREATE%20STATISTICS%20\(Transact-SQL\).md) or [UPDATE STATISTICS &#40;Transact-SQL&#41;](../Topic/UPDATE%20STATISTICS%20\(Transact-SQL\).md), you must specify the `FULLSCAN` option for memory-optimized tables.  
...
```  
 ...
 To update statistics for all tables in the database, run [sp_updatestats &#40;Transact-SQL&#41;](../Topic/sp_updatestats%20\(Transact-SQL\).md).  
