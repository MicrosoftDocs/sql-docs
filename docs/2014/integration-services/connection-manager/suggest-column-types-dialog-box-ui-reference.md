...
# Suggest Column Types Dialog Box UI Reference
 ...
 To learn more about the data types used by [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)], see [Integration Services Data Types](../data-flow/integration-services-data-types.md).  
...
## See Also  
 ...
 [Flat File Connection Manager](file-connection-manager.md)  
