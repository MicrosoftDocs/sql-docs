...
|last_replication|**datetimeoffset**|The timestamp of the last transaction's acknowledgment by the secondary based on the primary database clock. This value is available on the primary database only.|  
