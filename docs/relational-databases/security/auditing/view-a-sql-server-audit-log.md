...
description: Learn how to view a SQL Server audit log in SQL Server 2019 by using SQL Server Management Studio, which requires CONTROL SERVER permission.
ms.custom: ""
ms.date: "03/14/2017"
ms.prod: sql
