...
|[EnumString](enumstring-data-type-xmla.md)|A set of named string constants for a given enumerator.|  
|Integer|The standard XML `int` data type.|  
|[MDDataSet](mddataset-data-type-xmla.md)|Multidimensional data returned by the *Result* parameter of the [Execute](../xml-elements-methods-execute.md) method.|  
|[Resultset](resultset-data-type-xmla.md)|A self-describing XML result set returned by the `Execute` method.|  
|[Rowset](rowset-data-type-xmla.md)|Rows from a data source, structured by an embedded XML schema, returned by the [Discover](../xml-elements-methods-discover.md) method.|  
