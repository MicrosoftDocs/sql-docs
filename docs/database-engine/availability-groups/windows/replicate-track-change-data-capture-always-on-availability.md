...
If you need to disable Change Data Capture on a database that is part of an Always On availability group and your SQL Server version is below [SQL Server 2016 SP2](https://support.microsoft.com/en-us/topic/kb4092045-fix-lsn-truncation-occurs-in-alwayson-ag-when-disabling-the-change-data-capture-feature-in-sql-server-2016-cf5f641f-5550-caa0-8bb9-418294101bf3), then you will need to implement one of the following steps to prevent Change Data Capture from blocking log truncation after Change Data Capture is disabled:
