...
description: Learn how to start the Distributed Transaction Coordinator service, write a single-transaction SQL Server unit test, and roll back changes that the test makes.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
