...
description: This topic explains how to configure SQL Server Reporting Services to use an SAN by modifying the rsreportserver.config file and using the Netsh.exe tool.
ms.date: 09/25/2017
