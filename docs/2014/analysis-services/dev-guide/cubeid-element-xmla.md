...
|------------------------|-----------------|  
|[Source](../../../2014/analysis-services/dev-guide/source-element-xmla.md)|1-1: Required element that occurs once and only once.|  
|[Target](../../../2014/analysis-services/dev-guide/target-element-xmla.md)|1-1: Required element that occurs once and only once.|  
