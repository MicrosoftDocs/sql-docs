...
| [Hyperscale premium-series and premium-series memory optimized hardware](service-tier-hyperscale.md#compute-resources) | Premium-series and premium-series memory optimized hardware is in preview for for Hyperscale databases. For more information, read the [Premium-series announcement blog post](https://aka.ms/AAiq28n).|
