...
# Export and Import Data Mining Objects
 ...
 This section provides an overview of how to transfer data mining structures and models by using DMX statements. For details of the syntax, together with examples, see [EXPORT &#40;DMX&#41;](../Topic/EXPORT%20\(DMX\).md) and [IMPORT &#40;DMX&#41;](../Topic/IMPORT%20\(DMX\).md).  
...
## Exporting Data Mining Structures  
 ...
 If the mining structure has been processed and the results have been cached, which is the default behavior, when you export the mining structure, the definition contains a summary of the data on which the structure is based. To remove this summary, you must clear the cache associated with the mining structure by performing a `Process Clear Structure` operation. For more information, see [Process a Mining Structure](../../2014/analysis-services/process-a-mining-structure.md).  
...
## Importing Data Mining Structures and Models  
 ...
 You can also import a mining structure or mining model by using the `Restore` command. Your models or structures will be restored into the database that has the same name as the database from which they were exported. For more information, see [Restore Options](../../2014/analysis-services/restore-options.md).  
