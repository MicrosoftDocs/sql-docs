...
1.  [Delete the trigger](../../2014/database-engine/delete-or-disable-dml-triggers.md) that you want to rename.  
  
2.  [Re-create the trigger](../../2014/database-engine/create-dml-triggers.md), specifying the new name.  
