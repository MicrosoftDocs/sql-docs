...
The [!INCLUDE[tsql](../../includes/tsql-md.md)] reference includes articles related to [!INCLUDE [sssql16-md](../../includes/sssql16-md.md)] and later versions, as well as [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)], [!INCLUDE[ssazuremi_md](../../includes/ssazuremi_md.md)], [!INCLUDE[ssazuresynapse_md](../../includes/ssazuresynapse_md.md)], and [!INCLUDE[ssazurepdw_md](../../includes/ssazurepdw_md.md)]. For older versions of [!INCLUDE[ssnoversion-md](../../includes/ssnoversion-md.md)], refer to the [Previous versions of SQL Server documentation](../../sql-server/previous-versions-sql-server.md).
