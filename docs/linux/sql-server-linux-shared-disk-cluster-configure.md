...
|Distribution |Topic 
|----- |-----
|**Red Hat Enterprise Linux 7.2** |[Configure](sql-server-linux-shared-disk-cluster-red-hat-7-configure.md)<br/>[Operate](sql-server-linux-shared-disk-cluster-red-hat-7-operate.md)<br/>[Troubleshoot](sql-server-linux-shared-disk-cluster-red-hat-7-troubleshoot.md)
## Next steps
