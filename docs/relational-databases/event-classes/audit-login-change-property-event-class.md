...
- [sys.sp_defaultdb (Transact-SQL)](../system-stored-procedures/sp-defaultdb-transact-sql.md)
- [sys.sp_defaultlanguage (Transact-SQL)](../system-stored-procedures/sp-defaultlanguage-transact-sql.md)
