...
# QueryDefinition Element (ASSL)
  Contains an opaque expression for a query associated with a [DataSource](../../../2014/analysis-services/dev-guide/datasource-element-assl.md) element in a [QueryBinding](../../../2014/analysis-services/dev-guide/querybinding-data-type-assl.md) element.  
...
|------------------|-------------|  
|Parent element|[QueryBinding](../../../2014/analysis-services/dev-guide/querybinding-data-type-assl.md)|  
|Child elements|None|  
