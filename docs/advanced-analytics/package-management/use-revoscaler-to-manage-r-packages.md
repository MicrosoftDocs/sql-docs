---
title: Install R packages with RevoScaleR
description: Use RevoScaleR package management functions to install R packages on SQL Server without direct access to the server.
ms.prod: sql
...
Use RevoScaleR 9.0.1 and later R package management functions to install R packages on SQL Server without direct access to the server. These functions can be used remotely by non-administrators.
