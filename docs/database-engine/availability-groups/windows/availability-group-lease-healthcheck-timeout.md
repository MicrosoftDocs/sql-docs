...
## Summary of Timeout Guidelines 
 ...
 | :-------------- | :------ | :------ | :--- | :------------------- | :----- | :------ | :-----------| :------------ | 
 | Lease timeout | Prevent splitbrain | Primary to Cluster | [Windows event objects](/windows/desktop/Sync/event-objects)| Used in both | OS hang, low virtual memory, generating dump, pegged CPU, WSFC down (loss of quorum) | AG resource offline-online, failover | HADR | 20000 |
