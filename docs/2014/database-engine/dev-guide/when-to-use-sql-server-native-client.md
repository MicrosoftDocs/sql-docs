...
# When to Use SQL Server Native Client
 ...
 For information about the differences between [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client and MDAC, see [Updating an Application to SQL Server Native Client from MDAC](../../../2014/database-engine/dev-guide/updating-an-application-to-sql-server-native-client-from-mdac.md).  
