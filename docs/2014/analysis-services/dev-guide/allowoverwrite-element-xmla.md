...
# AllowOverwrite Element (XMLA)
  Determines whether the parent [Backup](../../../2014/analysis-services/dev-guide/backup-element-xmla.md) or [Restore](../../../2014/analysis-services/dev-guide/restore-element-xmla.md) command attempts to overwrite the target file or database.  
