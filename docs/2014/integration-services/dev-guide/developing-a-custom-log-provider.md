...
## In This Section  
 ...
 [Creating a Custom Log Provider](../../../2014/integration-services/dev-guide/creating-a-custom-log-provider.md)  
 Describes how to create the classes for a custom log provider project.  
  
 [Coding a Custom Log Provider](../../../2014/integration-services/dev-guide/coding-a-custom-log-provider.md)  
 Describes how to implement a custom log provider by overriding the methods and properties of the base class.  
  
 [Developing a User Interface for a Custom Log Provider](../../../2014/integration-services/dev-guide/developing-a-user-interface-for-a-custom-log-provider.md)  
...
### Information about Other Custom Objects  
 ...
 [Developing a Custom Data Flow Component](../../../2014/integration-services/dev-guide/developing-a-custom-data-flow-component.md)  
