...
description: Once you create a custom assembly, learn how to access classes in your custom assembly by using report expressions.
author: maggiesMSFT
ms.author: maggies
ms.date: 03/04/2017
