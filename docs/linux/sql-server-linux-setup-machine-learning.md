...
+ [Tutorial: Run Python in T-SQL](../python-ski-rental-linear-regression-deploy-model.md)
+ [Tutorial: In-database analytics for Python developers](../advanced-analytics/tutorials/python-clustering-model.md)
