...
# Use Nested FOR XML Queries
  The `xml` data type and the [TYPE directive in FOR XML queries](../../2014/database-engine/type-directive-in-for-xml-queries.md) enable the XML returned by the FOR XML queries to be processed on the server as well as on the client.  
...
## Controlling the Shape of Resulting XML Data  
 ...
 For more information about specifying both attribute-centric and element-centric XML with nested FOR XML queries, see [FOR XML Query Compared to Nested FOR XML Query](../../2014/database-engine/for-xml-query-compared-to-nested-for-xml-query.md) and [Shape XML with Nested FOR XML Queries](../../2014/database-engine/shape-xml-with-nested-for-xml-queries.md).  
  
 You can generate XML hierarchies that include siblings by specifying nested AUTO mode FOR XML queries. For more information, see [Generate Siblings with a Nested AUTO Mode Query](../../2014/database-engine/generate-siblings-with-a-nested-auto-mode-query.md).  
...
## Examples  
 ...
 [FOR XML Query Compared to Nested FOR XML Query](../../2014/database-engine/for-xml-query-compared-to-nested-for-xml-query.md)  
 ...
 [Generate Siblings with a Nested AUTO Mode Query](../../2014/database-engine/generate-siblings-with-a-nested-auto-mode-query.md)  
