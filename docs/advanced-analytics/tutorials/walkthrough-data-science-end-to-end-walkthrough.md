...
The estimated times do not include setup. For more information, see [Prerequisties for the walkthrough](/walkthrough-prerequisites-for-data-science-walkthroughs.md).
...
|[Explore the data using R and SQL](/walkthrough-view-and-explore-the-data.md)<br /><br />Understand your data  using SQL tools and summaries.|10 minutes|
...
|[Creates plots using R for SQL data](/walkthrough-create-graphs-and-plots-using-r.md)<br /><br />Create plots in local and remote compute contexts by mixing R and SQL.|10 minutes|
