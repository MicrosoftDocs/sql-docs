...
|client_interface_name|**nvarchar(32)**|Name of library/client driver being used by the client to communicate with the server. The value is NULL for internal sessions. Is nullable.|  
