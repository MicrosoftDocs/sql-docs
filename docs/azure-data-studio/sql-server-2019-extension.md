...
**Note**: There is a known issue with Internet Explorer where the VSIX will be downloaded as zip files. Using Edge or another browser will download the VSIX correctly. 
