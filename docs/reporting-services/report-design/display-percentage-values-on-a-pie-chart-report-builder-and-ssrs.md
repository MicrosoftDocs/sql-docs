...
#customer intent: As a Report Builder user, I want to learn how to display percentage values in my reports so that can customize the data visualizations in my reports to fit my needs.
---
