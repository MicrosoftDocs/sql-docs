...
> [!NOTE]  
>  To enable [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] to listen on multiple TCP ports for each IP address, see [Configure the Database Engine to Listen on Multiple TCP Ports](../../2014/database-engine/configure-the-database-engine-to-listen-on-multiple-tcp-ports.md).  
...
## See Also  
 [Configure SQL Server to Use Soft-NUMA &#40;SQL Server&#41;](../../2014/database-engine/configure-sql-server-to-use-soft-numa-sql-server.md)  
