...
|**Replication**|Specifies a replication connection. When enabled, triggers with NOT FOR REPLICATION option will not be run on the connection. Recognized values are "yes" and "no". The default is "no". |  
