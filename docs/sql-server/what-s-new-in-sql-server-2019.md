...
| `sys.dm_db_page_info(database_id, file_id, page_id, mode)` | A new DMF that returns information about a page in a database. See [sys.dm_db_page_info](../relational-databases/system-dynamic-management-views/sys-dm-db-page-info-transact-sql.md). |
...
| Support for the Microsoft Distributed Transaction Coordinator (MSDTC) | See [How to configure the Microsoft Distributed Transaction Coordinator (MSDTC) on Linux](../linux/sql-server-linux-configure-msdtc.md). |
...
| Machine Learning Services on Linux | See [Install SQL Server 2019 Machine Learning Services (Python and R) on Linux](../linux/sql-server-linux-setup-machine-learning.md). |
