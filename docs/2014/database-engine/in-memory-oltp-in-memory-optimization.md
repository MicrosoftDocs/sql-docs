...
> [!IMPORTANT]  
>  Some syntax changes to tables and stored procedures will be required to use [!INCLUDE[hek_2](../includes/hek-2-md.md)]. For more information, see [Migrating to In-Memory OLTP](../../2014/database-engine/migrating-to-in-memory-oltp.md). Before you attempt to migrate a disk-based table to a memory-optimized table, read [Determining if a Table or Stored Procedure Should Be Ported to In-Memory OLTP](../../2014/database-engine/determining-if-a-table-or-stored-procedure-should-be-ported-to-in-memory-oltp.md) to see which tables and stored procedures will benefit from [!INCLUDE[hek_2](../includes/hek-2-md.md)].  
...
|Topic|Description|  
|-----------|-----------------|  
|[Requirements for Using Memory-Optimized Tables](../../2014/database-engine/requirements-for-using-memory-optimized-tables.md)|Discusses hardware and software requirements and guidelines for using memory-optimized tables.|  
...
|[In-Memory OLTP Code Samples](../../2014/database-engine/in-memory-oltp-code-samples.md)|Contains code samples that show how to create and use a memory-optimized table.|  
...
|[Natively Compiled Stored Procedures](../../2014/database-engine/natively-compiled-stored-procedures.md)|Introduces natively compiled stored procedures.|  
