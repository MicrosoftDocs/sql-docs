...
## In This Section  
 [Enumerating Instances of SQL Server (ADO.NET)](../../connect/ado-net/enumerating-instances-of-sql-server.md)  
 Describes how to enumerate active instances of SQL Server.  
  
 [Provider Statistics for SQL Server](../../connect/ado-net/provider-statistics-for-sql-server.md)  
 Describes support for obtaining SQL Server run-time statistics.  
  
 [SQL Server Express User Instances](../../connect/ado-net/sql-server-express-user-instances.md)  
 Describes support for SQL Server Express user instances.  
  
 [Database Mirroring in SQL Server](../../connect/ado-net/database-mirroring-in-sql-server.md)  
 ...
 [Snapshot Isolation in SQL Server](../../connect/ado-net/snapshot-isolation-in-sql-server.md)  
 ...
 [SqlClient Support for High Availability, Disaster Recovery](../../connect/ado-net/sqlclient-support-for-high-availability-disaster-recovery.md)  
 Describes SqlClient support for high-availability, disaster recovery (AlwaysOn) availability groups.  
  
 [SqlClient Support for LocalDB](../../connect/ado-net/sqlclient-support-for-localdb.md)  
...
- [LINQ to SQL](../../connect/ado-net/linq/index.md)
