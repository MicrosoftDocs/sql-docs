...
-   Mapping Schema  
 ...
 In this sample ADO application, an XML template that consists of an XPath query (root) is specified against the XSD mapping schema (MySchema.xml) that is described in [Executing XPath Queries &#40;SQLXMLOLEDB Provider&#41;](../../../2014/database-engine/dev-guide/executing-xpath-queries-sqlxmloledb-provider.md).  
