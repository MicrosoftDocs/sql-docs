...
## Example  
 For a usage example of this element, see [XML Input File Sample with User-specified Configuration &#40;DTA&#41;](../../2014/database-engine/xml-input-file-sample-with-user-specified-configuration-dta.md).  
