...
Holds information about all requests currently or recently active in [!INCLUDEssazuresynapse-md(../../includes/ssazuresynapse-md.md)]. It lists one row per request/query. 
