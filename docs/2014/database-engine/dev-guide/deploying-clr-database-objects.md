...
# Deploying CLR Database Objects
 ...
 The CLR integration feature is turned off by default in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] and must be enabled in order to use CLR assemblies. For more information, see [Enabling CLR Integration](../../../2014/database-engine/dev-guide/enabling-clr-integration.md).  
