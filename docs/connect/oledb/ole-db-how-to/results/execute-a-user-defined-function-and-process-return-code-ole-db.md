...
description: See how to run user-defined function and print a return code using OLE DB Driver for SQL Server with this example which uses the AdventureWorks sample database.
ms.custom: ""
ms.date: "06/14/2018"
ms.prod: sql
