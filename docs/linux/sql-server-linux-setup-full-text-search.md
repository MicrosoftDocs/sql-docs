...
In order to use Semantic Search, you must first download and attach the [Semantic Language Statistics database](../relational-databases/search/install-and-configure-semantic-search.md).
