...
# Capability Element (XMLA)
  Indicates support for a protocol capability in the parent [ProtocolCapabilities](../../../2014/analysis-services/dev-guide/protocolcapabilities-element-xmla.md) header element.  
...
|------------------|-------------|  
|Parent elements|[ProtocolCapabilities](../../../2014/analysis-services/dev-guide/protocolcapabilities-element-xmla.md)|  
|Child elements|None|  
