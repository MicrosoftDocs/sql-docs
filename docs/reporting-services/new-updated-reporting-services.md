...
1. [Configure the web portal](report-server/configure-web-portal.md)
2. [Grant user access to a report server](security/grant-user-access-to-a-report-server.md)
