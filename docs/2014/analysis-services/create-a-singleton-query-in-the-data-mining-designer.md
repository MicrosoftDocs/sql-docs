...
# Create a Singleton Query in the Data Mining Designer
  A singleton query is useful if you want to create a prediction for a single case. For more information about singleton queries, see [Data Mining Queries](../../2014/analysis-services/data-mining-queries.md).  
