...
|[MeasureGroupAttribute](measuregroupattribute-data-type-assl.md)|[KeyColumn](keycolumn-element-assl.md)|`Source` element of the `DataItem` must be of type [ColumnBinding](binding-data-type-assl.md), [AttributeBinding](attributebinding-data-type-assl.md) or [InheritedBinding](inheritedbinding-data-type-assl.md)|  
|[ScalarMiningStructureColumn](miningstructurecolumn-data-type-assl.md)|[KeyColumn](keycolumn-element-assl.md)|`Source` element of the `DataItem` must be of type [ColumnBinding](binding-data-type-assl.md)|  
|[ScalarMiningStructureColumn](miningstructurecolumn-data-type-assl.md)|[NameColumn](namecolumn-element-assl.md)|`Source` element of the `DataItem` must be of type [ColumnBinding](binding-data-type-assl.md)|  
