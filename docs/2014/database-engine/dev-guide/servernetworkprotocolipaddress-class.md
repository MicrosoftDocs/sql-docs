...
---
# ServerNetworkProtocolIPAddress Class
  The [ServerNetworkProtocolIPAddress Class](../../../2014/database-engine/dev-guide/servernetworkprotocolipaddress-class.md) represents an IP address supported by the server network protocol.  
