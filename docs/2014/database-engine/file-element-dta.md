...
|--------------------|-----------------|  
|**Data type and length**|Use the `string` data type to specify the directory path to your workload file. For example:<br /><br /> `<File>C:\Tuning\tun.sql</File>`<br /><br /> Length limit is enforced by the server.|  
|**Default value**|None.|  
...
|------------------|--------------|  
|**Parent element**|[Workload Element &#40;DTA&#41;](../../2014/database-engine/workload-element-dta.md)|  
|**Child elements**|None.|  
  
## Example  
 For a usage example of this element, see [Simple XML Input File Sample &#40;DTA&#41;](../../2014/database-engine/simple-xml-input-file-sample-dta.md).  
