...
|[Prepared Statement Metadata Caching](../../connect/jdbc/prepared-statement-metadata-caching.md)|Discusses the techniques for improving performance with prepared statement queries.|
