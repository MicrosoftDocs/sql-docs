...
> [!NOTE]  
> Starting with [!INCLUDE[sssql22-md](../../includes/sssql22-md.md)] Cumulative Update 4, several fixes for a race condition which can lead to an access violation have been released. If access violations realated to PSP optimization with Query Store integration occur after applying Cumulative Update 4 for SQL Server 2022, please consider the workaround section below.
