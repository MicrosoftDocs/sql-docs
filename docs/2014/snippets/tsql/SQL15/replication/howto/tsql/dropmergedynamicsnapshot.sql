...
-- Remove all articles from a merge publication.
USE [AdventureWorks2012]
EXEC sp_dropmergearticle @publication = @myMergePub, @article = 'all',
...
USE [AdventureWorks2012]
EXEC sp_dropmergepublication @publication = @myMergePub
