...
description: This topic contains the release notes and supported features for SQL Server vNext running on Linux. Release notes for 1.1 and 1.0 are included.
author: rothja 
ms.author: jroth 
manager: jhubbard
ms.date: 01/04/2016
