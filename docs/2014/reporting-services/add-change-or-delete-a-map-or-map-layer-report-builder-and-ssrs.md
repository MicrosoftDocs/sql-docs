...
|![rs_IconMapTileLayer](../../2014/reporting-services/media/rs-iconmaptilelayer.gif "rs_IconMapTileLayer")|Tile Layer|Add a map layer that displays Bing Map tiles that correspond to the current map view area that is defined by the viewport.|  
 ...
 For more information about layers, see [Maps &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/maps-report-builder-and-ssrs.md).  
...
-   From the Ribbon, on the **Insert** menu, click **Map**, and then click **Map Wizard.** The wizard enables you to add a layer to the existing map. Most wizard pages are identical between the map wizard and the map layer wizard.  
     ...
     For more information, see [Map Wizard and Map Layer Wizard &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/map-wizard-and-map-layer-wizard-report-builder-and-ssrs.md).  
...
4.  In **Use spatial data from**, select the source of spatial data. Options vary based on your selection.  
    ...
    5.  Type the name of the match field from the analytical dataset.  
     ...
     For more information about linking spatial and analytical data, see [Customize the Data and Display of a Map or Map Layer &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/customize-the-data-and-display-of-a-map-or-map-layer-report-builder-and-ssrs.md).  
...
4.  Define a filter equation to limit the analytical data that is used in the map display. For more information, see [Filter Equation Examples &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/filter-equation-examples-report-builder-and-ssrs.md).  
...
1.  Set `Visibility` options to control the display for a map layer.  
    ...
    -   Optional. Enter a value for transparency.  
     ...
     You can also conditionally hide the layer. For more information, see [Hide an Item &#40;Report Builder and SSRS&#41;](../../2014/reporting-services/hide-an-item-report-builder-and-ssrs.md).  
