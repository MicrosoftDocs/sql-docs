...
2.  Build the project and deploy your delivery extension assembly and the accompanying .pdb file to the report server and Report Manager. For more information about deployment, see [Deploying a Delivery Extension](../../../2014/reporting-services/dev-guide/deploying-a-delivery-extension.md).  
...
## See Also  
 [Implementing a Delivery Extension](../../../2014/reporting-services/dev-guide/implementing-a-delivery-extension.md)   
