...
##  <a name="DbBuRMf"></a> Database Backups Under the Full Recovery Model  
 ...
 For information about how to create log backups, see [Transaction Log Backups &#40;SQL Server&#41;](../../2014/database-engine/transaction-log-backups-sql-server.md).  
...
##  <a name="RestoreDbBu"></a> Use a Full Database Backup to Restore the Database  
 ...
 For more information, see [Complete Database Restores &#40;Simple Recovery Model&#41;](../../2014/database-engine/complete-database-restores-simple-recovery-model.md) or [Complete Database Restores &#40;Full Recovery Model&#41;](../../2014/database-engine/complete-database-restores-full-recovery-model.md).  
