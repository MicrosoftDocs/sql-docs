...
## See Also  
 ...
 [Developing a User Interface for a Custom Connection Manager](../../../2014/integration-services/dev-guide/developing-a-user-interface-for-a-custom-connection-manager.md)  
