...
> [!NOTE]
> SQL Server documentation uses the term B-tree generally in reference to indexes. In row store indexes, SQL Server implements a B+ tree. This_ does not apply to columnstore or in-memory data stores.
