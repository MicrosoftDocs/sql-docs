...
# AggregationInstanceSource Element (ASSL)
  Identifies the source of data for user-defined aggregation instances bound to a [Partition](../../../2014/analysis-services/dev-guide/partition-element-assl.md) element.  
...
|--------------------|-----------------|  
|Data type and length|[DataSourceViewBinding](../../../2014/analysis-services/dev-guide/datasourceviewbinding-data-type-assl.md)|  
|Default value|None|  
