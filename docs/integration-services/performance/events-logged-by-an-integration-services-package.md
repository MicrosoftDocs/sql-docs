...
# Events Logged by an Integration Services Package
 ...
 For general information about how to run SSIS packages, see [Execution of Projects and Packages](/sql-docs/docs/integration-services/packages/run-integration-services-ssis-packages).  
