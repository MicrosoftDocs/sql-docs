...
|Topic|Description|  
|-----------|-----------------|  
|[User-Configurable Event Class](../../2014/database-engine/user-configurable-event-class.md)|Used to monitor user-defined events that cannot be monitored by the system-supplied events in other event categories.|  
