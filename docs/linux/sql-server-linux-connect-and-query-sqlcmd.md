...
This topic provides connection requirements and guidance for SQL Server 2017 CTP 2.0 running on Linux. In most cases, the connection requirements and processes do not differ across platforms. This topic approaches the subject in the context of Linux and then points to other resources. 
