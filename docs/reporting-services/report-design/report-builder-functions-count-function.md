...
description: Learn about the Count function, which returns a count of non-null values specified by the expression, evaluated in the context of the given scope.
ms.date: 03/07/2017
