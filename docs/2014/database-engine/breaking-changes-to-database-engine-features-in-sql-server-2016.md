...
##  <a name="Yukon"></a> Breaking Changes in SQL Server 2005  
 For a list of breaking changes introduced in [!INCLUDE[ssVersion2005](../includes/ssversion2005-md.md)], see [Breaking Changes to Database Engine Features in SQL Server 2005](breaking-changes-to-database-engine-features-in-sql-server-2016.md).aspx).  
