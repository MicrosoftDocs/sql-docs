...
| **Automated Backup fails for SQL Server 2016+**| **Allow Blob Public Access** is enabled on the storage Account. This solution provides a temporary workaround to a known issue. |
