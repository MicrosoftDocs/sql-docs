...
description: Create a clustered index
author: MikeRayMSFT
ms.author: mikeray
ms.reviewer: mikeray
ms.date: 01/12/2024
...
#### To create a clustered index from Object Explorer
...
1. In the **Select Columns from** _table\_name_ dialog box, select the check box of the table column to be added to the clustered index.
...
1. Right-click the new table created above and select **Design**.
...
1. On the **File** menu, select **Save**_table\_name_.
