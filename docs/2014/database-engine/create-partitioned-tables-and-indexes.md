...
9. Expand the **Tables** folder and create a table as you normally would. For more information, see [Create Tables &#40;Database Engine&#41;](../../2014/database-engine/create-tables-database-engine.md). Alternatively, you can specify an existing table in the next procedure.  
