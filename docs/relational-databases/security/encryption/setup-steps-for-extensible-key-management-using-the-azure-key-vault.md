...
1. On the **Key Vault** pane, select **Keys** and add enter a key vault name, use key type **RSA**, RSA Key Size **2048**, set activation and expiration dates as appropriate, set Enabled? as **Yes**.
