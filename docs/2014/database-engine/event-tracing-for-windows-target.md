...
```  
 ...
 For more information about a full example that shows how to use the ETW target, including how to view the data, see [Monitor System Activity Using Extended Events](../../2014/database-engine/monitor-system-activity-using-extended-events.md).  
