...
description: This tutorial demonstrates how to query Oracle data from a SQL Server 2019 Big Data Clusters. You create an external table over data in Oracle and then run a query.
author: MikeRayMSFT 
ms.author: mikeray
ms.reviewer: ""
ms.date: 08/21/2019
