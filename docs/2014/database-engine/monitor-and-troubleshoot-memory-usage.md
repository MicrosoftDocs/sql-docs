...
-   [Create a sample database with memory-optimized tables](../../2014/database-engine/monitor-and-troubleshoot-memory-usage.md#bkmk_CreateDB)  
  
-   [Monitoring Memory Usage](../../2014/database-engine/monitor-and-troubleshoot-memory-usage.md#bkmk_Monitoring)  
  
    -   [Using SQL Server Management Studio](../../2014/database-engine/monitor-and-troubleshoot-memory-usage.md#bkmk_UsingSSMS)  
  
    -   [Using DMVs](../../2014/database-engine/monitor-and-troubleshoot-memory-usage.md#bkmk_UsingDMVs)  
  
-   [Managing memory consumed by memory-optimized objects](../../2014/database-engine/monitor-and-troubleshoot-memory-usage.md#bkmk_MemOptObjects)  
  
-   [Troubleshooting Memory Issues](../../2014/database-engine/monitor-and-troubleshoot-memory-usage.md#bkmk_Troubleshooting)  
...
```  
 ...
 For more information see [sys.dm_db_xtp_table_memory_stats](http://msdn.microsoft.com/en-us/99b8a95f-d04b-4edb-a764-17b95581d071).  
...
3.  Take action to mitigate the potential memory issues. For more information see [Resolve Out Of Memory Issues](../../2014/database-engine/resolve-out-of-memory-issues.md).  
