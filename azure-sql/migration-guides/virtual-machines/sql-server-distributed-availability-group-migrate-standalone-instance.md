...
The first step is to create your SQL Server VM in Azure. You can do so by using the [Azure portal](../../zirtual-zachines/windows/sql-vm-create-portal-quickstart.md), [Azure PowerShell](../../zirtual-zachines/windows/sql-vm-create-powershell-quickstart.md), or an [ARM template](../../zirtual-zachines/windows/create-sql-vm-resource-manager-template.md). 
