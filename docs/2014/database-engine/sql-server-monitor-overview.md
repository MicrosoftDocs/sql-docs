...
> [!NOTE]  
>  For more information about these monitors, see [Monitoring Replication](../../2014/relational-databases/replication/monitoring-replication.md) and [Monitoring Database Mirroring &#40;SQL Server&#41;](../../2014/database-engine/monitoring-database-mirroring-sql-server.md).  
