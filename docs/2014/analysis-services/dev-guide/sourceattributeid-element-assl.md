...
# SourceAttributeID Element (ASSL)
  Contains the identifier (ID) of the source attribute on which the [Level](../../../2014/analysis-services/dev-guide/level-element-assl.md) element is based.  
...
|------------------|-------------|  
|Parent element|[Level](../../../2014/analysis-services/dev-guide/level-element-assl.md)|  
|Child elements|None|  
