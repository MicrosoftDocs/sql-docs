...
# Recovery of Related  Databases That Contain Marked Transaction
 ...
 For information about the requirements for restoring to a specific recovery point, see [Restore a SQL Server Database to a Point in Time &#40;Full Recovery Model&#41;](../../2014/database-engine/restore-a-sql-server-database-to-a-point-in-time-full-recovery-model.md).  
...
> [!NOTE]  
>  For information about how to mark transactions, see [Use Marked Transactions to Recover Related Databases Consistently &#40;Full Recovery Model&#41;](../../2014/database-engine/use-marked-transactions-to-recover-related-databases-consistently.md).  
...
```  
 ...
 For information about how to insert a mark into a transaction that spans multiple databases, see [Use Marked Transactions to Recover Related Databases Consistently &#40;Full Recovery Model&#41;](../../2014/database-engine/use-marked-transactions-to-recover-related-databases-consistently.md).  
...
1.  Create [tail-log backups](../../2014/database-engine/tail-log-backups-sql-server.md) of the undamaged databases, if possible.  
...
## See Also  
 ...
 [Use Marked Transactions to Recover Related Databases Consistently &#40;Full Recovery Model&#41;](../../2014/database-engine/use-marked-transactions-to-recover-related-databases-consistently.md)   
