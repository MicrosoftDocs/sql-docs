...
> [!NOTE]  
> Starting with [!INCLUDE[sssql14-md](../../includes/sssql14-md.md)], the Selective XML Index functionality cannot be disabled irrespective of the database recovery model. [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)]. In [!INCLUDE[sssql11-md](../../includes/sssql11-md.md)], in order to disable the Selective XML Index using this stored procedure, the database must be put in simple recovery mode by using the [ALTER DATABASE SET Options &#40;Transact-SQL&#41;](../../t-sql/statements/alter-database-transact-sql-set-options.md) command.  
