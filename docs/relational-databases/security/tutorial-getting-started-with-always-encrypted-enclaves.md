...
- CPU support for virtualization technologies:
  ...
  - If you're running [!INCLUDE [ssnoversion-md](../../includes/ssnoversion-md.md)] in a VM:
    ...
    - On Hyper-V 2016 or later, make sure your VM is a Generation 2 VM (recommended) or it is a Generation 1 VM with nested virtuazliation enabled. For more information, see [Should I create a generation 1 or 2 virtual machine in Hyper-V?](/virtualization/hyper-v/plan/should-i-create-a-generation-1-or-2-virtual-machine-in-hyper-v) and [Configure nested virtualization](/virtualization/hyper-v-on-windows/user-guide/nested-virtualization#configure-nested-virtualization).
