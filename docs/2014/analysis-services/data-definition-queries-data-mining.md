...
-   Define the data set used for training a model, by using [INSERT INTO &#40;DMX&#41;](~/dmx/insert-into-dmx.md) together with a data source query such as OPENROWSET.  
 ...
 [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] provides query templates that can help you create data definition queries. For more information, see [Use Analysis Services Templates in SQL Server Management Studio](../../2014/analysis-services/use-analysis-services-templates-in-sql-server-management-studio.md).  
 ...
 For an example of how to enter parameters using the interface, see [Create a Singleton Prediction Query from a Template](../../2014/analysis-services/create-a-singleton-prediction-query-from-a-template.md).  
...
|||  
|-|-|  
|Work with templates for DMX queries.|[Use Analysis Services Templates in SQL Server Management Studio](../../2014/analysis-services/use-analysis-services-templates-in-sql-server-management-studio.md)|  
|Design queries of all kinds, using Prediction Query Builder.|[Create a Prediction Query Using the Prediction Query Builder](../../2014/analysis-services/create-a-prediction-query-using-the-prediction-query-builder.md)|  
|Capture query definitions by using SQL Server Profiler, and use traces to monitor [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)].|[Use SQL Server Profiler to Monitor Analysis Services](../../2014/analysis-services/use-sql-server-profiler-to-monitor-analysis-services.md)|  
|Learn more about the scripting languages and programming languages provided for [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)].|[XML for Analysis  &#40;XMLA&#41; Reference](../../2014/analysis-services/dev-guide/xml-for-analysis-xmla-reference.md)<br /><br /> [Developing with Analysis Management Objects &#40;AMO&#41;](../../2014/analysis-services/dev-guide/developing-with-analysis-management-objects-amo.md)|  
|Learn how to manage models in [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] and [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)].|[Export and Import Data Mining Objects](../../2014/analysis-services/export-and-import-data-mining-objects.md)<br /><br /> [EXPORT &#40;DMX&#41;](~/dmx/export-dmx.md)<br /><br /> [IMPORT &#40;DMX&#41;](~/dmx/import-dmx.md)|  
