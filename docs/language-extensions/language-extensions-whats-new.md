...
|---------|----------------|
| CTP 3.2 | Open Zulu JRE 11.0.3 is now included with the [SQL Server Language Extensions installation](install/install-sql-server-language-extensions-on-windows.md). |
