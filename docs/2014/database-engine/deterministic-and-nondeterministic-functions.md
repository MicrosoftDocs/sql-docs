...
## Built-in Function Determinism  
 ...
 All of the string built-in functions are deterministic. For a list of these functions, see [String Functions &#40;Transact-SQL&#41;](../Topic/String%20Functions%20\(Transact-SQL\).md).  
...
|Function|Comments|  
|--------------|--------------|  
|all aggregate functions|All aggregate functions are deterministic unless they are specified with the OVER and ORDER BY clauses. For a list of these functions, see [Aggregate Functions &#40;Transact-SQL&#41;](../Topic/Aggregate%20Functions%20\(Transact-SQL\).md).|  
...
|RAND|RAND is deterministic only when a *seed* parameter is specified.|  
 ...
 All the configuration, cursor, metadata, security, and system statistical functions are nondeterministic. For a list of these functions, see [Configuration Functions &#40;Transact-SQL&#41;](../Topic/Configuration%20Functions%20\(Transact-SQL\).md), [Cursor Functions &#40;Transact-SQL&#41;](../Topic/Cursor%20Functions%20\(Transact-SQL\).md), [Metadata Functions &#40;Transact-SQL&#41;](../Topic/Metadata%20Functions%20\(Transact-SQL\).md), [Security Functions &#40;Transact-SQL&#41;](../Topic/Security%20Functions%20\(Transact-SQL\).md), and [System Statistical Functions &#40;Transact-SQL&#41;](../Topic/System%20Statistical%20Functions%20\(Transact-SQL\).md).  
