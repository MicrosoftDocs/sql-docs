...
-   The contents of the right pane varies based on which  item is selected in the left pane.  
    ...
    If a group of objects (such as a schema) or a table is selected, the right pane displays a two panes. The **Conversion Statistics** pane shows the conversion statistics for the selected objects. The **Objects by Categories** pane shows the conversion statistics for the object or categories of objects.  
