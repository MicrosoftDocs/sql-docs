...
description: This topic shows how to take a SQL Server database backup on Windows and restore it to a Linux machine running SQL Server 2017 CTP 2.0.
author: MikeRayMSFT 
ms.author: mikeray 
manager: jhubbard
ms.date: 03/17/2017
...
SQL Server's backup and restore feature is the recommended way to migrate a database from SQL Server on Windows to SQL Server 2017 CTP 2.0 on Linux. This topic provides step-by-step instructions for this technique. In this tutorial, you will:
...
> [!NOTE] 
> This tutorial assumes that you have installed [SQL Server 2017 CTP 2.0](sql-server-linux-setup.md) and the [SQL Server Tools](sql-server-linux-setup-tools.md) on your target Linux server.
