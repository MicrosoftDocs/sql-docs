...
Returns successful [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)] database connections and connection failures. You can use this information to track or troubleshoot your database activity.  
