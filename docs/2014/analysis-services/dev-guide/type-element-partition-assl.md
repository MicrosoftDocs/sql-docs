...
# Type Element (Partition) (ASSL)
  Contains the type of the [Partition](../../../2014/analysis-services/dev-guide/partition-element-assl.md) element.  
...
|------------------|-------------|  
|Parent element|[Partition](../../../2014/analysis-services/dev-guide/partition-element-assl.md)|  
|Child elements|None|  
