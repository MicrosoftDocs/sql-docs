...
## See Also  
 [Resource Database](../../2014/database-engine/resource-database.md)   
 [tempdb Database](../../2014/database-engine/tempdb-database.md)   
 [master Database](../../2014/database-engine/master-database.md)   
 [msdb Database](../../2014/database-engine/msdb-database.md)   
 [model Database](../../2014/database-engine/model-database.md)   
