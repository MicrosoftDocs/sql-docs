...
|**ColumnPermissions**|**int**|Indicator of whether a column permission was set. Parse the statement text to determine exactly which permissions were applied to which columns.|44|Yes|  
...
||||||  
|**EventClass**|**int**|Type of event = 116.|27|No|  
...
||||||  
||||||  
|**TextData**|**ntext**|SQL text of the DBCC command.|1|Yes|  
