...
|User Defined|40|Collects all user defined events since the trace started.|  
 ...
 For information about the columns associated with each of the Notification Events event classes, see [Notification Events Data Columns](../../analysis-services/trace-events/notification-events-data-columns.md).  
