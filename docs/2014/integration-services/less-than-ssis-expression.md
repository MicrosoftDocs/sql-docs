...
## Expression Examples  
 This example evaluates to TRUE if the current date is later than July 4, 2003. For more information, see [GETDATE &#40;SSIS Expression&#41;](../../2014/integration-services/getdate-ssis-expression.md).  
