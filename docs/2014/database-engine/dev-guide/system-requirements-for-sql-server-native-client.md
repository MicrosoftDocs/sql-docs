...
## Operating System Requirements  
 For a list of operating systems that support [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client, see [Support Policies for SQL Server Native Client](../../../2014/database-engine/dev-guide/support-policies-for-sql-server-native-client.md).  
