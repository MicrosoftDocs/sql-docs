...
# Language Element (XMLA)
  Contains the locale identifier (LCID) for the parent [Translation](../../../2014/analysis-services/dev-guide/translation-element-xmla.md) element.  
...
|------------------|-------------|  
|Parent elements|[Translation](../../../2014/analysis-services/dev-guide/translation-element-xmla.md)|  
|Child elements|None|  
