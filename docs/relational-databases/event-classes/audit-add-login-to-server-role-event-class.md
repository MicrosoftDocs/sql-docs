...
- [sys.sp_addsrvrolemember (Transact-SQL)](../system-stored-procedures/sp-addsrvrolemember-transact-sql.md)
- [sys.sp_dropsrvrolemember (Transact-SQL)](../system-stored-procedures/sp-dropsrvrolemember-transact-sql.md)
