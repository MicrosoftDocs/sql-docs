...
:::image type="content" source="media/sql-server-business-continuity/simple-availability-group.png" alt-text="Diagram of a simple availability group.":::
...
:::image type="content" source="media/sql-server-business-continuity/availability-group-options.png" alt-text="Screenshot of SSMS AG options.":::
...
:::image type="content" source="media/sql-server-business-continuity/failover-cluster-instance.png" alt-text="Diagram of a Failover Cluster Instance.":::

After a failover, ownership changes as is seen in the diagram below.

:::image type="content" source="media/sql-server-business-continuity/failover-cluster-instance-post-failover.png" alt-text="Diagram of a Failover Cluster Instance, post failover.":::
...
:::image type="content" source="media/sql-server-business-continuity/log-shipping.png" alt-text="Diagram of Log Shipping.":::
...
:::image type="content" source="media/sql-server-business-continuity/availability-group-span.png" alt-text="Diagram of an availability group spanning data centers.":::
...
:::image type="content" source="media/sql-server-business-continuity/distributed-availability-group.png" alt-text="Diagram of a Distributed Availability Group.":::
...
:::image type="content" source="media/sql-server-business-continuity/failover-cluster-instance-span.png" alt-text="Diagram of an FCI spanning data centers.":::
