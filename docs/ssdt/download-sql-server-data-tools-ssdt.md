...
> - Use SSDT for Visual Studio 2017 (15.8.0) or earlier versions for designing SSIS packages that contain Teradata Source/Destination. VS2017 (15.8.2) can’t design SSIS packages that contain Teradata Source/Destination. 
