...
## Remarks
 ...
 In [!INCLUDE[sssql22-md](../../includes/sssql22-md.md)], SQL Server support for HDFS Cloudera (CDP) and Hortonworks (HDP) external data sources are retired and not included. There's no need to use the `CREATE EXTERNAL DATA SOURCE ... TYPE` argument in [!INCLUDE[sssql22-md](../../includes/sssql22-md.md)].
