...
[MicrosoftML R package](/machine-learning-server/r-reference/microsoftml/microsoftml-package) or [microsoftml Python package](/sql/machine-learning/python/microsoftml-package) contain the pre-trained models.
...
+ [microsoftml package for Python](/sql/machine-learning/python/microsoftml-package)
