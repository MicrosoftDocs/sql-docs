...
# MSReportServer_ConfigurationSetting Class
 ...
 For a list of all members of this type, see [MSReportServer_ConfigurationSetting Members](msreportserver-configurationsetting-members.md).  
...
## Example  
 To run the following code, add your server name in place of each \<*servername*>. Update the path to point to your installation location, if it is not the default. The following code example iterates through each property in the [MSReportServer_ConfigurationSetting](msreportserver-configurationsetting-class.md) class, printing the name of each property and its value to the console.  
