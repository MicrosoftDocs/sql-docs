...
To connect to Microsoft SQL Server, use the <xref:Microsoft.Data.SqlClient.SqlConnection> object of the ADO.NET Data Provider for SQL Server. For securely storing and retrieving connection strings, see [Protecting Connection Information](protecting-connection-information.md).
