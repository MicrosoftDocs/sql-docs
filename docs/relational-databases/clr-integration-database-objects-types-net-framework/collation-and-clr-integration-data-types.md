...
description: In SQL Server CRL integration, the .NET Framework string APIs use the CompareInfo property of CultureInfo of the current thread to perform string comparisons.
ms.custom: ""
ms.date: "03/14/2017"
ms.prod: sql
ms.reviewer: ""
