...
### [Setup Machine Learning Server Standalone](r/create-a-standalone-r-server.md)  
...
## [Operationalization](r/creating-workflows-that-use-r-in-sql-server.md)  

### [Operationalizing Your R Code](r/operationalizing-your-r-code.md)  

## [Performance Tuning](r/sql-server-r-services-performance-tuning.md)  
### [SQL Server Configuration (Machine Learning Services)](r/sql-server-configuration-r-services.md)    
### [R and Data Optimization (Machine Learning Services)](r/r-and-data-optimization-r-services.md)  
