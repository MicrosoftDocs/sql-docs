...
![Knox login](media/quickstart-sql-server-aris-jupyter-notebook/hadoop-gateway-knox-login.png)
...
![HDFS Browse](media/quickstart-sql-server-aris-jupyter-notebook/browse-hdfs.png)
...
![Start notebook](media/quickstart-sql-server-aris-jupyter-notebook/start-notebook.png)
...
![Select a kernel](media/quickstart-sql-server-aris-jupyter-notebook/kernel-select.png)
...
![Attach to](media/quickstart-sql-server-aris-jupyter-notebook/attach-to.png)
...
![Pyspark kernel code](media/quickstart-sql-server-aris-jupyter-notebook/pyspark-kernel-code.png)
...
![Spark kernel code](media/quickstart-sql-server-aris-jupyter-notebook/spark-kernel-code.png)
...
For more information about using Notebooks in [!INCLUDE [SQL Operations Studio](../includes/name-sos-short.md)], see [How to use Jupyter notebooks in SQL Server vNext](sql-server-aris-jupyter-notebook-guidance.md).