 ...
 **Perspectives:** A client can request CSDL for individual perspectives. For more information, see [DISCOVER_CSDL_METADATA Rowset](https://docs.microsoft.com/previous-versions/sql/sql-server-2012/gg471582(v=sql.110)).  
