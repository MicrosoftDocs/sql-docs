...
> [!IMPORTANT]  
> [ssSQL14](../includes/sssql14-md.md)] and later **MDSModelDeploy tool** is backward compatible with the packages created in [!INCLUDE[ssSQL11](../includes/sssql11-md.md)] or higher.  
