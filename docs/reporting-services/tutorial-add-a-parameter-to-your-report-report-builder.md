...
2.  In the Report Data pane, expand the **Datasets** folder, right-click **DataSet1**, and then select **Query**.  
...
4.  In **Value field**, from the drop-down list, select StoreID.  
  
5.  In **Label field**, from the drop-down list, select StoreName. The label field specifies the display name for the value.  
...
5.  In **Value field**, from the drop-down list, select StoreID.  
...
2.  In the Report Data pane, right-click *\@StoreID*, and then select **Parameter Properties**.  
...
2.  On the design surface, in the matrix, in the first row column header, right-click `[StoreID]` and then select **Expression**.  
  
3.  In the expression pane, delete all text except the beginning **equals sign** (=).  
  
4.  In **Category**, expand **Common Functions**, and select **Miscellaneous**. The Item pane displays a set of functions.  
...
2.  Right-click a row or column header handle on the matrix, and then select **Tablix Properties**.  
  
3.  Select **Filters**, and then choose **Add**. A new filter row appears.  
...
5.  In the Report Data pane, expand the **Datasets** folder, right-click **DataSet1**, and then select **Query**.  
...
8.  Right-click a row or column header handle on the matrix, and then select **Tablix Properties**.  
...
17. Select the drop-down list next to Store Name?  
  
    Each valid value appears next to a check box.  
  
18. Select **Select All**, and then choose **View Report**.  
