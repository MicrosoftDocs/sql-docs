...
# Import and Export Data with the SQL Server Import and Export Wizard
 ...
 > For content related to previous versions of SQL Server, see [Run the SQL Server Import and Export Wizard](start-the-sql-server-import-and-export-wizard.md).aspx).
