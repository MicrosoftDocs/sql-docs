...
1.  [Specify a password](http://msdn.microsoft.com/b099d0f9-dd37-4c87-8b6f-ed0177881ea4) and export/ import it onto other Window machines  
  
2.  [Generate Reports](http://msdn.microsoft.com/abb4264a-622e-4215-af5b-14e309b8a399) to view the detailed xml output reports for assessment /conversion and data migration. Detailed error reports can also be generated for refresh and synchronization commands.  
...
## See Also  
[Installing SQL Server Migration Assistant for Access](http://msdn.microsoft.com/dd50eebd-75df-4e0d-8c4d-88b511aae4c7)  
