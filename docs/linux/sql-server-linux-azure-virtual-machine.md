...
Azure provides Linux virtual machine images that have SQL Server vNext CTP 1.4 installed. This topic provides a short walkthrough on how to use the Azure portal to create a Linux SQL Server virtual machine. 
