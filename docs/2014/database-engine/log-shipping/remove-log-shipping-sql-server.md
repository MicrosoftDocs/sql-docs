...
4.  On the log shipping primary server, disable the backup job. For more information, see [Disable or Enable a Job](../../2014/database-engine/disable-or-enable-a-job.md).  
