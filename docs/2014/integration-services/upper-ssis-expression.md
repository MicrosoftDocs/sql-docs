...
```  
 ...
 This example converts the first character in the **FirstName** column to an uppercase character. If **FirstName** is anna, the return result is "A". For more information, see [SUBSTRING &#40;SSIS Expression&#41;](../../2014/integration-services/substring-ssis-expression.md).  
...
## See Also  
 [LOWER &#40;SSIS Expression&#41;](../../2014/integration-services/lower-ssis-expression.md)   
