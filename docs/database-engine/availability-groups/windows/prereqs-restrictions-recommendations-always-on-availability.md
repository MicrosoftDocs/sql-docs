...
-   **Do not add resources or alter dependencies associated to availability group role**. We do not recommend placing any user/third-party resources into the availability group role or altering the role dependencies as these changes can negatively impact failover performance.
