...
| dist_statement_id | **uniqueidentifier** | **Applies to**: SQL Server 2022 and later versions, Azure SQL Database, Microsoft Fabric<br /><br /> Unique ID for the statement for the request submitted. Not nullable. |
## Remarks
