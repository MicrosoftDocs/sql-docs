...
description: Learn how to query columns in Always Encrypted using SQL Server Management Studio. You can retrieve ciphertext or text values stored in encrypted columns.
ms.custom: ""
ms.date: 10/31/2019
ms.prod: sql
ms.reviewer: vanto
