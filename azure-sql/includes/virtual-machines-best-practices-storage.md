...
- Place data, log, and `tempdb` files on separate drives.
  ...
  - Place [tempdb](/sql/relational-databases/databases/tempdb-database) on the [local ephemeral SSD](azure/virtual-machines/managed-disks-overview#temporary-disk) (default `D:\`) drive for most SQL Server workloads that aren't part of Failover Cluster Instance (FCI) after choosing the optimal VM size.
