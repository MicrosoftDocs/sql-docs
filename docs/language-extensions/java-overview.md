...
1. Configure development tools.
   ...
   - Use the [MSSQL extension for Visual Studio Code](../tools/visual-studio-code-extensions/mssql/mssql-extension-visual-studio-code.md) for executing external code on SQL Server.
