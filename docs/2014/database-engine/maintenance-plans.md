...
|-|-|  
|**Description**|**Topic**|  
|Describes how to create a maintenance plan by using [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] or [!INCLUDE[tsql](../includes/tsql-md.md)].|[Create a Maintenance Plan](../../2014/database-engine/create-a-maintenance-plan.md)|  
|Describes how to create a maintenance plan by using the Maintenance Plan Design Surface.|[Create a Maintenance Plan &#40;Maintenance Plan Design Surface&#41;](../../2014/database-engine/create-a-maintenance-plan-maintenance-plan-design-surface.md)|  
|Documents maintenance plan functionality available in Object Explorer.|[Maintenance Plans Node &#40;Object Explorer&#41;](../../2014/database-engine/maintenance-plans-node-object-explorer.md)|  
