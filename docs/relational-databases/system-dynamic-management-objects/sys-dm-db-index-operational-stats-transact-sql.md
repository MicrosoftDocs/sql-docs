...
|`hobt_id`|**bigint**|ID of the data heap or B-tree rowset that tracks internal data for a columnstore index.<br /><br /> NULL - this is not an internal columnstore rowset.<br /><br /> For more information, see [sys.internal_partitions (Transact-SQL)](../system-catalog-views/sys-internal-partitions-transact-sql.md).|
...
For more information, see [Dynamic Management Views and Functions (Transact-SQL)](system-dynamic-management-objects.md).
