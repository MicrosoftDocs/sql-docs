...
> [!NOTE]
> This step applies only to [!INCLUDE [ssnoversion-md](../../includes/ssnoversion-md.md)]. If you're using [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)], skip this step. ADR is automatically enabled in [!INCLUDE[ssSDSfull](../../includes/ssazure-sqldb.md)] and disabling it is not supported.
