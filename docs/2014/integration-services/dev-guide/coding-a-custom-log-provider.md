...
# Coding a Custom Log Provider
 ...
 For working samples of custom log providers, see [Developing a User Interface for a Custom Log Provider](../../../2014/integration-services/dev-guide/developing-a-user-interface-for-a-custom-log-provider.md).  
