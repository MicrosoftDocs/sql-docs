...
# Create a SQL Server Database Alert
 ...
 Alerts also can be defined by using [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] and [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Agent. For more information, see [Alerts](../../2014/database-engine/alerts.md).  
  
 For more information about using System Monitor to set up a [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] database alert, see [Set Up a SQL Server Database Alert &#40;Windows&#41;](../../2014/database-engine/set-up-a-sql-server-database-alert-windows.md) .  
