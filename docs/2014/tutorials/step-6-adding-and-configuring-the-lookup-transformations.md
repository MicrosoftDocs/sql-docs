...
> [!NOTE]  
>  You can also configure the Lookup transformation to connect to a cache that contains the reference dataset. For more information, see [Lookup Transformation](../../2014/integration-services/lookup-transformation.md).  
...
## Next Task in Lesson  
 [Step 7: Adding and Configuring the OLE DB Destination](../../2014/tutorials/step-7-adding-and-configuring-the-ole-db-destination.md)  
