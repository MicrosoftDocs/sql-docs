...
:::image type="content" source="../../relational-databases/system-dynamic-management-objects/media/join-dm-fts-active-catalogs.svg" alt-text="Diagram of physical joins for sys.dm_fts_active_catalogs.":::
