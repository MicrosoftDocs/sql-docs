...
The following article provides reference for the cluster-scoped **settings** commands in the **azdata** tool. For more information about other **azdata** commands, see [azdata reference](reference-azdata.md)
