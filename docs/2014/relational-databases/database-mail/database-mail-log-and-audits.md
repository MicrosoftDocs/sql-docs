...
|Check the delivery status of an individual message|[Check the Status of E-Mail Messages Sent With Database Mail](../relational-databases/database-mail/database-mail.md)|  
