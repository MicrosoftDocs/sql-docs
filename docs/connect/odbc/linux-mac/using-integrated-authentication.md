...
As of version 17.6, the driver also supports integrated authentication with Microsoft Entra ID using a federated account, system library limitations notwithstanding. See [Using Microsoft Entra ID](../using-azure-active-directory.md) for more information.
