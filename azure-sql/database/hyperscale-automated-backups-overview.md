...
Default short-term retention (STR) of backups for Hyperscale databases is 7 days. Long-term retention (LTR) policies aren't currently supported.

> [!NOTE]
> STR of backups in the range of 1 to 35 days for Hyperscale databases is now in preview. 
