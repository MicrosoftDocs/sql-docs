...
> [!NOTE]  
>  Collections of child objects appear as the property of an object. For example, the `Tables` collection is a property of a `Server` object. For more information, see [Using Collections](../../../2014/database-engine/dev-guide/using-collections.md).  
