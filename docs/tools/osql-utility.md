---
title: osql Utility
description: In SQL Server, the osql utility lets you Transact-SQL statements, system procedures, and script files. This utility uses ODBC to communicate with the server.
ms.prod: sql
