...
| `is_remote_data_archive_enabled` | **bit** | Indicates whether the table is Stretch-enabled.<br /><br />0 = The table isn't Stretch-enabled.<br />1 = The table is Stretch-enabled.<br /><br />For more info, see [Stretch Database](../../sql-server/stretch-database/stretch-database.md).<br /><br />**Applies to**: [!INCLUDE [sssql16-md](../../includes/sssql16-md.md)] and later versions, and [!INCLUDE [ssazure-sqldb](../../includes/ssazure-sqldb.md)] |
