...
-   [Example memory-optimized table](../../2014/database-engine/estimate-memory-requirements-for-memory-optimized-tables.md#bkmk_ExampleTable)  
  
-   [Memory for the table](../../2014/database-engine/estimate-memory-requirements-for-memory-optimized-tables.md#bkmk_MemoryForTable)  
  
-   [Memory for indexes](../../2014/database-engine/estimate-memory-requirements-for-memory-optimized-tables.md#bkmk_IndexMeemory)  
  
-   [Memory for row versioning](../../2014/database-engine/estimate-memory-requirements-for-memory-optimized-tables.md#bkmk_MemoryForRowVersions)  
  
-   [Memory for table variables](../../2014/database-engine/estimate-memory-requirements-for-memory-optimized-tables.md#bkmk_TableVariables)  
  
-   [Memory for growth](../../2014/database-engine/estimate-memory-requirements-for-memory-optimized-tables.md#bkmk_MemoryForGrowth)  
...
##  <a name="bkmk_MemoryForRowVersions"></a> Memory for row versioning  
 ...
 Memory needs for stale rows is then estimated by multiplying the number of stale rows by the size of a memory-optimized table row (see [Memory for the table](../../2014/database-engine/estimate-memory-requirements-for-memory-optimized-tables.md#bkmk_MemoryForTable) above).  
