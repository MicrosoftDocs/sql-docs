...
|--------------------|------------------------|  
|[Server](../../dev-guide/server-element-assl.md)|The name must follow the rules for [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Windows computer names. IP addresses are not valid.|  
...
## See Also  
 [ID Element &#40;ASSL&#41;](../../dev-guide/id-element-assl.md)   
