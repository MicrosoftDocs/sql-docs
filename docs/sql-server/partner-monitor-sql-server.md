...
| :---: | --- | --- |
| :::image type="icon" source="media/partner-hadr-sql-server/fortified-wisdom.png" border="false"::: <br />**Fortified** | Fortified WISdom is SQL Server performance monitoring with cost optimization built in. It attributes a dollar cost to every query and stored procedure, so teams can find the most expensive workloads, fix them, and prove the savings. WISdom adds capacity planning and right-sizing, pre- and post-migration analysis, and machine-learning anomaly detection. It supports SQL Server on-premises and on virtual machines, Azure SQL Database, Azure SQL Managed Instance, and Amazon RDS for SQL Server, with no agent installed on your SQL Server instances.<br /><br />- [System requirements](https://docs.fortifiedwisdom.com/user-guide/installation-requirements) | -&nbsp;[Website](https://fortified.com/wisdom-for-databases/)<br />- [Microsoft Marketplace](https://marketplace.microsoft.com/en-us/product/fortifiedinsight.wisd-ent-01)<br />- [LinkedIn](https://www.linkedin.com/company/fortifiedinsight/) |
