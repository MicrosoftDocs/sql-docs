...
> [!Note]
> This public preview feature is available in [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)] – including in Azure SQL single databases, elastic pools, managed instances, and Hyperscale databases.  
