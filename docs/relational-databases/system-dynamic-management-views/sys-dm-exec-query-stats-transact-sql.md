...
|**last_logical_writes**|**bigint**|Number of buffer pool pages dirtied the last time the plan was executed. If a page is already dirty (modified), no writes are counted.<br /><br /> Will always be 0 querying a memory-optimized table.|  
