...
|![A node for which we have complete information](../../includes/sskatmai-md.md)] or a later version, for which replication has complete information. To specify configuration options, right-click the node.|  
