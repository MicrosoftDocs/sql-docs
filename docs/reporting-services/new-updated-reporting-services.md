...
1. [Server Properties (Advanced Page) - Reporting Services](#TitleNum_1)
...
### 1. &nbsp; [Server Properties (Advanced Page) - Reporting Services](tools/server-properties-advanced-page-reporting-services.md)
