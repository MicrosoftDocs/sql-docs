...
# AllowedSet Element (ASSL)
  Contains a set expression that defines the set of allowed permissions for a [Role](../../../2014/analysis-services/dev-guide/role-element-assl.md) element on an attribute.  
...
|------------------|-------------|  
|Parent elements|[AttributePermission](../../../2014/analysis-services/dev-guide/attributepermission-element-assl.md)|  
|Child elements|None|  
