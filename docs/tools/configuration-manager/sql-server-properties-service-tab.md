...
description: Learn about the options on the Service tab of the MSSQLSERVER Properties dialog box, such as the binary path, the start mode, and other properties.
