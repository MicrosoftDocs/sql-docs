...
## In This Section  
 [Regular vs. Context Connections](../../../2014/database-engine/dev-guide/regular-vs-context-connections.md)  
 Describes the differences between regular and context connections.  
  
 [Restrictions on Regular and Context Connections](../../../2014/database-engine/dev-guide/restrictions-on-regular-and-context-connections.md)  
