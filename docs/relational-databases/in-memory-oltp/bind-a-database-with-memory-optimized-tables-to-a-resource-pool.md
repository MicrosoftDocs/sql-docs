...
```  
 ...
 For more information, see [sys.dm_resource_governor_resource_pools (Transact-SQL)](../system-dynamic-management-objects/sys-dm-resource-governor-resource-pools-transact-sql.md).  
