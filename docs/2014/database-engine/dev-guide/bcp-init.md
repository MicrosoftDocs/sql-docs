 ...
 *szTable*  
 ...
 If *eDirection* is DB_OUT and a SELECT statement is specified using [bcp_control](../../../2014/database-engine/dev-guide/bcp-control.md) before [bcp_exec](../../../2014/database-engine/dev-guide/bcp-exec.md) is called, **bcp_init***szTable* must be set to NULL.  
  
 *szDataFile*  
 Is the name of the user file to be copied into or out of. If data is being copied directly from variables by using [bcp_sendrow](../../../2014/database-engine/dev-guide/bcp-sendrow.md), set *szDataFile* to NULL.  
