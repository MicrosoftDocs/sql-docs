...
description: Learn how to build a query in the Relational Query Designer so that you can specify which data to retrive from an external data source for a report dataset. 
