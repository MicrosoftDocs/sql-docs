...
# PendingValue Element (ASSL)
  Contains the read-only pending value of the associated [ServerProperty](../../../2014/analysis-services/dev-guide/serverproperty-element-assl.md) element.  
...
|------------------|-------------|  
|Parent element|[ServerProperty](../../../2014/analysis-services/dev-guide/serverproperty-element-assl.md)|  
|Child elements|None|  
