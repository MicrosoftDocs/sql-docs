...
# Display Column and Catalog Metadata for Sparse Columns (OLE DB)
 ...
 This sample works with [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] or later. For more information about sparse columns, see [Sparse Columns Support in SQL Server Native Client](../native-client/features/sparse-columns-support-in-sql-server-native-client.md).  
