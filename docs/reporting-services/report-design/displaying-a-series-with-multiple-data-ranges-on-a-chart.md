...
description: Discover ways to improve readability of your charts using scale breaks, filters, and separating the data ranges into separate series in Report Builder. 
ms.date: 03/07/2017
