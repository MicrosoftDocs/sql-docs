...
# Connect to a Microsoft Access Database (SSAS)
 ...
 To connect to a Microsoft Access database, you must have the appropriate ACE provider installed on your computer. For more information, see [Data Sources Supported &#40;SSAS Tabular&#41;](data-sources-supported-ssas-tabular.md).  
