...
## See Also  
 [Building Applications with SQL Server Native Client](../../../2014/database-engine/dev-guide/installing-sql-server-native-client.md)   
