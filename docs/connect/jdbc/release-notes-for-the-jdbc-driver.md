...
For more information about how to use this feature with JDBC Driver, refer sample [here](../../connect/jdbc/code-samples/sql-discovery-and-classification-sample.md).
