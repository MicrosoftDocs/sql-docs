...
-   Break when the hit count is greater than or equal to a specified value.  
 ...
 The default action for a breakpoint is to break execution when both the hit count and breakpoint condition have been satisfied. For information about specifying other actions, see [Specify a Breakpoint Action](../../2014/database-engine/specify-a-breakpoint-action.md).  
...
## See Also  
 [Specify a Breakpoint Condition](../../2014/database-engine/specify-a-breakpoint-condition.md)  
